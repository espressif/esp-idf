...
typedef void (* esp_mesh_model_cb_t)(esp_ble_mesh_model_cb_event_t event,
 ...
 *                - Callback the messages received by user-defined client and server models to the
 *                  application layer;
 ...
 *                - If the user-defined client model fails to receive the response message during a
 ...
 *                For example, the esp_ble_mesh_register_config_client_callback is the register
 ...
 * @param[in]     msg_timeout: Time to get response to the message.
 ...
 *                needs to be reprovisioned. The esp_ble_mesh_node_prov_enable() API needs
 *                to be called to start a new provisioning procedure.
 *
 * @param         None.
 *
 * @return        ESP_OK on success or error code otherwise.
 ...
 *
 * @note         index is got from the parameters of the ESP_BLE_MESH_PROVISIONER_PROV_COMPLETE_EVT.
 *
 * @return       ESP_OK on success or error code otherwise.
 *
 */
 ...
 *
 * @param[in]     app_key: The app key to be set to the local BLE Mesh stack.
 * @param[in]     net_idx: The network key index.
 * @param[in]     app_idx: The app key index.
 *
 * @note          app_key: If it is set to NULL, app_key will be generated internally.
 ...
 * @param[in]     net_idx: The network key index.
 *
 * @note          net_key: If it is set to NULL, net_key will be generated internally.
