...
typedef void (* esp_mesh_health_client_cb_t)(esp_ble_mesh_health_client_cb_event_t event,
...
typedef void (* esp_mesh_health_server_cb_t)(esp_ble_mesh_health_server_cb_event_t event,
 ...
 *
 */
esp_err_t esp_ble_mesh_register_health_client_callback(esp_mesh_health_client_cb_t callback);
 ...
 *
 */
esp_err_t esp_ble_mesh_register_health_server_callback(esp_mesh_health_server_cb_t callback);
