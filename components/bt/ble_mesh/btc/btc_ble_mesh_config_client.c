...
static inline void btc_ble_mesh_cb_to_app(esp_ble_mesh_cfg_client_cb_event_t event,
        esp_ble_mesh_cfg_client_cb_param_t *param)
{
    esp_mesh_cfg_client_cb_t btc_mesh_cb = (esp_mesh_cfg_client_cb_t)btc_profile_cb_get(BTC_PID_CFG_CLIENT);
    if (btc_mesh_cb) {
...
static void btc_mesh_cfg_client_callback(esp_ble_mesh_cfg_client_cb_param_t *cb_params, uint8_t act)
{
    ...
    btc_transfer_context(&msg, cb_params,
                         sizeof(esp_ble_mesh_cfg_client_cb_param_t), btc_ble_mesh_copy_req_data);
}
        ...
        esp_ble_mesh_cfg_client_cb_param_t *cfg_client_cb)
{
    ...
    case ESP_BLE_MESH_MODEL_OP_MODEL_PUB_GET:
        if (get_state->model_pub_get.company_id == CID_NVAL) {
            return (cfg_client_cb->error_code =
                        bt_mesh_cfg_mod_pub_get(&ctx, get_state->model_pub_get.element_addr,
                                                get_state->model_pub_get.model_id));
        } else {
            return (cfg_client_cb->error_code =
                        bt_mesh_cfg_mod_pub_get_vnd(&ctx, get_state->model_pub_get.element_addr,
                                                    get_state->model_pub_get.model_id, get_state->model_pub_get.company_id));
        }
        ...
        esp_ble_mesh_cfg_client_cb_param_t *cfg_client_cb)
{
    ...
    case ESP_BLE_MESH_MODEL_OP_MODEL_APP_BIND:
        if (set_state->model_app_bind.company_id == CID_NVAL) {
            return (cfg_client_cb->error_code =
                        bt_mesh_cfg_mod_app_bind(&ctx, set_state->model_app_bind.element_addr,
                                                 set_state->model_app_bind.model_app_idx, set_state->model_app_bind.model_id));
        } else {
            return (cfg_client_cb->error_code =
                        bt_mesh_cfg_mod_app_bind_vnd(&ctx, set_state->model_app_bind.element_addr, set_state->model_app_bind.model_app_idx,
    ...
    case ESP_BLE_MESH_MODEL_OP_MODEL_PUB_SET: {
        ...
        if (set_state->model_pub_set.company_id == CID_NVAL) {
            return (cfg_client_cb->error_code =
                        bt_mesh_cfg_mod_pub_set(&ctx, set_state->model_pub_set.element_addr, set_state->model_pub_set.model_id, &model_pub));
        } else {
            return (cfg_client_cb->error_code =
                        bt_mesh_cfg_mod_pub_set_vnd(&ctx, set_state->model_pub_set.element_addr,
                                                    set_state->model_pub_set.model_id, set_state->model_pub_set.company_id, &model_pub));
        }
    }
    case ESP_BLE_MESH_MODEL_OP_MODEL_SUB_ADD:
        if (set_state->model_sub_add.company_id == CID_NVAL) {
            return (cfg_client_cb->error_code =
                        bt_mesh_cfg_mod_sub_add(&ctx, set_state->model_sub_add.element_addr,
                                                set_state->model_sub_add.sub_addr, set_state->model_sub_add.model_id));
        } else {
            return (cfg_client_cb->error_code =
                        bt_mesh_cfg_mod_sub_add_vnd(&ctx, set_state->model_sub_add.element_addr,
                                                    set_state->model_sub_add.sub_addr, set_state->model_sub_add.model_id,
                                                    set_state->model_sub_add.company_id));
        }
    case ESP_BLE_MESH_MODEL_OP_MODEL_SUB_DELETE:
        if (set_state->model_sub_delete.company_id == CID_NVAL) {
            return (cfg_client_cb->error_code =
                        bt_mesh_cfg_mod_sub_del(&ctx, set_state->model_sub_delete.element_addr,
                                                set_state->model_sub_delete.sub_addr, set_state->model_sub_delete.model_id));
        } else {
            return (cfg_client_cb->error_code =
                        bt_mesh_cfg_mod_sub_del_vnd(&ctx, set_state->model_sub_delete.element_addr,
                                                    set_state->model_sub_delete.sub_addr, set_state->model_sub_delete.model_id,
                                                    set_state->model_sub_delete.company_id));
        }
    case ESP_BLE_MESH_MODEL_OP_MODEL_SUB_OVERWRITE:
        if (set_state->model_sub_overwrite.company_id == CID_NVAL) {
            return (cfg_client_cb->error_code =
                        bt_mesh_cfg_mod_sub_overwrite(&ctx, set_state->model_sub_overwrite.element_addr,
                                set_state->model_sub_overwrite.sub_addr, set_state->model_sub_overwrite.model_id));
        } else {
            return (cfg_client_cb->error_code =
                        bt_mesh_cfg_mod_sub_overwrite_vnd(&ctx, set_state->model_sub_overwrite.element_addr,
                                set_state->model_sub_overwrite.sub_addr, set_state->model_sub_overwrite.model_id,
                                set_state->model_sub_overwrite.company_id));
        }
    case ESP_BLE_MESH_MODEL_OP_MODEL_SUB_VIRTUAL_ADDR_ADD:
        if (set_state->model_sub_va_add.company_id == CID_NVAL) {
            return (cfg_client_cb->error_code =
                        bt_mesh_cfg_mod_sub_va_add(&ctx, set_state->model_sub_va_add.element_addr,
                                                   &set_state->model_sub_va_add.label_uuid[0], set_state->model_sub_va_add.model_id));
        } else {
            return (cfg_client_cb->error_code =
                        bt_mesh_cfg_mod_sub_va_add_vnd(&ctx, set_state->model_sub_va_add.element_addr,
                                &set_state->model_sub_va_add.label_uuid[0], set_state->model_sub_va_add.model_id,
                                set_state->model_sub_va_add.company_id));
        }
    case ESP_BLE_MESH_MODEL_OP_MODEL_SUB_VIRTUAL_ADDR_OVERWRITE:
        if (set_state->model_sub_va_overwrite.company_id == CID_NVAL) {
            return (cfg_client_cb->error_code =
                        bt_mesh_cfg_mod_sub_va_overwrite(&ctx, set_state->model_sub_va_overwrite.element_addr,
                                &set_state->model_sub_va_overwrite.label_uuid[0], set_state->model_sub_va_overwrite.model_id));
        } else {
            return (cfg_client_cb->error_code =
                        bt_mesh_cfg_mod_sub_va_overwrite_vnd(&ctx, set_state->model_sub_va_overwrite.element_addr,
                                &set_state->model_sub_va_overwrite.label_uuid[0], set_state->model_sub_va_overwrite.model_id,
                                set_state->model_sub_va_overwrite.company_id));
        }
    case ESP_BLE_MESH_MODEL_OP_MODEL_SUB_VIRTUAL_ADDR_DELETE:
        if (set_state->model_sub_va_delete.company_id == CID_NVAL) {
            return (cfg_client_cb->error_code =
                        bt_mesh_cfg_mod_sub_va_del(&ctx, set_state->model_sub_va_delete.element_addr,
                                                   &set_state->model_sub_va_delete.label_uuid[0], set_state->model_sub_va_delete.model_id));
        } else {
            return (cfg_client_cb->error_code =
                        bt_mesh_cfg_mod_sub_va_del_vnd(&ctx, set_state->model_sub_va_delete.element_addr,
                                &set_state->model_sub_va_delete.label_uuid[0], set_state->model_sub_va_delete.model_id,
                                set_state->model_sub_va_delete.company_id));
        }
