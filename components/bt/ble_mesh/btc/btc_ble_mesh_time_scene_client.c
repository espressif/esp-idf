...
{
    esp_mesh_time_scene_client_cb_t btc_mesh_cb = (esp_mesh_time_scene_client_cb_t)btc_profile_cb_get(BTC_PID_TIME_SCENE_CLIENT);
    if (btc_mesh_cb) {
...
#if 0   /* Currently time scene get state is a empty union */
