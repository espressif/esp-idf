...
esp_err_t esp_ble_gap_config_local_icon (uint16_t icon)
{
    ...
    case ESP_BLE_APPEARANCE_DESKTOP_WORKSTATION:
    case ESP_BLE_APPEARANCE_SERVER_CLASS_COMPUTER:
    case ESP_BLE_APPEARANCE_LAPTOP:
    case ESP_BLE_APPEARANCE_HANDHELD_PC_PDA_CLAMSHELL:
    case ESP_BLE_APPEARANCE_PALM_SIZE_PC_PDA:
    case ESP_BLE_APPEARANCE_WEARABLE_COMPUTER_WATCH_SIZE:
    case ESP_BLE_APPEARANCE_TABLET:
    case ESP_BLE_APPEARANCE_DOCKING_STATION:
    case ESP_BLE_APPEARANCE_ALL_IN_ONE:
    case ESP_BLE_APPEARANCE_BLADE_SERVER:
    case ESP_BLE_APPEARANCE_CONVERTIBLE:
    case ESP_BLE_APPEARANCE_DETACHABLE:
    case ESP_BLE_APPEARANCE_IOT_GATEWAY:
    case ESP_BLE_APPEARANCE_MINI_PC:
    case ESP_BLE_APPEARANCE_STICK_PC:
    case ESP_BLE_APPEARANCE_GENERIC_WATCH:
    case ESP_BLE_APPEARANCE_SPORTS_WATCH:
    case ESP_BLE_APPEARANCE_SMARTWATCH:
    ...
    case ESP_BLE_APPEARANCE_TOUCHPAD:
    case ESP_BLE_APPEARANCE_PRESENTATION_REMOTE:
    ...
    case ESP_BLE_APPEARANCE_GENERIC_CONTROL_DEVICE:
    case ESP_BLE_APPEARANCE_SWITCH:
    case ESP_BLE_APPEARANCE_MULTI_SWITCH:
    case ESP_BLE_APPEARANCE_BUTTON:
    case ESP_BLE_APPEARANCE_SLIDER:
    case ESP_BLE_APPEARANCE_ROTARY_SWITCH:
    case ESP_BLE_APPEARANCE_TOUCH_PANEL:
    case ESP_BLE_APPEARANCE_SINGLE_SWITCH:
    case ESP_BLE_APPEARANCE_DOUBLE_SWITCH:
    case ESP_BLE_APPEARANCE_TRIPLE_SWITCH:
    case ESP_BLE_APPEARANCE_BATTERY_SWITCH:
    case ESP_BLE_APPEARANCE_ENERGY_HARVESTING_SWITCH:
    case ESP_BLE_APPEARANCE_PUSH_BUTTON:
    case ESP_BLE_APPEARANCE_DIAL:
    case ESP_BLE_APPEARANCE_GENERIC_NETWORK_DEVICE:
    case ESP_BLE_APPEARANCE_ACCESS_POINT:
    case ESP_BLE_APPEARANCE_MESH_DEVICE:
    case ESP_BLE_APPEARANCE_MESH_NETWORK_PROXY:
    case ESP_BLE_APPEARANCE_GENERIC_SENSOR:
    case ESP_BLE_APPEARANCE_MOTION_SENSOR:
    case ESP_BLE_APPEARANCE_AIR_QUALITY_SENSOR:
    case ESP_BLE_APPEARANCE_TEMPERATURE_SENSOR:
    case ESP_BLE_APPEARANCE_HUMIDITY_SENSOR:
    case ESP_BLE_APPEARANCE_LEAK_SENSOR:
    case ESP_BLE_APPEARANCE_SMOKE_SENSOR:
    case ESP_BLE_APPEARANCE_OCCUPANCY_SENSOR:
    case ESP_BLE_APPEARANCE_CONTACT_SENSOR:
    case ESP_BLE_APPEARANCE_CARBON_MONOXIDE_SENSOR:
    case ESP_BLE_APPEARANCE_CARBON_DIOXIDE_SENSOR:
    case ESP_BLE_APPEARANCE_AMBIENT_LIGHT_SENSOR:
    case ESP_BLE_APPEARANCE_ENERGY_SENSOR:
    case ESP_BLE_APPEARANCE_COLOR_LIGHT_SENSOR:
    case ESP_BLE_APPEARANCE_RAIN_SENSOR:
    case ESP_BLE_APPEARANCE_FIRE_SENSOR:
    case ESP_BLE_APPEARANCE_WIND_SENSOR:
    case ESP_BLE_APPEARANCE_PROXIMITY_SENSOR:
    case ESP_BLE_APPEARANCE_MULTI_SENSOR:
    case ESP_BLE_APPEARANCE_FLUSH_MOUNTED_SENSOR:
    case ESP_BLE_APPEARANCE_CEILING_MOUNTED_SENSOR:
    case ESP_BLE_APPEARANCE_WALL_MOUNTED_SENSOR:
    case ESP_BLE_APPEARANCE_MULTISENSOR:
    case ESP_BLE_APPEARANCE_ENERGY_METER:
    case ESP_BLE_APPEARANCE_FLAME_DETECTOR:
    case ESP_BLE_APPEARANCE_VEHICLE_TIRE_PRESSURE_SENSOR:
    case ESP_BLE_APPEARANCE_GENERIC_LIGHT_FIXTURES:
    case ESP_BLE_APPEARANCE_WALL_LIGHT:
    case ESP_BLE_APPEARANCE_CEILING_LIGHT:
    case ESP_BLE_APPEARANCE_FLOOR_LIGHT:
    case ESP_BLE_APPEARANCE_CABINET_LIGHT:
    case ESP_BLE_APPEARANCE_DESK_LIGHT:
    case ESP_BLE_APPEARANCE_TROFFER_LIGHT:
    case ESP_BLE_APPEARANCE_PENDANT_LIGHT:
    case ESP_BLE_APPEARANCE_IN_GROUND_LIGHT:
    case ESP_BLE_APPEARANCE_FLOOD_LIGHT:
    case ESP_BLE_APPEARANCE_UNDERWATER_LIGHT:
    case ESP_BLE_APPEARANCE_BOLLARD_WITH_LIGHT:
    case ESP_BLE_APPEARANCE_PATHWAY_LIGHT:
    case ESP_BLE_APPEARANCE_GARDEN_LIGHT:
    case ESP_BLE_APPEARANCE_POLE_TOP_LIGHT:
    case ESP_BLE_APPEARANCE_SPOTLIGHT:
    case ESP_BLE_APPEARANCE_LINEAR_LIGHT:
    case ESP_BLE_APPEARANCE_STREET_LIGHT:
    case ESP_BLE_APPEARANCE_SHELVES_LIGHT:
    case ESP_BLE_APPEARANCE_BAY_LIGHT:
    case ESP_BLE_APPEARANCE_EMERGENCY_EXIT_LIGHT:
    case ESP_BLE_APPEARANCE_LIGHT_CONTROLLER:
    case ESP_BLE_APPEARANCE_LIGHT_DRIVER:
    case ESP_BLE_APPEARANCE_BULB:
    case ESP_BLE_APPEARANCE_LOW_BAY_LIGHT:
    case ESP_BLE_APPEARANCE_HIGH_BAY_LIGHT:
    case ESP_BLE_APPEARANCE_GENERIC_FAN:
    case ESP_BLE_APPEARANCE_CEILING_FAN:
    case ESP_BLE_APPEARANCE_AXIAL_FAN:
    case ESP_BLE_APPEARANCE_EXHAUST_FAN:
    case ESP_BLE_APPEARANCE_PEDESTAL_FAN:
    case ESP_BLE_APPEARANCE_DESK_FAN:
    case ESP_BLE_APPEARANCE_WALL_FAN:
    case ESP_BLE_APPEARANCE_GENERIC_HVAC:
    case ESP_BLE_APPEARANCE_THERMOSTAT:
    case ESP_BLE_APPEARANCE_HUMIDIFIER:
    case ESP_BLE_APPEARANCE_DE_HUMIDIFIER:
    case ESP_BLE_APPEARANCE_HEATER:
    case ESP_BLE_APPEARANCE_RADIATOR:
    case ESP_BLE_APPEARANCE_BOILER:
    case ESP_BLE_APPEARANCE_HEAT_PUMP:
    case ESP_BLE_APPEARANCE_INFRARED_HEATER:
    case ESP_BLE_APPEARANCE_RADIANT_PANEL_HEATER:
    case ESP_BLE_APPEARANCE_FAN_HEATER:
    case ESP_BLE_APPEARANCE_AIR_CURTAIN:
    case ESP_BLE_APPEARANCE_GENERIC_AIR_CONDITIONING:
    case ESP_BLE_APPEARANCE_GENERIC_HUMIDIFIER:
    case ESP_BLE_APPEARANCE_GENERIC_HEATING:
    case ESP_BLE_APPEARANCE_RADIATOR:
    case ESP_BLE_APPEARANCE_BOILER:
    case ESP_BLE_APPEARANCE_HEAT_PUMP:
    case ESP_BLE_APPEARANCE_INFRARED_HEATER:
    ...
    case ESP_BLE_APPEARANCE_FAN_HEATER:
    case ESP_BLE_APPEARANCE_AIR_CURTAIN:
    case ESP_BLE_APPEARANCE_GENERIC_ACCESS_CONTROL:
    case ESP_BLE_APPEARANCE_ACCESS_DOOR:
    case ESP_BLE_APPEARANCE_GARAGE_DOOR:
    case ESP_BLE_APPEARANCE_EMERGENCY_EXIT_DOOR:
    case ESP_BLE_APPEARANCE_ACCESS_LOCK:
    case ESP_BLE_APPEARANCE_ELEVATOR:
    case ESP_BLE_APPEARANCE_WINDOW:
    case ESP_BLE_APPEARANCE_ENTRANCE_GATE:
    case ESP_BLE_APPEARANCE_DOOR_LOCK:
    case ESP_BLE_APPEARANCE_LOCKER:
    case ESP_BLE_APPEARANCE_GENERIC_MOTORIZED_DEVICE:
    case ESP_BLE_APPEARANCE_MOTORIZED_GATE:
    case ESP_BLE_APPEARANCE_AWNING:
    case ESP_BLE_APPEARANCE_BLINDS_OR_SHADES:
    case ESP_BLE_APPEARANCE_CURTAINS:
    case ESP_BLE_APPEARANCE_SCREEN:
    case ESP_BLE_APPEARANCE_GENERIC_POWER_DEVICE:
    case ESP_BLE_APPEARANCE_POWER_OUTLET:
    case ESP_BLE_APPEARANCE_POWER_STRIP:
    case ESP_BLE_APPEARANCE_PLUG:
    case ESP_BLE_APPEARANCE_POWER_SUPPLY:
    case ESP_BLE_APPEARANCE_LED_DRIVER:
    case ESP_BLE_APPEARANCE_FLUORESCENT_LAMP_GEAR:
    case ESP_BLE_APPEARANCE_HID_LAMP_GEAR:
    case ESP_BLE_APPEARANCE_CHARGE_CASE:
    case ESP_BLE_APPEARANCE_POWER_BANK:
    case ESP_BLE_APPEARANCE_GENERIC_LIGHT_SOURCE:
    case ESP_BLE_APPEARANCE_INCANDESCENT_LIGHT_BULB:
    case ESP_BLE_APPEARANCE_LED_LAMP:
    case ESP_BLE_APPEARANCE_HID_LAMP:
    case ESP_BLE_APPEARANCE_FLUORESCENT_LAMP:
    case ESP_BLE_APPEARANCE_LED_ARRAY:
    case ESP_BLE_APPEARANCE_MULTI_COLOR_LED_ARRAY:
    case ESP_BLE_APPEARANCE_LOW_VOLTAGE_HALOGEN:
    case ESP_BLE_APPEARANCE_ORGANIC_LIGHT_EMITTING_DIODE_OLED:
    case ESP_BLE_APPEARANCE_GENERIC_WINDOW_COVERING:
    case ESP_BLE_APPEARANCE_WINDOW_SHADES:
    case ESP_BLE_APPEARANCE_WINDOW_BLINDS:
    case ESP_BLE_APPEARANCE_WINDOW_AWNING:
    case ESP_BLE_APPEARANCE_WINDOW_CURTAIN:
    case ESP_BLE_APPEARANCE_EXTERIOR_SHUTTER:
    case ESP_BLE_APPEARANCE_EXTERIOR_SCREEN:
    case ESP_BLE_APPEARANCE_GENERIC_AUDIO_SINK:
    case ESP_BLE_APPEARANCE_STANDALONE_SPEAKER:
    case ESP_BLE_APPEARANCE_SOUNDBAR:
    case ESP_BLE_APPEARANCE_BOOKSHELF_SPEAKER:
    case ESP_BLE_APPEARANCE_STANDMOUNTED_SPEAKER:
    case ESP_BLE_APPEARANCE_SPEAKERPHONE:
    case ESP_BLE_APPEARANCE_GENERIC_AUDIO_SOURCE:
    case ESP_BLE_APPEARANCE_MICROPHONE:
    case ESP_BLE_APPEARANCE_ALARM:
    case ESP_BLE_APPEARANCE_BELL:
    case ESP_BLE_APPEARANCE_HORN:
    case ESP_BLE_APPEARANCE_BROADCASTING_DEVICE:
    case ESP_BLE_APPEARANCE_SERVICE_DESK:
    case ESP_BLE_APPEARANCE_KIOSK:
    case ESP_BLE_APPEARANCE_BROADCASTING_ROOM:
    case ESP_BLE_APPEARANCE_AUDITORIUM:
    case ESP_BLE_APPEARANCE_GENERIC_MOTORIZED_VEHICLE:
    case ESP_BLE_APPEARANCE_CAR:
    case ESP_BLE_APPEARANCE_LARGE_GOODS_VEHICLE:
    case ESP_BLE_APPEARANCE_TWO_WHEELED_VEHICLE:
    case ESP_BLE_APPEARANCE_MOTORBIKE:
    case ESP_BLE_APPEARANCE_SCOOTER:
    case ESP_BLE_APPEARANCE_MOPED:
    case ESP_BLE_APPEARANCE_THREE_WHEELED_VEHICLE:
    case ESP_BLE_APPEARANCE_LIGHT_VEHICLE:
    case ESP_BLE_APPEARANCE_QUAD_BIKE:
    case ESP_BLE_APPEARANCE_MINIBUS:
    case ESP_BLE_APPEARANCE_BUS:
    case ESP_BLE_APPEARANCE_TROLLEY:
    case ESP_BLE_APPEARANCE_AGRICULTURAL_VEHICLE:
    case ESP_BLE_APPEARANCE_CAMPER_CARAVAN:
    case ESP_BLE_APPEARANCE_RECREATIONAL_VEHICLE_MOTOR_HOME:
    case ESP_BLE_APPEARANCE_GENERIC_DOMESTIC_APPLIANCE:
    case ESP_BLE_APPEARANCE_REFRIGERATOR:
    case ESP_BLE_APPEARANCE_FREEZER:
    case ESP_BLE_APPEARANCE_OVEN:
    case ESP_BLE_APPEARANCE_MICROWAVE:
    case ESP_BLE_APPEARANCE_TOASTER:
    case ESP_BLE_APPEARANCE_WASHING_MACHINE:
    case ESP_BLE_APPEARANCE_DRYER:
    case ESP_BLE_APPEARANCE_COFFEE_MAKER:
    case ESP_BLE_APPEARANCE_CLOTHES_IRON:
    case ESP_BLE_APPEARANCE_CURLING_IRON:
    case ESP_BLE_APPEARANCE_HAIR_DRYER:
    case ESP_BLE_APPEARANCE_VACUUM_CLEANER:
    case ESP_BLE_APPEARANCE_ROBOTIC_VACUUM_CLEANER:
    case ESP_BLE_APPEARANCE_RICE_COOKER:
    case ESP_BLE_APPEARANCE_CLOTHES_STEAMER:
    case ESP_BLE_APPEARANCE_GENERIC_WEARABLE_AUDIO_DEVICE:
    case ESP_BLE_APPEARANCE_EARBUD:
    case ESP_BLE_APPEARANCE_HEADSET:
    case ESP_BLE_APPEARANCE_HEADPHONES:
    case ESP_BLE_APPEARANCE_NECK_BAND:
    case ESP_BLE_APPEARANCE_GENERIC_AIRCRAFT:
    case ESP_BLE_APPEARANCE_LIGHT_AIRCRAFT:
    case ESP_BLE_APPEARANCE_MICROLIGHT:
    case ESP_BLE_APPEARANCE_PARAGLIDER:
    case ESP_BLE_APPEARANCE_LARGE_PASSENGER_AIRCRAFT:
    case ESP_BLE_APPEARANCE_GENERIC_AV_EQUIPMENT:
    case ESP_BLE_APPEARANCE_AMPLIFIER:
    case ESP_BLE_APPEARANCE_RECEIVER:
    case ESP_BLE_APPEARANCE_RADIO:
    case ESP_BLE_APPEARANCE_TUNER:
    case ESP_BLE_APPEARANCE_TURNTABLE:
    case ESP_BLE_APPEARANCE_CD_PLAYER:
    case ESP_BLE_APPEARANCE_DVD_PLAYER:
    case ESP_BLE_APPEARANCE_BLURAY_PLAYER:
    case ESP_BLE_APPEARANCE_OPTICAL_DISC_PLAYER:
    case ESP_BLE_APPEARANCE_SET_TOP_BOX:
    case ESP_BLE_APPEARANCE_GENERIC_DISPLAY_EQUIPMENT:
    case ESP_BLE_APPEARANCE_TELEVISION:
    case ESP_BLE_APPEARANCE_MONITOR:
    case ESP_BLE_APPEARANCE_PROJECTOR:
    case ESP_BLE_APPEARANCE_GENERIC_HEARING_AID:
    case ESP_BLE_APPEARANCE_IN_EAR_HEARING_AID:
    case ESP_BLE_APPEARANCE_BEHIND_EAR_HEARING_AID:
    case ESP_BLE_APPEARANCE_COCHLEAR_IMPLANT:
    case ESP_BLE_APPEARANCE_GENERIC_GAMING:
    case ESP_BLE_APPEARANCE_HOME_VIDEO_GAME_CONSOLE:
    case ESP_BLE_APPEARANCE_PORTABLE_HANDHELD_CONSOLE:
    case ESP_BLE_APPEARANCE_GENERIC_SIGNAGE:
    case ESP_BLE_APPEARANCE_DIGITAL_SIGNAGE:
    case ESP_BLE_APPEARANCE_ELECTRONIC_LABEL:
    ...
    case ESP_BLE_APPEARANCE_GENERIC_SPIROMETER:
    case ESP_BLE_APPEARANCE_HANDHELD_SPIROMETER:
