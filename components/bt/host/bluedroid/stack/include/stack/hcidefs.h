...
#define HCI_BLE_ADD_MONITOR_ADV_LIST         (0x0098 | HCI_GRP_BLE_CMDS)
#define HCI_BLE_RMV_MONITOR_ADV_LIST         (0x0099 | HCI_GRP_BLE_CMDS)
#define HCI_BLE_CLEAR_MONITOR_ADV_LIST       (0x009A | HCI_GRP_BLE_CMDS)
#define HCI_BLE_READ_MONITOR_ADV_LIST_SIZE   (0x009B | HCI_GRP_BLE_CMDS)
...
/* Supported Commands (Byte 45) - HCI_Set_Min_Encryption_Key_Size (bit 7) */
#define HCI_SUPP_COMMANDS_SET_MIN_ENC_KEY_SIZE_MASK     0x80
#define HCI_SUPP_COMMANDS_SET_MIN_ENC_KEY_SIZE_OFF      45
#define HCI_SET_MIN_ENC_KEY_SIZE_SUPPORTED(x)   ((x)[HCI_SUPP_COMMANDS_SET_MIN_ENC_KEY_SIZE_OFF] & HCI_SUPP_COMMANDS_SET_MIN_ENC_KEY_SIZE_MASK)
