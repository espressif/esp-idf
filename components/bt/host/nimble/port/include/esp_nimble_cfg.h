...
#ifndef MYNEWT_VAL_BLE_STORE_OVERFLOW_LFU
#ifdef CONFIG_BT_NIMBLE_STORE_OVERFLOW_LFU
#define MYNEWT_VAL_BLE_STORE_OVERFLOW_LFU (1)
#else
#define MYNEWT_VAL_BLE_STORE_OVERFLOW_LFU (0)
#endif
#endif
