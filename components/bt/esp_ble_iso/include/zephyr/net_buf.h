...
#ifndef _BT_AUDIO_BUF_H_
#define _BT_AUDIO_BUF_H_
...
#define NET_BUF_USER_DATA_SIZE      8
...
struct net_buf {
    ...
    uint8_t user_data[NET_BUF_USER_DATA_SIZE] __net_buf_align;
};
