...
#if defined(CONFIG_BT_CTRL_ALLOW_MALLOC_FROM_SPIRAM) && defined(CONFIG_SPIRAM)
#define UC_BT_CTRL_ALLOW_MALLOC_FROM_SPIRAM (CONFIG_BT_CTRL_ALLOW_MALLOC_FROM_SPIRAM && CONFIG_SPIRAM)
#else
