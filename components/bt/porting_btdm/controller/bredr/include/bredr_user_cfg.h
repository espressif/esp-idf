...
#if defined(CONFIG_BT_CTRL_BR_EDR_SAM_EN) && CONFIG_BT_CTRL_BR_EDR_SAM_EN
#define UC_BR_EDR_SAM_EN 1
#else
#define UC_BR_EDR_SAM_EN 0
#endif

#if defined(CONFIG_BT_CTRL_BR_EDR_MWS_EN) && CONFIG_BT_CTRL_BR_EDR_MWS_EN
#define UC_BR_EDR_MWS_EN 1
#else
#define UC_BR_EDR_MWS_EN 0
#endif
...
#if (UC_BR_EDR_CTRL_MAX_SYNC_CONN != 0) && defined(CONFIG_BT_CTRL_BR_EDR_STATIC_SYNC_TX_BUF_NB)
#define UC_BR_EDR_STATIC_SYNC_TX_BUF_NB (CONFIG_BT_CTRL_BR_EDR_STATIC_SYNC_TX_BUF_NB)
#else
#define UC_BR_EDR_STATIC_SYNC_TX_BUF_NB (0)
#endif

#if (UC_BR_EDR_CTRL_MAX_SYNC_CONN != 0) && defined(CONFIG_BT_CTRL_BR_EDR_DYNAMIC_SYNC_TX_BUF_NB)
#define UC_BR_EDR_DYNAMIC_SYNC_TX_BUF_NB (CONFIG_BT_CTRL_BR_EDR_DYNAMIC_SYNC_TX_BUF_NB)
#else
#define UC_BR_EDR_DYNAMIC_SYNC_TX_BUF_NB (0)
#endif

#if (UC_BR_EDR_CTRL_MAX_SYNC_CONN != 0) && defined(CONFIG_BT_CTRL_BR_EDR_STATIC_SYNC_RX_BUF_NB)
#define UC_BR_EDR_STATIC_SYNC_RX_BUF_NB (CONFIG_BT_CTRL_BR_EDR_STATIC_SYNC_RX_BUF_NB)
#else
#define UC_BR_EDR_STATIC_SYNC_RX_BUF_NB (0)
#endif

#if (UC_BR_EDR_CTRL_MAX_SYNC_CONN != 0) && defined(CONFIG_BT_CTRL_BR_EDR_SYNC_RX_BUF_NB_PER_LINK)
#define UC_BR_EDR_SYNC_RX_BUF_NB_PER_LINK (CONFIG_BT_CTRL_BR_EDR_SYNC_RX_BUF_NB_PER_LINK)
#else
#define UC_BR_EDR_SYNC_RX_BUF_NB_PER_LINK (0)
#endif

#if (UC_BR_EDR_CTRL_MAX_SYNC_CONN != 0)
#define UC_BR_EDR_SYNC_RX_BUF_NB ((UC_BR_EDR_STATIC_SYNC_RX_BUF_NB > (UC_BR_EDR_CTRL_MAX_SYNC_CONN * UC_BR_EDR_SYNC_RX_BUF_NB_PER_LINK)) ? \
                                  (UC_BR_EDR_STATIC_SYNC_RX_BUF_NB) : (UC_BR_EDR_CTRL_MAX_SYNC_CONN * UC_BR_EDR_SYNC_RX_BUF_NB_PER_LINK))
#else
