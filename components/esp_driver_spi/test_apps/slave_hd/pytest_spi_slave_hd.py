...
@pytest.mark.generic
@idf_parametrize('target', ['esp32s2', 'esp32s3', 'esp32c2', 'esp32c3', 'esp32c6', 'esp32h2'], indirect=['target'])
...
@idf_parametrize(
    'target', ['esp32s2', 'esp32s3', 'esp32c2', 'esp32c3', 'esp32c6', 'esp32h2', 'esp32p4'], indirect=['target']
)
