...
typedef union {
    struct {
        ...
        /** secure_boot_disable_fast_wake : RO; bitpos: [24]; default: 0;
...
typedef union {
    struct {
        ...
        /** secure_boot_key_revoke_0_err : RO; bitpos: [26]; default: 0;
         *  Represents the programming error of EFUSE_SECURE_BOOT_KEY_REVOKE_0
         */
        uint32_t secure_boot_key_revoke_0_err:1;
        /** secure_boot_key_revoke_1_err : RO; bitpos: [27]; default: 0;
         *  Represents the programming error of EFUSE_SECURE_BOOT_KEY_REVOKE_1
         */
        uint32_t secure_boot_key_revoke_1_err:1;
        /** secure_boot_key_revoke_2_err : RO; bitpos: [28]; default: 0;
         *  Represents the programming error of EFUSE_SECURE_BOOT_KEY_REVOKE_2
         */
        uint32_t secure_boot_key_revoke_2_err:1;
...
typedef union {
    struct {
        ...
        /** dis_usb_serial_jtag_download_mode_err : RO; bitpos: [3]; default: 0;
