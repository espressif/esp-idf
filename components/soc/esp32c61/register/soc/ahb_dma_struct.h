...
typedef union {
    struct {
        ...
        /** out_dscr_clk_en : R/W; bitpos: [3:2]; default: 7;
        ...
        /** out_ctrl_clk_en : R/W; bitpos: [5:4]; default: 7;
        ...
        /** in_dscr_clk_en : R/W; bitpos: [7:6]; default: 7;
        ...
        /** in_ctrl_clk_en : R/W; bitpos: [9:8]; default: 7;
...
typedef union {
    struct {
        ...
        /** ahbinf_resp_err_ch_id : RO; bitpos: [6:5]; default: 0;
...
typedef struct {
    ...
    volatile ahb_dma_in_peri_chn_reg_t in_pri;
...
typedef struct {
    ...
    volatile ahb_dma_out_peri_chn_reg_t out_pri;
...
#ifndef __cplusplus
_Static_assert(sizeof(ahb_dma_dev_t) == 0x410, "Invalid size of ahb_dma_dev_t structure");
#endif
