 ...
 *  The raw interrupt status of AHB_DMA_IN_AHBINF_RESP_ERR_CH0_INT.
 */
 ...
 *  The masked interrupt status of AHB_DMA_IN_AHBINF_RESP_ERR_CH0_INT.
 */
 ...
 *  Write 1 to enable AHB_DMA_IN_AHBINF_RESP_ERR_CH0_INT.
 */
 ...
 *  Write 1 to clear AHB_DMA_IN_AHBINF_RESP_ERR_CH0_INT.
 */
 ...
 *  The raw interrupt status of AHB_DMA_IN_AHBINF_RESP_ERR_CH1_INT.
 */
 ...
 *  The masked interrupt status of AHB_DMA_IN_AHBINF_RESP_ERR_CH1_INT.
 */
 ...
 *  Write 1 to enable AHB_DMA_IN_AHBINF_RESP_ERR_CH1_INT.
 */
 ...
 *  Write 1 to clear AHB_DMA_IN_AHBINF_RESP_ERR_CH1_INT.
 */
 ...
 *  The raw interrupt status of AHB_DMA_OUT_AHBINF_RESP_ERR_CH0_INT.
 */
 ...
 *  The masked interrupt status of AHB_DMA_OUT_AHBINF_RESP_ERR_CH0_INT.
 */
 ...
 *  Write 1 to enable AHB_DMA_OUT_AHBINF_RESP_ERR_CH0_INT.
 */
 ...
 *  Write 1 to clear AHB_DMA_OUT_AHBINF_RESP_ERR_CH0_INT.
 */
 ...
 *  The raw interrupt status of AHB_DMA_OUT_AHBINF_RESP_ERR_CH1_INT.
 */
 ...
 *  The masked interrupt status of AHB_DMA_OUT_AHBINF_RESP_ERR_CH1_INT.
 */
 ...
 *  Write 1 to enable AHB_DMA_OUT_AHBINF_RESP_ERR_CH1_INT.
 */
 ...
 *  Write 1 to clear AHB_DMA_OUT_AHBINF_RESP_ERR_CH1_INT.
 */
...
/** AHB_DMA_TX_CH_ARB_WEIGHT_CH0 : R/W; bitpos: [3:0]; default: 0;
 *  Configures the weight (i.e. the number of tokens) of TX channel0.
 *  Value range: 0 ~ 15.
 */
#define AHB_DMA_TX_CH_ARB_WEIGHT_CH0    0x0000000FU
#define AHB_DMA_TX_CH_ARB_WEIGHT_CH0_M  (AHB_DMA_TX_CH_ARB_WEIGHT_CH0_V << AHB_DMA_TX_CH_ARB_WEIGHT_CH0_S)
#define AHB_DMA_TX_CH_ARB_WEIGHT_CH0_V  0x0000000FU
#define AHB_DMA_TX_CH_ARB_WEIGHT_CH0_S  0
...
/** AHB_DMA_TX_CH_ARB_WEIGHT_CH1 : R/W; bitpos: [3:0]; default: 0;
 *  Configures the weight (i.e. the number of tokens) of TX channel1.
 *  Value range: 0 ~ 15.
 */
#define AHB_DMA_TX_CH_ARB_WEIGHT_CH1    0x0000000FU
#define AHB_DMA_TX_CH_ARB_WEIGHT_CH1_M  (AHB_DMA_TX_CH_ARB_WEIGHT_CH1_V << AHB_DMA_TX_CH_ARB_WEIGHT_CH1_S)
#define AHB_DMA_TX_CH_ARB_WEIGHT_CH1_V  0x0000000FU
#define AHB_DMA_TX_CH_ARB_WEIGHT_CH1_S  0
...
/** AHB_DMA_RX_CH_ARB_WEIGHT_CH0 : R/W; bitpos: [3:0]; default: 0;
 *  Configures the weight (i.e. the number of tokens) of RX channel0.
 *  Value range: 0 ~ 15.
 */
#define AHB_DMA_RX_CH_ARB_WEIGHT_CH0    0x0000000FU
#define AHB_DMA_RX_CH_ARB_WEIGHT_CH0_M  (AHB_DMA_RX_CH_ARB_WEIGHT_CH0_V << AHB_DMA_RX_CH_ARB_WEIGHT_CH0_S)
#define AHB_DMA_RX_CH_ARB_WEIGHT_CH0_V  0x0000000FU
#define AHB_DMA_RX_CH_ARB_WEIGHT_CH0_S  0
...
/** AHB_DMA_RX_CH_ARB_WEIGHT_CH1 : R/W; bitpos: [3:0]; default: 0;
 *  Configures the weight (i.e. the number of tokens) of RX channel1.
 *  Value range: 0 ~ 15.
 */
#define AHB_DMA_RX_CH_ARB_WEIGHT_CH1    0x0000000FU
#define AHB_DMA_RX_CH_ARB_WEIGHT_CH1_M  (AHB_DMA_RX_CH_ARB_WEIGHT_CH1_V << AHB_DMA_RX_CH_ARB_WEIGHT_CH1_S)
#define AHB_DMA_RX_CH_ARB_WEIGHT_CH1_V  0x0000000FU
#define AHB_DMA_RX_CH_ARB_WEIGHT_CH1_S  0
 ...
 *  Weight arbitration timeout configuration register
 */
#define AHB_DMA_ARB_TIMEOUT_REG (DR_REG_AHB_DMA_BASE + 0x3dc)
/** AHB_DMA_ARB_TIMEOUT : R/W; bitpos: [15:0]; default: 0;
 *  Configures the time slot for weight arbitration. Measurement unit: AHB bus clock
 *  cycle.
 */
 ...
 *  Weight arbitration enable register
 */
 ...
 *  Force clock enable register for all internal GDMA modules
 */
#define AHB_DMA_MODULE_CLK_EN_REG (DR_REG_AHB_DMA_BASE + 0x404)
/** AHB_DMA_AHB_APB_SYNC_CLK_EN : R/W; bitpos: [1:0]; default: 3;
 *  Configures whether to force enable the clock for the GDMA register configuration
 *  synchronization module.
 *  Bit 0 corresponds to TX and RX channel 0, bit 1 corresponds to TX and RX channel 1,
 *  and so on.
 *  0: Not forced to enable
 *  1: Forced to enable
 */
#define AHB_DMA_AHB_APB_SYNC_CLK_EN    0x00000003U
#define AHB_DMA_AHB_APB_SYNC_CLK_EN_M  (AHB_DMA_AHB_APB_SYNC_CLK_EN_V << AHB_DMA_AHB_APB_SYNC_CLK_EN_S)
#define AHB_DMA_AHB_APB_SYNC_CLK_EN_V  0x00000003U
#define AHB_DMA_AHB_APB_SYNC_CLK_EN_S  0
/** AHB_DMA_OUT_DSCR_CLK_EN : R/W; bitpos: [3:2]; default: 7;
 *  Configures whether to force enable the clock for the GDMA TX descriptor processing
 *  module.
 *  Bit 0 corresponds to TX channel 0, bit 1 corresponds to TX channel 1, and so on.
 *  0: Not forced to enable
 *  1: Forced to enable
 */
#define AHB_DMA_OUT_DSCR_CLK_EN    0x00000003U
#define AHB_DMA_OUT_DSCR_CLK_EN_M  (AHB_DMA_OUT_DSCR_CLK_EN_V << AHB_DMA_OUT_DSCR_CLK_EN_S)
#define AHB_DMA_OUT_DSCR_CLK_EN_V  0x00000003U
#define AHB_DMA_OUT_DSCR_CLK_EN_S  2
/** AHB_DMA_OUT_CTRL_CLK_EN : R/W; bitpos: [5:4]; default: 7;
 *  Configures whether to force enable the clock for the GDMA TX data processing module.
 *  Bit 0 corresponds to TX channel 0, bit 1 corresponds to TX channel 1, and so on.
 *  0: Not forced to enable
 *  1: Forced to enable
 */
#define AHB_DMA_OUT_CTRL_CLK_EN    0x00000003U
#define AHB_DMA_OUT_CTRL_CLK_EN_M  (AHB_DMA_OUT_CTRL_CLK_EN_V << AHB_DMA_OUT_CTRL_CLK_EN_S)
#define AHB_DMA_OUT_CTRL_CLK_EN_V  0x00000003U
#define AHB_DMA_OUT_CTRL_CLK_EN_S  4
/** AHB_DMA_IN_DSCR_CLK_EN : R/W; bitpos: [7:6]; default: 7;
 *  Configures whether to force enable the clock for the GDMA RX descriptor processing
 *  module.
 *  Bit 0 corresponds to RX channel 0, bit 1 corresponds to RX channel 1, and so on.
 *  0: Not forced to enable
 *  1: Forced to enable
 */
#define AHB_DMA_IN_DSCR_CLK_EN    0x00000003U
#define AHB_DMA_IN_DSCR_CLK_EN_M  (AHB_DMA_IN_DSCR_CLK_EN_V << AHB_DMA_IN_DSCR_CLK_EN_S)
#define AHB_DMA_IN_DSCR_CLK_EN_V  0x00000003U
#define AHB_DMA_IN_DSCR_CLK_EN_S  6
/** AHB_DMA_IN_CTRL_CLK_EN : R/W; bitpos: [9:8]; default: 7;
 *  Configures whether to force enable the clock for the GDMA RX data processing module.
 *  Bit 0 corresponds to RX channel 0, bit 1 corresponds to RX channel 1, and so on.
 *  0: Not forced to enable
 *  1: Forced to enable
 */
#define AHB_DMA_IN_CTRL_CLK_EN    0x00000003U
#define AHB_DMA_IN_CTRL_CLK_EN_M  (AHB_DMA_IN_CTRL_CLK_EN_V << AHB_DMA_IN_CTRL_CLK_EN_S)
#define AHB_DMA_IN_CTRL_CLK_EN_V  0x00000003U
#define AHB_DMA_IN_CTRL_CLK_EN_S  8
/** AHB_DMA_CMD_ARB_CLK_EN : R/W; bitpos: [27]; default: 0;
 *  Configures whether to force enable the clock for the GDMA arbiter module.
 *  0: Not forced to enable
 *  1: Forced to enable
 */
 ...
 *  Configures whether to force enable the clock for the GDMA bus interface processing
 *  module.
 *  0: Not forced to enable
 *  1: Forced to enable
 */
 ...
 *  AHB bus error response status register 0
 */
 ...
 *  Represents the address of the current AHB bus transfer that triggers an error
 *  response.
 */
 ...
 *  AHB bus error response status register 1
 */
#define AHB_DMA_AHBINF_RESP_ERR_STATUS1_REG (DR_REG_AHB_DMA_BASE + 0x40c)
/** AHB_DMA_AHBINF_RESP_ERR_WR : RO; bitpos: [0]; default: 0;
 *  Represents the type of the transfer that triggered the AHB bus error response
 *  received by the GDMA.
 *  0: Read
 *  1: Write
 */
 ...
 *  Represents the ID of the transfer that triggers the AHB bus error response.
 *  0: Reserved
...
/** AHB_DMA_AHBINF_RESP_ERR_CH_ID : RO; bitpos: [6:5]; default: 0;
 *  Represents the channel ID of the transfer that triggers the AHB bus error response.
 *  Bit[0]: Channel number. Value range: 0 ~ 1
 *  Bit[1]: Channel direction.
 *  0: RX
 *  1: TX
 */
#define AHB_DMA_AHBINF_RESP_ERR_CH_ID    0x00000003U
#define AHB_DMA_AHBINF_RESP_ERR_CH_ID_M  (AHB_DMA_AHBINF_RESP_ERR_CH_ID_V << AHB_DMA_AHBINF_RESP_ERR_CH_ID_S)
#define AHB_DMA_AHBINF_RESP_ERR_CH_ID_V  0x00000003U
