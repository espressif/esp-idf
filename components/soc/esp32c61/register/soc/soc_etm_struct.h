...
/** Type of ch_evt_id register
 *  Channel0 event id register
 */
typedef union {
    struct {
        /** ch_evt_id : R/W; bitpos: [6:0]; default: 0;
         *  Configures ch_evt_id
         */
...
/** Type of ch_task_id register
 *  Channel0 task id register
 */
typedef union {
    struct {
        /** ch_task_id : R/W; bitpos: [7:0]; default: 0;
         *  Configures ch_task_id
         */
