...
typedef union {
    struct {
        ...
        /** hp_active_hp_regulator_slp_connect_en : R/W; bitpos: [3]; default: 1;
         *  need_des
         */
...
typedef union {
    struct {
        ...
        /** hp_modem_pd_hp_peri_pd_en : R/W; bitpos: [28]; default: 0;
         *  need_des
         */
        uint32_t hp_modem_pd_hp_peri_pd_en:1;
...
/** Type of power_pd_hpperi_cntl register
 *  need_des
 */
typedef union {
    struct {
    ...
    uint32_t val;
} pmu_power_pd_hpperi_cntl_reg_t;
...
typedef union {
    struct {
        /** pmu_date : R/W; bitpos: [30:0]; default: 36770128;
         *  need_des
         */
...
typedef struct {
    ...
    volatile pmu_power_pd_hpperi_cntl_reg_t power_pd_hpperi_cntl;
