...
typedef union {
    struct {
        ...
        /** l1_icache2_miss_disable_access : HRO; bitpos: [2]; default: 0;
         *  Reserved
         */
...
typedef union {
    struct {
        ...
        /** l1_icache2_data_mem_rd_en : HRO; bitpos: [8]; default: 0;
         *  Reserved
         */
        uint32_t l1_icache2_data_mem_rd_en:1;
        /** l1_icache2_data_mem_wr_en : HRO; bitpos: [9]; default: 0;
         *  Reserved
         */
...
typedef union {
    struct {
        ...
        uint32_t reserved_6:2;
        /** l1_icache2_tag_mem_rd_en : HRO; bitpos: [8]; default: 0;
         *  Reserved
         */
        uint32_t l1_icache2_tag_mem_rd_en:1;
        /** l1_icache2_tag_mem_wr_en : HRO; bitpos: [9]; default: 0;
         *  Reserved
         */
...
typedef union {
    struct {
        ...
        /** l1_dbus2_ovf_int_clr : R/W; bitpos: [6]; default: 0;
         *  Reserved
         */
        uint32_t l1_dbus2_ovf_int_clr:1;
        /** l1_dbus3_ovf_int_clr : R/W; bitpos: [7]; default: 0;
         *  Reserved
         */
...
typedef union {
    struct {
        ...
        /** l1_dbus2_ovf_int_st : RO; bitpos: [6]; default: 0;
         *  Reserved
         */
        uint32_t l1_dbus2_ovf_int_st:1;
        /** l1_dbus3_ovf_int_st : RO; bitpos: [7]; default: 0;
         *  Reserved
         */
...
typedef union {
    struct {
        ...
        /** l1_icache3_fail_int_clr : WT; bitpos: [3]; default: 0;
         *  Reserved
         */
...
typedef union {
    struct {
        ...
        /** l1_icache3_fail_int_st : RO; bitpos: [3]; default: 0;
         *  Reserved
         */
...
typedef union {
    struct {
        ...
        /** l1_icache2_acs_fail_check_mode : HRO; bitpos: [2]; default: 0;
...
typedef union {
    struct {
        ...
        /** l1_icache3_tag_object : R/W; bitpos: [3]; default: 0;
         *  Reserved
         */
        ...
        /** l1_icache3_mem_object : R/W; bitpos: [9]; default: 0;
         *  Reserved
         */
