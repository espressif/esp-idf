 ...
 *  the input signals are delayed by SPI module clock cycles, 0: input without delayed,
 *  1: input at the (SPI_DIN5_NUM+1)th falling edge of clk_spi_mst,2 input at the
 *  (SPI_DIN5_NUM+1)th rising edge of clk_hclk plus one clk_spi_mst rising edge cycle,
 *  3: input at the (SPI_DIN5_NUM+1)th rising edge of clk_hclk plus one clk_spi_mst
 *  falling edge cycle. Can be configured in CONF state.
 */
 ...
 *  the input signals are delayed by SPI module clock cycles, 0: input without delayed,
 *  1: input at the (SPI_DIN6_NUM+1)th falling edge of clk_spi_mst,2 input at the
 *  (SPI_DIN6_NUM+1)th rising edge of clk_hclk plus one clk_spi_mst rising edge cycle,
 *  3: input at the (SPI_DIN6_NUM+1)th rising edge of clk_hclk plus one clk_spi_mst
 *  falling edge cycle. Can be configured in CONF state.
 */
 ...
 *  the input signals are delayed by SPI module clock cycles, 0: input without delayed,
 *  1: input at the (SPI_DIN7_NUM+1)th falling edge of clk_spi_mst,2 input at the
 *  (SPI_DIN7_NUM+1)th rising edge of clk_hclk plus one clk_spi_mst rising edge cycle,
 *  3: input at the (SPI_DIN7_NUM+1)th rising edge of clk_hclk plus one clk_spi_mst
 *  falling edge cycle. Can be configured in CONF state.
 */
