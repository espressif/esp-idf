...
typedef volatile struct {
    union {
        struct {
            ...
            uint32_t xpd_rfpll                     :    1;  /*Need add description*/
            uint32_t xpd_rfpll_force               :    1;  /*Need add description*/
            uint32_t ctr_sel                       :    3;  /*Need add description*/
            uint32_t xtl_force_iso                 :    1;  /*Need add description*/
            uint32_t pll_force_iso                 :    1;  /*Need add description*/
            uint32_t analog_force_iso              :    1;  /*Need add description*/
            uint32_t xtl_force_noiso               :    1;  /*Need add description*/
            uint32_t pll_force_noiso               :    1;  /*Need add description*/
            uint32_t analog_force_noiso            :    1;  /*Need add description*/
    ...
    union {
        struct {
            uint32_t wifi_wait_timer               :    9;  /*Need add description*/
            uint32_t wifi_powerup_timer            :    7;  /*Need add description*/
            uint32_t bt_wait_timer                 :    9;  /*Need add description*/
            uint32_t bt_powerup_timer              :    7;  /*Need add description*/
        };
        uint32_t val;
    } timer3;
    union {
        struct {
            uint32_t cpu_top_wait_timer            :    9;  /*Need add description*/
            uint32_t cpu_top_powerup_timer         :    7;  /*Need add description*/
            uint32_t dg_wrap_wait_timer            :    9;  /*Need add description*/
            uint32_t dg_wrap_powerup_timer         :    7;  /*Need add description*/
        };
        uint32_t val;
    } timer4;
    union {
    ...
    union {
        struct {
            ...
            uint32_t dg_peri_wait_timer            :    9;  /*Need add description*/
            uint32_t dg_peri_powerup_timer         :    7;  /*Need add description*/
        };
        uint32_t val;
    } timer6;
    union {
        struct {
            uint32_t reserved0                     :    16;  /*Reserved*/
            uint32_t xpd_trx_force_pd              :    1;  /*Need add description*/
            uint32_t xpd_trx_force_pu              :    1;  /*Need add description*/
            uint32_t i2c_reset_por_force_pd        :    1;  /*Need add description*/
            uint32_t i2c_reset_por_force_pu        :    1;  /*Need add description*/
            uint32_t glitch_rst_en                 :    1;  /*Need add description*/
            uint32_t reserved21                    :    1;  /*ReservedPLLA force power down*/
            uint32_t peri_i2c_pu                   :    1;  /*PLLA force power up*/
            ...
            uint32_t pll_i2c_pu                    :    1;  /*Need add description*/
        };
        uint32_t val;
    } ana_conf;
    union {
        struct {
            ...
            uint32_t jtag_reset_flag_procpu        :    1;  /*Need add description*/
            uint32_t jtag_reset_flag_appcpu        :    1;  /*Need add description*/
            uint32_t jtag_reset_flag_clr_procpu    :    1;  /*Need add description*/
            uint32_t jtag_reset_flag_clr_appcpu    :    1;  /*Need add description*/
            uint32_t rtc_dreset_mask_appcpu        :    1;  /*Need add description*/
            uint32_t rtc_dreset_mask_procpu        :    1;  /*Need add description*/
    ...
    union {
        struct {
            ...
            uint32_t rtc_wakeup_ena                :    19;  /*wakeup enable bitmap*/
        };
        uint32_t val;
    } wakeup_state;
    union {
        struct {
            ...
            uint32_t reserved17                    :    2;  /*Reservedenable touch timeout interrupt*/
            uint32_t rtc_glitch_det                :    1;  /*enbale gitch det interrupt*/
            uint32_t rtc_bbpll_cal                 :    1;  /*Need add description*/
            uint32_t rtc_ble_compare_wake          :    1;  /*Need add description*/
            uint32_t vset_dcdc_done                :    1;  /*Need add description*/
    ...
    union {
        struct {
            ...
            uint32_t reserved17                    :    2;  /*Reservedtouch timeout interrupt raw*/
    ...
    union {
        struct {
            ...
            uint32_t rtc_sleep_reject_ena          :    19;  /*sleep reject enable*/
    ...
    union {
        struct {
            ...
            uint32_t cpuperiod_sel                 :    2;  /*Need add description*/
        };
        uint32_t val;
    } cpu_period_conf;
    union {
        struct {
            uint32_t rtc_ble_tmr_rst               :    1;  /*Need add description*/
            uint32_t efuse_clk_force_gating        :    1;  /*Need add description*/
            uint32_t efuse_clk_force_nogating      :    1;  /*Need add description*/
            ...
            uint32_t dig_rc32k_en                  :    1;  /*enable RC32K for digital core (no relationship with RTC core)*/
            uint32_t dig_clk8m_en                  :    1;  /*enable CK8M for digital core (no relationship with RTC core)*/
            uint32_t rtc_ble_timer_sel             :    1;  /*Need add description*/
            ...
            uint32_t xtal_global_force_gating      :    1;  /*Need add description*/
            uint32_t xtal_global_force_nogating    :    1;  /*Need add description*/
            uint32_t fast_clk_rtc_sel              :    1;  /*fast_clk_rtc sel. 0: XTAL div 4, 1: CK8M */
            uint32_t ana_clk_rtc_sel               :    2;  /*Need add description*/
        };
        uint32_t val;
    } clk_conf;
    union {
        struct {
            ...
            uint32_t rtc_ana_clk_pd_slp            :    1;  /*Need add description*/
            uint32_t rtc_ana_clk_pd_monitor        :    1;  /*Need add description*/
            uint32_t rtc_ana_clk_pd_idle           :    1;  /*Need add description*/
            ...
            uint32_t rtc_ana_clk_div               :    8;  /*Need add description*/
            uint32_t slow_clk_next_edge            :    1;  /*Need add description*/
        };
        uint32_t val;
    } slow_clk_conf;
    union {
        struct {
            ...
            uint32_t xpd_sdio                      :    1;  /*Need add description*/
        };
        uint32_t val;
    } sdio_conf;
    union {
        struct {
            ...
            uint32_t bias_buf_idle                 :    1;  /*Need add description*/
            uint32_t bias_buf_wake                 :    1;  /*Need add description*/
            uint32_t bias_buf_deep_slp             :    1;  /*Need add description*/
            uint32_t bias_buf_monitor              :    1;  /*Need add description*/
            ...
            uint32_t xpd_dcdc_slp                  :    1;  /*Need add description*/
            uint32_t xpd_dcdc_monitor              :    1;  /*Need add description*/
            uint32_t xpd_dcdc_idle                 :    1;  /*Need add description*/
    ...
    union {
        struct {
            uint32_t dbias_switch_slp              :    1;  /*Need add description*/
            uint32_t dbias_switch_monitor          :    1;  /*Need add description*/
            uint32_t dbias_switch_idle             :    1;  /*Need add description*/
            uint32_t dig_cal_en                    :    1;  /*Need add description*/
            uint32_t sck_dcap                      :    8;  /*Need add description*/
            uint32_t reserved12                    :    3;  /*Reserved*/
            uint32_t rtc_vdd_drv_b_active          :    6;  /*SCK_DCAP*/
            uint32_t rtc_vdd_drv_b_slp             :    6;  /*Need add description*/
            uint32_t rtc_vdd_drv_b_slp_en          :    1;  /*Need add description*/
            ...
            uint32_t rtculator_force_pu            :    1;  /*Need add description*/
        };
        uint32_t val;
    } rtculator;
    union {
        struct {
            ...
            uint32_t pvt_rtc_dbias                 :    5;  /*get pvt dbias value*/
            uint32_t rtculator0_dbias_slp          :    5;  /*the rtc regulator0 dbias when chip in sleep state*/
            uint32_t rtculator0_dbias_active       :    5;  /*the rtc regulator0 dbias when chip in active state*/
            uint32_t reserved30                    :    1;  /*Reserved*/
            uint32_t rtculator0_dbias_sel          :    1;  /*1: select sw dbias_active 0: select pvt value*/
        };
        uint32_t val;
    } rtculator0_dbias;
    union {
        struct {
            ...
            uint32_t rtculator1_dbias_slp          :    4;  /*the rtc regulator1 dbias when chip in sleep state*/
            uint32_t reserved24                    :    1;  /*Reserved*/
            uint32_t rtculator1_dbias_active       :    4;  /*the rtc regulator1 dbias when chip in active state*/
            uint32_t reserved29                    :    3;  /*Reserved*/
        };
        uint32_t val;
    } rtculator1_dbias;
    union {
        struct {
            ...
            uint32_t memulator_slp_force_pd        :    1;  /*Need add description*/
            uint32_t memulator_slp_force_pu        :    1;  /*Need add description*/
            uint32_t dg_vdd_drv_b_slp              :    24;  /*Need add description*/
            uint32_t dg_vdd_drv_b_slp_en           :    1;  /*Need add description*/
            uint32_t dgulator_slp_force_pd         :    1;  /*Need add description*/
            uint32_t dgulator_slp_force_pu         :    1;  /*Need add description*/
            uint32_t dgulator_force_pd             :    1;  /*Need add description*/
            uint32_t dgulator_force_pu             :    1;  /*Need add description*/
        };
        uint32_t val;
    } digulator;
    union {
        struct {
            uint32_t dg_vdd_drv_b_active           :    24;  /*Need add description*/
    ...
    union {
        struct {
            uint32_t reserved0                     :    15;  /*Reserved*/
            uint32_t pvt_dig_dbias                 :    5;  /*get pvt dbias value*/
            uint32_t digulator0_dbias_slp          :    5;  /*the dig regulator0 dbias when chip in sleep state*/
            uint32_t digulator0_dbias_active       :    5;  /*the dig regulator0 dbias when chip in active state*/
            uint32_t digulator0_dbias_init         :    1;  /*initial pvt dbias value*/
            uint32_t digulator0_dbias_sel          :    1;  /*1: select sw dbias_active 0: select pvt value*/
        };
        uint32_t val;
    } digulator0_dbias;
    union {
        struct {
            ...
            uint32_t memulator1_dbias_slp          :    4;  /*Need add description*/
            uint32_t memulator1_dbias_active       :    4;  /*Need add description*/
            uint32_t digulator1_dbias_slp          :    4;  /*the dig regulator1 dbias when chip in sleep state*/
            uint32_t reserved24                    :    1;  /*Reserved*/
            uint32_t digulator1_dbias_active       :    4;  /*the dig regulator1 dbias when chip in active state*/
            uint32_t reserved29                    :    3;  /*Reserved*/
        };
        uint32_t val;
    } digulator1_dbias;
    ...
    union {
        struct {
            uint32_t vdd_spi_pwr_drv               :    2;  /*Need add description*/
            uint32_t vdd_spi_pwr_force             :    1;  /*Need add description*/
            ...
            uint32_t dg_mem_force_pd               :    1;  /*Need add description*/
            uint32_t dg_mem_force_pu               :    1;  /*Need add description*/
            uint32_t dg_wrap_force_pd              :    1;  /*Need add description*/
            uint32_t dg_wrap_force_pu              :    1;  /*Need add description*/
            uint32_t bt_force_pd                   :    1;  /*Need add description*/
            uint32_t bt_force_pu                   :    1;  /*Need add description*/
            uint32_t dg_peri_force_pd              :    1;  /*Need add description*/
            uint32_t dg_peri_force_pu              :    1;  /*Need add description*/
            uint32_t fastmem_force_lpd             :    1;  /*Need add description*/
            uint32_t fastmem_force_lpu             :    1;  /*Need add description*/
            uint32_t wifi_force_pd                 :    1;  /*wifi force power down*/
            uint32_t wifi_force_pu                 :    1;  /*wifi force power up*/
            uint32_t reserved19                    :    2;  /*Reserveddigital core force power down*/
            uint32_t cpu_top_force_pd              :    1;  /*Need add description*/
            uint32_t cpu_top_force_pu              :    1;  /*Need add description*/
            uint32_t reserved23                    :    3;  /*Reserved*/
            uint32_t dg_wrap_ret_pd_en             :    1;  /*Need add description*/
            uint32_t bt_pd_en                      :    1;  /*Need add description*/
            uint32_t dg_peri_pd_en                 :    1;  /*Need add description*/
            uint32_t cpu_top_pd_en                 :    1;  /*Need add description*/
            uint32_t wifi_pd_en                    :    1;  /*enable power down wifi in sleep*/
            uint32_t dg_wrap_pd_en                 :    1;  /*Need add description*/
        };
        uint32_t val;
    } dig_pwc;
    union {
        struct {
            ...
            uint32_t pd_dg_peri_switch_mask        :    5;  /*Need add description*/
            uint32_t pd_dg_wrap_switch_mask        :    5;  /*Need add description*/
            uint32_t pd_mem_switch_mask            :    20;  /*Need add description*/
        };
        uint32_t val;
    } dig_power_slave0_pd;
    union {
        struct {
            ...
            uint32_t pd_wifi_switch_mask           :    5;  /*Need add description*/
            uint32_t pd_cpu_switch_mask            :    5;  /*Need add description*/
        };
        uint32_t val;
    } dig_power_slave1_pd;
    union {
        struct {
            uint32_t reserved0                     :    2;  /*Reserved*/
            uint32_t xpd_dg_peri_switch_mask       :    5;  /*Need add description*/
            uint32_t xpd_dg_wrap_switch_mask       :    5;  /*Need add description*/
            uint32_t xpd_mem_switch_mask           :    20;  /*Need add description*/
        };
        uint32_t val;
    } dig_power_slave0_fpu;
    union {
        struct {
            uint32_t reserved0                     :    22;  /*Reserved*/
            uint32_t xpd_wifi_switch_mask          :    5;  /*Need add description*/
            uint32_t xpd_cpu_switch_mask           :    5;  /*Need add description*/
        };
        uint32_t val;
    } dig_power_slave1_fpu;
    union {
        struct {
            uint32_t reserved0                     :    5;  /*Reserved*/
            uint32_t dg_mem_force_noiso            :    1;  /*Need add description*/
            uint32_t dg_mem_force_iso              :    1;  /*Need add description*/
            uint32_t dig_iso_force_off             :    1;  /*Need add description*/
            uint32_t dig_iso_force_on              :    1;  /*Need add description*/
            ...
            uint32_t reserved16                    :    6;  /*Reserved*/
            uint32_t bt_force_iso                  :    1;  /*Need add description*/
            uint32_t bt_force_noiso                :    1;  /*Need add description*/
            uint32_t dg_peri_force_iso             :    1;  /*Need add description*/
            uint32_t dg_peri_force_noiso           :    1;  /*Need add description*/
            ...
            uint32_t dg_wrap_force_noiso           :    1;  /*Need add description*/
        };
        uint32_t val;
    } dig_iso;
    union {
        struct {
            ...
            uint32_t en                            :    1;  /*Need add description*/
        };
        uint32_t val;
    } wdt_config0;
    ...
    union {
        struct {
            uint32_t reserved0                     :    31;  /*Reserved*/
            uint32_t feed                          :    1;  /*Need add description*/
        };
        uint32_t val;
    } wdt_feed;
    ...
    union {
        struct {
            uint32_t reserved0                     :    16;  /*Reserved*/
            uint32_t reset_chip_target             :    8;  /*Need add description*/
            uint32_t reset_chip_key                :    8;  /*Need add description*/
        };
        uint32_t val;
    } wdtreset_chip;
    union {
        struct {
            ...
            uint32_t swd_bypass_rst                :    1;  /*Need add description*/
    ...
    union {
        struct {
            ...
            uint32_t procpu_c1                     :    6;  /*Need add description*/
        };
        uint32_t val;
    } sw_cpu_stall;
    uint32_t store4;
    ...
    union {
        struct {
            uint32_t rtc_gpio_pin0_hold            :    1;  /*Need add description*/
            uint32_t rtc_gpio_pin1_hold            :    1;  /*Need add description*/
            uint32_t rtc_gpio_pin2_hold            :    1;  /*Need add description*/
            uint32_t rtc_gpio_pin3_hold            :    1;  /*Need add description*/
            uint32_t rtc_gpio_pin4_hold            :    1;  /*Need add description*/
            uint32_t rtc_gpio_pin5_hold            :    1;  /*Need add description*/
    ...
    union {
        struct {
            uint32_t dig_pad_hold1                 :    9;  /*Need add description*/
    ...
    union {
        struct {
            ...
            uint32_t rst_sel                       :    1;  /*1:  4-pos reset,    0:  sys_reset*/
            uint32_t ana_rst_en                    :    1;  /*Need add description*/
            uint32_t cnt_clr                       :    1;  /*clear brown out counter*/
            uint32_t ena                           :    1;  /*enable brown out*/
            uint32_t det                           :    1;  /*Need add description*/
        };
        uint32_t val;
    } brown_out;
    uint32_t time_low1;
    ...
    union {
        struct {
            ...
            uint32_t io_mux_reset_disable          :    1;  /*Need add description*/
    ...
    union {
        struct {
            uint32_t reject_cause                  :    19;  /*sleep reject cause*/
            uint32_t reserved19                    :    13;  /*Reserved*/
        };
        uint32_t val;
    } slp_reject_cause;
    union {
        struct {
            uint32_t force_download_boot           :    1;  /*Need add description*/
    ...
    union {
        struct {
            uint32_t wakeup_cause                  :    19;  /*sleep wakeup cause*/
            uint32_t reserved19                    :    13;  /*Reserved*/
        };
        uint32_t val;
    } slp_wakeup_cause;
    ...
    union {
        struct {
            ...
            uint32_t rtc_bbpll_cal_w1ts            :    1;  /*Need add description*/
            uint32_t rtc_ble_compare_wake_w1ts     :    1;  /*Need add description*/
            uint32_t vset_dcdc_done_w1ts           :    1;  /*Need add description*/
            uint32_t reserved23                    :    9;  /*Reserved*/
        };
        uint32_t val;
    } int_ena_w1ts;
    union {
        struct {
            ...
            uint32_t rtc_bbpll_cal_w1tc            :    1;  /*Need add description*/
            uint32_t rtc_ble_compare_wake_w1tc     :    1;  /*Need add description*/
            uint32_t vset_dcdc_done_w1tc           :    1;  /*Need add description*/
            uint32_t reserved23                    :    9;  /*Reserved*/
        };
        uint32_t val;
    } int_ena_w1tc;
    union {
        struct {
            ...
            uint32_t rtc_cntl_clk_en               :    1;  /*Need add description*/
            uint32_t retention_clk_sel             :    1;  /*Need add description*/
            uint32_t retention_done_wait           :    3;  /*Need add description*/
            uint32_t retention_clkoff_wait         :    4;  /*Need add description*/
            uint32_t retention_en                  :    1;  /*Need add description*/
    ...
    union {
        struct {
            uint32_t retention_link_addr           :    27;  /*Need add description*/
    ...
    union {
        struct {
            uint32_t rtc_gpio_wakeup_status        :    6;  /*Need add description*/
            uint32_t rtc_gpio_wakeup_status_clr    :    1;  /*Need add description*/
            uint32_t rtc_gpio_pin_clk_gate         :    1;  /*Need add description*/
            uint32_t rtc_gpio_pin5_int_type        :    3;  /*Need add description*/
            uint32_t rtc_gpio_pin4_int_type        :    3;  /*Need add description*/
            uint32_t rtc_gpio_pin3_int_type        :    3;  /*Need add description*/
            uint32_t rtc_gpio_pin2_int_type        :    3;  /*Need add description*/
            uint32_t rtc_gpio_pin1_int_type        :    3;  /*Need add description*/
            uint32_t rtc_gpio_pin0_int_type        :    3;  /*Need add description*/
            uint32_t rtc_gpio_pin5_wakeup_enable   :    1;  /*Need add description*/
            uint32_t rtc_gpio_pin4_wakeup_enable   :    1;  /*Need add description*/
            uint32_t rtc_gpio_pin3_wakeup_enable   :    1;  /*Need add description*/
            uint32_t rtc_gpio_pin2_wakeup_enable   :    1;  /*Need add description*/
            uint32_t rtc_gpio_pin1_wakeup_enable   :    1;  /*Need add description*/
            uint32_t rtc_gpio_pin0_wakeup_enable   :    1;  /*Need add description*/
        };
        uint32_t val;
    } gpio_wakeup;
    union {
        struct {
            uint32_t rtc_mtdi_enamux               :    1;  /*Need add description*/
            uint32_t rtc_debug_12m_no_gating       :    1;  /*Need add description*/
            uint32_t rtc_debug_bit_sel             :    5;  /*Need add description*/
            uint32_t rtc_debug_sel0                :    5;  /*Need add description*/
            uint32_t rtc_debug_sel1                :    5;  /*Need add description*/
            uint32_t rtc_debug_sel2                :    5;  /*Need add description*/
            uint32_t rtc_debug_sel3                :    5;  /*Need add description*/
            uint32_t rtc_debug_sel4                :    5;  /*Need add description*/
        };
        uint32_t val;
    } dbg_sel;
    union {
        struct {
            uint32_t vdd_dig_test                  :    2;  /*Need add description*/
            uint32_t rtc_gpio_pin5_mux_sel         :    1;  /*Need add description*/
            uint32_t rtc_gpio_pin4_mux_sel         :    1;  /*Need add description*/
            uint32_t rtc_gpio_pin3_mux_sel         :    1;  /*Need add description*/
            uint32_t rtc_gpio_pin2_mux_sel         :    1;  /*Need add description*/
            uint32_t rtc_gpio_pin1_mux_sel         :    1;  /*Need add description*/
            uint32_t rtc_gpio_pin0_mux_sel         :    1;  /*Need add description*/
            uint32_t rtc_gpio_pin5_fun_sel         :    4;  /*Need add description*/
            uint32_t rtc_gpio_pin4_fun_sel         :    4;  /*Need add description*/
            uint32_t rtc_gpio_pin3_fun_sel         :    4;  /*Need add description*/
            uint32_t rtc_gpio_pin2_fun_sel         :    4;  /*Need add description*/
            uint32_t rtc_gpio_pin1_fun_sel         :    4;  /*Need add description*/
            uint32_t rtc_gpio_pin0_fun_sel         :    4;  /*Need add description*/
        };
        uint32_t val;
    } dbg_map;
    union {
        struct {
            uint32_t reserved0                     :    27;  /*Reserved*/
            uint32_t sar_debug_sel                 :    5;  /*Need add description*/
        };
        uint32_t val;
    } dbg_sar_sel;
    union {
        struct {
            ...
            uint32_t power_glitch_dsense           :    2;  /*Need add description*/
            uint32_t power_glitch_force_pd         :    1;  /*Need add description*/
            uint32_t power_glitch_force_pu         :    1;  /*Need add description*/
            uint32_t power_glitch_efuse_sel        :    1;  /*Need add description*/
            uint32_t power_glitch_en               :    1;  /*Need add description*/
        };
        uint32_t val;
    } pg_ctrl;
    union {
        struct {
            uint32_t vset_dcdc_value               :    5;  /*Need add description*/
            uint32_t power_good_dcdc               :    1;  /*Need add description*/
            uint32_t reserved6                     :    13;  /*Reserved*/
            uint32_t pmu_mode                      :    2;  /*Need add description*/
            uint32_t ramplevel_dcdc                :    1;  /*Need add description*/
            uint32_t ramp_dcdc                     :    1;  /*Need add description*/
            uint32_t dcm2enb_dcdc                  :    1;  /*Need add description*/
            uint32_t dcmlevel_dcdc                 :    2;  /*Need add description*/
            uint32_t fsw_dcdc                      :    3;  /*Need add description*/
            uint32_t ccm_dcdc                      :    1;  /*Need add description*/
            uint32_t sstime_dcdc                   :    1;  /*Need add description*/
            uint32_t pocpenb_dcdc                  :    1;  /*Need add description*/
        };
        uint32_t val;
    } dcdc_ctrl0;
    union {
        struct {
            ...
            uint32_t dcdc_mode_slp                 :    3;  /*Need add description*/
            uint32_t dcdc_mode_monitor             :    3;  /*Need add description*/
            uint32_t dcdc_mode_idle                :    3;  /*Need add description*/
        };
        uint32_t val;
    } dcdc_ctrl1;
    union {
        struct {
            uint32_t vset_dcdc_target_value1       :    5;  /*Need add description*/
            uint32_t vset_dcdc_target_value0       :    5;  /*Need add description*/
            uint32_t vset_dcdc_init_value          :    5;  /*Need add description*/
            uint32_t vset_dcdc_init                :    1;  /*Need add description*/
            uint32_t vset_dcdc_fix                 :    1;  /*Need add description*/
            uint32_t vset_dcdc_step                :    5;  /*Need add description*/
            uint32_t vset_dcdc_gap                 :    5;  /*Need add description*/
            uint32_t vset_dcdc_sel_hw_sw           :    1;  /*Need add description*/
            uint32_t vset_dcdc_sw_sel              :    1;  /*Need add description*/
            uint32_t reserved29                    :    3;  /*Reserved*/
        };
        uint32_t val;
    } dcdc_ctrl2;
    union {
        struct {
            uint32_t reserved0                     :    21;  /*Reserved*/
            uint32_t rc32k_dfreq                   :    10;  /*Need add description*/
            uint32_t rc32k_xpd                     :    1;  /*Need add description*/
        };
        uint32_t val;
    } rc32k_ctrl;
    union {
        struct {
            ...
            uint32_t ckref_pll8m_sel               :    1;  /*Need add description*/
            uint32_t xpd_pll8m                     :    1;  /*Need add description*/
        };
        uint32_t val;
    } pll8m;
    ...
    union {
        struct {
            uint32_t date                          :    28;  /*Need add description*/
