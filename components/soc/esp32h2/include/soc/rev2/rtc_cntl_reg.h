...
/* RTC_CNTL_BLE_TIMER_SEL : R/W ;bitpos:[7] ;default: 1'b0 ; */
/*description: Need add description.*/
#define RTC_CNTL_BLE_TIMER_SEL    (BIT(7))
#define RTC_CNTL_BLE_TIMER_SEL_M  (BIT(7))
#define RTC_CNTL_BLE_TIMER_SEL_V  0x1
...
/*description: used to sync reg_ck8m_div_sel bus. Clear vld before set reg_ck8m_div_sel, then s
et vld to actually switch the clk.*/
...
/*description: used to sync div bus. clear vld before set reg_rtc_ana_clk_div, then set vld to
...
/* RTC_CNTL_SDIO_REG_PD_EN : R/W ;bitpos:[21] ;default: 1'd1 ; */
...
/*description: Tieh = 1 mode drive ability. Initially set to 0 to limit charge current, set to
3 after several us..*/
...
/* RTC_CNTL_DIG_REG_CAL_EN : R/W ;bitpos:[3] ;default: 1'b0 ; */
/*description: Need add description.*/
#define RTC_CNTL_DIG_REG_CAL_EN    (BIT(3))
#define RTC_CNTL_DIG_REG_CAL_EN_M  (BIT(3))
...
/* RTC_CNTL_MEM_REGULATOR_SLP_FORCE_PU : R/W ;bitpos:[2] ;default: 1'b1 ; */
/*description: Need add description.*/
#define RTC_CNTL_MEM_REGULATOR_SLP_FORCE_PU    (BIT(2))
#define RTC_CNTL_MEM_REGULATOR_SLP_FORCE_PU_M  (BIT(2))
#define RTC_CNTL_MEM_REGULATOR_SLP_FORCE_PU_V  0x1
#define RTC_CNTL_MEM_REGULATOR_SLP_FORCE_PU_S  2
/* RTC_CNTL_MEM_REGULATOR_SLP_FORCE_PD : R/W ;bitpos:[1] ;default: 1'b0 ; */
/*description: Need add description.*/
#define RTC_CNTL_MEM_REGULATOR_SLP_FORCE_PD    (BIT(1))
#define RTC_CNTL_MEM_REGULATOR_SLP_FORCE_PD_M  (BIT(1))
#define RTC_CNTL_MEM_REGULATOR_SLP_FORCE_PD_V  0x1
...
/* RTC_CNTL_MEM_REGULATOR1_DBIAS_ACTIVE : R/W ;bitpos:[19:16] ;default: 4'b1000 ; */
/*description: Need add description.*/
#define RTC_CNTL_MEM_REGULATOR1_DBIAS_ACTIVE    0x0000000F
...
#define RTC_CNTL_MEM_REGULATOR1_DBIAS_ACTIVE_V  0xF
#define RTC_CNTL_MEM_REGULATOR1_DBIAS_ACTIVE_S  16
/* RTC_CNTL_MEM_REGULATOR1_DBIAS_SLP : R/W ;bitpos:[15:12] ;default: 4'b1000 ; */
/*description: Need add description.*/
#define RTC_CNTL_MEM_REGULATOR1_DBIAS_SLP    0x0000000F
#define RTC_CNTL_MEM_REGULATOR1_DBIAS_SLP_M  ((RTC_CNTL_MEM_REGULATOR1_DBIAS_SLP_V)<<(RTC_CNTL_MEM_REGULATOR1_DBIAS_SLP_S))
#define RTC_CNTL_MEM_REGULATOR1_DBIAS_SLP_V  0xF
...
/* RTC_CNTL_XPD_DG_WRAP_SWITCH_MASK : R/W ;bitpos:[11:7] ;default: 5'h1f ; */
/*description: Need add description.*/
...
/* RTC_CNTL_XPD_DG_PERI_SWITCH_MASK : R/W ;bitpos:[6:2] ;default: 5'h1f ; */
/*description: Need add description.*/
...
/* RTC_CNTL_XPD_CPU_SWITCH_MASK : R/W ;bitpos:[31:27] ;default: 5'h1f ; */
/*description: Need add description.*/
...
/* RTC_CNTL_XPD_WIFI_SWITCH_MASK : R/W ;bitpos:[26:22] ;default: 5'h1f ; */
/*description: Need add description.*/
...
/*description: 1: interrupt stage en, 2: CPU reset stage en, 3: system reset stage en, 4: RTC r
eset stage en.*/
...
/* RTC_CNTL_CLK_EN : R/W ;bitpos:[17] ;default: 1'b0 ; */
/*description: Need add description.*/
#define RTC_CNTL_CLK_EN    (BIT(17))
#define RTC_CNTL_CLK_EN_M  (BIT(17))
#define RTC_CNTL_CLK_EN_V  0x1
...
/* RTC_CNTL_PMU_MODE : R/W ;bitpos:[20:19] ;default: 2'b0 ; */
/*description: Need add description.*/
#define RTC_CNTL_PMU_MODE    0x00000003
#define RTC_CNTL_PMU_MODE_M  ((RTC_CNTL_PMU_MODE_V)<<(RTC_CNTL_PMU_MODE_S))
#define RTC_CNTL_PMU_MODE_V  0x3
...
/* RTC_CNTL_DATE : R/W ;bitpos:[27:0] ;default: 28'h2109240 ; */
/*description: Need add description.*/
