...
/** LP_IO_LP_GPIO_STATUS_INTERRUPT_NEXT : RO; bitpos: [7:0]; default: 0;
 *  need des
 */
#define LP_IO_LP_GPIO_STATUS_INTERRUPT_NEXT    0x000000FFU
#define LP_IO_LP_GPIO_STATUS_INTERRUPT_NEXT_M  (LP_IO_LP_GPIO_STATUS_INTERRUPT_NEXT_V << LP_IO_LP_GPIO_STATUS_INTERRUPT_NEXT_S)
#define LP_IO_LP_GPIO_STATUS_INTERRUPT_NEXT_V  0x000000FFU
#define LP_IO_LP_GPIO_STATUS_INTERRUPT_NEXT_S  0
