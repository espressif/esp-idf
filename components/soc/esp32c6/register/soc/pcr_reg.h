...
#define PCR_MSPI_FAST_LS_DIV_NUM_M  (PCR_MSPI_FAST_LS_DIV_NUM_V << PCR_MSPI_FAST_LS_DIV_NUM_S)
#define PCR_MSPI_FAST_LS_DIV_NUM_V  0x000000FFU
...
#define PCR_MSPI_FAST_HS_DIV_NUM_V  0x000000FFU
#define PCR_MSPI_FAST_HS_DIV_NUM_S  8
 ...
 */
#define PCR_UHCI_CONF_REG (DR_REG_PCR_BASE + 0x28)
 ...
 */
#define PCR_RMT_CONF_REG (DR_REG_PCR_BASE + 0x2c)
 ...
 */
#define PCR_RMT_SCLK_CONF_REG (DR_REG_PCR_BASE + 0x30)
 ...
 */
#define PCR_TIMERGROUP0_CONF_REG (DR_REG_PCR_BASE + 0x3c)
 ...
 */
#define PCR_TIMERGROUP0_TIMER_CLK_CONF_REG (DR_REG_PCR_BASE + 0x40)
 ...
 */
#define PCR_TIMERGROUP0_WDT_CLK_CONF_REG (DR_REG_PCR_BASE + 0x44)
 ...
 */
#define PCR_TIMERGROUP1_CONF_REG (DR_REG_PCR_BASE + 0x48)
 ...
 */
#define PCR_TIMERGROUP1_TIMER_CLK_CONF_REG (DR_REG_PCR_BASE + 0x4c)
 ...
 */
#define PCR_TIMERGROUP1_WDT_CLK_CONF_REG (DR_REG_PCR_BASE + 0x50)
 ...
 */
#define PCR_SYSTIMER_CONF_REG (DR_REG_PCR_BASE + 0x54)
 ...
 */
#define PCR_SYSTIMER_FUNC_CLK_CONF_REG (DR_REG_PCR_BASE + 0x58)
 ...
 */
#define PCR_TWAI0_CONF_REG (DR_REG_PCR_BASE + 0x5c)
 ...
 */
#define PCR_TWAI0_FUNC_CLK_CONF_REG (DR_REG_PCR_BASE + 0x60)
 ...
 */
#define PCR_TWAI1_CONF_REG (DR_REG_PCR_BASE + 0x64)
 ...
 */
#define PCR_TWAI1_FUNC_CLK_CONF_REG (DR_REG_PCR_BASE + 0x68)
 ...
 */
#define PCR_SDIO_SLAVE_CONF_REG (DR_REG_PCR_BASE + 0xb0)
 ...
 */
#define PCR_PVT_MONITOR_CONF_REG (DR_REG_PCR_BASE + 0xb4)
 ...
 */
#define PCR_PVT_MONITOR_FUNC_CLK_CONF_REG (DR_REG_PCR_BASE + 0xb8)
 ...
 */
#define PCR_GDMA_CONF_REG (DR_REG_PCR_BASE + 0xbc)
 ...
 */
#define PCR_SPI2_CONF_REG (DR_REG_PCR_BASE + 0xc0)
 ...
 */
#define PCR_SPI2_CLKM_CONF_REG (DR_REG_PCR_BASE + 0xc4)
 ...
 */
#define PCR_AES_CONF_REG (DR_REG_PCR_BASE + 0xc8)
 ...
 */
#define PCR_SHA_CONF_REG (DR_REG_PCR_BASE + 0xcc)
 ...
 */
#define PCR_RSA_CONF_REG (DR_REG_PCR_BASE + 0xd0)
 ...
 */
#define PCR_RSA_PD_CTRL_REG (DR_REG_PCR_BASE + 0xd4)
 ...
 */
#define PCR_ECC_CONF_REG (DR_REG_PCR_BASE + 0xd8)
 ...
 */
#define PCR_ECC_PD_CTRL_REG (DR_REG_PCR_BASE + 0xdc)
 ...
 */
#define PCR_DS_CONF_REG (DR_REG_PCR_BASE + 0xe0)
 ...
 */
#define PCR_HMAC_CONF_REG (DR_REG_PCR_BASE + 0xe4)
...
/** PCR_IOMUX_FUNC_CLK_SEL : R/W; bitpos: [21:20]; default: 3;
 *  set this field to select clock-source. 0: do not select anyone clock, 1: 80MHz, 2:
 *  FOSC, 3(default): XTAL.
 */
...
/** PCR_RETENTION_CONF_REG register
 *  retention configuration register
 */
#define PCR_RETENTION_CONF_REG (DR_REG_PCR_BASE + 0xf8)
/** PCR_RETENTION_CLK_EN : R/W; bitpos: [0]; default: 0;
 *  Set 1 to enable retention clock
 */
#define PCR_RETENTION_CLK_EN    (BIT(0))
#define PCR_RETENTION_CLK_EN_M  (PCR_RETENTION_CLK_EN_V << PCR_RETENTION_CLK_EN_S)
#define PCR_RETENTION_CLK_EN_V  0x00000001U
#define PCR_RETENTION_CLK_EN_S  0
/** PCR_RETENTION_RST_EN : R/W; bitpos: [1]; default: 0;
 *  Set 0 to reset retention module
 */
#define PCR_RETENTION_RST_EN    (BIT(1))
#define PCR_RETENTION_RST_EN_M  (PCR_RETENTION_RST_EN_V << PCR_RETENTION_RST_EN_S)
#define PCR_RETENTION_RST_EN_V  0x00000001U
#define PCR_RETENTION_RST_EN_S  1
...
/** PCR_MODEM_APB_CONF_REG register
 *  MODEM_APB configuration register
 */
#define PCR_MODEM_APB_CONF_REG (DR_REG_PCR_BASE + 0x108)
...
#define PCR_CPU_LS_DIV_NUM_M  (PCR_CPU_LS_DIV_NUM_V << PCR_CPU_LS_DIV_NUM_S)
...
#define PCR_CPU_HS_DIV_NUM_M  (PCR_CPU_HS_DIV_NUM_V << PCR_CPU_HS_DIV_NUM_S)
#define PCR_CPU_HS_DIV_NUM_V  0x000000FFU
...
#define PCR_CPU_HS_120M_FORCE_V  0x00000001U
#define PCR_CPU_HS_120M_FORCE_S  16
 ...
 *  PCR_CPU_LS_DIV_NUM.
 */
#define PCR_AHB_LS_DIV_NUM    0x000000FFU
#define PCR_AHB_LS_DIV_NUM_M  (PCR_AHB_LS_DIV_NUM_V << PCR_AHB_LS_DIV_NUM_S)
...
#define PCR_AHB_HS_DIV_NUM_M  (PCR_AHB_HS_DIV_NUM_V << PCR_AHB_HS_DIV_NUM_S)
#define PCR_AHB_HS_DIV_NUM_V  0x000000FFU
#define PCR_AHB_HS_DIV_NUM_S  8
...
/** PCR_FOSC_FREQ : HRO; bitpos: [7:0]; default: 20;
...
/** PCR_PLL_FREQ : HRO; bitpos: [17:8]; default: 480;
 ...
 */
#define PCR_CTRL_TICK_CONF_REG (DR_REG_PCR_BASE + 0x130)
 ...
 */
#define PCR_CTRL_32K_CONF_REG (DR_REG_PCR_BASE + 0x134)
...
/** PCR_SRAM_POWER_CONF_REG register
 *  HP SRAM/ROM configuration register
 */
#define PCR_SRAM_POWER_CONF_REG (DR_REG_PCR_BASE + 0x138)
...
/** PCR_SRAM_FORCE_PD : R/W; bitpos: [7:4]; default: 0;
...
#define PCR_SRAM_FORCE_PD_S  4
/** PCR_SRAM_CLKGATE_FORCE_ON : R/W; bitpos: [11:8]; default: 0;
...
#define PCR_SRAM_CLKGATE_FORCE_ON_S  8
/** PCR_ROM_FORCE_PU : R/W; bitpos: [14:12]; default: 7;
...
#define PCR_ROM_FORCE_PU_S  12
/** PCR_ROM_FORCE_PD : R/W; bitpos: [17:15]; default: 0;
...
/** PCR_ROM_CLKGATE_FORCE_ON : R/W; bitpos: [20:18]; default: 0;
...
#define PCR_ROM_CLKGATE_FORCE_ON_S  18
...
/** PCR_DATE : R/W; bitpos: [27:0]; default: 35676496;
