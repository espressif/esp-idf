...
typedef union {
    ...
    uint32_t val;
} spi_mem_nand_flash_sr_addr0_reg_t;
...
typedef union {
    ...
    uint32_t val;
} spi_mem_nand_flash_sr_din0_reg_t;
...
typedef union {
    ...
    uint32_t val;
} spi_mem_nand_flash_cfg_data0_reg_t;
...
typedef union {
    ...
    uint32_t val;
} spi_mem_nand_flash_cfg_data1_reg_t;
...
typedef union {
    ...
    uint32_t val;
} spi_mem_nand_flash_cfg_data2_reg_t;
...
typedef union {
    ...
    uint32_t val;
} spi_mem_nand_flash_cmd_lut0_reg_t;
...
typedef union {
    ...
    uint32_t val;
} spi_mem_nand_flash_spi_seq0_reg_t;
...
typedef union {
    ...
    uint32_t val;
} spi_mem_xts_pseudo_round_conf_reg_t;
...
typedef union {
    ...
    uint32_t val;
} spi_mem_registerrnd_eco_high_reg_t;
...
typedef union {
    ...
    uint32_t val;
} spi_mem_registerrnd_eco_low_reg_t;
...
typedef struct {
    ...
    volatile spi_mem_rd_status_reg_t mem_rd_status;
    ...
    volatile spi_mem_cache_sctrl_reg_t mem_cache_sctrl;
    volatile spi_mem_sram_cmd_reg_t mem_sram_cmd;
    volatile spi_mem_sram_drd_cmd_reg_t mem_sram_drd_cmd;
    volatile spi_mem_sram_dwr_cmd_reg_t mem_sram_dwr_cmd;
    volatile spi_mem_sram_clk_reg_t mem_sram_clk;
    ...
    volatile spi_mem_pms_reject_addr_reg_t mem_pms_reject_addr;
    ...
    volatile spi_mem_nand_flash_en_reg_t mem_nand_flash_en;
    volatile spi_mem_nand_flash_sr_addr0_reg_t mem_nand_flash_sr_addr0;
    volatile spi_mem_nand_flash_sr_din0_reg_t mem_nand_flash_sr_din0;
    volatile spi_mem_nand_flash_cfg_data0_reg_t mem_nand_flash_cfg_data0;
    volatile spi_mem_nand_flash_cfg_data1_reg_t mem_nand_flash_cfg_data1;
    volatile spi_mem_nand_flash_cfg_data2_reg_t mem_nand_flash_cfg_data2;
    uint32_t reserved_21c[9];
    volatile spi_mem_nand_flash_cmd_lut0_reg_t mem_nand_flash_cmd_lut0;
    uint32_t reserved_244[15];
    volatile spi_mem_nand_flash_spi_seq0_reg_t mem_nand_flash_spi_seq0;
    ...
    volatile spi_mem_xts_pseudo_round_conf_reg_t mem_xts_pseudo_round_conf;
    uint32_t reserved_390[24];
    volatile spi_mem_registerrnd_eco_high_reg_t mem_registerrnd_eco_high;
    volatile spi_mem_registerrnd_eco_low_reg_t mem_registerrnd_eco_low;
    uint32_t reserved_3f8;
    volatile spi_mem_date_reg_t mem_date;
} spi_dev_t;

extern spi_dev_t SPIMEM0;
