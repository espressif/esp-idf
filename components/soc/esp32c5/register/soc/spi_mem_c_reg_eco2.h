 ...
 *  applications.
 */
#define SPI_MEM_RD_STATUS_REG (DR_REG_SPI_BASE + 0x2c)
 ...
 *  applications.
 */
#define SPI_MEM_CACHE_SCTRL_REG (DR_REG_SPI_BASE + 0x40)
 ...
 *  applications.
 */
#define SPI_MEM_SRAM_DRD_CMD_REG (DR_REG_SPI_BASE + 0x48)
 ...
 *  applications.
 */
#define SPI_MEM_SRAM_DWR_CMD_REG (DR_REG_SPI_BASE + 0x4c)
 ...
 *  applications.
 */
#define SPI_MEM_SRAM_CLK_REG (DR_REG_SPI_BASE + 0x50)
 ...
 */
#define SPI_MEM_PMS_REJECT_REG (DR_REG_SPI_BASE + 0x160)
 ...
 */
#define SPI_MEM_PMS_REJECT_ADDR_REG (DR_REG_SPI_BASE + 0x164)
 ...
 */
#define SPI_MEM_NAND_FLASH_EN_REG (DR_REG_SPI_BASE + 0x204)
 ...
 */
#define SPI_MEM_NAND_FLASH_SR_ADDR0_REG (DR_REG_SPI_BASE + 0x208)
 ...
 *  NAND FLASH SPI SEQ control register
 */
#define SPI_MEM_NAND_FLASH_SR_DIN0_REG (DR_REG_SPI_BASE + 0x20c)
 ...
 *  NAND FLASH SPI SEQ control register
 */
#define SPI_MEM_NAND_FLASH_CFG_DATA0_REG (DR_REG_SPI_BASE + 0x210)
 ...
 *  NAND FLASH SPI SEQ control register
 */
#define SPI_MEM_NAND_FLASH_CFG_DATA1_REG (DR_REG_SPI_BASE + 0x214)
 ...
 *  NAND FLASH SPI SEQ control register
 */
#define SPI_MEM_NAND_FLASH_CFG_DATA2_REG (DR_REG_SPI_BASE + 0x218)
 ...
 */
#define SPI_MEM_NAND_FLASH_CMD_LUT0_REG (DR_REG_SPI_BASE + 0x240)
 ...
 *  NAND FLASH SPI SEQ control register
 */
#define SPI_MEM_NAND_FLASH_SPI_SEQ0_REG (DR_REG_SPI_BASE + 0x280)
 ...
 */
#define SPI_MEM_XTS_PSEUDO_ROUND_CONF_REG (DR_REG_SPI_BASE + 0x38c)
 ...
 *  applications.
 */
#define SPI_MEM_REGISTERRND_ECO_HIGH_REG (DR_REG_SPI_BASE + 0x3f0)
 ...
 *  applications.
 */
#define SPI_MEM_REGISTERRND_ECO_LOW_REG (DR_REG_SPI_BASE + 0x3f4)
