...
typedef struct {
    ...
    volatile sdio_slc_host_func2_0_reg_t func2_0;
    volatile sdio_slc_host_func2_1_reg_t func2_1;
    uint32_t reserved_018[2];
    volatile sdio_slc_host_func2_2_reg_t func2_2;
    uint32_t reserved_024[4];
    volatile sdio_slc_host_gpio_status0_reg_t gpio_status0;
    volatile sdio_slc_host_gpio_status1_reg_t gpio_status1;
    volatile sdio_slc_host_gpio_in0_reg_t gpio_in0;
    volatile sdio_slc_host_gpio_in1_reg_t gpio_in1;
    volatile sdio_slc_host_slc0host_token_rdata_reg_t slc0host_token_rdata;
    volatile sdio_slc_host_slc0_host_pf_reg_t slc0_host_pf;
    volatile sdio_slc_host_slc1_host_pf_reg_t slc1_host_pf;
    volatile sdio_slc_host_slc0host_int_raw_reg_t slc0host_int_raw;
    volatile sdio_slc_host_slc1host_int_raw_reg_t slc1host_int_raw;
    volatile sdio_slc_host_slc0host_int_st_reg_t slc0host_int_st;
    volatile sdio_slc_host_slc1host_int_st_reg_t slc1host_int_st;
    volatile sdio_slc_host_pkt_len_reg_t pkt_len;
    volatile sdio_slc_host_state_w0_reg_t state_w0;
    volatile sdio_slc_host_state_w1_reg_t state_w1;
    volatile sdio_slc_host_conf_w0_reg_t conf_w0;
    volatile sdio_slc_host_conf_w1_reg_t conf_w1;
    volatile sdio_slc_host_conf_w2_reg_t conf_w2;
    volatile sdio_slc_host_conf_w3_reg_t conf_w3;
    volatile sdio_slc_host_conf_w4_reg_t conf_w4;
    volatile sdio_slc_host_conf_w5_reg_t conf_w5;
    volatile sdio_slc_host_win_cmd_reg_t win_cmd;
    volatile sdio_slc_host_conf_w6_reg_t conf_w6;
    volatile sdio_slc_host_conf_w7_reg_t conf_w7;
    volatile sdio_slc_host_pkt_len0_reg_t pkt_len0;
    volatile sdio_slc_host_pkt_len1_reg_t pkt_len1;
    volatile sdio_slc_host_pkt_len2_reg_t pkt_len2;
    volatile sdio_slc_host_conf_w8_reg_t conf_w8;
    volatile sdio_slc_host_conf_w9_reg_t conf_w9;
    volatile sdio_slc_host_conf_w10_reg_t conf_w10;
    volatile sdio_slc_host_conf_w11_reg_t conf_w11;
    volatile sdio_slc_host_conf_w12_reg_t conf_w12;
    volatile sdio_slc_host_conf_w13_reg_t conf_w13;
    volatile sdio_slc_host_conf_w14_reg_t conf_w14;
    volatile sdio_slc_host_conf_w15_reg_t conf_w15;
    volatile sdio_slc_host_check_sum0_reg_t check_sum0;
    volatile sdio_slc_host_check_sum1_reg_t check_sum1;
    volatile sdio_slc_host_slc1host_token_rdata_reg_t slc1host_token_rdata;
    volatile sdio_slc_host_slc0host_token_wdata_reg_t slc0host_token_wdata;
    volatile sdio_slc_host_slc1host_token_wdata_reg_t slc1host_token_wdata;
    volatile sdio_slc_host_token_con_reg_t token_con;
    volatile sdio_slc_host_slc0host_int_clr_reg_t slc0host_int_clr;
    volatile sdio_slc_host_slc1host_int_clr_reg_t slc1host_int_clr;
    volatile sdio_slc_host_slc0host_func1_int_ena_reg_t slc0host_func1_int_ena;
    volatile sdio_slc_host_slc1host_func1_int_ena_reg_t slc1host_func1_int_ena;
    volatile sdio_slc_host_slc0host_func2_int_ena_reg_t slc0host_func2_int_ena;
    volatile sdio_slc_host_slc1host_func2_int_ena_reg_t slc1host_func2_int_ena;
    volatile sdio_slc_host_slc0host_int_ena_reg_t slc0host_int_ena;
    volatile sdio_slc_host_slc1host_int_ena_reg_t slc1host_int_ena;
    volatile sdio_slc_host_slc0host_rx_infor_reg_t slc0host_rx_infor;
    volatile sdio_slc_host_slc1host_rx_infor_reg_t slc1host_rx_infor;
    volatile sdio_slc_host_slc0host_len_wd_reg_t slc0host_len_wd;
    volatile sdio_slc_host_slc_apbwin_wdata_reg_t slc_apbwin_wdata;
    volatile sdio_slc_host_slc_apbwin_conf_reg_t slc_apbwin_conf;
    volatile sdio_slc_host_slc_apbwin_rdata_reg_t slc_apbwin_rdata;
    volatile sdio_slc_host_rdclr0_reg_t rdclr0;
    volatile sdio_slc_host_rdclr1_reg_t rdclr1;
    volatile sdio_slc_host_slc0host_int_ena1_reg_t slc0host_int_ena1;
    volatile sdio_slc_host_slc1host_int_ena1_reg_t slc1host_int_ena1;
    uint32_t reserved_11c[23];
    volatile sdio_slc_host_date_reg_t date;
    volatile sdio_slc_host_id_reg_t id;
    uint32_t reserved_180[28];
    volatile sdio_slc_host_conf_reg_t conf;
    volatile sdio_slc_host_inf_st_reg_t inf_st;
} host_dev_t;
