...
typedef union {
    struct {
        /** date : R/W; bitpos: [31:0]; default: 2410220;
         *  Version control register
         */
        uint32_t date:32;
    };
...
typedef union {
    struct {
         ...
         *  Write 1 and then 0 to reset AHB_DMA channel n RX FSM and RX FIFO pointer.
         */
...
typedef union {
    struct {
         ...
         *  8: ADC_DAC
         *  9: PARL_IO
         *  10: CH0 M2M (auto selected by hw)
         *  11: CH1 M2M (auto selected by hw)
         *  12: CH2 M2M (auto selected by hw)
         *  13~15: Dummy
         */
...
/** Type of tx_arb_weight_opt_dis_chn register
...
/** Type of rx_arb_weight_opt_dis_chn register
...
typedef struct {
    ahb_dma_in_done_des_addr_chn_reg_t in_done_des_addr;
    ahb_dma_out_done_des_addr_chn_reg_t out_done_des_addr;
...
typedef struct {
    ...
    volatile ahb_dma_done_des_addr_chn_reg_t done_des_addr[3];
} ahb_dma_dev_t;
