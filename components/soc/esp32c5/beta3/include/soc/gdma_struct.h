...
typedef union {
    struct {
        /** date : R/W; bitpos: [31:0]; default: 36720912;
         *  register version.
         */
        uint32_t date:32;
    };
...
/** Group: Configuration Registers0 */
...
#ifndef __cplusplus
_Static_assert(sizeof(gdma_dev_t) == 0x28c, "Invalid size of gdma_dev_t structure");
#endif
