...
/** EFUSE_HUK_GEN_STATE_PART1 : RO; bitpos: [31:27]; default: 0;
 *  Represents the validation of HUK generate mode.
 */
#define EFUSE_HUK_GEN_STATE_PART1    0x0000001FU
#define EFUSE_HUK_GEN_STATE_PART1_M  (EFUSE_HUK_GEN_STATE_PART1_V << EFUSE_HUK_GEN_STATE_PART1_S)
#define EFUSE_HUK_GEN_STATE_PART1_V  0x0000001FU
#define EFUSE_HUK_GEN_STATE_PART1_S  27

/** EFUSE_RD_REPEAT_DATA1_REG register
 *  BLOCK0 data register 2.
 */
#define EFUSE_RD_REPEAT_DATA1_REG (DR_REG_EFUSE_BASE + 0x34)
/** EFUSE_HUK_GEN_STATE_PART2 : RO; bitpos: [3:0]; default: 0;
 *  Represents the validation of HUK generate mode.
 */
#define EFUSE_HUK_GEN_STATE_PART2    0x0000000FU
#define EFUSE_HUK_GEN_STATE_PART2_M  (EFUSE_HUK_GEN_STATE_PART2_V << EFUSE_HUK_GEN_STATE_PART2_S)
#define EFUSE_HUK_GEN_STATE_PART2_V  0x0000000FU
#define EFUSE_HUK_GEN_STATE_PART2_S  0
...
/** EFUSE_KM_DISABLE_DEPLOY_MODE : RO; bitpos: [15]; default: 0;
 *  TBD.
 */
#define EFUSE_KM_DISABLE_DEPLOY_MODE    (BIT(15))
#define EFUSE_KM_DISABLE_DEPLOY_MODE_M  (EFUSE_KM_DISABLE_DEPLOY_MODE_V << EFUSE_KM_DISABLE_DEPLOY_MODE_S)
#define EFUSE_KM_DISABLE_DEPLOY_MODE_V  0x00000001U
#define EFUSE_KM_DISABLE_DEPLOY_MODE_S  15
...
/** EFUSE_RESERVED_0 : RO; bitpos: [31:24]; default: 0;
 *  Reserved.
 */
#define EFUSE_RESERVED_0    0x000000FFU
#define EFUSE_RESERVED_0_M  (EFUSE_RESERVED_0_V << EFUSE_RESERVED_0_S)
#define EFUSE_RESERVED_0_V  0x000000FFU
#define EFUSE_RESERVED_0_S  24
...
/** EFUSE_HUK_GEN_STATE_PART1_ERR : RO; bitpos: [31:27]; default: 0;
 *  Indicates a programming error of EFUSE_HUK_GEN_STATE_PART1.
 */
#define EFUSE_HUK_GEN_STATE_PART1_ERR    0x0000001FU
#define EFUSE_HUK_GEN_STATE_PART1_ERR_M  (EFUSE_HUK_GEN_STATE_PART1_ERR_V << EFUSE_HUK_GEN_STATE_PART1_ERR_S)
#define EFUSE_HUK_GEN_STATE_PART1_ERR_V  0x0000001FU
#define EFUSE_HUK_GEN_STATE_PART1_ERR_S  27
...
/** EFUSE_HUK_GEN_STATE_PART2_ERR : RO; bitpos: [3:0]; default: 0;
 *  Indicates a programming error of EFUSE_HUK_GEN_STATE_PART2.
 */
#define EFUSE_HUK_GEN_STATE_PART2_ERR    0x0000000FU
#define EFUSE_HUK_GEN_STATE_PART2_ERR_M  (EFUSE_HUK_GEN_STATE_PART2_ERR_V << EFUSE_HUK_GEN_STATE_PART2_ERR_S)
#define EFUSE_HUK_GEN_STATE_PART2_ERR_V  0x0000000FU
#define EFUSE_HUK_GEN_STATE_PART2_ERR_S  0
...
/** EFUSE_KM_DISABLE_DEPLOY_MODE_ERR : RO; bitpos: [15]; default: 0;
 *  Indicates a programming error of EFUSE_KM_DISABLE_DEPLOY_MODE.
 */
#define EFUSE_KM_DISABLE_DEPLOY_MODE_ERR    (BIT(15))
#define EFUSE_KM_DISABLE_DEPLOY_MODE_ERR_M  (EFUSE_KM_DISABLE_DEPLOY_MODE_ERR_V << EFUSE_KM_DISABLE_DEPLOY_MODE_ERR_S)
#define EFUSE_KM_DISABLE_DEPLOY_MODE_ERR_V  0x00000001U
#define EFUSE_KM_DISABLE_DEPLOY_MODE_ERR_S  15
...
/** EFUSE_USB_SERIAL_JTAG_ROM_PRINT_ERR : RO; bitpos: [2]; default: 0;
 *  Indicates a programming error of UART_PRINT_CHANNEL.
 */
#define EFUSE_USB_SERIAL_JTAG_ROM_PRINT_ERR    (BIT(2))
#define EFUSE_USB_SERIAL_JTAG_ROM_PRINT_ERR_M  (EFUSE_USB_SERIAL_JTAG_ROM_PRINT_ERR_V << EFUSE_USB_SERIAL_JTAG_ROM_PRINT_ERR_S)
#define EFUSE_USB_SERIAL_JTAG_ROM_PRINT_ERR_V  0x00000001U
#define EFUSE_USB_SERIAL_JTAG_ROM_PRINT_ERR_S  2
...
/** EFUSE_RESERVED_0_ERR : RO; bitpos: [31:24]; default: 0;
 *  Reserved.
 */
#define EFUSE_RESERVED_0_ERR    0x000000FFU
#define EFUSE_RESERVED_0_ERR_M  (EFUSE_RESERVED_0_ERR_V << EFUSE_RESERVED_0_ERR_S)
#define EFUSE_RESERVED_0_ERR_V  0x000000FFU
#define EFUSE_RESERVED_0_ERR_S  24
