 ...
 *
 * It can also be ran manually with `./tools/gen_soc_caps_kconfig/gen_soc_caps_kconfig.py 'components/soc/esp32h4/include/soc/'`
 *
...
#   include "sdkconfig.h"
#  else
#   warning Chip version cannot be determined. Default chip to ESP32H4_BETA_VERSION_1.
#   define CONFIG_IDF_TARGET_ESP32H4_BETA_VERSION_1     1
#  endif
#endif
...
/*-------------------------- RTCIO CAPS --------------------------------------*/
/* No dedicated RTCIO subsystem on ESP32-H4. RTC functions are still supported
