...
// ---- All DWC register typedef unions from S3 ----
typedef union {
    struct {
...
typedef struct {
    volatile usb_dwc_hcchar_reg_t hcchar_reg;
    uint32_t reserved_0x04[1];
    volatile usb_dwc_hcint_reg_t hcint_reg;
    volatile usb_dwc_hcintmsk_reg_t hcintmsk_reg;
    volatile usb_dwc_hctsiz_reg_t hctsiz_reg;
    volatile usb_dwc_hcdma_reg_t hcdma_reg;
    uint32_t reserved_0x18[1];
    volatile usb_dwc_hcdmab_reg_t hcdmab_reg;
} usb_dwc_host_chan_regs_t;

typedef struct {
    volatile usb_dwc_diepctl_reg_t diepctl_reg;
    uint32_t reserved_0x04[1];
    volatile usb_dwc_diepint_reg_t diepint_reg;
    uint32_t reserved_0x0c[1];
    volatile usb_dwc_dieptsiz_reg_t dieptsiz_reg;
    volatile usb_dwc_diepdma_reg_t diepdma_reg;
    volatile usb_dwc_dtxfsts_reg_t dtxfsts_reg;
    volatile usb_dwc_diepdmab_reg_t diepdmab_reg;
} usb_dwc_in_ep_regs_t;

typedef struct {
    volatile usb_dwc_doepctl_reg_t doepctl_reg;
    uint32_t reserved_0x04[1];
    volatile usb_dwc_doepint_reg_t doepint_reg;
    uint32_t reserved_0x0c[1];
    volatile usb_dwc_doeptsiz_reg_t doeptsiz_reg;
    volatile usb_dwc_doepdma_reg_t doepdma_reg;
    uint32_t reserved_0x18[1];
    volatile usb_dwc_doepdmab_reg_t doepdmab_reg;
...
typedef struct {
    ...
    volatile usb_dwc_dieptxfi_reg_t dieptxf_regs[4];        // 0x0104 to 0x0110
    usb_dwc_dieptxfi_reg_t reserved_0x0114_0x013c[11];      // 0x0114 to 0x013c
    ...
    usb_dwc_host_chan_regs_t host_chans[8];                 // 0x0500 to 0x05fc
    usb_dwc_host_chan_regs_t reserved_0x0600_0x06fc[8];     // 0x0600 to 0x06fc
    ...
    uint32_t reserved_0x0844_0x087c[15];                    // 0x0844 to 0x087c
    uint32_t reserved_0x0880;                               // 0x0880
    uint32_t reserved_0x0884_0x08c0[15];                    // 0x0884 to 0x08c0
    ...
    usb_dwc_in_ep_regs_t in_eps[6];                         // 0x0920 to 0x09dc
    usb_dwc_in_ep_regs_t reserved_0x09e0_0x0afc[9];         // 0x09e0 to 0x0afc
    ...
    usb_dwc_out_ep_regs_t out_eps[6];                       // 0x0b20 to 0x0bdc
    usb_dwc_out_ep_regs_t reserved_0x0be0_0x0d00[9];        // 0x0be0 to 0x0cfc
