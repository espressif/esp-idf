...
typedef union {
    struct {
        /** aon_touch_freq_dcap_lpf : R/W; bitpos: [6:0]; default: 0;
         *  need_des
         */
        uint32_t aon_touch_freq_dcap_lpf:7;
        /** aon_touch_freq_dres_lpf : R/W; bitpos: [8:7]; default: 0;
         *  need_des
         */
        uint32_t aon_touch_freq_dres_lpf:2;
        /** aon_touch_freq_drv_ls : R/W; bitpos: [12:9]; default: 0;
         *  need_des
         */
        uint32_t aon_touch_freq_drv_ls:4;
        /** aon_touch_freq_drv_hs : R/W; bitpos: [17:13]; default: 0;
         *  need_des
         */
        uint32_t aon_touch_freq_drv_hs:5;
        /** aon_touch_freq_dbias : R/W; bitpos: [22:18]; default: 0;
         *  need_des
         */
        uint32_t aon_touch_freq_dbias:5;
        /** aon_touch_freq_buf_sel_en : R/W; bitpos: [23]; default: 1;
         *  need_des
         */
        uint32_t aon_touch_freq_buf_sel_en:1;
...
typedef struct {
    ...
    volatile touch_aon_freq_scan_para_reg_t aon_freq_scan_para[3];
    ...
    volatile touch_aon_pad_thresh_reg_t aon_padx_thn[15];
