...
/** I2C_RX_FULL_ACK_LEVEL : R/W; bitpos: [3]; default: 0;
 *  Configures the ACK value that needs to be sent by master when rx_fifo_cnt has
 ...
 *  Configures whether the slave starts sending the data in TX FIFO.
 *  0: No effect
 *  1: Start
 */
 ...
 *  Configures whether or not to control the sending order for data needing to be sent.
 ...
 *  Configures whether or not to control the storage order for received data.
...
/** I2C_ARBITRATION_EN : R/W; bitpos: [9]; default: 0;
 *  Configures whether to enable I2C bus arbitration detection.
 *  0: No effect
 *  1: Enable
 */
 ...
 *  Configures whether to reset the SCL_FSM.
 *  0: No effect
 *  1: Reset
 */
 ...
 *  Configures the bit for synchronization.
 *  0: No effect
 *  1: Synchronize
 */
 ...
 *  Configures whether to enable slave to send data automatically
 *  0: Disable
 *  1: Enable
 */
 ...
 *  Configures whether to check if the $R/\overline W$ bit of 10-bit addressing
 ...
 *  Configures whether to support the 7-bit general call function.
 *  0: Not support
 *  1: Support
 */
 ...
 *  Configures whether to enable timeout control.
 *  0: No effect
 *  1: Enable
 */
 ...
 *  Configures whether to enable the slave 10-bit addressing mode in Master mode.
 *  0: No effect
 *  1: Enable
 */
 ...
 *  Represents the offset address of i2c module receiving data and writing to RX FIFO.
 */
 ...
 *  Represents the offset address of I2C module reading from TX FIFO.
 */
 ...
 *  Represents the offset address of APB bus writing to TX FIFO.
 */
...
/** I2C_RXFIFO_WM_THRHD : R/W; bitpos: [4:0]; default: 0;
 ...
 *  the I2C_RXFIFO_WM_INT_RAW bit will be valid.
 */
...
/** I2C_TXFIFO_WM_THRHD : R/W; bitpos: [9:5]; default: 0;
 *  Configures the watermark threshold of TX FIFO in non-FIFO access mode.  When
 *  I2C_FIFO_PRT_EN is 1 and TC FIFO counter is bigger than I2C_TXFIFO_WM_THRHD[4:0],
 *  the I2C_TXFIFO_WM_INT_RAW bit will be valid.
 */
 ...
 *  Configures whether to enable APB non-FIFO access.
 */
 ...
 *  Configures whether or not to reset RX FIFO.
 *  0: No effect
 *  1: Reset
 */
 ...
 *  Configures whether or not to reset TX FIFO.
 *  0: No effect
 *  1: Reset
 */
...
/** I2C_FIFO_PRT_EN : R/W; bitpos: [14]; default: 0;
 *  Configures whether to enable FIFO pointer in non-FIFO access mode. This bit
 *  controls the valid bits and the TX/RX FIFO overflow, underflow, full and empty
 *  interrupts.
 *  0: No effect
 *  1: Enable
 */
 ...
 *  Represents the value of RX FIFO read data.
 */
...
/** I2C_TXFIFO_WM_INT_RAW : R/SS/WTC; bitpos: [1]; default: 0;
 *  The raw interrupt status of I2C_TXFIFO_WM_INT.
 */
 ...
 *  The raw interrupt status of I2C_RXFIFO_OVF_INT.
 */
 ...
 *  The raw interrupt status of I2C_END_DETECT_INT.
 */
 ...
 *  The raw interrupt status of I2C_BYTE_TRANS_DONE_INT.
 */
 ...
 *  The raw interrupt status of I2C_ARBITRATION_LOST_INT.
 */
 ...
 *  The raw interrupt status of I2C_MST_TXFIFO_UDF_INT.
 */
 ...
 *  The raw interrupt status of the I2C_TRANS_COMPLETE_INT.
 */
 ...
 *  The raw interrupt status of I2C_TIME_OUT_INT.
 */
 ...
 *  The raw interrupt status of I2C_TRANS_START_INT.
 */
 ...
 *  The raw interrupt status of I2C_NACK_INT.
 */
 ...
 *  The raw interrupt status of I2C_TXFIFO_OVF_INT.
 */
 ...
 *  The raw interrupt status of I2C_SCL_ST_TO_INT.
 */
 ...
 *  The raw interrupt status of I2C_SCL_MAIN_ST_TO_INT.
 */
 ...
 *  The raw interrupt status of I2C_SLAVE_STRETCH_INT.
 */
 ...
 *  The raw interrupt status of I2C_GENERAL_CALL_INT.
 */
 ...
 *  The raw interrupt status of I2C_SLAVE_ADDR_UNMATCH_INT.
 */
 ...
 *  Write 1 to clear I2C_TXFIFO_WM_INT.
 */
 ...
 *  Write 1 to clear I2C_END_DETECT_INT.
 */
 ...
 *  Write 1 to clear I2C_BYTE_TRANS_DONE_INT.
 */
 ...
 *  Write 1 to clear I2C_ARBITRATION_LOST_INT.
 */
 ...
 *  Write 1 to clear I2C_MST_TXFIFO_UDF_INT.
 */
 ...
 *  Write 1 to clear I2C_TRANS_COMPLETE_INT.
 */
 ...
 *  Write 1 to clear I2C_TIME_OUT_INT.
 */
 ...
 *  Write 1 to clear I2C_TRANS_START_INT.
 */
 ...
 *  Write 1 to clear I2C_TXFIFO_OVF_INT.
 */
 ...
 *  Write 1 to clear I2C_RXFIFO_UDF_INT.
 */
 ...
 *  Write 1 to clear I2C_SCL_ST_TO_INT.
 */
 ...
 *  Write 1 to clear I2C_SCL_MAIN_ST_TO_INT.
 */
 ...
 *  Write 1 to clear I2C_DET_START_INT.
 */
 ...
 *  Write 1 to clear I2C_SLAVE_STRETCH_INT.
 */
 ...
 *  Write 1 to clear I2C_GENERAL_CALL_INT.
 */
 ...
 *  Write 1 to clear I2C_SLAVE_ADDR_UNMATCH_INT.
 */
 ...
 *  Write 1 to enable I2C_TXFIFO_WM_INT.
 */
 ...
 *  Write 1 to enable I2C_RXFIFO_OVF_INT.
 */
 ...
 *  Write 1 to enable I2C_END_DETECT_INT.
 */
 ...
 *  Write 1 to enable I2C_BYTE_TRANS_DONE_INT.
 */
 ...
 *  Write 1 to enable I2C_ARBITRATION_LOST_INT.
 */
 ...
 *  Write 1 to enable I2C_MST_TXFIFO_UDF_INT.
 */
 ...
 *  Write 1 to enable I2C_TRANS_COMPLETE_INT.
 */
 ...
 *  Write 1 to enable I2C_TIME_OUT_INT.
 */
 ...
 *  Write 1 to enable I2C_TRANS_START_INT.
 */
 ...
 *  Write 1 to enable I2C_NACK_INT.
 */
 ...
 *  Write 1 to enable I2C_RXFIFO_UDF_INT.
 */
 ...
 *  Write 1 to enable I2C_SCL_ST_TO_INT.
 */
 ...
 *  Write 1 to enable I2C_SCL_MAIN_ST_TO_INT.
 */
 ...
 *  Write 1 to enable I2C_DET_START_INT.
 */
 ...
 *  Write 1 to enable I2C_SLAVE_STRETCH_INT.
 */
 ...
 *  Write 1 to enable I2C_GENERAL_CALL_INT.
 */
 ...
 *  The masked interrupt status of I2C_TXFIFO_WM_INT.
 */
 ...
 *  The masked interrupt status of I2C_RXFIFO_OVF_INT.
 */
 ...
 *  The masked interrupt status of I2C_END_DETECT_INT.
 */
 ...
 *  The masked interrupt status of I2C_BYTE_TRANS_DONE_INT.
 */
 ...
 *  The masked interrupt status of I2C_ARBITRATION_LOST_INT.
 */
 ...
 *  The masked interrupt status of I2C_MST_TXFIFO_UDF_INT.
 */
 ...
 *  The masked interrupt status of I2C_TRANS_COMPLETE_INT.
 */
 ...
 *  The masked interrupt status of I2C_TIME_OUT_INT.
 */
 ...
 *  The masked interrupt status of I2C_TRANS_START_INT.
 */
 ...
 *  The masked interrupt status of I2C_NACK_INT.
 */
 ...
 *  The masked interrupt status of I2C_TXFIFO_OVF_INT.
 */
 ...
 *  The masked interrupt status of I2C_RXFIFO_UDF_INT.
 */
 ...
 *  The masked interrupt status of I2C_SCL_ST_TO_INT.
 */
 ...
 *  The masked interrupt status of I2C_SCL_MAIN_ST_TO_INT.
 */
 ...
 *  The masked interrupt status of I2C_DET_START_INT.
 */
 ...
 *  The masked interrupt status of I2C_SLAVE_STRETCH_INT.
 */
 ...
 *  The masked interrupt status of I2C_GENERAL_CALL_INT.
 */
 ...
 *  The masked interrupt status of I2C_SLAVE_ADDR_UNMATCH_INT.
 */
...
/** I2C_SCL_START_HOLD_TIME : R/W; bitpos: [8:0]; default: 0;
...
/** I2C_SCL_RSTART_SETUP_TIME : R/W; bitpos: [8:0]; default: 0;
...
/** I2C_SCL_STOP_HOLD_TIME : R/W; bitpos: [8:0]; default: 0;
...
/** I2C_SCL_STOP_SETUP_TIME : R/W; bitpos: [8:0]; default: 0;
...
/** I2C_SCL_FILTER_EN : R/W; bitpos: [8]; default: 0;
 *  Configures whether to enable the filter function for SCL.
 *  0: No effect
 *  1: Enable
 */
...
/** I2C_SDA_FILTER_EN : R/W; bitpos: [9]; default: 0;
 *  Configures whether to enable the filter function for SDA.
 *  0: No effect
 *  1: Enable
 */
 ...
 *  \[
 *  \text{Threshold} = 2^{\text{I2C_SCL_ST_TO_I2C} - 1}
 *  \]
 *
 *  Measurement unit: I2C_SCLK
 */
 ...
 *  Configures whether or not to power down the I2C output SCL line.
 *  0: Not power down
 *  1: Power down
 ...
 *  Configures whether or not to power down the I2C output SDA line.
 *  0: Not power down
 *  1: Power down
 ...
 *  Configures whether to enable slave SCL stretch function. The SCL output line will
 *  be stretched low when I2C_SLAVE_SCL_STRETCH_EN is 1 and stretch event happens. The
 ...
 *  Configures whether or not to clear the I2C slave SCL stretch function.
 *  0: No effect
 *  1: Clear
 */
 ...
 *  Configures whether to enable the function for slave to control ACK level.
 *  0: Disable
 *  1: Enable
 */
 ...
 *  Configures the ACK level when slave controlling ACK level function enables.
 *  0: Low level
 *  1: High level
 */
