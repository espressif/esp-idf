...
typedef union {
    struct {
        ...
        /** hp_active_hp_regulator_drv_b : R/W; bitpos: [31:8]; default: 16;
         *  need_des
         */
...
typedef union {
    struct {
        uint32_t reserved_0:8;
        /** hp_sleep_hp_regulator_drv_b : R/W; bitpos: [31:8]; default: 16;
         *  need_des
         */
...
typedef union {
    struct {
        /** wait_xtl_stable : R/W; bitpos: [15:0]; default: 384;
         *  need_des
         */
...
typedef union {
    struct {
        /** pmu_date : R/W; bitpos: [30:0]; default: 38814336;
         *  need_des
         */
