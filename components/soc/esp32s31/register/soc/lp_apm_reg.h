...
/** LP_APM_REGION0_TEE_X : R/W; bitpos: [12]; default: 1;
 *  Configures the execution authority of TEE_MODE in region 0.
 */
#define LP_APM_REGION0_TEE_X    (BIT(12))
#define LP_APM_REGION0_TEE_X_M  (LP_APM_REGION0_TEE_X_V << LP_APM_REGION0_TEE_X_S)
#define LP_APM_REGION0_TEE_X_V  0x00000001U
#define LP_APM_REGION0_TEE_X_S  12
/** LP_APM_REGION0_TEE_W : R/W; bitpos: [13]; default: 1;
 *  Configures the write authority of TEE_MODE in region 0.
 */
#define LP_APM_REGION0_TEE_W    (BIT(13))
#define LP_APM_REGION0_TEE_W_M  (LP_APM_REGION0_TEE_W_V << LP_APM_REGION0_TEE_W_S)
#define LP_APM_REGION0_TEE_W_V  0x00000001U
#define LP_APM_REGION0_TEE_W_S  13
/** LP_APM_REGION0_TEE_R : R/W; bitpos: [14]; default: 1;
 *  Configures the read authority of TEE_MODE in region 0.
 */
#define LP_APM_REGION0_TEE_R    (BIT(14))
#define LP_APM_REGION0_TEE_R_M  (LP_APM_REGION0_TEE_R_V << LP_APM_REGION0_TEE_R_S)
#define LP_APM_REGION0_TEE_R_V  0x00000001U
#define LP_APM_REGION0_TEE_R_S  14
/** LP_APM_REGION0_LOCK : R/W; bitpos: [16]; default: 0;
 *  Set 1 to lock region0 configuration
 */
#define LP_APM_REGION0_LOCK    (BIT(16))
#define LP_APM_REGION0_LOCK_M  (LP_APM_REGION0_LOCK_V << LP_APM_REGION0_LOCK_S)
#define LP_APM_REGION0_LOCK_V  0x00000001U
#define LP_APM_REGION0_LOCK_S  16
...
/** LP_APM_REGION1_TEE_X : R/W; bitpos: [12]; default: 1;
 *  Configures the execution authority of TEE_MODE in region 1.
 */
#define LP_APM_REGION1_TEE_X    (BIT(12))
#define LP_APM_REGION1_TEE_X_M  (LP_APM_REGION1_TEE_X_V << LP_APM_REGION1_TEE_X_S)
#define LP_APM_REGION1_TEE_X_V  0x00000001U
#define LP_APM_REGION1_TEE_X_S  12
/** LP_APM_REGION1_TEE_W : R/W; bitpos: [13]; default: 1;
 *  Configures the write authority of TEE_MODE in region 1.
 */
#define LP_APM_REGION1_TEE_W    (BIT(13))
#define LP_APM_REGION1_TEE_W_M  (LP_APM_REGION1_TEE_W_V << LP_APM_REGION1_TEE_W_S)
#define LP_APM_REGION1_TEE_W_V  0x00000001U
#define LP_APM_REGION1_TEE_W_S  13
/** LP_APM_REGION1_TEE_R : R/W; bitpos: [14]; default: 1;
 *  Configures the read authority of TEE_MODE in region 1.
 */
#define LP_APM_REGION1_TEE_R    (BIT(14))
#define LP_APM_REGION1_TEE_R_M  (LP_APM_REGION1_TEE_R_V << LP_APM_REGION1_TEE_R_S)
#define LP_APM_REGION1_TEE_R_V  0x00000001U
#define LP_APM_REGION1_TEE_R_S  14
/** LP_APM_REGION1_LOCK : R/W; bitpos: [16]; default: 0;
 *  Set 1 to lock region0 configuration
 */
#define LP_APM_REGION1_LOCK    (BIT(16))
#define LP_APM_REGION1_LOCK_M  (LP_APM_REGION1_LOCK_V << LP_APM_REGION1_LOCK_S)
#define LP_APM_REGION1_LOCK_V  0x00000001U
#define LP_APM_REGION1_LOCK_S  16
...
/** LP_APM_REGION2_TEE_X : R/W; bitpos: [12]; default: 1;
 *  Configures the execution authority of TEE_MODE in region 2.
 */
#define LP_APM_REGION2_TEE_X    (BIT(12))
#define LP_APM_REGION2_TEE_X_M  (LP_APM_REGION2_TEE_X_V << LP_APM_REGION2_TEE_X_S)
#define LP_APM_REGION2_TEE_X_V  0x00000001U
#define LP_APM_REGION2_TEE_X_S  12
/** LP_APM_REGION2_TEE_W : R/W; bitpos: [13]; default: 1;
 *  Configures the write authority of TEE_MODE in region 2.
 */
#define LP_APM_REGION2_TEE_W    (BIT(13))
#define LP_APM_REGION2_TEE_W_M  (LP_APM_REGION2_TEE_W_V << LP_APM_REGION2_TEE_W_S)
#define LP_APM_REGION2_TEE_W_V  0x00000001U
#define LP_APM_REGION2_TEE_W_S  13
/** LP_APM_REGION2_TEE_R : R/W; bitpos: [14]; default: 1;
 *  Configures the read authority of TEE_MODE in region 2.
 */
#define LP_APM_REGION2_TEE_R    (BIT(14))
#define LP_APM_REGION2_TEE_R_M  (LP_APM_REGION2_TEE_R_V << LP_APM_REGION2_TEE_R_S)
#define LP_APM_REGION2_TEE_R_V  0x00000001U
#define LP_APM_REGION2_TEE_R_S  14
/** LP_APM_REGION2_LOCK : R/W; bitpos: [16]; default: 0;
 *  Set 1 to lock region0 configuration
 */
#define LP_APM_REGION2_LOCK    (BIT(16))
#define LP_APM_REGION2_LOCK_M  (LP_APM_REGION2_LOCK_V << LP_APM_REGION2_LOCK_S)
#define LP_APM_REGION2_LOCK_V  0x00000001U
#define LP_APM_REGION2_LOCK_S  16
...
/** LP_APM_REGION3_TEE_X : R/W; bitpos: [12]; default: 1;
 *  Configures the execution authority of TEE_MODE in region 3.
 */
#define LP_APM_REGION3_TEE_X    (BIT(12))
#define LP_APM_REGION3_TEE_X_M  (LP_APM_REGION3_TEE_X_V << LP_APM_REGION3_TEE_X_S)
#define LP_APM_REGION3_TEE_X_V  0x00000001U
#define LP_APM_REGION3_TEE_X_S  12
/** LP_APM_REGION3_TEE_W : R/W; bitpos: [13]; default: 1;
 *  Configures the write authority of TEE_MODE in region 3.
 */
#define LP_APM_REGION3_TEE_W    (BIT(13))
#define LP_APM_REGION3_TEE_W_M  (LP_APM_REGION3_TEE_W_V << LP_APM_REGION3_TEE_W_S)
#define LP_APM_REGION3_TEE_W_V  0x00000001U
#define LP_APM_REGION3_TEE_W_S  13
/** LP_APM_REGION3_TEE_R : R/W; bitpos: [14]; default: 1;
 *  Configures the read authority of TEE_MODE in region 3.
 */
#define LP_APM_REGION3_TEE_R    (BIT(14))
#define LP_APM_REGION3_TEE_R_M  (LP_APM_REGION3_TEE_R_V << LP_APM_REGION3_TEE_R_S)
#define LP_APM_REGION3_TEE_R_V  0x00000001U
#define LP_APM_REGION3_TEE_R_S  14
/** LP_APM_REGION3_LOCK : R/W; bitpos: [16]; default: 0;
 *  Set 1 to lock region0 configuration
 */
#define LP_APM_REGION3_LOCK    (BIT(16))
#define LP_APM_REGION3_LOCK_M  (LP_APM_REGION3_LOCK_V << LP_APM_REGION3_LOCK_S)
#define LP_APM_REGION3_LOCK_V  0x00000001U
#define LP_APM_REGION3_LOCK_S  16
...
/** LP_APM_REGION4_TEE_X : R/W; bitpos: [12]; default: 1;
 *  Configures the execution authority of TEE_MODE in region 4.
 */
#define LP_APM_REGION4_TEE_X    (BIT(12))
#define LP_APM_REGION4_TEE_X_M  (LP_APM_REGION4_TEE_X_V << LP_APM_REGION4_TEE_X_S)
#define LP_APM_REGION4_TEE_X_V  0x00000001U
#define LP_APM_REGION4_TEE_X_S  12
/** LP_APM_REGION4_TEE_W : R/W; bitpos: [13]; default: 1;
 *  Configures the write authority of TEE_MODE in region 4.
 */
#define LP_APM_REGION4_TEE_W    (BIT(13))
#define LP_APM_REGION4_TEE_W_M  (LP_APM_REGION4_TEE_W_V << LP_APM_REGION4_TEE_W_S)
#define LP_APM_REGION4_TEE_W_V  0x00000001U
#define LP_APM_REGION4_TEE_W_S  13
/** LP_APM_REGION4_TEE_R : R/W; bitpos: [14]; default: 1;
 *  Configures the read authority of TEE_MODE in region 4.
 */
#define LP_APM_REGION4_TEE_R    (BIT(14))
#define LP_APM_REGION4_TEE_R_M  (LP_APM_REGION4_TEE_R_V << LP_APM_REGION4_TEE_R_S)
#define LP_APM_REGION4_TEE_R_V  0x00000001U
#define LP_APM_REGION4_TEE_R_S  14
/** LP_APM_REGION4_LOCK : R/W; bitpos: [16]; default: 0;
 *  Set 1 to lock region0 configuration
 */
#define LP_APM_REGION4_LOCK    (BIT(16))
#define LP_APM_REGION4_LOCK_M  (LP_APM_REGION4_LOCK_V << LP_APM_REGION4_LOCK_S)
#define LP_APM_REGION4_LOCK_V  0x00000001U
#define LP_APM_REGION4_LOCK_S  16
...
/** LP_APM_REGION5_TEE_X : R/W; bitpos: [12]; default: 1;
 *  Configures the execution authority of TEE_MODE in region 5.
 */
#define LP_APM_REGION5_TEE_X    (BIT(12))
#define LP_APM_REGION5_TEE_X_M  (LP_APM_REGION5_TEE_X_V << LP_APM_REGION5_TEE_X_S)
#define LP_APM_REGION5_TEE_X_V  0x00000001U
#define LP_APM_REGION5_TEE_X_S  12
/** LP_APM_REGION5_TEE_W : R/W; bitpos: [13]; default: 1;
 *  Configures the write authority of TEE_MODE in region 5.
 */
#define LP_APM_REGION5_TEE_W    (BIT(13))
#define LP_APM_REGION5_TEE_W_M  (LP_APM_REGION5_TEE_W_V << LP_APM_REGION5_TEE_W_S)
#define LP_APM_REGION5_TEE_W_V  0x00000001U
#define LP_APM_REGION5_TEE_W_S  13
/** LP_APM_REGION5_TEE_R : R/W; bitpos: [14]; default: 1;
 *  Configures the read authority of TEE_MODE in region 5.
 */
#define LP_APM_REGION5_TEE_R    (BIT(14))
#define LP_APM_REGION5_TEE_R_M  (LP_APM_REGION5_TEE_R_V << LP_APM_REGION5_TEE_R_S)
#define LP_APM_REGION5_TEE_R_V  0x00000001U
#define LP_APM_REGION5_TEE_R_S  14
/** LP_APM_REGION5_LOCK : R/W; bitpos: [16]; default: 0;
 *  Set 1 to lock region0 configuration
 */
#define LP_APM_REGION5_LOCK    (BIT(16))
#define LP_APM_REGION5_LOCK_M  (LP_APM_REGION5_LOCK_V << LP_APM_REGION5_LOCK_S)
#define LP_APM_REGION5_LOCK_V  0x00000001U
#define LP_APM_REGION5_LOCK_S  16
...
/** LP_APM_REGION6_TEE_X : R/W; bitpos: [12]; default: 1;
 *  Configures the execution authority of TEE_MODE in region 6.
 */
#define LP_APM_REGION6_TEE_X    (BIT(12))
#define LP_APM_REGION6_TEE_X_M  (LP_APM_REGION6_TEE_X_V << LP_APM_REGION6_TEE_X_S)
#define LP_APM_REGION6_TEE_X_V  0x00000001U
#define LP_APM_REGION6_TEE_X_S  12
/** LP_APM_REGION6_TEE_W : R/W; bitpos: [13]; default: 1;
 *  Configures the write authority of TEE_MODE in region 6.
 */
#define LP_APM_REGION6_TEE_W    (BIT(13))
#define LP_APM_REGION6_TEE_W_M  (LP_APM_REGION6_TEE_W_V << LP_APM_REGION6_TEE_W_S)
#define LP_APM_REGION6_TEE_W_V  0x00000001U
#define LP_APM_REGION6_TEE_W_S  13
/** LP_APM_REGION6_TEE_R : R/W; bitpos: [14]; default: 1;
 *  Configures the read authority of TEE_MODE in region 6.
 */
#define LP_APM_REGION6_TEE_R    (BIT(14))
#define LP_APM_REGION6_TEE_R_M  (LP_APM_REGION6_TEE_R_V << LP_APM_REGION6_TEE_R_S)
#define LP_APM_REGION6_TEE_R_V  0x00000001U
#define LP_APM_REGION6_TEE_R_S  14
/** LP_APM_REGION6_LOCK : R/W; bitpos: [16]; default: 0;
 *  Set 1 to lock region0 configuration
 */
#define LP_APM_REGION6_LOCK    (BIT(16))
#define LP_APM_REGION6_LOCK_M  (LP_APM_REGION6_LOCK_V << LP_APM_REGION6_LOCK_S)
#define LP_APM_REGION6_LOCK_V  0x00000001U
#define LP_APM_REGION6_LOCK_S  16
...
/** LP_APM_REGION7_TEE_X : R/W; bitpos: [12]; default: 1;
 *  Configures the execution authority of TEE_MODE in region 7.
 */
#define LP_APM_REGION7_TEE_X    (BIT(12))
#define LP_APM_REGION7_TEE_X_M  (LP_APM_REGION7_TEE_X_V << LP_APM_REGION7_TEE_X_S)
#define LP_APM_REGION7_TEE_X_V  0x00000001U
#define LP_APM_REGION7_TEE_X_S  12
/** LP_APM_REGION7_TEE_W : R/W; bitpos: [13]; default: 1;
 *  Configures the write authority of TEE_MODE in region 7.
 */
#define LP_APM_REGION7_TEE_W    (BIT(13))
#define LP_APM_REGION7_TEE_W_M  (LP_APM_REGION7_TEE_W_V << LP_APM_REGION7_TEE_W_S)
#define LP_APM_REGION7_TEE_W_V  0x00000001U
#define LP_APM_REGION7_TEE_W_S  13
/** LP_APM_REGION7_TEE_R : R/W; bitpos: [14]; default: 1;
 *  Configures the read authority of TEE_MODE in region 7.
 */
#define LP_APM_REGION7_TEE_R    (BIT(14))
#define LP_APM_REGION7_TEE_R_M  (LP_APM_REGION7_TEE_R_V << LP_APM_REGION7_TEE_R_S)
#define LP_APM_REGION7_TEE_R_V  0x00000001U
#define LP_APM_REGION7_TEE_R_S  14
/** LP_APM_REGION7_LOCK : R/W; bitpos: [16]; default: 0;
 *  Set 1 to lock region0 configuration
 */
#define LP_APM_REGION7_LOCK    (BIT(16))
#define LP_APM_REGION7_LOCK_M  (LP_APM_REGION7_LOCK_V << LP_APM_REGION7_LOCK_S)
#define LP_APM_REGION7_LOCK_V  0x00000001U
#define LP_APM_REGION7_LOCK_S  16

/** LP_APM_FUNC_CTRL_REG register
 *  APM function control register
 */
#define LP_APM_FUNC_CTRL_REG (DR_REG_LP_APM_BASE + 0xbc)
...
/** LP_APM_M2_FUNC_EN : R/W; bitpos: [2]; default: 1;
 *  PMS M2 function enable
 */
#define LP_APM_M2_FUNC_EN    (BIT(2))
#define LP_APM_M2_FUNC_EN_M  (LP_APM_M2_FUNC_EN_V << LP_APM_M2_FUNC_EN_S)
#define LP_APM_M2_FUNC_EN_V  0x00000001U
#define LP_APM_M2_FUNC_EN_S  2
/** LP_APM_M3_FUNC_EN : R/W; bitpos: [3]; default: 1;
 *  PMS M3 function enable
 */
#define LP_APM_M3_FUNC_EN    (BIT(3))
#define LP_APM_M3_FUNC_EN_M  (LP_APM_M3_FUNC_EN_V << LP_APM_M3_FUNC_EN_S)
#define LP_APM_M3_FUNC_EN_V  0x00000001U
#define LP_APM_M3_FUNC_EN_S  3

/** LP_APM_M0_STATUS_REG register
 *  M0 status register
 */
#define LP_APM_M0_STATUS_REG (DR_REG_LP_APM_BASE + 0xc0)
 ...
 */
#define LP_APM_M0_STATUS_CLR_REG (DR_REG_LP_APM_BASE + 0xc4)
 ...
 */
#define LP_APM_M0_EXCEPTION_INFO0_REG (DR_REG_LP_APM_BASE + 0xc8)
 ...
 *  M1 status register
 */
#define LP_APM_M1_STATUS_REG (DR_REG_LP_APM_BASE + 0xd4)
 ...
 */
#define LP_APM_M1_STATUS_CLR_REG (DR_REG_LP_APM_BASE + 0xd8)
 ...
 */
#define LP_APM_M1_EXCEPTION_INFO0_REG (DR_REG_LP_APM_BASE + 0xdc)
...
/** LP_APM_M1_EXCEPTION_ID : RO; bitpos: [23:18]; default: 0;
 *  Represents exception id information
 */
#define LP_APM_M1_EXCEPTION_ID    0x0000003FU
#define LP_APM_M1_EXCEPTION_ID_M  (LP_APM_M1_EXCEPTION_ID_V << LP_APM_M1_EXCEPTION_ID_S)
#define LP_APM_M1_EXCEPTION_ID_V  0x0000003FU
#define LP_APM_M1_EXCEPTION_ID_S  18

/** LP_APM_M1_EXCEPTION_INFO1_REG register
 *  M1 exception_info1 register
 */
#define LP_APM_M1_EXCEPTION_INFO1_REG (DR_REG_LP_APM_BASE + 0xe0)
...
/** LP_APM_M2_STATUS_REG register
 *  M2 status register
 */
#define LP_APM_M2_STATUS_REG (DR_REG_LP_APM_BASE + 0xe8)
/** LP_APM_M2_EXCEPTION_STATUS : RO; bitpos: [1:0]; default: 0;
 *  Represents exception status.
 *  bit0: 1 represents authority_exception
 *  bit1: 1 represents space_exception
 */
#define LP_APM_M2_EXCEPTION_STATUS    0x00000003U
#define LP_APM_M2_EXCEPTION_STATUS_M  (LP_APM_M2_EXCEPTION_STATUS_V << LP_APM_M2_EXCEPTION_STATUS_S)
#define LP_APM_M2_EXCEPTION_STATUS_V  0x00000003U
#define LP_APM_M2_EXCEPTION_STATUS_S  0

/** LP_APM_M2_STATUS_CLR_REG register
 *  M2 status clear register
 */
#define LP_APM_M2_STATUS_CLR_REG (DR_REG_LP_APM_BASE + 0xec)
/** LP_APM_M2_EXCEPTION_STATUS_CLR : WT; bitpos: [0]; default: 0;
 *  Configures to clear exception status
 */
#define LP_APM_M2_EXCEPTION_STATUS_CLR    (BIT(0))
#define LP_APM_M2_EXCEPTION_STATUS_CLR_M  (LP_APM_M2_EXCEPTION_STATUS_CLR_V << LP_APM_M2_EXCEPTION_STATUS_CLR_S)
#define LP_APM_M2_EXCEPTION_STATUS_CLR_V  0x00000001U
#define LP_APM_M2_EXCEPTION_STATUS_CLR_S  0

/** LP_APM_M2_EXCEPTION_INFO0_REG register
 *  M2 exception_info0 register
 */
#define LP_APM_M2_EXCEPTION_INFO0_REG (DR_REG_LP_APM_BASE + 0xf0)
/** LP_APM_M2_EXCEPTION_REGION : RO; bitpos: [7:0]; default: 0;
 *  Represents exception region
 */
#define LP_APM_M2_EXCEPTION_REGION    0x000000FFU
#define LP_APM_M2_EXCEPTION_REGION_M  (LP_APM_M2_EXCEPTION_REGION_V << LP_APM_M2_EXCEPTION_REGION_S)
#define LP_APM_M2_EXCEPTION_REGION_V  0x000000FFU
#define LP_APM_M2_EXCEPTION_REGION_S  0
/** LP_APM_M2_EXCEPTION_MODE : RO; bitpos: [17:16]; default: 0;
 *  Represents exception mode
 */
#define LP_APM_M2_EXCEPTION_MODE    0x00000003U
#define LP_APM_M2_EXCEPTION_MODE_M  (LP_APM_M2_EXCEPTION_MODE_V << LP_APM_M2_EXCEPTION_MODE_S)
#define LP_APM_M2_EXCEPTION_MODE_V  0x00000003U
#define LP_APM_M2_EXCEPTION_MODE_S  16
/** LP_APM_M2_EXCEPTION_ID : RO; bitpos: [23:18]; default: 0;
 *  Represents exception id information
 */
#define LP_APM_M2_EXCEPTION_ID    0x0000003FU
#define LP_APM_M2_EXCEPTION_ID_M  (LP_APM_M2_EXCEPTION_ID_V << LP_APM_M2_EXCEPTION_ID_S)
#define LP_APM_M2_EXCEPTION_ID_V  0x0000003FU
#define LP_APM_M2_EXCEPTION_ID_S  18

/** LP_APM_M2_EXCEPTION_INFO1_REG register
 *  M2 exception_info1 register
 */
#define LP_APM_M2_EXCEPTION_INFO1_REG (DR_REG_LP_APM_BASE + 0xf4)
/** LP_APM_M2_EXCEPTION_ADDR : RO; bitpos: [31:0]; default: 0;
 *  Represents exception addr
 */
#define LP_APM_M2_EXCEPTION_ADDR    0xFFFFFFFFU
#define LP_APM_M2_EXCEPTION_ADDR_M  (LP_APM_M2_EXCEPTION_ADDR_V << LP_APM_M2_EXCEPTION_ADDR_S)
#define LP_APM_M2_EXCEPTION_ADDR_V  0xFFFFFFFFU
#define LP_APM_M2_EXCEPTION_ADDR_S  0

/** LP_APM_M3_STATUS_REG register
 *  M3 status register
 */
#define LP_APM_M3_STATUS_REG (DR_REG_LP_APM_BASE + 0xfc)
/** LP_APM_M3_EXCEPTION_STATUS : RO; bitpos: [1:0]; default: 0;
 *  Represents exception status.
 *  bit0: 1 represents authority_exception
 *  bit1: 1 represents space_exception
 */
#define LP_APM_M3_EXCEPTION_STATUS    0x00000003U
#define LP_APM_M3_EXCEPTION_STATUS_M  (LP_APM_M3_EXCEPTION_STATUS_V << LP_APM_M3_EXCEPTION_STATUS_S)
#define LP_APM_M3_EXCEPTION_STATUS_V  0x00000003U
#define LP_APM_M3_EXCEPTION_STATUS_S  0

/** LP_APM_M3_STATUS_CLR_REG register
 *  M3 status clear register
 */
#define LP_APM_M3_STATUS_CLR_REG (DR_REG_LP_APM_BASE + 0x100)
/** LP_APM_M3_EXCEPTION_STATUS_CLR : WT; bitpos: [0]; default: 0;
 *  Configures to clear exception status
 */
#define LP_APM_M3_EXCEPTION_STATUS_CLR    (BIT(0))
#define LP_APM_M3_EXCEPTION_STATUS_CLR_M  (LP_APM_M3_EXCEPTION_STATUS_CLR_V << LP_APM_M3_EXCEPTION_STATUS_CLR_S)
#define LP_APM_M3_EXCEPTION_STATUS_CLR_V  0x00000001U
#define LP_APM_M3_EXCEPTION_STATUS_CLR_S  0

/** LP_APM_M3_EXCEPTION_INFO0_REG register
 *  M3 exception_info0 register
 */
#define LP_APM_M3_EXCEPTION_INFO0_REG (DR_REG_LP_APM_BASE + 0x104)
/** LP_APM_M3_EXCEPTION_REGION : RO; bitpos: [7:0]; default: 0;
 *  Represents exception region
 */
#define LP_APM_M3_EXCEPTION_REGION    0x000000FFU
#define LP_APM_M3_EXCEPTION_REGION_M  (LP_APM_M3_EXCEPTION_REGION_V << LP_APM_M3_EXCEPTION_REGION_S)
#define LP_APM_M3_EXCEPTION_REGION_V  0x000000FFU
#define LP_APM_M3_EXCEPTION_REGION_S  0
/** LP_APM_M3_EXCEPTION_MODE : RO; bitpos: [17:16]; default: 0;
 *  Represents exception mode
 */
#define LP_APM_M3_EXCEPTION_MODE    0x00000003U
#define LP_APM_M3_EXCEPTION_MODE_M  (LP_APM_M3_EXCEPTION_MODE_V << LP_APM_M3_EXCEPTION_MODE_S)
#define LP_APM_M3_EXCEPTION_MODE_V  0x00000003U
#define LP_APM_M3_EXCEPTION_MODE_S  16
/** LP_APM_M3_EXCEPTION_ID : RO; bitpos: [23:18]; default: 0;
 *  Represents exception id information
 */
#define LP_APM_M3_EXCEPTION_ID    0x0000003FU
#define LP_APM_M3_EXCEPTION_ID_M  (LP_APM_M3_EXCEPTION_ID_V << LP_APM_M3_EXCEPTION_ID_S)
#define LP_APM_M3_EXCEPTION_ID_V  0x0000003FU
#define LP_APM_M3_EXCEPTION_ID_S  18

/** LP_APM_M3_EXCEPTION_INFO1_REG register
 *  M3 exception_info1 register
 */
#define LP_APM_M3_EXCEPTION_INFO1_REG (DR_REG_LP_APM_BASE + 0x108)
/** LP_APM_M3_EXCEPTION_ADDR : RO; bitpos: [31:0]; default: 0;
 *  Represents exception addr
 */
#define LP_APM_M3_EXCEPTION_ADDR    0xFFFFFFFFU
#define LP_APM_M3_EXCEPTION_ADDR_M  (LP_APM_M3_EXCEPTION_ADDR_V << LP_APM_M3_EXCEPTION_ADDR_S)
#define LP_APM_M3_EXCEPTION_ADDR_V  0xFFFFFFFFU
#define LP_APM_M3_EXCEPTION_ADDR_S  0

/** LP_APM_INT_EN_REG register
 *  APM interrupt enable register
 */
#define LP_APM_INT_EN_REG (DR_REG_LP_APM_BASE + 0x10c)
 ...
 *  Configures APM M1 interrupt enable.
 *  0: disable
 *  1: enable
 */
...
/** LP_APM_M2_APM_INT_EN : R/W; bitpos: [2]; default: 0;
 *  Configures APM M2 interrupt enable.
 *  0: disable
 *  1: enable
 */
#define LP_APM_M2_APM_INT_EN    (BIT(2))
#define LP_APM_M2_APM_INT_EN_M  (LP_APM_M2_APM_INT_EN_V << LP_APM_M2_APM_INT_EN_S)
#define LP_APM_M2_APM_INT_EN_V  0x00000001U
#define LP_APM_M2_APM_INT_EN_S  2
/** LP_APM_M3_APM_INT_EN : R/W; bitpos: [3]; default: 0;
 *  Configures APM M3 interrupt enable.
 *  0: disable
 *  1: enable
 */
#define LP_APM_M3_APM_INT_EN    (BIT(3))
#define LP_APM_M3_APM_INT_EN_M  (LP_APM_M3_APM_INT_EN_V << LP_APM_M3_APM_INT_EN_S)
#define LP_APM_M3_APM_INT_EN_V  0x00000001U
#define LP_APM_M3_APM_INT_EN_S  3

/** LP_APM_BUS_ERR_CONF_REG register
 *  APM interrupt enable register
 */
#define LP_APM_BUS_ERR_CONF_REG (DR_REG_LP_APM_BASE + 0x110)
/** LP_APM_BUS_ERR_RESP_EN : R/W; bitpos: [0]; default: 0;
 *  Configures whether return error response to cpu when access blocked
 *  0: disable error response
 *  1: enable error response
 */
#define LP_APM_BUS_ERR_RESP_EN    (BIT(0))
#define LP_APM_BUS_ERR_RESP_EN_M  (LP_APM_BUS_ERR_RESP_EN_V << LP_APM_BUS_ERR_RESP_EN_S)
#define LP_APM_BUS_ERR_RESP_EN_V  0x00000001U
#define LP_APM_BUS_ERR_RESP_EN_S  0

/** LP_APM_CLOCK_GATE_REG register
 *  Clock gating register
 */
#define LP_APM_CLOCK_GATE_REG (DR_REG_LP_APM_BASE + 0x3f8)
 ...
 */
#define LP_APM_DATE_REG (DR_REG_LP_APM_BASE + 0x3fc)
/** LP_APM_DATE : R/W; bitpos: [27:0]; default: 38822496;
 *  Version control register
 */
