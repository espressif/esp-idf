...
/** Type of clk_force_on register
 *  RSA mem clk force register
 */
typedef union {
    struct {
        /** mem_clk_force_on : R/W; bitpos: [0]; default: 0;
...
typedef union {
    struct {
        /** date : R/W; bitpos: [29:0]; default: 539297305;
         *  Version control register.
         */
        uint32_t date:30;
...
typedef struct {
    ...
    volatile rsa_clk_force_on_reg_t clk_force_on;
    volatile rsa_free_reg_t free;
} rsa_dev_t;


#ifndef __cplusplus
_Static_assert(sizeof(rsa_dev_t) == 0x83c, "Invalid size of rsa_dev_t structure");
#endif
