...
typedef union {
    struct {
        ...
        /** qnr_precision : R/W; bitpos: [2]; default: 0;
         *  0:8bit qnr,1:12bit qnr(TBD)
         */
        uint32_t qnr_precision:1;
...
typedef union {
    struct {
        ...
        /** encode_timeout_int_raw : R/WTC/SS; bitpos: [25]; default: 0;
         ...
         */
        uint32_t encode_timeout_int_raw:1;
...
typedef union {
    struct {
        ...
        /** encode_timeout_int_ena : R/W; bitpos: [25]; default: 0;
         ...
         */
        uint32_t encode_timeout_int_ena:1;
        uint32_t reserved_26:6;
    };
    uint32_t val;
} jpeg_int_ena_reg_t;
...
typedef union {
    struct {
        /** jpeg_ver : R/W; bitpos: [27:0]; default: 38809904;
         *  Reserved
         */
...
typedef struct {
    ...
    volatile jpeg_config1_reg_t config1;
    uint32_t reserved_0b0[18];
