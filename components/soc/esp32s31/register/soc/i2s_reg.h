...
/** I2S_RX_TDM_BITS_MODE_DET_EN : R/W; bitpos: [20]; default: 0;
 *  1: Auto detect bit mode in tdm slave mode. 0: Disable.
 */
#define I2S_RX_TDM_BITS_MODE_DET_EN    (BIT(20))
#define I2S_RX_TDM_BITS_MODE_DET_EN_M  (I2S_RX_TDM_BITS_MODE_DET_EN_V << I2S_RX_TDM_BITS_MODE_DET_EN_S)
...
/** I2S_TX_TDM_BITS_MODE_DET_EN : R/W; bitpos: [21]; default: 0;
 *  1: Auto detect bit mode in tdm slave mode. 0: Disable.
 */
#define I2S_TX_TDM_BITS_MODE_DET_EN    (BIT(21))
#define I2S_TX_TDM_BITS_MODE_DET_EN_M  (I2S_TX_TDM_BITS_MODE_DET_EN_V << I2S_TX_TDM_BITS_MODE_DET_EN_S)
