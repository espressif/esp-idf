...
typedef union {
    struct {
        ...
        /** mem_dq_oe_ctrl : R/W; bitpos: [4]; default: 1;
...
typedef union {
    struct {
        ...
        /** mem_arb_wei_en : R/W; bitpos: [9]; default: 0;
...
typedef union {
    ...
    uint32_t val;
} spi_mem_s_pms_reject_addr_reg_t;
...
typedef union {
    ...
    uint32_t val;
} spi_smem_s__axi_addr_ctrl_reg_t;
...
typedef union {
    struct {
        ...
        /** smem_dqs1_270_sel : R/W; bitpos: [12:11]; default: 1;
         *  Set these bits to delay dqs signal & invert delayed signal for DLL timing adjust.
         *  2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns.
         */
        uint32_t smem_dqs1_270_sel:2;
        /** smem_dqs1_90_sel : R/W; bitpos: [14:13]; default: 1;
         *  Set these bits to delay dqs signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns,
         *  2'd2: 1.5ns 2'd3: 2.0ns.
         */
...
typedef union {
    ...
    uint32_t val;
} spi_smem_s__din_hex_mode_reg_t;
...
typedef union {
    ...
    uint32_t val;
} spi_smem_s__dout_hex_mode_reg_t;
...
typedef union {
    ...
    uint32_t val;
} spi_mem_s_nand_flash_sr_addr0_reg_t;
...
typedef union {
    ...
    uint32_t val;
} spi_mem_s_nand_flash_sr_din0_reg_t;
...
typedef union {
    ...
    uint32_t val;
} spi_mem_s_nand_flash_cfg_data0_reg_t;
...
typedef union {
    ...
    uint32_t val;
} spi_mem_s_nand_flash_cfg_data1_reg_t;
...
typedef union {
    ...
    uint32_t val;
} spi_mem_s_nand_flash_cfg_data2_reg_t;
...
typedef union {
    ...
    uint32_t val;
} spi_mem_s_nand_flash_cmd_lut0_reg_t;
...
typedef union {
    ...
    uint32_t val;
} spi_mem_s_nand_flash_spi_seq0_reg_t;
...
typedef union {
    struct {
        ...
        /** xts_shadow_for_sec : R/W; bitpos: [5]; default: 1;
...
typedef struct {
    ...
    volatile spi_smem_s__ddr_reg_t smem_ddr;
    volatile spi_mem_s_dll_dly_db_reg_t mem_dll_dly_db;
    volatile spi_mem_s_dll_db_st0_reg_t mem_dll_db_st0;
    volatile spi_mem_s_dll_db_st1_reg_t mem_dll_db_st1;
    uint32_t reserved_0e8[6];
    volatile spi_fmem_s_pmsn_attr_reg_t fmem_pmsn_attr[4];
    volatile spi_fmem_s_pmsn_addr_reg_t fmem_pmsn_addr[4];
    volatile spi_fmem_s_pmsn_size_reg_t fmem_pmsn_size[4];
    volatile spi_smem_s__pmsn_attr_reg_t smem_pmsn_attr[4];
    volatile spi_smem_s__pmsn_addr_reg_t smem_pmsn_addr[4];
    volatile spi_smem_s__pmsn_size_reg_t smem_pmsn_size[4];
    volatile spi_mem_s_pms_reject_reg_t mem_pms_reject;
    volatile spi_mem_s_pms_reject_addr_reg_t mem_pms_reject_addr;
    ...
    volatile spi_smem_s__ecc_ctrl_reg_t smem_ecc_ctrl;
    volatile spi_smem_s__axi_addr_ctrl_reg_t smem_axi_addr_ctrl;
    ...
    volatile spi_smem_s__timing_cali_reg_t smem_timing_cali;
    volatile spi_smem_s__din_mode_reg_t smem_din_mode;
    volatile spi_smem_s__din_num_reg_t smem_din_num;
    volatile spi_smem_s__dout_mode_reg_t smem_dout_mode;
    volatile spi_smem_s__ac_reg_t smem_ac;
    volatile spi_smem_s__din_hex_mode_reg_t smem_din_hex_mode;
    volatile spi_smem_s__din_hex_num_reg_t smem_din_hex_num;
    volatile spi_smem_s__dout_hex_mode_reg_t smem_dout_hex_mode;
    uint32_t reserved_1b0[20];
    volatile spi_mem_s_clock_gate_reg_t mem_clock_gate;
    volatile spi_mem_s_nand_flash_en_reg_t mem_nand_flash_en;
    volatile spi_mem_s_nand_flash_sr_addr0_reg_t mem_nand_flash_sr_addr0;
    volatile spi_mem_s_nand_flash_sr_din0_reg_t mem_nand_flash_sr_din0;
    volatile spi_mem_s_nand_flash_cfg_data0_reg_t mem_nand_flash_cfg_data0;
    volatile spi_mem_s_nand_flash_cfg_data1_reg_t mem_nand_flash_cfg_data1;
    volatile spi_mem_s_nand_flash_cfg_data2_reg_t mem_nand_flash_cfg_data2;
    uint32_t reserved_21c[9];
    volatile spi_mem_s_nand_flash_cmd_lut0_reg_t mem_nand_flash_cmd_lut0;
    uint32_t reserved_244[15];
    volatile spi_mem_s_nand_flash_spi_seq0_reg_t mem_nand_flash_spi_seq0;
    ...
    volatile spi_mem_s_xts_pseudo_round_conf_reg_t mem_xts_pseudo_round_conf;
