...
typedef volatile struct esp_ieee802154_s {
    ...
    union {
        struct {
            ...
            uint32_t rx_filter_multipan_cross_check: 1;
    ...
    union {
        struct {
            ...
            uint32_t stby_coex_grant_mask: 1;
    ...
    union {
        struct {
            ...
            uint32_t last_tx_ant: 1;
            uint32_t last_rx_ant: 1;
            uint32_t reserved22: 10;
        };
        uint32_t val;
    } txrx_status; //0x88
    ...
    union {
        struct {
            uint32_t dtm_tx_length: 8;
            uint32_t dtm_tx_payload_type: 4;
            uint32_t reserved12: 4;
            uint32_t dtm_hop_freq: 8;
            uint32_t dtm_cont_rx_en: 1;
            uint32_t dtm_on: 1;
            uint32_t extend_preamble_byte_num: 4;
            uint32_t reserved30: 2;
        };
        uint32_t val;
    } dtm_cfg; //0x98
    ...
    union {
        struct {
            uint32_t txrx_pkt_count: 16;
            uint32_t crc_err_pkt_count: 16;
        };
        uint32_t val;
    } dtm_pkt_cnt; //0xa0
    ...
    union {
        struct {
            uint32_t rx_timeout_target_cnt: 24;
            uint32_t reserved24: 8;
        };
        uint32_t val;
    } rx_timeout_target; //0x18c

    union {
        struct {
            uint32_t modslp_mode_ena: 1;
            uint32_t modslp_run_time_wake_en: 1;
            uint32_t modslp_rfoff_wake_en: 1;
            uint32_t modslp_intr_wake_en: 1;
            uint32_t modslp_run_time_limit: 4;
            uint32_t reserved8: 24;
        };
        uint32_t val;
    } modslp_cfg; //0x190
    ...
    union {
        struct {
            ...
            uint32_t modslp_run_time_wake: 1;
            uint32_t modslp_rfoff_wake: 1;
            uint32_t modslp_intr_wake: 1;
            uint32_t modslp_run_time_cnt: 4;
            uint32_t reserved8: 24;
        };
        uint32_t val;
    } modslp_status; //0x194
    ...
    union {
        struct {
            uint32_t modslp_ww_ini: 16;
            uint32_t modslp_ww_delta: 16;
        };
        uint32_t val;
    } modslp_ww; //0x198
    ...
    union {
        struct {
            uint32_t modslp_intr_wake_config: 14;
            uint32_t reserved14: 18;
        };
        uint32_t val;
    } modslp_intr_wake_cfg; //0x19c

    uint32_t i154_version; //0x1a0
