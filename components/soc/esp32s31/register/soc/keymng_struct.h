...
typedef union {
    struct {
        /** reg_cg_force_on : R/W; bitpos: [0]; default: 0;
...
typedef struct {
    ...
    volatile keymng_timeout_limit_reg_t timeout_limit;
    uint32_t reserved_03c[48];
