...
/** KEYMNG_REG_CG_FORCE_ON : R/W; bitpos: [0]; default: 0;
 ...
 *  ecdsa_key_384_h. 13: aes 14: mspi_lsfr 15: rma_nonce. Others: reserved.
 */
...
/** KEYMNG_KEY_AES_VLD : RO; bitpos: [7]; default: 0;
 *  The status bit for key_aes.   1: The key has been deployed correctly. 0: The key
 *  has not been deployed yet.
 */
#define KEYMNG_KEY_AES_VLD    (BIT(7))
#define KEYMNG_KEY_AES_VLD_M  (KEYMNG_KEY_AES_VLD_V << KEYMNG_KEY_AES_VLD_S)
#define KEYMNG_KEY_AES_VLD_V  0x00000001U
#define KEYMNG_KEY_AES_VLD_S  7
/** KEYMNG_KEY_MSPI_LSFR_VLD : RO; bitpos: [8]; default: 0;
 *  The status bit for key_mspi_lsfr.   1: The key has been deployed correctly. 0: The
 *  key has not been deployed yet.
 */
#define KEYMNG_KEY_MSPI_LSFR_VLD    (BIT(8))
#define KEYMNG_KEY_MSPI_LSFR_VLD_M  (KEYMNG_KEY_MSPI_LSFR_VLD_V << KEYMNG_KEY_MSPI_LSFR_VLD_S)
#define KEYMNG_KEY_MSPI_LSFR_VLD_V  0x00000001U
#define KEYMNG_KEY_MSPI_LSFR_VLD_S  8
/** KEYMNG_KEY_RMA_NONCE_VLD : RO; bitpos: [9]; default: 0;
 *  The status bit for key_rma_nonce.   1: The key has been deployed correctly. 0: The
 *  key has not been deployed yet.
 */
#define KEYMNG_KEY_RMA_NONCE_VLD    (BIT(9))
#define KEYMNG_KEY_RMA_NONCE_VLD_M  (KEYMNG_KEY_RMA_NONCE_VLD_V << KEYMNG_KEY_RMA_NONCE_VLD_S)
#define KEYMNG_KEY_RMA_NONCE_VLD_V  0x00000001U
#define KEYMNG_KEY_RMA_NONCE_VLD_S  9
...
/** KEYMNG_TIMEOUT_LIMIT_REG register
 *  KEYMNG timeout limit configure register
 */
#define KEYMNG_TIMEOUT_LIMIT_REG (DR_REG_KEYMNG_BASE + 0x38)
/** KEYMNG_TIMEOUT_LIMIT : R/W; bitpos: [31:0]; default: 4294967295;
 *  The timeout limitation for waiting sub-IP.
 */
#define KEYMNG_TIMEOUT_LIMIT    0xFFFFFFFFU
#define KEYMNG_TIMEOUT_LIMIT_M  (KEYMNG_TIMEOUT_LIMIT_V << KEYMNG_TIMEOUT_LIMIT_S)
#define KEYMNG_TIMEOUT_LIMIT_V  0xFFFFFFFFU
#define KEYMNG_TIMEOUT_LIMIT_S  0

/** KEYMNG_DATE_REG register
 *  Version control register
 */
#define KEYMNG_DATE_REG (DR_REG_KEYMNG_BASE + 0xfc)
/** KEYMNG_DATE : R/W; bitpos: [27:0]; default: 38830480;
