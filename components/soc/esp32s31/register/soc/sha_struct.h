...
/** Type of dma_tx_reset register
 *  DMA TX FIFO Reset Signal
 */
typedef union {
    struct {
        /** dma_tx_reset : WO; bitpos: [0]; default: 0;
         *  Write 1 to reset DMA TX FIFO
         */
        uint32_t dma_tx_reset:1;
        uint32_t reserved_1:31;
    };
    uint32_t val;
} sha_dma_tx_reset_reg_t;
...
typedef union {
    struct {
        /** date : R/W; bitpos: [29:0]; default: 539297315;
         *  Version control register.
         */
        uint32_t date:30;
...
#ifndef __cplusplus
_Static_assert(sizeof(sha_dev_t) == 0x2c8, "Invalid size of sha_dev_t structure");
#endif
