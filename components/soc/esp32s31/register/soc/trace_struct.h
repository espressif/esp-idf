...
typedef union {
    struct {
        /** match_choice_privilege : R/W; bitpos: [1:0]; default: 0;
         ...
         */
        uint32_t match_choice_privilege:2;
        /** match_value_interrupt : R/W; bitpos: [2]; default: 0;
        ...
        /** match_choice_ecause : R/W; bitpos: [8:3]; default: 0;
...
typedef union {
    struct {
        /** date : R/W; bitpos: [27:0]; default: 36733584;
