 ...
 *  After RES/DP/HPM/PES command is sent, SPI1 waits (SPI1_MEM_S_CS_HOLD_DELAY_RES[9:0] *
 *  128) SPI_CLK cycles.
 */
...
/** SPI1_MEM_S_CS_HOLD_DLY_PER : R/W; bitpos: [21:12]; default: 1023;
 *  After PER command is sent, SPI1 waits (SPI1_MEM_S_CS_HOLD_DLY_PER[9:0] * 128) SPI_CLK
 *  cycles.
 */
#define SPI1_MEM_S_CS_HOLD_DLY_PER    0x000003FFU
#define SPI1_MEM_S_CS_HOLD_DLY_PER_M  (SPI1_MEM_S_CS_HOLD_DLY_PER_V << SPI1_MEM_S_CS_HOLD_DLY_PER_S)
#define SPI1_MEM_S_CS_HOLD_DLY_PER_V  0x000003FFU
...
/** SPI1_MEM_S_WB_MODE_BITLEN : R/W; bitpos: [26:24]; default: 0;
 *  Mode bits length for flash fast read mode.
 *  This field is only for internal debugging purposes. Do not use it in applications.
 */
#define SPI1_MEM_S_WB_MODE_BITLEN    0x00000007U
#define SPI1_MEM_S_WB_MODE_BITLEN_M  (SPI1_MEM_S_WB_MODE_BITLEN_V << SPI1_MEM_S_WB_MODE_BITLEN_S)
#define SPI1_MEM_S_WB_MODE_BITLEN_V  0x00000007U
#define SPI1_MEM_S_WB_MODE_BITLEN_S  24
/** SPI1_MEM_S_WB_MODE_EN : R/W; bitpos: [27]; default: 0;
 *  Mode bits is valid while this bit is enable. 1: enable 0: disable.
 *  This field is only for internal debugging purposes. Do not use it in applications.
 */
#define SPI1_MEM_S_WB_MODE_EN    (BIT(27))
#define SPI1_MEM_S_WB_MODE_EN_M  (SPI1_MEM_S_WB_MODE_EN_V << SPI1_MEM_S_WB_MODE_EN_S)
#define SPI1_MEM_S_WB_MODE_EN_V  0x00000001U
#define SPI1_MEM_S_WB_MODE_EN_S  27
...
/** SPI1_MEM_S_FLASH_WAITI_CTRL1_REG register
 *  SPI1 wait idle control register
 */
#define SPI1_MEM_S_FLASH_WAITI_CTRL1_REG (DR_REG_PSRAM_MSPI1_BASE + 0xac)
/** SPI1_MEM_S_WAITI_IDLE_DELAY_TIME : R/W; bitpos: [9:0]; default: 0;
 *  SPI1 wait idle gap time configuration. SPI1 slv fsm will count during SPI1 IDLE.
 */
#define SPI1_MEM_S_WAITI_IDLE_DELAY_TIME    0x000003FFU
#define SPI1_MEM_S_WAITI_IDLE_DELAY_TIME_M  (SPI1_MEM_S_WAITI_IDLE_DELAY_TIME_V << SPI1_MEM_S_WAITI_IDLE_DELAY_TIME_S)
#define SPI1_MEM_S_WAITI_IDLE_DELAY_TIME_V  0x000003FFU
#define SPI1_MEM_S_WAITI_IDLE_DELAY_TIME_S  0
/** SPI1_MEM_S_WAITI_IDLE_DELAY_TIME_EN : R/W; bitpos: [10]; default: 0;
 *  Enable SPI1 wait idle gap time count function. 1: Enable. 0: Disable.
 */
#define SPI1_MEM_S_WAITI_IDLE_DELAY_TIME_EN    (BIT(10))
#define SPI1_MEM_S_WAITI_IDLE_DELAY_TIME_EN_M  (SPI1_MEM_S_WAITI_IDLE_DELAY_TIME_EN_V << SPI1_MEM_S_WAITI_IDLE_DELAY_TIME_EN_S)
#define SPI1_MEM_S_WAITI_IDLE_DELAY_TIME_EN_V  0x00000001U
#define SPI1_MEM_S_WAITI_IDLE_DELAY_TIME_EN_S  10
...
/** SPI1_MEM_S_DATE : R/W; bitpos: [27:0]; default: 37786176;
 *  Version control register
 */
