...
typedef union {
    struct {
        ...
        /** core_0_trace_lockup_ena : R/W; bitpos: [12]; default: 0;
         *  trace lockup monitor enable
         */
        uint32_t core_0_trace_lockup_ena:1;
...
/** Type of core_1_montr_ena register
...
typedef union {
    struct {
        ...
        uint32_t reserved_10:2;
        /** core_1_trace_lockup_ena : R/W; bitpos: [12]; default: 0;
         *  trace lockup monitor enable
         */
        uint32_t core_1_trace_lockup_ena:1;
        uint32_t reserved_13:19;
    };
    uint32_t val;
...
typedef union {
    struct {
        /** core_1_area_dram0_0_rd_intr_ena : R/W; bitpos: [0]; default: 0;
         *  Core1 dram0 area0 read monitor interrupt enable
         */
        uint32_t core_1_area_dram0_0_rd_intr_ena:1;
        /** core_1_area_dram0_0_wr_intr_ena : R/W; bitpos: [1]; default: 0;
         *  Core1 dram0 area0 write monitor interrupt enable
         */
        uint32_t core_1_area_dram0_0_wr_intr_ena:1;
        /** core_1_area_dram0_1_rd_intr_ena : R/W; bitpos: [2]; default: 0;
         *  Core1 dram0 area1 read monitor interrupt enable
         */
        uint32_t core_1_area_dram0_1_rd_intr_ena:1;
        /** core_1_area_dram0_1_wr_intr_ena : R/W; bitpos: [3]; default: 0;
         *  Core1 dram0 area1 write monitor interrupt enable
         */
        uint32_t core_1_area_dram0_1_wr_intr_ena:1;
        /** core_1_area_pif_0_rd_intr_ena : R/W; bitpos: [4]; default: 0;
         *  Core1 PIF area0 read monitor interrupt enable
         */
        uint32_t core_1_area_pif_0_rd_intr_ena:1;
        /** core_1_area_pif_0_wr_intr_ena : R/W; bitpos: [5]; default: 0;
         *  Core1 PIF area0 write monitor interrupt enable
         */
        uint32_t core_1_area_pif_0_wr_intr_ena:1;
        /** core_1_area_pif_1_rd_intr_ena : R/W; bitpos: [6]; default: 0;
         *  Core1 PIF area1 read monitor interrupt enable
         */
        uint32_t core_1_area_pif_1_rd_intr_ena:1;
        /** core_1_area_pif_1_wr_intr_ena : R/W; bitpos: [7]; default: 0;
         *  Core1 PIF area1 write monitor interrupt enable
         */
        uint32_t core_1_area_pif_1_wr_intr_ena:1;
        /** core_1_sp_spill_min_intr_ena : R/W; bitpos: [8]; default: 0;
         *  Core1 stackpoint underflow monitor interrupt enable
         */
        uint32_t core_1_sp_spill_min_intr_ena:1;
        /** core_1_sp_spill_max_intr_ena : R/W; bitpos: [9]; default: 0;
         *  Core1 stackpoint overflow monitor interrupt enable
         */
        uint32_t core_1_sp_spill_max_intr_ena:1;
        uint32_t reserved_10:22;
    };
    uint32_t val;
...
typedef union {
    struct {
         ...
         *  BUS_MONITOR_CORE_1_RCD_PDEBUGSP_REG starts to record SP in real time
         */
...
/** Type of core_0_trace_lockup_cause_0 register
 *  TRACE lockup cause logging register
 */
typedef union {
    struct {
        /** core_0_trace_lockup_recording_cause_0 : RO; bitpos: [11:0]; default: 0;
         *  Represents the latest lockup cause
         */
        uint32_t core_0_trace_lockup_recording_cause_0:12;
        uint32_t reserved_12:20;
    };
    uint32_t val;
} bus_monitor_core_0_trace_lockup_cause_0_reg_t;

/** Type of core_0_trace_lockup_tval_0 register
 *  TRACE lockup tval logging register
 */
typedef union {
    struct {
        /** core_0_trace_lockup_recording_tval_0 : RO; bitpos: [31:0]; default: 0;
         *  Represents the latest lockup tval
         */
        uint32_t core_0_trace_lockup_recording_tval_0:32;
    };
    uint32_t val;
} bus_monitor_core_0_trace_lockup_tval_0_reg_t;

/** Type of core_0_trace_lockup_iaddr_0 register
 *  TRACE lockup iaddr logging register
 */
typedef union {
    struct {
        /** core_0_trace_lockup_recording_iaddr_0 : RO; bitpos: [31:0]; default: 0;
         *  Represents the latest lockup iaddr
         */
        uint32_t core_0_trace_lockup_recording_iaddr_0:32;
    };
    uint32_t val;
} bus_monitor_core_0_trace_lockup_iaddr_0_reg_t;

/** Type of core_0_trace_lockup_priv_0 register
 *  TRACE lockup priv logging register
 */
typedef union {
    struct {
        /** core_0_trace_lockup_recording_priv_0 : RO; bitpos: [1:0]; default: 0;
         *  Represents the latest lockup priv
         */
        uint32_t core_0_trace_lockup_recording_priv_0:2;
        uint32_t reserved_2:30;
    };
    uint32_t val;
} bus_monitor_core_0_trace_lockup_priv_0_reg_t;

/** Type of core_0_trace_lockup_cause_1 register
 *  TRACE lockup cause logging register
 */
typedef union {
    struct {
        /** core_0_trace_lockup_recording_cause_1 : RO; bitpos: [11:0]; default: 0;
         *  Represents the last lockup cause
         */
        uint32_t core_0_trace_lockup_recording_cause_1:12;
        uint32_t reserved_12:20;
    };
    uint32_t val;
} bus_monitor_core_0_trace_lockup_cause_1_reg_t;

/** Type of core_0_trace_lockup_tval_1 register
 *  TRACE lockup tval logging register
 */
typedef union {
    struct {
        /** core_0_trace_lockup_recording_tval_1 : RO; bitpos: [31:0]; default: 0;
         *  Represents the last lockup tval
         */
        uint32_t core_0_trace_lockup_recording_tval_1:32;
    };
    uint32_t val;
} bus_monitor_core_0_trace_lockup_tval_1_reg_t;

/** Type of core_0_trace_lockup_iaddr_1 register
 *  TRACE lockup iaddr logging register
 */
typedef union {
    struct {
        /** core_0_trace_lockup_recording_iaddr_1 : RO; bitpos: [31:0]; default: 0;
         *  Represents the last lockup iaddr
         */
        uint32_t core_0_trace_lockup_recording_iaddr_1:32;
    };
    uint32_t val;
} bus_monitor_core_0_trace_lockup_iaddr_1_reg_t;

/** Type of core_0_trace_lockup_priv_1 register
 *  TRACE lockup priv logging register
 */
typedef union {
    struct {
        /** core_0_trace_lockup_recording_priv_1 : RO; bitpos: [1:0]; default: 0;
         *  Represents the last lockup priv
         */
        uint32_t core_0_trace_lockup_recording_priv_1:2;
        uint32_t reserved_2:30;
    };
    uint32_t val;
} bus_monitor_core_0_trace_lockup_priv_1_reg_t;

/** Type of core_1_trace_lockup_cause_0 register
 *  TRACE lockup cause logging register
 */
typedef union {
    struct {
        /** core_1_trace_lockup_recording_cause_0 : RO; bitpos: [11:0]; default: 0;
         *  Represents the latest lockup cause
         */
        uint32_t core_1_trace_lockup_recording_cause_0:12;
        uint32_t reserved_12:20;
    };
    uint32_t val;
} bus_monitor_core_1_trace_lockup_cause_0_reg_t;

/** Type of core_1_trace_lockup_tval_0 register
 *  TRACE lockup tval logging register
 */
typedef union {
    struct {
        /** core_1_trace_lockup_recording_tval_0 : RO; bitpos: [31:0]; default: 0;
         *  Represents the latest lockup tval
         */
        uint32_t core_1_trace_lockup_recording_tval_0:32;
    };
    uint32_t val;
} bus_monitor_core_1_trace_lockup_tval_0_reg_t;

/** Type of core_1_trace_lockup_iaddr_0 register
 *  TRACE lockup iaddr logging register
 */
typedef union {
    struct {
        /** core_1_trace_lockup_recording_iaddr_0 : RO; bitpos: [31:0]; default: 0;
         *  Represents the latest lockup iaddr
         */
        uint32_t core_1_trace_lockup_recording_iaddr_0:32;
    };
    uint32_t val;
} bus_monitor_core_1_trace_lockup_iaddr_0_reg_t;

/** Type of core_1_trace_lockup_priv_0 register
 *  TRACE lockup priv logging register
 */
typedef union {
    struct {
        /** core_1_trace_lockup_recording_priv_0 : RO; bitpos: [1:0]; default: 0;
         *  Represents the latest lockup priv
         */
        uint32_t core_1_trace_lockup_recording_priv_0:2;
        uint32_t reserved_2:30;
    };
    uint32_t val;
} bus_monitor_core_1_trace_lockup_priv_0_reg_t;

/** Type of core_1_trace_lockup_cause_1 register
 *  TRACE lockup cause logging register
 */
typedef union {
    struct {
        /** core_1_trace_lockup_recording_cause_1 : RO; bitpos: [11:0]; default: 0;
         *  Represents the last lockup cause
         */
        uint32_t core_1_trace_lockup_recording_cause_1:12;
        uint32_t reserved_12:20;
    };
    uint32_t val;
} bus_monitor_core_1_trace_lockup_cause_1_reg_t;

/** Type of core_1_trace_lockup_tval_1 register
 *  TRACE lockup tval logging register
 */
typedef union {
    struct {
        /** core_1_trace_lockup_recording_tval_1 : RO; bitpos: [31:0]; default: 0;
         *  Represents the last lockup tval
         */
        uint32_t core_1_trace_lockup_recording_tval_1:32;
    };
    uint32_t val;
...
typedef union {
    struct {
        /** core_1_trace_lockup_recording_iaddr_1 : RO; bitpos: [31:0]; default: 0;
         *  Represents the last lockup iaddr
         */
        uint32_t core_1_trace_lockup_recording_iaddr_1:32;
    };
    uint32_t val;
} bus_monitor_core_1_trace_lockup_iaddr_1_reg_t;

/** Type of core_1_trace_lockup_priv_1 register
 *  TRACE lockup priv logging register
 */
typedef union {
    struct {
        /** core_1_trace_lockup_recording_priv_1 : RO; bitpos: [1:0]; default: 0;
         *  Represents the last lockup priv
         */
        uint32_t core_1_trace_lockup_recording_priv_1:2;
        uint32_t reserved_2:30;
    };
    uint32_t val;
...
typedef struct {
    ...
    volatile bus_monitor_core_0_trace_lockup_cause_0_reg_t core_0_trace_lockup_cause_0;
    volatile bus_monitor_core_0_trace_lockup_tval_0_reg_t core_0_trace_lockup_tval_0;
    volatile bus_monitor_core_0_trace_lockup_iaddr_0_reg_t core_0_trace_lockup_iaddr_0;
    volatile bus_monitor_core_0_trace_lockup_priv_0_reg_t core_0_trace_lockup_priv_0;
    volatile bus_monitor_core_0_trace_lockup_cause_1_reg_t core_0_trace_lockup_cause_1;
    volatile bus_monitor_core_0_trace_lockup_tval_1_reg_t core_0_trace_lockup_tval_1;
    volatile bus_monitor_core_0_trace_lockup_iaddr_1_reg_t core_0_trace_lockup_iaddr_1;
    volatile bus_monitor_core_0_trace_lockup_priv_1_reg_t core_0_trace_lockup_priv_1;
    volatile bus_monitor_core_1_montr_ena_reg_t core_1_montr_ena;
    volatile bus_monitor_core_1_intr_raw_reg_t core_1_intr_raw;
    volatile bus_monitor_core_1_intr_ena_reg_t core_1_intr_ena;
    volatile bus_monitor_core_1_intr_clr_reg_t core_1_intr_clr;
    volatile bus_monitor_core_1_area_dram0_0_min_reg_t core_1_area_dram0_0_min;
    volatile bus_monitor_core_1_area_dram0_0_max_reg_t core_1_area_dram0_0_max;
    volatile bus_monitor_core_1_area_dram0_1_min_reg_t core_1_area_dram0_1_min;
    volatile bus_monitor_core_1_area_dram0_1_max_reg_t core_1_area_dram0_1_max;
    volatile bus_monitor_core_1_area_pif_0_min_reg_t core_1_area_pif_0_min;
    volatile bus_monitor_core_1_area_pif_0_max_reg_t core_1_area_pif_0_max;
    volatile bus_monitor_core_1_area_pif_1_min_reg_t core_1_area_pif_1_min;
    volatile bus_monitor_core_1_area_pif_1_max_reg_t core_1_area_pif_1_max;
    volatile bus_monitor_core_1_area_pc_reg_t core_1_area_pc;
    volatile bus_monitor_core_1_area_sp_reg_t core_1_area_sp;
    volatile bus_monitor_core_1_sp_min_reg_t core_1_sp_min;
    volatile bus_monitor_core_1_sp_max_reg_t core_1_sp_max;
    volatile bus_monitor_core_1_sp_pc_reg_t core_1_sp_pc;
    volatile bus_monitor_core_1_rcd_en_reg_t core_1_rcd_en;
    volatile bus_monitor_core_1_rcd_pdebugpc_reg_t core_1_rcd_pdebugpc;
    volatile bus_monitor_core_1_rcd_pdebugsp_reg_t core_1_rcd_pdebugsp;
    uint32_t reserved_0d8[4];
    volatile bus_monitor_core_1_lastpc_before_exception_reg_t core_1_lastpc_before_exception;
    volatile bus_monitor_core_1_debug_mode_reg_t core_1_debug_mode;
    volatile bus_monitor_core_1_trace_lockup_cause_0_reg_t core_1_trace_lockup_cause_0;
    volatile bus_monitor_core_1_trace_lockup_tval_0_reg_t core_1_trace_lockup_tval_0;
    volatile bus_monitor_core_1_trace_lockup_iaddr_0_reg_t core_1_trace_lockup_iaddr_0;
    volatile bus_monitor_core_1_trace_lockup_priv_0_reg_t core_1_trace_lockup_priv_0;
    volatile bus_monitor_core_1_trace_lockup_cause_1_reg_t core_1_trace_lockup_cause_1;
    volatile bus_monitor_core_1_trace_lockup_tval_1_reg_t core_1_trace_lockup_tval_1;
    volatile bus_monitor_core_1_trace_lockup_iaddr_1_reg_t core_1_trace_lockup_iaddr_1;
    volatile bus_monitor_core_1_trace_lockup_priv_1_reg_t core_1_trace_lockup_priv_1;
