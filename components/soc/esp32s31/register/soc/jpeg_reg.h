...
/** JPEG_DEBUG_DIRECT_OUT_EN : R/W; bitpos: [6]; default: 0;
...
/** JPEG_QNR_FIFO_EN : R/W; bitpos: [7]; default: 1;
...
/** JPEG_LQNR_TBL_SEL : R/W; bitpos: [9:8]; default: 0;
...
/** JPEG_CQNR_TBL_SEL : R/W; bitpos: [11:10]; default: 1;
...
/** JPEG_COLOR_SPACE : R/W; bitpos: [14:12]; default: 0;
 *  configure picture's color space:0-rgb888,1-yuv422,2-rgb565,3-gray,4-yuv444,5-yuv420
 */
#define JPEG_COLOR_SPACE    0x00000007U
#define JPEG_COLOR_SPACE_M  (JPEG_COLOR_SPACE_V << JPEG_COLOR_SPACE_S)
#define JPEG_COLOR_SPACE_V  0x00000007U
...
/** JPEG_ENCODE_TIMEOUT_INT_RAW : R/WTC/SS; bitpos: [25]; default: 0;
 *  The raw interrupt bit to sign that encode can not output bitstream time is longer
 *  than the setting encode timeout time when encoding.
 */
#define JPEG_ENCODE_TIMEOUT_INT_RAW    (BIT(25))
#define JPEG_ENCODE_TIMEOUT_INT_RAW_M  (JPEG_ENCODE_TIMEOUT_INT_RAW_V << JPEG_ENCODE_TIMEOUT_INT_RAW_S)
#define JPEG_ENCODE_TIMEOUT_INT_RAW_V  0x00000001U
#define JPEG_ENCODE_TIMEOUT_INT_RAW_S  25
...
/** JPEG_ENCODE_TIMEOUT_INT_ENA : R/W; bitpos: [25]; default: 0;
 *  The enable interrupt bit to sign that encode can not output bitstream time is
 *  longer than the setting encode timeout time when encoding.
 */
#define JPEG_ENCODE_TIMEOUT_INT_ENA    (BIT(25))
#define JPEG_ENCODE_TIMEOUT_INT_ENA_M  (JPEG_ENCODE_TIMEOUT_INT_ENA_V << JPEG_ENCODE_TIMEOUT_INT_ENA_S)
#define JPEG_ENCODE_TIMEOUT_INT_ENA_V  0x00000001U
#define JPEG_ENCODE_TIMEOUT_INT_ENA_S  25
...
/** JPEG_ENCODE_TIMEOUT_INT_ST : RO; bitpos: [25]; default: 0;
 *  The status interrupt bit to sign that encode can not output bitstream time is
 *  longer than the setting encode timeout time when encoding.
 */
#define JPEG_ENCODE_TIMEOUT_INT_ST    (BIT(25))
#define JPEG_ENCODE_TIMEOUT_INT_ST_M  (JPEG_ENCODE_TIMEOUT_INT_ST_V << JPEG_ENCODE_TIMEOUT_INT_ST_S)
#define JPEG_ENCODE_TIMEOUT_INT_ST_V  0x00000001U
#define JPEG_ENCODE_TIMEOUT_INT_ST_S  25
...
/** JPEG_ENCODE_TIMEOUT_INT_CLR : WT; bitpos: [25]; default: 0;
 *  The clear interrupt bit to sign that encode can not output bitstream time is longer
 *  than the setting encode timeout time when encoding.
 */
#define JPEG_ENCODE_TIMEOUT_INT_CLR    (BIT(25))
#define JPEG_ENCODE_TIMEOUT_INT_CLR_M  (JPEG_ENCODE_TIMEOUT_INT_CLR_V << JPEG_ENCODE_TIMEOUT_INT_CLR_S)
#define JPEG_ENCODE_TIMEOUT_INT_CLR_V  0x00000001U
#define JPEG_ENCODE_TIMEOUT_INT_CLR_S  25
...
/** JPEG_CONFIG1_REG register
 *  Control and configuration registers
 */
#define JPEG_CONFIG1_REG (DR_REG_JPEG_BASE + 0xac)
/** JPEG_ENCODE_TIMEOUT_THRES : R/W; bitpos: [5:0]; default: 32;
 *  Configure the timeout period for encode can not output bitstream. The timeout
 *  periods =2 power (reg_encode_timeout_thres) -1
 */
#define JPEG_ENCODE_TIMEOUT_THRES    0x0000003FU
#define JPEG_ENCODE_TIMEOUT_THRES_M  (JPEG_ENCODE_TIMEOUT_THRES_V << JPEG_ENCODE_TIMEOUT_THRES_S)
#define JPEG_ENCODE_TIMEOUT_THRES_V  0x0000003FU
#define JPEG_ENCODE_TIMEOUT_THRES_S  0
...
/** JPEG_JPEG_VER : R/W; bitpos: [27:0]; default: 38809904;
 *  Reserved
 */
