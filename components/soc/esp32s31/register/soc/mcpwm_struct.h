...
typedef union {
    struct {
        ...
        /** evt_timer0_tea_en : R/W; bitpos: [6]; default: 0;
         *  Configures whether or not to enable timer0 equal tea event generate.
         *  0: Disable
         *  1: Enable
         */
        uint32_t evt_timer0_tea_en:1;
        /** evt_timer1_tea_en : R/W; bitpos: [7]; default: 0;
         *  Configures whether or not to enable timer1 equal tea event generate.
         *  0: Disable
         *  1: Enable
         */
        uint32_t evt_timer1_tea_en:1;
        /** evt_timer2_tea_en : R/W; bitpos: [8]; default: 0;
         *  Configures whether or not to enable timer2 equal tea event generate.
         *  0: Disable
         *  1: Enable
         */
        uint32_t evt_timer2_tea_en:1;
        /** evt_timer0_teb_en : R/W; bitpos: [9]; default: 0;
         *  Configures whether or not to enable timer0 equal teb event generate.
         *  0: Disable
         *  1: Enable
         */
        uint32_t evt_timer0_teb_en:1;
        /** evt_timer1_teb_en : R/W; bitpos: [10]; default: 0;
         *  Configures whether or not to enable timer1 equal teb event generate.
         *  0: Disable
         *  1: Enable
         */
        uint32_t evt_timer1_teb_en:1;
        /** evt_timer2_teb_en : R/W; bitpos: [11]; default: 0;
         *  Configures whether or not to enable timer2 equal teb event generate.
         *  0: Disable
         *  1: Enable
         */
        uint32_t evt_timer2_teb_en:1;
        uint32_t reserved_12:20;
    };
    uint32_t val;
} mcpwm_evt_en2_reg_t;
