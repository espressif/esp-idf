...
typedef union {
    struct {
        ...
        /** rx_tdm_bits_mode_det_en : R/W; bitpos: [20]; default: 0;
         *  1: Auto detect bit mode in tdm slave mode. 0: Disable.
         */
        uint32_t rx_tdm_bits_mode_det_en:1;
...
typedef union {
    struct {
        ...
        /** tx_tdm_bits_mode_det_en : R/W; bitpos: [21]; default: 0;
         *  1: Auto detect bit mode in tdm slave mode. 0: Disable.
         */
        uint32_t tx_tdm_bits_mode_det_en:1;
...
typedef union {
    struct {
        /** date : R/W; bitpos: [27:0]; default: 38813744;
...
typedef struct {
    ...
    uint32_t reserved_094[24];
    volatile i2s_destination_reg_t destination;
