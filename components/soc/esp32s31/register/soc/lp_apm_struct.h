...
typedef union {
    ...
    uint32_t val;
} lp_apm_m2_exception_info0_reg_t;
...
typedef union {
    ...
    uint32_t val;
} lp_apm_m2_exception_info1_reg_t;
...
typedef union {
    ...
    uint32_t val;
} lp_apm_m3_exception_info0_reg_t;
...
typedef union {
    ...
    uint32_t val;
} lp_apm_m3_exception_info1_reg_t;
...
typedef struct {
    ...
    volatile lp_apm_m2_status_reg_t m2_status;
    volatile lp_apm_m2_status_clr_reg_t m2_status_clr;
    volatile lp_apm_m2_exception_info0_reg_t m2_exception_info0;
    volatile lp_apm_m2_exception_info1_reg_t m2_exception_info1;
    uint32_t reserved_0f8;
    volatile lp_apm_m3_status_reg_t m3_status;
    volatile lp_apm_m3_status_clr_reg_t m3_status_clr;
    volatile lp_apm_m3_exception_info0_reg_t m3_exception_info0;
    volatile lp_apm_m3_exception_info1_reg_t m3_exception_info1;
    volatile lp_apm_int_en_reg_t int_en;
    volatile lp_apm_bus_err_conf_reg_t bus_err_conf;
    uint32_t reserved_114[185];
