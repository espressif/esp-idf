...
/** SHA_DATE : R/W; bitpos: [29:0]; default: 539297315;
 *  Version control register.
 */
...
/** SHA_DMA_TX_RESET_REG register
 *  DMA TX FIFO Reset Signal
 */
#define SHA_DMA_TX_RESET_REG (DR_REG_SHA_BASE + 0x34)
/** SHA_DMA_TX_RESET : WO; bitpos: [0]; default: 0;
 *  Write 1 to reset DMA TX FIFO
 */
#define SHA_DMA_TX_RESET    (BIT(0))
#define SHA_DMA_TX_RESET_M  (SHA_DMA_TX_RESET_V << SHA_DMA_TX_RESET_S)
#define SHA_DMA_TX_RESET_V  0x00000001U
#define SHA_DMA_TX_RESET_S  0

/** SHA_FREE_REG register
 *  SHA free state
 */
#define SHA_FREE_REG (DR_REG_SHA_BASE + 0x38)
/** SHA_FREE : R/W; bitpos: [0]; default: 1;
 *  Represents if SHA Accelerator is free or not.
 *  0: non-free
 *  1: free
 */
#define SHA_FREE    (BIT(0))
#define SHA_FREE_M  (SHA_FREE_V << SHA_FREE_S)
#define SHA_FREE_V  0x00000001U
#define SHA_FREE_S  0

/** SHA_3_SHAKE_LENGTH_REG register
 *  DMA configuration register 3.
 */
#define SHA_3_SHAKE_LENGTH_REG (DR_REG_SHA_BASE + 0x3c)
/** SHA_3_SHAKE_LENGTH : R/W; bitpos: [20:0]; default: 50;
 *  SHAKE output hash word length
 */
#define SHA_3_SHAKE_LENGTH    0x001FFFFFU
#define SHA_3_SHAKE_LENGTH_M  (SHA_3_SHAKE_LENGTH_V << SHA_3_SHAKE_LENGTH_S)
#define SHA_3_SHAKE_LENGTH_V  0x001FFFFFU
...
/** SHA_3_H_MEM register
 *  SHA3, SHAKE H memory which contains intermediate hash or final hash.
 */
#define SHA_3_H_MEM (DR_REG_SHA_BASE + 0x100)
#define SHA_3_H_MEM_SIZE_BYTES 200

/** SHA_3_M_MEM register
 *  SHA3, SHAKE M memory which contains message.
 */
#define SHA_3_M_MEM (DR_REG_SHA_BASE + 0x200)
