...
typedef union {
    struct {
        /** out_arb_token_num_chn : R/W; bitpos: [3:0]; default: 0;
         *  Set the max number of token count of arbiter
         */
        uint32_t out_arb_token_num_chn:4;
        /** out_arb_priority_chn : R/W; bitpos: [7:4]; default: 0;
...
typedef union {
    struct {
        ...
        /** out_ro_ram_force_pd_chn : R/W; bitpos: [4]; default: 1;
         *  unused! dma reorder ram power down
         */
        uint32_t out_ro_ram_force_pd_chn:1;
        /** out_ro_ram_force_pu_chn : R/W; bitpos: [5]; default: 0;
 ...
 *  Configures the tx color convert parameter of channel n
 */
typedef union {
    struct {
...
typedef union {
    struct {
        /** in_arb_token_num_chn : R/W; bitpos: [3:0]; default: 0;
         *  Set the max number of token count of arbiter
         */
        uint32_t in_arb_token_num_chn:4;
        /** in_arb_priority_chn : R/W; bitpos: [7:4]; default: 0;
         *  Set the priority of channel
         */
...
typedef union {
    struct {
        uint32_t reserved_0:4;
        /** in_ro_ram_force_pd_chn : R/W; bitpos: [4]; default: 1;
         *  unused! dma reorder ram power down
         */
        uint32_t in_ro_ram_force_pd_chn:1;
        /** in_ro_ram_force_pu_chn : R/W; bitpos: [5]; default: 0;
         *  unused! dma reorder ram power up
         */
...
typedef union {
    struct {
        /** access_extr_mem_start_addr : R/W; bitpos: [31:0]; default: 0;
         *  The start address of accessible address space.
         */
...
typedef union {
    struct {
        /** access_extr_mem_end_addr : R/W; bitpos: [31:0]; default: 4294967295;
         *  The end address of accessible address space. The access address beyond this range
         *  would lead to descriptor error.
         */
...
typedef union {
    struct {
        /** date : R/W; bitpos: [31:0]; default: 36725136;
         *  register version.
         */
        uint32_t date:32;
    };
