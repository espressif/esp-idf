...
typedef union {
    struct {
        ...
        /** mem_arb_req1_wei : HRO; bitpos: [19:16]; default: 0;
...
typedef union {
    struct {
         ...
         */
        uint32_t clk_en:1;
        /** mspi_clk_force_on : R/W; bitpos: [1]; default: 0;
...
typedef union {
    struct {
        ...
        /** mem_nandflash_pe_fail_int_ena : R/W; bitpos: [11]; default: 0;
         *  The enable bit for SPI_MEM_NANDFLASH_PE_FAIL_INT interrupt.
         */
        uint32_t mem_nandflash_pe_fail_int_ena:1;
        /** mem_nandflash_ecc_err_int_ena : R/W; bitpos: [12]; default: 0;
         *  The enable bit for SPI_MEM_NANDFLASH_ECC_ERR_INT interrupt.
         */
        uint32_t mem_nandflash_ecc_err_int_ena:1;
        /** mem_xts_fault_detected_int_ena : R/W; bitpos: [13]; default: 0;
         *  The enable  bit for SPI_MEM_XTS_FAULT_DETECTED_INT interrupt.
         */
        uint32_t mem_xts_fault_detected_int_ena:1;
        uint32_t reserved_14:12;
        /** mem_rx_trans_ovf_int_ena : HRO; bitpos: [26]; default: 0;
         *  The enable bit for SPI_MEM_RX_TRANS_OVF_INT interrupt.
         */
        uint32_t mem_rx_trans_ovf_int_ena:1;
        /** mem_tx_trans_udf_int_ena : HRO; bitpos: [27]; default: 0;
         *  The enable bit for SPI_MEM_TX_TRANS_UDF_INT interrupt.
         */
...
typedef union {
    struct {
        ...
        uint32_t reserved_10:1;
        /** mem_nandflash_pe_fail_int_clr : WT; bitpos: [11]; default: 0;
         *  The clear bit for SPI_MEM_NANDFLASH_PE_FAIL_INT interrupt.
         */
        uint32_t mem_nandflash_pe_fail_int_clr:1;
        /** mem_nandflash_ecc_err_int_clr : WT; bitpos: [12]; default: 0;
         *  The clear bit for SPI_MEM_NANDFLASH_ECC_ERR_INT interrupt.
         */
        uint32_t mem_nandflash_ecc_err_int_clr:1;
        /** mem_xts_fault_detected_int_clr : WT; bitpos: [13]; default: 0;
         *  The clear  bit for SPI_MEM_XTS_FAULT_DETECTED_INT interrupt.
         */
        uint32_t mem_xts_fault_detected_int_clr:1;
        uint32_t reserved_14:12;
        /** mem_rx_trans_ovf_int_clr : HRO; bitpos: [26]; default: 0;
         *  The clear bit for SPI_MEM_RX_TRANS_OVF_INT interrupt.
         */
        uint32_t mem_rx_trans_ovf_int_clr:1;
        /** mem_tx_trans_udf_int_clr : HRO; bitpos: [27]; default: 0;
         *  The clear bit for SPI_MEM_TX_TRANS_UDF_INT interrupt.
         */
...
typedef union {
    struct {
        ...
        uint32_t reserved_10:1;
        /** mem_nandflash_pe_fail_int_raw : R/WTC/SS; bitpos: [11]; default: 0;
        ...
        /** mem_nandflash_ecc_err_int_raw : R/WTC/SS; bitpos: [12]; default: 0;
        ...
        /** mem_xts_fault_detected_int_raw : R/WTC/SS; bitpos: [13]; default: 0;
         *  The raw bit for SPI_MEM_XTS_FAULT_DETECTED_INT interrupt. 1: Triggered when xts aes
         *  core detected fault injection attack. 0: Others.
         */
        uint32_t mem_xts_fault_detected_int_raw:1;
        uint32_t reserved_14:12;
        /** mem_rx_trans_ovf_int_raw : R/WTC/SS; bitpos: [26]; default: 0;
         *  The raw bit for  SPI_MEM_RX_TRANS_OVF_INT interrupt. 1: Triggered when the rx fifo
         *  to spi bus is overrflow.
         */
        uint32_t mem_rx_trans_ovf_int_raw:1;
        /** mem_tx_trans_udf_int_raw : R/WTC/SS; bitpos: [27]; default: 0;
         *  The raw bit for SPI_MEM_TX_TRANS_UDF_INT interrupt. 1: Triggered when the tx fifo
...
typedef union {
    struct {
        ...
        /** mem_xts_fault_detected_int_st : RO; bitpos: [13]; default: 0;
         *  The status bit for SPI_MEM_XTS_FAULT_DETECTED_INT interrupt.
         */
        uint32_t mem_xts_fault_detected_int_st:1;
        uint32_t reserved_14:12;
        /** mem_rx_trans_ovf_int_st : HRO; bitpos: [26]; default: 0;
         *  The status bit for  SPI_MEM_RX_TRANS_OVF_INT interrupt.
         */
        uint32_t mem_rx_trans_ovf_int_st:1;
        /** mem_tx_trans_udf_int_st : HRO; bitpos: [27]; default: 0;
         *  The status bit for SPI_MEM_TX_TRANS_UDF_INT interrupt.
         */
...
typedef union {
    struct {
        /** mem_dll_db_cfg_vld_cnt : HRO; bitpos: [7:0]; default: 0;
         *  Configures the end time of the debug window.
         */
        uint32_t mem_dll_db_cfg_vld_cnt:8;
        /** mem_dll_db_cnt_mode_sel : HRO; bitpos: [11:8]; default: 0;
        ...
        /** mem_dll_db_cnt_clr : HRO; bitpos: [12]; default: 0;
        ...
        /** mem_dll_din_dly_sel : HRO; bitpos: [13]; default: 0;
...
typedef union {
    struct {
        /** mem_nand_flash_en : R/W; bitpos: [0]; default: 0;
        ...
        /** mem_nand_flash_seq_hd_index : R/W; bitpos: [15:1]; default: 32767;
        ...
        /** mem_nand_flash_seq_usr_trig : R/W; bitpos: [16]; default: 0;
        ...
        /** mem_nand_flash_lut_en : HRO; bitpos: [17]; default: 1;
         *  NAND FLASH spi seq & cmd lut cfg en. 1: enable 0: disable.
         */
        uint32_t mem_nand_flash_lut_en:1;
        /** mem_nand_flash_seq_usr_wend : R/W; bitpos: [18]; default: 0;
...
typedef union {
    struct {
        /** mem_nand_flash_sr_addr0 : R/W; bitpos: [7:0]; default: 0;
        ...
        /** mem_nand_flash_sr_addr1 : R/W; bitpos: [15:8]; default: 0;
         *  configure state register address for SPI SEQ need. If OIP is in address C0H , user
         *  could configure C0H into this register
         */
        uint32_t mem_nand_flash_sr_addr1:8;
        /** mem_nand_flash_sr_addr2 : R/W; bitpos: [23:16]; default: 0;
         *  configure state register address for SPI SEQ need. If OIP is in address C0H , user
         *  could configure C0H into this register
         */
        uint32_t mem_nand_flash_sr_addr2:8;
        /** mem_nand_flash_sr_addr3 : R/W; bitpos: [31:24]; default: 0;
         *  configure state register address for SPI SEQ need. If OIP is in address C0H , user
         *  could configure C0H into this register
         */
...
typedef union {
    struct {
        /** mem_nand_flash_cfg_data0 : R/W; bitpos: [15:0]; default: 0;
        ...
        /** mem_nand_flash_cfg_data1 : R/W; bitpos: [31:16]; default: 0;
         *  configure data for SPI SEQ din/dout need. The data could be use to configure NAND
         *  FLASH or compare read data
         */
...
typedef union {
    struct {
        /** mem_nand_flash_cfg_data2 : R/W; bitpos: [15:0]; default: 0;
         *  configure data for SPI SEQ din/dout need. The data could be use to configure NAND
         *  FLASH or compare read data
         */
        uint32_t mem_nand_flash_cfg_data2:16;
        /** mem_nand_flash_cfg_data3 : R/W; bitpos: [31:16]; default: 0;
         *  configure data for SPI SEQ din/dout need. The data could be use to configure NAND
         *  FLASH or compare read data
         */
...
typedef union {
    struct {
        /** mem_nand_flash_cfg_data4 : R/W; bitpos: [15:0]; default: 0;
         *  configure data for SPI SEQ din/dout need. The data could be use to configure NAND
         *  FLASH or compare read data
         */
        uint32_t mem_nand_flash_cfg_data4:16;
        /** mem_nand_flash_cfg_data5 : R/W; bitpos: [31:16]; default: 0;
         *  configure data for SPI SEQ din/dout need. The data could be use to configure NAND
         *  FLASH or compare read data
         */
...
typedef union {
    struct {
        /** mem_nand_flash_lut_cmd_value0 : R/W; bitpos: [15:0]; default: 0;
         *  MSPI NAND FLASH config cmd value at cmd lut address 0.
         */
        uint32_t mem_nand_flash_lut_cmd_value0:16;
        /** mem_nand_flash_lut_sfsm_st_en0 : R/W; bitpos: [19:16]; default: 0;
...
typedef union {
    struct {
        /** mem_nand_flash_seq_tail_flg0 : R/W; bitpos: [0]; default: 0;
        ...
        /** mem_nand_flash_addr_index0 : R/W; bitpos: [9:6]; default: 0;
...
typedef union {
    struct {
        /** mem_date : R/W; bitpos: [27:0]; default: 38834224;
...
typedef struct {
    ...
    volatile spi_mem_c_addr_reg_t mem_addr;
    ...
    volatile spi_mem_c_dll_dly_db_reg_t mem_dll_dly_db;
    volatile spi_mem_c_dll_db_st0_reg_t mem_dll_db_st0;
    volatile spi_mem_c_dll_db_st1_reg_t mem_dll_db_st1;
