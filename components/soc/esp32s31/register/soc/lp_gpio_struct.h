...
/** Type of funca_in_sel_cfg register
 *  Configuration register for input signal a
 */
typedef union {
    struct {
        /** funca_in_sel : R/W; bitpos: [3:0]; default: 8;
         *  Configures to select a pin from the 8 LP_GPIO pins to connect the input signal a.
         *  0: Select LP_GPIO0
         *  1: Select LP_GPIO1
         *  ......
         *  6: Select LP_GPIO6
         ...
         */
        uint32_t funca_in_sel:4;
        /** funca_in_inv_sel : R/W; bitpos: [4]; default: 0;
         *  Configures whether or not to invert the input value.
         *  0: Not invert
         *  1: Invert
         */
        uint32_t funca_in_inv_sel:1;
        /** siga_in_sel : R/W; bitpos: [5]; default: 0;
         ...
         */
        uint32_t siga_in_sel:1;
        uint32_t reserved_6:26;
    };
    uint32_t val;
} lp_gpio_funca_in_sel_cfg_reg_t;
...
typedef union {
    struct {
         ...
         *  31: Select signal 31
         *  Or
         *  32: Bit n of LP_GPIO_OUT_REG and LP_GPIO_ENABLE_REG are selected as the output
         *  value and output enable.
         *
         *  For the detailed signal list, see Table .
         *  "
         */
        uint32_t funcn_out_sel:6;
        /** funcn_out_inv_sel : R/W; bitpos: [6]; default: 0;
         *  Configures whether or not to invert the output value.
         *  0: Not invert
         *  1: Invert
         */
        uint32_t funcn_out_inv_sel:1;
        /** funcn_oe_sel : R/W; bitpos: [7]; default: 0;
        ...
        /** funcn_oe_inv_sel : R/W; bitpos: [8]; default: 0;
...
typedef union {
    struct {
        /** date : R/W; bitpos: [27:0]; default: 38826048;
...
typedef struct {
    ...
    uint32_t reserved_050[24];
    volatile lp_gpio_funca_in_sel_cfg_reg_t funca_in_sel_cfg[9];
    uint32_t reserved_0d4[119];
