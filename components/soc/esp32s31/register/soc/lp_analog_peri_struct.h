...
typedef union {
    struct {
        /** detmode_sel : R/W; bitpos: [5:0]; default: 63;
         *  need_des
         */
        uint32_t detmode_sel:6;
...
typedef union {
    struct {
        ...
        /** power_glitch_reset_ena : R/W; bitpos: [31:26]; default: 0;
         *  need_des
         */
        uint32_t power_glitch_reset_ena:6;
    };
    uint32_t val;
...
typedef union {
    struct {
        /** lp_ana_date : R/W; bitpos: [30:0]; default: 38818112;
         *  need_des
         */
