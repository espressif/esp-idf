...
/** Type of srm_color_mode register
 *  Scaling and rotating engine color mode register
 */
typedef union {
    struct {
        /** srm_rx_cm : R/W; bitpos: [3:0]; default: 0;
         ...
         */
        uint32_t srm_rx_cm:4;
        /** srm_tx_cm : R/W; bitpos: [7:4]; default: 0;
...
/** Type of srm_byte_order register
 *  Scaling and rotating engine byte order register
 */
typedef union {
    struct {
        /** srm_rx_byte_swap_en : R/W; bitpos: [0]; default: 0;
         ...
         */
        uint32_t srm_rx_byte_swap_en:1;
        /** srm_rx_rgb_swap_en : R/W; bitpos: [1]; default: 0;
         *  Set this bit to 1  the data into Rx channel 0 would be swapped in rgb. It means rgb
         *  would be swap to bgr.
         */
        uint32_t srm_rx_rgb_swap_en:1;
        /** srm_macro_bk_ro_bypass : R/W; bitpos: [2]; default: 0;
         ...
         */
        uint32_t srm_macro_bk_ro_bypass:1;
        /** srm_bk_size_sel : R/W; bitpos: [3]; default: 0;
         *  sel srm pix_blk size, 0:32x32, 1:16x16
         */
        uint32_t srm_bk_size_sel:1;
        uint32_t reserved_4:28;
    };
    uint32_t val;
} ppa_srm_byte_order_reg_t;
...
/** Type of srm_fix_alpha register
 *  Scaling and rotating engine alpha override register
 */
typedef union {
    struct {
        /** srm_rx_fix_alpha : R/W; bitpos: [7:0]; default: 128;
         ...
         */
        uint32_t srm_rx_fix_alpha:8;
        /** srm_rx_alpha_mod : R/W; bitpos: [9:8]; default: 0;
         ...
         */
        uint32_t srm_rx_alpha_mod:2;
        /** srm_rx_alpha_inv : R/W; bitpos: [10]; default: 0;
         *  Set this bit to invert the original alpha value. When RX color mode is
         *  RGB565/RGB88. The original alpha value is 255.
         */
        uint32_t srm_rx_alpha_inv:1;
        uint32_t reserved_11:21;
    };
    uint32_t val;
} ppa_srm_fix_alpha_reg_t;
...
/** Type of srm_scal_rotate register
 *  Scaling and rotating coefficient register
 */
typedef union {
    struct {
        /** srm_scal_x_int : R/W; bitpos: [7:0]; default: 1;
         *  The integrated part of scaling coefficient in X direction.
         */
        uint32_t srm_scal_x_int:8;
        /** srm_scal_x_frag : R/W; bitpos: [11:8]; default: 0;
         *  The fragment part of scaling coefficient in X direction.
         */
        uint32_t srm_scal_x_frag:4;
        /** srm_scal_y_int : R/W; bitpos: [19:12]; default: 1;
         *  The integrated part of scaling coefficient in Y direction.
         */
        uint32_t srm_scal_y_int:8;
        /** srm_scal_y_frag : R/W; bitpos: [23:20]; default: 0;
         *  The fragment part of scaling coefficient in Y direction.
         */
        uint32_t srm_scal_y_frag:4;
        /** srm_rotate_angle : R/W; bitpos: [25:24]; default: 0;
         *  The rotate angle. 0: 0 degree. 1: 90 degree. 2: 180 degree. 3: 270 degree.
         */
        uint32_t srm_rotate_angle:2;
        ...
        /** srm_mirror_x : R/W; bitpos: [28]; default: 0;
         *  Image mirror in X direction. 0: disable, 1: enable
         */
        uint32_t srm_mirror_x:1;
        /** srm_mirror_y : R/W; bitpos: [29]; default: 0;
         *  Image mirror in Y direction. 0: disable, 1: enable
         */
        uint32_t srm_mirror_y:1;
        uint32_t reserved_30:2;
    };
    uint32_t val;
} ppa_srm_scal_rotate_reg_t;

/** Type of srm_mem_pd register
 *  SR memory power done register
 */
typedef union {
    struct {
        /** srm_mem_clk_ena : R/W; bitpos: [0]; default: 0;
         *  Set this bit to force clock enable of scaling and rotating engine's data memory.
         */
        uint32_t srm_mem_clk_ena:1;
        /** srm_mem_force_pd : R/W; bitpos: [1]; default: 0;
         *  Set this bit to force power down scaling and rotating engine's data memory.
         */
        uint32_t srm_mem_force_pd:1;
        /** srm_mem_force_pu : R/W; bitpos: [2]; default: 0;
         *  Set this bit to force power up scaling and rotating engine's data memory.
         */
        uint32_t srm_mem_force_pu:1;
        uint32_t reserved_3:29;
    };
    uint32_t val;
} ppa_srm_mem_pd_reg_t;
...
typedef union {
    struct {
        ...
        /** srm_param_cfg_err_int_raw : R/WTC/SS; bitpos: [2]; default: 0;
         ...
         */
        uint32_t srm_param_cfg_err_int_raw:1;
...
typedef union {
    struct {
        ...
        /** srm_param_cfg_err_int_st : RO; bitpos: [2]; default: 0;
         *  The raw interrupt status bit for the PPA_SRM_PARAM_CFG_ERR_INT interrupt.
         */
        uint32_t srm_param_cfg_err_int_st:1;
...
typedef union {
    struct {
        /** srm_eof_int_ena : R/W; bitpos: [0]; default: 0;
         *  The interrupt enable bit for the PPA_SRM_EOF_INT interrupt.
         */
        uint32_t srm_eof_int_ena:1;
        ...
        /** srm_param_cfg_err_int_ena : R/W; bitpos: [2]; default: 0;
         *  The interrupt enable bit for the PPA_SRM_PARAM_CFG_ERR_INT interrupt.
         */
        uint32_t srm_param_cfg_err_int_ena:1;
...
/** Type of srm_param_err_st register
...
typedef union {
    struct {
        ...
        /** x_yuv_rx_scale_err_st : RO; bitpos: [10]; default: 0;
         *  The error is that the ha/hb/x param in dma2d descriptor is an odd num when enable
         *  yuv422 or yuv420 rx
         */
        uint32_t x_yuv_rx_scale_err_st:1;
        /** y_yuv_rx_scale_err_st : RO; bitpos: [11]; default: 0;
         *  The error is that the va/vb/y param in dma2d descriptor is an odd num when enable
         *  yuv420 rx
         */
        uint32_t y_yuv_rx_scale_err_st:1;
        /** x_yuv_tx_scale_err_st : RO; bitpos: [12]; default: 0;
         *  The error is that the ha/hb/x param in dma2d descriptor is an odd num when enable
         *  yuv422 or yuv420 tx
         */
        uint32_t x_yuv_tx_scale_err_st:1;
        /** y_yuv_tx_scale_err_st : RO; bitpos: [13]; default: 0;
         *  The error is that the va/vb/y param in dma2d descriptor is an odd num when enable
         *  yuv420 tx
         */
        uint32_t y_yuv_tx_scale_err_st:1;
        uint32_t reserved_14:18;
    };
    uint32_t val;
} ppa_srm_param_err_st_reg_t;

/** Type of srm_status register
 *  SR FSM register
 */
typedef union {
    struct {
        /** srm_rx_dscr_sample_state : RO; bitpos: [1:0]; default: 0;
         *  Reserved.
         */
        uint32_t srm_rx_dscr_sample_state:2;
        /** srm_rx_scan_state : RO; bitpos: [3:2]; default: 0;
         *  Reserved.
         */
        uint32_t srm_rx_scan_state:2;
        /** srm_tx_dscr_sample_state : RO; bitpos: [5:4]; default: 0;
         *  Reserved.
         */
        uint32_t srm_tx_dscr_sample_state:2;
        /** srm_tx_scan_state : RO; bitpos: [8:6]; default: 0;
         *  Reserved.
         */
        uint32_t srm_tx_scan_state:3;
        uint32_t reserved_9:23;
    };
    uint32_t val;
} ppa_srm_status_reg_t;
...
typedef struct {
    ...
    volatile ppa_srm_color_mode_reg_t srm_color_mode;
    volatile ppa_blend_color_mode_reg_t blend_color_mode;
    volatile ppa_srm_byte_order_reg_t srm_byte_order;
    ...
    volatile ppa_srm_fix_alpha_reg_t srm_fix_alpha;
    ...
    volatile ppa_srm_scal_rotate_reg_t srm_scal_rotate;
    volatile ppa_srm_mem_pd_reg_t srm_mem_pd;
    volatile ppa_reg_conf_reg_t reg_conf;
    volatile ppa_clut_cnt_reg_t clut_cnt;
    volatile ppa_blend_st_reg_t blend_st;
    volatile ppa_srm_param_err_st_reg_t srm_param_err_st;
    volatile ppa_srm_status_reg_t srm_status;
