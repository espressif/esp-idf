...
/** RSA_DATE : R/W; bitpos: [29:0]; default: 539297305;
 *  Version control register.
 */
...
/** RSA_CLK_FORCE_ON_REG register
 *  RSA mem clk force register
 */
#define RSA_CLK_FORCE_ON_REG (DR_REG_RSA_BASE + 0x834)
/** RSA_MEM_CLK_FORCE_ON : R/W; bitpos: [0]; default: 0;
 *  0: RSA mem do not force on;
 *  1:RSA mem force on.
 */
#define RSA_MEM_CLK_FORCE_ON    (BIT(0))
#define RSA_MEM_CLK_FORCE_ON_M  (RSA_MEM_CLK_FORCE_ON_V << RSA_MEM_CLK_FORCE_ON_S)
#define RSA_MEM_CLK_FORCE_ON_V  0x00000001U
#define RSA_MEM_CLK_FORCE_ON_S  0

/** RSA_FREE_REG register
 *  RSA free state register
 */
#define RSA_FREE_REG (DR_REG_RSA_BASE + 0x838)
/** RSA_FREE : R/W; bitpos: [0]; default: 1;
 *  0: RSA is non-free;
 *  1:RSA is free.
 */
#define RSA_FREE    (BIT(0))
#define RSA_FREE_M  (RSA_FREE_V << RSA_FREE_S)
#define RSA_FREE_V  0x00000001U
#define RSA_FREE_S  0
