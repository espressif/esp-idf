 ...
 *  LP IO MUX configuration register for LP_GPIO7
 */
#define LP_IO_MUX_GPIO7_REG (DR_REG_LP_IO_MUX_BASE + 0x1c)
/** LP_IO_MUX_GPIO7_MCU_OE : R/W; bitpos: [0]; default: 0;
 *  Configures whether or not to enable the output of LP_GPIO7 in sleep mode.
 *  0: Disable
 *  1: Enable
 */
 ...
 *  Configures whether or not to enter sleep mode for LP_GPIO7.
 *  0: Not enter
 *  1: Enter
 */
 ...
 *  Configure whether or not to enable pull-down resistor of LP_GPIO7 in sleep mode.
 *  0: Disable
 *  1: Enable
 */
 ...
 *  Configures whether or not to enable pull-up resistor of LP_GPIO7 during sleep mode.
 *  0: Disable
 *  1: Enable
 */
 ...
 *  Configures whether or not to enable the input of LP_GPIO7 during sleep mode.
 *  0: Disable
 *  1: Enable
 */
 ...
 *  Configures the drive strength of LP_GPIO7 during sleep mode.
 *  0: ~5 mA
 *  1: ~10 mA
 *  2: ~20 mA
 *  3: ~40 mA
 ...
 *  Configures whether or not to enable pull-down resistor of LP_GPIO7.
 *  0: Disable
 *  1: Enable
 */
 ...
 *  Configures whether or not enable pull-up resistor of LP_GPIO7.
 *  0: Disable
 *  1: Enable
 */
 ...
 *  Configures whether or not to enable input of LP_GPIO7.
 *  0: Disable
 *  1: Enable
 */
 ...
 *  Configures the drive strength of LP_GPIO7.
 *  0: ~5 mA
 *  1: ~10 mA
 *  2: ~20 mA
 *  3: ~40 mA
 ...
 *  Configures whether or not to enable the hysteresis function of the pin when
 *  LP_IO_MUX_GPIO7_HYS_SEL is set to 1.
 *  0: Disable
 *  1: Enable
 */
 ...
 *  Configures to choose the signal for enabling the hysteresis function for LP_GPIO7.
 *  0: Choose the output enable signal of eFuse
 *  1: Choose the output enable signal of LP_IO_MUX_GPIO7_HYS_EN
 */
...
/** LP_IO_MUX_REG_DATE : R/W; bitpos: [27:0]; default: 35656208;
 *  Version control register
 */
