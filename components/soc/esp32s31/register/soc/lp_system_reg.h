...
/** LP_SYSTEM_REG_VER_DATE_REG register
 *  need_des
 */
#define LP_SYSTEM_REG_VER_DATE_REG (DR_REG_LP_SYS_BASE + 0x0)
/** LP_SYSTEM_REG_VER_DATE : R/W; bitpos: [31:0]; default: 539298083;
 *  need_des
 */
...
/** LP_SYSTEM_REG_LP_CPU_BOOT_ADDR : R/W; bitpos: [31:0]; default: 771751936;
 *  need_des
 */
...
/** LP_SYSTEM_REG_EXT_WAKEUP1_SEL : R/W; bitpos: [7:0]; default: 0;
 *  Bitmap to select RTC pads for ext wakeup1
 */
#define LP_SYSTEM_REG_EXT_WAKEUP1_SEL    0x000000FFU
#define LP_SYSTEM_REG_EXT_WAKEUP1_SEL_M  (LP_SYSTEM_REG_EXT_WAKEUP1_SEL_V << LP_SYSTEM_REG_EXT_WAKEUP1_SEL_S)
#define LP_SYSTEM_REG_EXT_WAKEUP1_SEL_V  0x000000FFU
#define LP_SYSTEM_REG_EXT_WAKEUP1_SEL_S  0
/** LP_SYSTEM_REG_EXT_WAKEUP1_STATUS_CLR : WT; bitpos: [8]; default: 0;
 *  clear ext wakeup1 status
 */
#define LP_SYSTEM_REG_EXT_WAKEUP1_STATUS_CLR    (BIT(8))
...
/** LP_SYSTEM_REG_USBOTGHS_WAKEUP_CLR : WT; bitpos: [2]; default: 0;
 *  clear usb wakeup to PMU.
 */
#define LP_SYSTEM_REG_USBOTGHS_WAKEUP_CLR    (BIT(2))
#define LP_SYSTEM_REG_USBOTGHS_WAKEUP_CLR_M  (LP_SYSTEM_REG_USBOTGHS_WAKEUP_CLR_V << LP_SYSTEM_REG_USBOTGHS_WAKEUP_CLR_S)
#define LP_SYSTEM_REG_USBOTGHS_WAKEUP_CLR_V  0x00000001U
#define LP_SYSTEM_REG_USBOTGHS_WAKEUP_CLR_S  2
/** LP_SYSTEM_REG_USBOTGHS_IN_SUSPEND : R/W; bitpos: [3]; default: 0;
 *  indicate usb otg2.0 hs is in suspend state.
 */
#define LP_SYSTEM_REG_USBOTGHS_IN_SUSPEND    (BIT(3))
#define LP_SYSTEM_REG_USBOTGHS_IN_SUSPEND_M  (LP_SYSTEM_REG_USBOTGHS_IN_SUSPEND_V << LP_SYSTEM_REG_USBOTGHS_IN_SUSPEND_S)
#define LP_SYSTEM_REG_USBOTGHS_IN_SUSPEND_V  0x00000001U
#define LP_SYSTEM_REG_USBOTGHS_IN_SUSPEND_S  3
/** LP_SYSTEM_REG_USBOTGHS_LS_MODE : R/W; bitpos: [4]; default: 0;
 *  indicate usb otg2.0 hs ls mode
 */
#define LP_SYSTEM_REG_USBOTGHS_LS_MODE    (BIT(4))
#define LP_SYSTEM_REG_USBOTGHS_LS_MODE_M  (LP_SYSTEM_REG_USBOTGHS_LS_MODE_V << LP_SYSTEM_REG_USBOTGHS_LS_MODE_S)
#define LP_SYSTEM_REG_USBOTGHS_LS_MODE_V  0x00000001U
#define LP_SYSTEM_REG_USBOTGHS_LS_MODE_S  4
...
/** LP_SYSTEM_REG_REGDMA_ERROR : RO; bitpos: [24:22]; default: 0;
 *  regdma error code
 */
#define LP_SYSTEM_REG_REGDMA_ERROR    0x00000007U
#define LP_SYSTEM_REG_REGDMA_ERROR_M  (LP_SYSTEM_REG_REGDMA_ERROR_V << LP_SYSTEM_REG_REGDMA_ERROR_S)
#define LP_SYSTEM_REG_REGDMA_ERROR_V  0x00000007U
#define LP_SYSTEM_REG_REGDMA_ERROR_S  22

/** LP_SYSTEM_REG_BACKUP_DMA_CFG1_REG register
 *  need_des
 */
#define LP_SYSTEM_REG_BACKUP_DMA_CFG1_REG (DR_REG_LP_SYS_BASE + 0x158)
/** LP_SYSTEM_REG_LINK_WAIT_TOUT_THRES_AON : R/W; bitpos: [9:0]; default: 100;
 *  Set this field to configure the number of consecutive links of link list.
 */
#define LP_SYSTEM_REG_LINK_WAIT_TOUT_THRES_AON    0x000003FFU
#define LP_SYSTEM_REG_LINK_WAIT_TOUT_THRES_AON_M  (LP_SYSTEM_REG_LINK_WAIT_TOUT_THRES_AON_V << LP_SYSTEM_REG_LINK_WAIT_TOUT_THRES_AON_S)
#define LP_SYSTEM_REG_LINK_WAIT_TOUT_THRES_AON_V  0x000003FFU
#define LP_SYSTEM_REG_LINK_WAIT_TOUT_THRES_AON_S  0
/** LP_SYSTEM_REG_LINK_WORK_TOUT_THRES_AON : R/W; bitpos: [19:10]; default: 100;
 *  Set this field to configure maximum waiting time in waiting mode.
 */
#define LP_SYSTEM_REG_LINK_WORK_TOUT_THRES_AON    0x000003FFU
#define LP_SYSTEM_REG_LINK_WORK_TOUT_THRES_AON_M  (LP_SYSTEM_REG_LINK_WORK_TOUT_THRES_AON_V << LP_SYSTEM_REG_LINK_WORK_TOUT_THRES_AON_S)
#define LP_SYSTEM_REG_LINK_WORK_TOUT_THRES_AON_V  0x000003FFU
#define LP_SYSTEM_REG_LINK_WORK_TOUT_THRES_AON_S  10
/** LP_SYSTEM_REG_BRANCH_LINK_LENGTH_AON : R/W; bitpos: [23:20]; default: 0;
 *  Set this field to configure link address.
 */
#define LP_SYSTEM_REG_BRANCH_LINK_LENGTH_AON    0x0000000FU
#define LP_SYSTEM_REG_BRANCH_LINK_LENGTH_AON_M  (LP_SYSTEM_REG_BRANCH_LINK_LENGTH_AON_V << LP_SYSTEM_REG_BRANCH_LINK_LENGTH_AON_S)
#define LP_SYSTEM_REG_BRANCH_LINK_LENGTH_AON_V  0x0000000FU
#define LP_SYSTEM_REG_BRANCH_LINK_LENGTH_AON_S  20
...
/** LP_SYSTEM_REG_SPRF_MEM_AUX_CTRL_REG register
 *  need_des
 */
#define LP_SYSTEM_REG_SPRF_MEM_AUX_CTRL_REG (DR_REG_LP_SYS_BASE + 0x180)
/** LP_SYSTEM_REG_SPRF_MEM_AUX_CTRL : R/W; bitpos: [31:0]; default: 8304;
 *  need_des
 */
#define LP_SYSTEM_REG_SPRF_MEM_AUX_CTRL    0xFFFFFFFFU
#define LP_SYSTEM_REG_SPRF_MEM_AUX_CTRL_M  (LP_SYSTEM_REG_SPRF_MEM_AUX_CTRL_V << LP_SYSTEM_REG_SPRF_MEM_AUX_CTRL_S)
#define LP_SYSTEM_REG_SPRF_MEM_AUX_CTRL_V  0xFFFFFFFFU
#define LP_SYSTEM_REG_SPRF_MEM_AUX_CTRL_S  0
...
/** LP_SYSTEM_REG_HP_PO_CPU_RSTN_BYPASS_CTRL : R/W; bitpos: [7:0]; default: 255;
 ...
 */
#define LP_SYSTEM_REG_HP_PO_CPU_RSTN_BYPASS_CTRL    0x000000FFU
#define LP_SYSTEM_REG_HP_PO_CPU_RSTN_BYPASS_CTRL_M  (LP_SYSTEM_REG_HP_PO_CPU_RSTN_BYPASS_CTRL_V << LP_SYSTEM_REG_HP_PO_CPU_RSTN_BYPASS_CTRL_S)
#define LP_SYSTEM_REG_HP_PO_CPU_RSTN_BYPASS_CTRL_V  0x000000FFU
#define LP_SYSTEM_REG_HP_PO_CPU_RSTN_BYPASS_CTRL_S  0
...
/** LP_SYSTEM_REG_HP_PO_ALIVE_RSTN_BYPASS_CTRL : R/W; bitpos: [23:16]; default: 255;
 ...
 */
#define LP_SYSTEM_REG_HP_PO_ALIVE_RSTN_BYPASS_CTRL    0x000000FFU
#define LP_SYSTEM_REG_HP_PO_ALIVE_RSTN_BYPASS_CTRL_M  (LP_SYSTEM_REG_HP_PO_ALIVE_RSTN_BYPASS_CTRL_V << LP_SYSTEM_REG_HP_PO_ALIVE_RSTN_BYPASS_CTRL_S)
#define LP_SYSTEM_REG_HP_PO_ALIVE_RSTN_BYPASS_CTRL_V  0x000000FFU
#define LP_SYSTEM_REG_HP_PO_ALIVE_RSTN_BYPASS_CTRL_S  16
...
/** LP_SYSTEM_REG_LP_CORE_IBUS_TIMEOUT_CONF_REG register
 *  need_des
 */
#define LP_SYSTEM_REG_LP_CORE_IBUS_TIMEOUT_CONF_REG (DR_REG_LP_SYS_BASE + 0x1b4)
/** LP_SYSTEM_REG_LP_CORE_IBUS_TIMEOUT_PROTECT_EN : R/W; bitpos: [0]; default: 1;
 *  set this field to 1 to enable lp core ibus timeout handle
 */
#define LP_SYSTEM_REG_LP_CORE_IBUS_TIMEOUT_PROTECT_EN    (BIT(0))
#define LP_SYSTEM_REG_LP_CORE_IBUS_TIMEOUT_PROTECT_EN_M  (LP_SYSTEM_REG_LP_CORE_IBUS_TIMEOUT_PROTECT_EN_V << LP_SYSTEM_REG_LP_CORE_IBUS_TIMEOUT_PROTECT_EN_S)
#define LP_SYSTEM_REG_LP_CORE_IBUS_TIMEOUT_PROTECT_EN_V  0x00000001U
#define LP_SYSTEM_REG_LP_CORE_IBUS_TIMEOUT_PROTECT_EN_S  0
...
/** LP_SYSTEM_REG_LP_CORE_DBUS_TIMEOUT_CONF_REG register
 *  need_des
 */
#define LP_SYSTEM_REG_LP_CORE_DBUS_TIMEOUT_CONF_REG (DR_REG_LP_SYS_BASE + 0x1b8)
/** LP_SYSTEM_REG_LP_CORE_DBUS_TIMEOUT_PROTECT_EN : R/W; bitpos: [0]; default: 1;
 *  set this field to 1 to enable lp core dbus timeout handle
 */
#define LP_SYSTEM_REG_LP_CORE_DBUS_TIMEOUT_PROTECT_EN    (BIT(0))
#define LP_SYSTEM_REG_LP_CORE_DBUS_TIMEOUT_PROTECT_EN_M  (LP_SYSTEM_REG_LP_CORE_DBUS_TIMEOUT_PROTECT_EN_V << LP_SYSTEM_REG_LP_CORE_DBUS_TIMEOUT_PROTECT_EN_S)
#define LP_SYSTEM_REG_LP_CORE_DBUS_TIMEOUT_PROTECT_EN_V  0x00000001U
#define LP_SYSTEM_REG_LP_CORE_DBUS_TIMEOUT_PROTECT_EN_S  0
...
/** LP_SYSTEM_REG_PADCTRL_REG register
 *  pad ctrl register
 */
#define LP_SYSTEM_REG_PADCTRL_REG (DR_REG_LP_SYS_BASE + 0x1c4)
/** LP_SYSTEM_REG_PAD_MUX_SEL : R/W; bitpos: [7:0]; default: 0;
 *  Pad 0 ~ 7 can be controlled by hp iomux or lp iomux
 *  0: pad is controlled by hp iomux
 *  1: pad is controlled by lp iomux
 */
#define LP_SYSTEM_REG_PAD_MUX_SEL    0x000000FFU
#define LP_SYSTEM_REG_PAD_MUX_SEL_M  (LP_SYSTEM_REG_PAD_MUX_SEL_V << LP_SYSTEM_REG_PAD_MUX_SEL_S)
#define LP_SYSTEM_REG_PAD_MUX_SEL_V  0x000000FFU
#define LP_SYSTEM_REG_PAD_MUX_SEL_S  0
/** LP_SYSTEM_REG_PAD_HOLD : R/W; bitpos: [15:8]; default: 0;
 *  Pad 0 ~ 7 hold, direct control, won't be muxed with hp
 */
#define LP_SYSTEM_REG_PAD_HOLD    0x000000FFU
#define LP_SYSTEM_REG_PAD_HOLD_M  (LP_SYSTEM_REG_PAD_HOLD_V << LP_SYSTEM_REG_PAD_HOLD_S)
#define LP_SYSTEM_REG_PAD_HOLD_V  0x000000FFU
#define LP_SYSTEM_REG_PAD_HOLD_S  8

/** LP_SYSTEM_REG_SYS_POWER_STATUS_REG register
 *  lp system pd ctrl register
 */
#define LP_SYSTEM_REG_SYS_POWER_STATUS_REG (DR_REG_LP_SYS_BASE + 0x1e8)
/** LP_SYSTEM_REG_LP_TCM_RAM_PRDYN : RO; bitpos: [0]; default: 1;
 *  Record lp tcm ram power status.
 */
#define LP_SYSTEM_REG_LP_TCM_RAM_PRDYN    (BIT(0))
#define LP_SYSTEM_REG_LP_TCM_RAM_PRDYN_M  (LP_SYSTEM_REG_LP_TCM_RAM_PRDYN_V << LP_SYSTEM_REG_LP_TCM_RAM_PRDYN_S)
#define LP_SYSTEM_REG_LP_TCM_RAM_PRDYN_V  0x00000001U
#define LP_SYSTEM_REG_LP_TCM_RAM_PRDYN_S  0
/** LP_SYSTEM_REG_LP_TCM_ROM_PRDYN : RO; bitpos: [1]; default: 1;
 *  Record lp tcm rom power status.
 */
#define LP_SYSTEM_REG_LP_TCM_ROM_PRDYN    (BIT(1))
#define LP_SYSTEM_REG_LP_TCM_ROM_PRDYN_M  (LP_SYSTEM_REG_LP_TCM_ROM_PRDYN_V << LP_SYSTEM_REG_LP_TCM_ROM_PRDYN_S)
#define LP_SYSTEM_REG_LP_TCM_ROM_PRDYN_V  0x00000001U
#define LP_SYSTEM_REG_LP_TCM_ROM_PRDYN_S  1
/** LP_SYSTEM_REG_LP_HUK_MEM_PRDYN : RO; bitpos: [2]; default: 1;
 *  Record lp huk mem power status.
 */
#define LP_SYSTEM_REG_LP_HUK_MEM_PRDYN    (BIT(2))
#define LP_SYSTEM_REG_LP_HUK_MEM_PRDYN_M  (LP_SYSTEM_REG_LP_HUK_MEM_PRDYN_V << LP_SYSTEM_REG_LP_HUK_MEM_PRDYN_S)
#define LP_SYSTEM_REG_LP_HUK_MEM_PRDYN_V  0x00000001U
#define LP_SYSTEM_REG_LP_HUK_MEM_PRDYN_S  2
/** LP_SYSTEM_REG_LP_EFUSE_MEM_PRDYN : RO; bitpos: [3]; default: 1;
 *  Record lp efuse mem power status.
 */
#define LP_SYSTEM_REG_LP_EFUSE_MEM_PRDYN    (BIT(3))
#define LP_SYSTEM_REG_LP_EFUSE_MEM_PRDYN_M  (LP_SYSTEM_REG_LP_EFUSE_MEM_PRDYN_V << LP_SYSTEM_REG_LP_EFUSE_MEM_PRDYN_S)
#define LP_SYSTEM_REG_LP_EFUSE_MEM_PRDYN_V  0x00000001U
#define LP_SYSTEM_REG_LP_EFUSE_MEM_PRDYN_S  3
/** LP_SYSTEM_REG_LP_UART_MEM_PRDYN : RO; bitpos: [4]; default: 1;
 *  Record lp uart mem power status.
 */
#define LP_SYSTEM_REG_LP_UART_MEM_PRDYN    (BIT(4))
#define LP_SYSTEM_REG_LP_UART_MEM_PRDYN_M  (LP_SYSTEM_REG_LP_UART_MEM_PRDYN_V << LP_SYSTEM_REG_LP_UART_MEM_PRDYN_S)
#define LP_SYSTEM_REG_LP_UART_MEM_PRDYN_V  0x00000001U
#define LP_SYSTEM_REG_LP_UART_MEM_PRDYN_S  4

/** LP_SYSTEM_REG_ANA_DCDC_REG register
 *  need_des
 */
#define LP_SYSTEM_REG_ANA_DCDC_REG (DR_REG_LP_SYS_BASE + 0x1ec)
/** LP_SYSTEM_REG_RAMPLEVEL_DCDC : HRO; bitpos: [0]; default: 0;
 *  need_des
 */
#define LP_SYSTEM_REG_RAMPLEVEL_DCDC    (BIT(0))
#define LP_SYSTEM_REG_RAMPLEVEL_DCDC_M  (LP_SYSTEM_REG_RAMPLEVEL_DCDC_V << LP_SYSTEM_REG_RAMPLEVEL_DCDC_S)
#define LP_SYSTEM_REG_RAMPLEVEL_DCDC_V  0x00000001U
#define LP_SYSTEM_REG_RAMPLEVEL_DCDC_S  0
/** LP_SYSTEM_REG_RAMP_DCDC : HRO; bitpos: [1]; default: 0;
 *  need_des
 */
#define LP_SYSTEM_REG_RAMP_DCDC    (BIT(1))
#define LP_SYSTEM_REG_RAMP_DCDC_M  (LP_SYSTEM_REG_RAMP_DCDC_V << LP_SYSTEM_REG_RAMP_DCDC_S)
#define LP_SYSTEM_REG_RAMP_DCDC_V  0x00000001U
#define LP_SYSTEM_REG_RAMP_DCDC_S  1
/** LP_SYSTEM_REG_DCM2ENB_DCDC : HRO; bitpos: [2]; default: 0;
 *  need_des
 */
#define LP_SYSTEM_REG_DCM2ENB_DCDC    (BIT(2))
#define LP_SYSTEM_REG_DCM2ENB_DCDC_M  (LP_SYSTEM_REG_DCM2ENB_DCDC_V << LP_SYSTEM_REG_DCM2ENB_DCDC_S)
#define LP_SYSTEM_REG_DCM2ENB_DCDC_V  0x00000001U
#define LP_SYSTEM_REG_DCM2ENB_DCDC_S  2
/** LP_SYSTEM_REG_DCMLEVEL_DCDC : HRO; bitpos: [4:3]; default: 0;
 *  need_des
 */
#define LP_SYSTEM_REG_DCMLEVEL_DCDC    0x00000003U
#define LP_SYSTEM_REG_DCMLEVEL_DCDC_M  (LP_SYSTEM_REG_DCMLEVEL_DCDC_V << LP_SYSTEM_REG_DCMLEVEL_DCDC_S)
#define LP_SYSTEM_REG_DCMLEVEL_DCDC_V  0x00000003U
#define LP_SYSTEM_REG_DCMLEVEL_DCDC_S  3
/** LP_SYSTEM_REG_FSW_DCDC : HRO; bitpos: [7:5]; default: 0;
 *  need_des
 */
#define LP_SYSTEM_REG_FSW_DCDC    0x00000007U
#define LP_SYSTEM_REG_FSW_DCDC_M  (LP_SYSTEM_REG_FSW_DCDC_V << LP_SYSTEM_REG_FSW_DCDC_S)
#define LP_SYSTEM_REG_FSW_DCDC_V  0x00000007U
#define LP_SYSTEM_REG_FSW_DCDC_S  5
/** LP_SYSTEM_REG_CCM_DCDC : HRO; bitpos: [8]; default: 0;
 *  need_des
 */
#define LP_SYSTEM_REG_CCM_DCDC    (BIT(8))
#define LP_SYSTEM_REG_CCM_DCDC_M  (LP_SYSTEM_REG_CCM_DCDC_V << LP_SYSTEM_REG_CCM_DCDC_S)
#define LP_SYSTEM_REG_CCM_DCDC_V  0x00000001U
#define LP_SYSTEM_REG_CCM_DCDC_S  8
/** LP_SYSTEM_REG_SSTIME_DCDC : HRO; bitpos: [9]; default: 0;
 *  need_des
 */
#define LP_SYSTEM_REG_SSTIME_DCDC    (BIT(9))
#define LP_SYSTEM_REG_SSTIME_DCDC_M  (LP_SYSTEM_REG_SSTIME_DCDC_V << LP_SYSTEM_REG_SSTIME_DCDC_S)
#define LP_SYSTEM_REG_SSTIME_DCDC_V  0x00000001U
#define LP_SYSTEM_REG_SSTIME_DCDC_S  9
/** LP_SYSTEM_REG_POCPENB_DCDC : HRO; bitpos: [10]; default: 0;
 *  need_des
 */
#define LP_SYSTEM_REG_POCPENB_DCDC    (BIT(10))
#define LP_SYSTEM_REG_POCPENB_DCDC_M  (LP_SYSTEM_REG_POCPENB_DCDC_V << LP_SYSTEM_REG_POCPENB_DCDC_S)
#define LP_SYSTEM_REG_POCPENB_DCDC_V  0x00000001U
#define LP_SYSTEM_REG_POCPENB_DCDC_S  10
/** LP_SYSTEM_REG_ENABLE_TRX_MODE_DCDC : HRO; bitpos: [11]; default: 1;
 *  need_des
 */
#define LP_SYSTEM_REG_ENABLE_TRX_MODE_DCDC    (BIT(11))
#define LP_SYSTEM_REG_ENABLE_TRX_MODE_DCDC_M  (LP_SYSTEM_REG_ENABLE_TRX_MODE_DCDC_V << LP_SYSTEM_REG_ENABLE_TRX_MODE_DCDC_S)
#define LP_SYSTEM_REG_ENABLE_TRX_MODE_DCDC_V  0x00000001U
#define LP_SYSTEM_REG_ENABLE_TRX_MODE_DCDC_S  11

/** LP_SYSTEM_REG_POR_CUR_ST_REG register
 *  need_des
 */
#define LP_SYSTEM_REG_POR_CUR_ST_REG (DR_REG_LP_SYS_BASE + 0x1f0)
/** LP_SYSTEM_REG_POR_CUR_ST : RO; bitpos: [8:0]; default: 0;
 *  current por state
 */
#define LP_SYSTEM_REG_POR_CUR_ST    0x000001FFU
#define LP_SYSTEM_REG_POR_CUR_ST_M  (LP_SYSTEM_REG_POR_CUR_ST_V << LP_SYSTEM_REG_POR_CUR_ST_S)
#define LP_SYSTEM_REG_POR_CUR_ST_V  0x000001FFU
#define LP_SYSTEM_REG_POR_CUR_ST_S  0

/** LP_SYSTEM_REG_SPRAM_MEM_AUX_CTRL_REG register
 *  need_des
 */
#define LP_SYSTEM_REG_SPRAM_MEM_AUX_CTRL_REG (DR_REG_LP_SYS_BASE + 0x1f8)
/** LP_SYSTEM_REG_SPRAM_MEM_AUX_CTRL : R/W; bitpos: [31:0]; default: 8304;
 *  need_des
 */
#define LP_SYSTEM_REG_SPRAM_MEM_AUX_CTRL    0xFFFFFFFFU
#define LP_SYSTEM_REG_SPRAM_MEM_AUX_CTRL_M  (LP_SYSTEM_REG_SPRAM_MEM_AUX_CTRL_V << LP_SYSTEM_REG_SPRAM_MEM_AUX_CTRL_S)
#define LP_SYSTEM_REG_SPRAM_MEM_AUX_CTRL_V  0xFFFFFFFFU
#define LP_SYSTEM_REG_SPRAM_MEM_AUX_CTRL_S  0

/** LP_SYSTEM_REG_UART_MEM_LP_CTRL_REG register
 *  config lp peri memory power in lp aon register
 */
#define LP_SYSTEM_REG_UART_MEM_LP_CTRL_REG (DR_REG_LP_SYS_BASE + 0x1fc)
/** LP_SYSTEM_REG_UART_MEM_LP_MODE : R/W; bitpos: [1:0]; default: 2;
 ...
 */
#define LP_SYSTEM_REG_UART_MEM_LP_MODE    0x00000003U
#define LP_SYSTEM_REG_UART_MEM_LP_MODE_M  (LP_SYSTEM_REG_UART_MEM_LP_MODE_V << LP_SYSTEM_REG_UART_MEM_LP_MODE_S)
#define LP_SYSTEM_REG_UART_MEM_LP_MODE_V  0x00000003U
#define LP_SYSTEM_REG_UART_MEM_LP_MODE_S  0
/** LP_SYSTEM_REG_UART_MEM_LP_EN : R/W; bitpos: [2]; default: 0;
 *  Set this bit to power down lp uart memory.
 */
#define LP_SYSTEM_REG_UART_MEM_LP_EN    (BIT(2))
#define LP_SYSTEM_REG_UART_MEM_LP_EN_M  (LP_SYSTEM_REG_UART_MEM_LP_EN_V << LP_SYSTEM_REG_UART_MEM_LP_EN_S)
#define LP_SYSTEM_REG_UART_MEM_LP_EN_V  0x00000001U
#define LP_SYSTEM_REG_UART_MEM_LP_EN_S  2
/** LP_SYSTEM_REG_UART_MEM_LP_FORCE_CTRL : R/W; bitpos: [3]; default: 0;
 *  Set this bit to force software control lp uart memory, disable hardware control.
 */
#define LP_SYSTEM_REG_UART_MEM_LP_FORCE_CTRL    (BIT(3))
#define LP_SYSTEM_REG_UART_MEM_LP_FORCE_CTRL_M  (LP_SYSTEM_REG_UART_MEM_LP_FORCE_CTRL_V << LP_SYSTEM_REG_UART_MEM_LP_FORCE_CTRL_S)
#define LP_SYSTEM_REG_UART_MEM_LP_FORCE_CTRL_V  0x00000001U
#define LP_SYSTEM_REG_UART_MEM_LP_FORCE_CTRL_S  3

/** LP_SYSTEM_REG_HUK_MEM_LP_CTRL_REG register
 *  config lp peri memory power in lp aon register
 */
#define LP_SYSTEM_REG_HUK_MEM_LP_CTRL_REG (DR_REG_LP_SYS_BASE + 0x200)
/** LP_SYSTEM_REG_HUK_MEM_LP_MODE : R/W; bitpos: [1:0]; default: 0;
 ...
 *  3: disable low power stage
 */
#define LP_SYSTEM_REG_HUK_MEM_LP_MODE    0x00000003U
#define LP_SYSTEM_REG_HUK_MEM_LP_MODE_M  (LP_SYSTEM_REG_HUK_MEM_LP_MODE_V << LP_SYSTEM_REG_HUK_MEM_LP_MODE_S)
#define LP_SYSTEM_REG_HUK_MEM_LP_MODE_V  0x00000003U
#define LP_SYSTEM_REG_HUK_MEM_LP_MODE_S  0
/** LP_SYSTEM_REG_HUK_MEM_LP_EN : R/W; bitpos: [2]; default: 0;
 *  Set this bit to power down huk memory.
 */
#define LP_SYSTEM_REG_HUK_MEM_LP_EN    (BIT(2))
#define LP_SYSTEM_REG_HUK_MEM_LP_EN_M  (LP_SYSTEM_REG_HUK_MEM_LP_EN_V << LP_SYSTEM_REG_HUK_MEM_LP_EN_S)
#define LP_SYSTEM_REG_HUK_MEM_LP_EN_V  0x00000001U
#define LP_SYSTEM_REG_HUK_MEM_LP_EN_S  2
/** LP_SYSTEM_REG_HUK_MEM_LP_FORCE_CTRL : R/W; bitpos: [3]; default: 0;
 *  Set this bit to force software control huk memory, disable hardware control.
 */
#define LP_SYSTEM_REG_HUK_MEM_LP_FORCE_CTRL    (BIT(3))
#define LP_SYSTEM_REG_HUK_MEM_LP_FORCE_CTRL_M  (LP_SYSTEM_REG_HUK_MEM_LP_FORCE_CTRL_V << LP_SYSTEM_REG_HUK_MEM_LP_FORCE_CTRL_S)
#define LP_SYSTEM_REG_HUK_MEM_LP_FORCE_CTRL_V  0x00000001U
#define LP_SYSTEM_REG_HUK_MEM_LP_FORCE_CTRL_S  3

/** LP_SYSTEM_REG_EFUSE_MEM_LP_CTRL_REG register
 *  config lp peri memory power in lp aon register
 */
#define LP_SYSTEM_REG_EFUSE_MEM_LP_CTRL_REG (DR_REG_LP_SYS_BASE + 0x204)
/** LP_SYSTEM_REG_EFUSE_MEM_LP_MODE : R/W; bitpos: [1:0]; default: 0;
 ...
 *  3: disable low power stage
 */
#define LP_SYSTEM_REG_EFUSE_MEM_LP_MODE    0x00000003U
#define LP_SYSTEM_REG_EFUSE_MEM_LP_MODE_M  (LP_SYSTEM_REG_EFUSE_MEM_LP_MODE_V << LP_SYSTEM_REG_EFUSE_MEM_LP_MODE_S)
#define LP_SYSTEM_REG_EFUSE_MEM_LP_MODE_V  0x00000003U
#define LP_SYSTEM_REG_EFUSE_MEM_LP_MODE_S  0
/** LP_SYSTEM_REG_EFUSE_MEM_LP_EN : R/W; bitpos: [2]; default: 0;
 *  Set this bit to power down efuse memory.
 */
#define LP_SYSTEM_REG_EFUSE_MEM_LP_EN    (BIT(2))
#define LP_SYSTEM_REG_EFUSE_MEM_LP_EN_M  (LP_SYSTEM_REG_EFUSE_MEM_LP_EN_V << LP_SYSTEM_REG_EFUSE_MEM_LP_EN_S)
#define LP_SYSTEM_REG_EFUSE_MEM_LP_EN_V  0x00000001U
#define LP_SYSTEM_REG_EFUSE_MEM_LP_EN_S  2
/** LP_SYSTEM_REG_EFUSE_MEM_LP_FORCE_CTRL : R/W; bitpos: [3]; default: 0;
 *  Set this bit to force software control efuse memory, disable hardware control.
 */
#define LP_SYSTEM_REG_EFUSE_MEM_LP_FORCE_CTRL    (BIT(3))
#define LP_SYSTEM_REG_EFUSE_MEM_LP_FORCE_CTRL_M  (LP_SYSTEM_REG_EFUSE_MEM_LP_FORCE_CTRL_V << LP_SYSTEM_REG_EFUSE_MEM_LP_FORCE_CTRL_S)
#define LP_SYSTEM_REG_EFUSE_MEM_LP_FORCE_CTRL_V  0x00000001U
#define LP_SYSTEM_REG_EFUSE_MEM_LP_FORCE_CTRL_S  3

/** LP_SYSTEM_REG_LP_TCM_MEM_LP_CTRL_REG register
 *  configure rmemory power in lp system register
 */
#define LP_SYSTEM_REG_LP_TCM_MEM_LP_CTRL_REG (DR_REG_LP_SYS_BASE + 0x208)
/** LP_SYSTEM_REG_LP_TCM_MEM_LP_MODE : R/W; bitpos: [1:0]; default: 0;
 ...
 *  3: disable low power stage
 */
#define LP_SYSTEM_REG_LP_TCM_MEM_LP_MODE    0x00000003U
#define LP_SYSTEM_REG_LP_TCM_MEM_LP_MODE_M  (LP_SYSTEM_REG_LP_TCM_MEM_LP_MODE_V << LP_SYSTEM_REG_LP_TCM_MEM_LP_MODE_S)
#define LP_SYSTEM_REG_LP_TCM_MEM_LP_MODE_V  0x00000003U
#define LP_SYSTEM_REG_LP_TCM_MEM_LP_MODE_S  0
/** LP_SYSTEM_REG_LP_TCM_MEM_LP_EN : R/W; bitpos: [2]; default: 0;
 *  Set this bit to power down lp_sram memory.
 */
#define LP_SYSTEM_REG_LP_TCM_MEM_LP_EN    (BIT(2))
#define LP_SYSTEM_REG_LP_TCM_MEM_LP_EN_M  (LP_SYSTEM_REG_LP_TCM_MEM_LP_EN_V << LP_SYSTEM_REG_LP_TCM_MEM_LP_EN_S)
#define LP_SYSTEM_REG_LP_TCM_MEM_LP_EN_V  0x00000001U
#define LP_SYSTEM_REG_LP_TCM_MEM_LP_EN_S  2
/** LP_SYSTEM_REG_LP_TCM_MEM_LP_FORCE_CTRL : R/W; bitpos: [3]; default: 0;
 *  Set this bit to force software control lp_sram memory, disable hardware control.
 */
#define LP_SYSTEM_REG_LP_TCM_MEM_LP_FORCE_CTRL    (BIT(3))
#define LP_SYSTEM_REG_LP_TCM_MEM_LP_FORCE_CTRL_M  (LP_SYSTEM_REG_LP_TCM_MEM_LP_FORCE_CTRL_V << LP_SYSTEM_REG_LP_TCM_MEM_LP_FORCE_CTRL_S)
#define LP_SYSTEM_REG_LP_TCM_MEM_LP_FORCE_CTRL_V  0x00000001U
#define LP_SYSTEM_REG_LP_TCM_MEM_LP_FORCE_CTRL_S  3

/** LP_SYSTEM_REG_MODEM_MEM_CLK_SEL_REG register
 *  configure clock source for modme_mem, this register must be config by regdma when
 *  power on
 */
#define LP_SYSTEM_REG_MODEM_MEM_CLK_SEL_REG (DR_REG_LP_SYS_BASE + 0x218)
/** LP_SYSTEM_REG_MODEM_MEM_CLK_SEL : R/W; bitpos: [0]; default: 0;
 *  configure clock source for modme_mem, this register must be config by regdma when
 *  power on
 */
#define LP_SYSTEM_REG_MODEM_MEM_CLK_SEL    (BIT(0))
#define LP_SYSTEM_REG_MODEM_MEM_CLK_SEL_M  (LP_SYSTEM_REG_MODEM_MEM_CLK_SEL_V << LP_SYSTEM_REG_MODEM_MEM_CLK_SEL_S)
#define LP_SYSTEM_REG_MODEM_MEM_CLK_SEL_V  0x00000001U
#define LP_SYSTEM_REG_MODEM_MEM_CLK_SEL_S  0

/** LP_SYSTEM_REG_LP_PERI_TIMEOUT_CONF_REG register
 *  LP_PERI_TIMEOUT configuration register
 */
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_CONF_REG (DR_REG_LP_SYS_BASE + 0x21c)
/** LP_SYSTEM_REG_LP_PERI_TIMEOUT_THRES : R/W; bitpos: [15:0]; default: 65535;
 ...
 */
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_THRES    0x0000FFFFU
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_THRES_M  (LP_SYSTEM_REG_LP_PERI_TIMEOUT_THRES_V << LP_SYSTEM_REG_LP_PERI_TIMEOUT_THRES_S)
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_THRES_V  0x0000FFFFU
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_THRES_S  0
/** LP_SYSTEM_REG_LP_PERI_TIMEOUT_INT_CLEAR : WT; bitpos: [16]; default: 0;
 *  Write 1 to clear timeout interrupt.
 */
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_INT_CLEAR    (BIT(16))
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_INT_CLEAR_M  (LP_SYSTEM_REG_LP_PERI_TIMEOUT_INT_CLEAR_V << LP_SYSTEM_REG_LP_PERI_TIMEOUT_INT_CLEAR_S)
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_INT_CLEAR_V  0x00000001U
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_INT_CLEAR_S  16
/** LP_SYSTEM_REG_LP_PERI_TIMEOUT_PROTECT_EN : R/W; bitpos: [17]; default: 1;
 *  Configures whether or not to enable timeout protection for accessing CPU peripheral
 *  registers.
 *  0: Disable
 *  1: Enable
 */
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_PROTECT_EN    (BIT(17))
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_PROTECT_EN_M  (LP_SYSTEM_REG_LP_PERI_TIMEOUT_PROTECT_EN_V << LP_SYSTEM_REG_LP_PERI_TIMEOUT_PROTECT_EN_S)
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_PROTECT_EN_V  0x00000001U
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_PROTECT_EN_S  17

/** LP_SYSTEM_REG_LP_PERI_TIMEOUT_ADDR_REG register
 *  LP_PERI_TIMEOUT_ADDR register
 */
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_ADDR_REG (DR_REG_LP_SYS_BASE + 0x220)
/** LP_SYSTEM_REG_LP_PERI_TIMEOUT_ADDR : RO; bitpos: [31:0]; default: 0;
 *  Represents the address information of abnormal access.
 */
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_ADDR    0xFFFFFFFFU
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_ADDR_M  (LP_SYSTEM_REG_LP_PERI_TIMEOUT_ADDR_V << LP_SYSTEM_REG_LP_PERI_TIMEOUT_ADDR_S)
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_ADDR_V  0xFFFFFFFFU
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_ADDR_S  0

/** LP_SYSTEM_REG_LP_PERI_TIMEOUT_UID_REG register
 *  LP_PERI_TIMEOUT_UID register
 */
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_UID_REG (DR_REG_LP_SYS_BASE + 0x224)
/** LP_SYSTEM_REG_LP_PERI_TIMEOUT_UID : RO; bitpos: [7:0]; default: 0;
 ...
 */
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_UID    0x000000FFU
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_UID_M  (LP_SYSTEM_REG_LP_PERI_TIMEOUT_UID_V << LP_SYSTEM_REG_LP_PERI_TIMEOUT_UID_S)
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_UID_V  0x000000FFU
#define LP_SYSTEM_REG_LP_PERI_TIMEOUT_UID_S  0

/** LP_SYSTEM_REG_RTC_EN_AMUX_REG register
 *  RTC_EN_AMUX register
 */
#define LP_SYSTEM_REG_RTC_EN_AMUX_REG (DR_REG_LP_SYS_BASE + 0x228)
/** LP_SYSTEM_REG_RTC_EN_AMUX : R/W; bitpos: [17:0]; default: 0;
 *  Configures the rtc_en_amux of the pad in hp_pad_top
 */
#define LP_SYSTEM_REG_RTC_EN_AMUX    0x0003FFFFU
#define LP_SYSTEM_REG_RTC_EN_AMUX_M  (LP_SYSTEM_REG_RTC_EN_AMUX_V << LP_SYSTEM_REG_RTC_EN_AMUX_S)
#define LP_SYSTEM_REG_RTC_EN_AMUX_V  0x0003FFFFU
#define LP_SYSTEM_REG_RTC_EN_AMUX_S  0

/** LP_SYSTEM_REG_RTC_EN_DMUX_REG register
 *  RTC_EN_DMUX register
 */
#define LP_SYSTEM_REG_RTC_EN_DMUX_REG (DR_REG_LP_SYS_BASE + 0x22c)
/** LP_SYSTEM_REG_RTC_EN_DMUX : R/W; bitpos: [1:0]; default: 0;
 *  Configures the rtc_en_dmux of the pad(digmux) in hp_pad_top
 */
#define LP_SYSTEM_REG_RTC_EN_DMUX    0x00000003U
#define LP_SYSTEM_REG_RTC_EN_DMUX_M  (LP_SYSTEM_REG_RTC_EN_DMUX_V << LP_SYSTEM_REG_RTC_EN_DMUX_S)
#define LP_SYSTEM_REG_RTC_EN_DMUX_V  0x00000003U
#define LP_SYSTEM_REG_RTC_EN_DMUX_S  0

/** LP_SYSTEM_REG_DIGMUX_PAD_DSEL_REG register
 *  DIGMUX_PAD_DSEL register
 */
#define LP_SYSTEM_REG_DIGMUX_PAD_DSEL_REG (DR_REG_LP_SYS_BASE + 0x230)
/** LP_SYSTEM_REG_DIGMUX_PAD_DSEL : R/W; bitpos: [5:0]; default: 0;
 *  Configures the rtc_en_dmux of the pad(digmux) in hp_pad_top
 */
#define LP_SYSTEM_REG_DIGMUX_PAD_DSEL    0x0000003FU
#define LP_SYSTEM_REG_DIGMUX_PAD_DSEL_M  (LP_SYSTEM_REG_DIGMUX_PAD_DSEL_V << LP_SYSTEM_REG_DIGMUX_PAD_DSEL_S)
#define LP_SYSTEM_REG_DIGMUX_PAD_DSEL_V  0x0000003FU
#define LP_SYSTEM_REG_DIGMUX_PAD_DSEL_S  0

/** LP_SYSTEM_REG_JTAG_TDIO_MUX_SEL_REG register
 *  LP_JTAG_TDIO_MUX_SEL register
 */
#define LP_SYSTEM_REG_JTAG_TDIO_MUX_SEL_REG (DR_REG_LP_SYS_BASE + 0x234)
/** LP_SYSTEM_REG_JTAG_TDIO_MUX_SEL : R/W; bitpos: [1:0]; default: 0;
 ...
 */
#define LP_SYSTEM_REG_JTAG_TDIO_MUX_SEL    0x00000003U
#define LP_SYSTEM_REG_JTAG_TDIO_MUX_SEL_M  (LP_SYSTEM_REG_JTAG_TDIO_MUX_SEL_V << LP_SYSTEM_REG_JTAG_TDIO_MUX_SEL_S)
#define LP_SYSTEM_REG_JTAG_TDIO_MUX_SEL_V  0x00000003U
#define LP_SYSTEM_REG_JTAG_TDIO_MUX_SEL_S  0

/** LP_SYSTEM_REG_LP_CORE_DMACTIVE_LPCORE_REG register
 *  LP_JTAG_TDI_SEL register
 */
#define LP_SYSTEM_REG_LP_CORE_DMACTIVE_LPCORE_REG (DR_REG_LP_SYS_BASE + 0x238)
/** LP_SYSTEM_REG_LP_CORE_DMACTIVE_LPCORE : RO; bitpos: [0]; default: 0;
 *  Record lpcore_dmactive_lpcore status
 */
#define LP_SYSTEM_REG_LP_CORE_DMACTIVE_LPCORE    (BIT(0))
#define LP_SYSTEM_REG_LP_CORE_DMACTIVE_LPCORE_M  (LP_SYSTEM_REG_LP_CORE_DMACTIVE_LPCORE_V << LP_SYSTEM_REG_LP_CORE_DMACTIVE_LPCORE_S)
#define LP_SYSTEM_REG_LP_CORE_DMACTIVE_LPCORE_V  0x00000001U
#define LP_SYSTEM_REG_LP_CORE_DMACTIVE_LPCORE_S  0

/** LP_SYSTEM_REG_TOUCH_PAD_RTC_EN_AMUX_REG register
 *  TOUCH_PAD_RTC_EN_AMUX register
 */
#define LP_SYSTEM_REG_TOUCH_PAD_RTC_EN_AMUX_REG (DR_REG_LP_SYS_BASE + 0x23c)
/** LP_SYSTEM_REG_TOUCH_PAD_RTC_EN_AMUX : R/W; bitpos: [13:0]; default: 0;
 *  Configures the rtc_en_amux of the touch_pads
 *  amux_reg[13:0] <->TOUCH_GPIO[19:6]
 */
#define LP_SYSTEM_REG_TOUCH_PAD_RTC_EN_AMUX    0x00003FFFU
#define LP_SYSTEM_REG_TOUCH_PAD_RTC_EN_AMUX_M  (LP_SYSTEM_REG_TOUCH_PAD_RTC_EN_AMUX_V << LP_SYSTEM_REG_TOUCH_PAD_RTC_EN_AMUX_S)
#define LP_SYSTEM_REG_TOUCH_PAD_RTC_EN_AMUX_V  0x00003FFFU
#define LP_SYSTEM_REG_TOUCH_PAD_RTC_EN_AMUX_S  0

/** LP_SYSTEM_REG_HP_GPIO_O_HOLD_CTRL1_REG register
 *  NA
 */
#define LP_SYSTEM_REG_HP_GPIO_O_HOLD_CTRL1_REG (DR_REG_LP_SYS_BASE + 0x270)
/** LP_SYSTEM_REG_HP_GPIO_0_HOLD_CTRL1 : R/W; bitpos: [22:0]; default: 0;
 *  hold control for gpio62~40
 */
#define LP_SYSTEM_REG_HP_GPIO_0_HOLD_CTRL1    0x007FFFFFU
#define LP_SYSTEM_REG_HP_GPIO_0_HOLD_CTRL1_M  (LP_SYSTEM_REG_HP_GPIO_0_HOLD_CTRL1_V << LP_SYSTEM_REG_HP_GPIO_0_HOLD_CTRL1_S)
#define LP_SYSTEM_REG_HP_GPIO_0_HOLD_CTRL1_V  0x007FFFFFU
#define LP_SYSTEM_REG_HP_GPIO_0_HOLD_CTRL1_S  0

/** LP_SYSTEM_REG_HP_GPIO_O_HOLD_CTRL0_REG register
 *  NA
 */
#define LP_SYSTEM_REG_HP_GPIO_O_HOLD_CTRL0_REG (DR_REG_LP_SYS_BASE + 0x274)
/** LP_SYSTEM_REG_HP_GPIO_0_HOLD_CTRL0 : R/W; bitpos: [31:0]; default: 0;
 *  hold control for gpio39~8
 */
#define LP_SYSTEM_REG_HP_GPIO_0_HOLD_CTRL0    0xFFFFFFFFU
#define LP_SYSTEM_REG_HP_GPIO_0_HOLD_CTRL0_M  (LP_SYSTEM_REG_HP_GPIO_0_HOLD_CTRL0_V << LP_SYSTEM_REG_HP_GPIO_0_HOLD_CTRL0_S)
#define LP_SYSTEM_REG_HP_GPIO_0_HOLD_CTRL0_V  0xFFFFFFFFU
#define LP_SYSTEM_REG_HP_GPIO_0_HOLD_CTRL0_S  0
