 ...
 *  PPA_SRM_CLUT_DATA_REG/PPA_BLEND0_CLUT_DATA_REG/PPA_BLEND1_CLUT_DATA_REG. 1'b1:
...
/** PPA_BLEND_CLUT_MEM_FORCE_PD : R/W; bitpos: [5]; default: 0;
 *  1: force power down BLEND CLUT memory.
 */
#define PPA_BLEND_CLUT_MEM_FORCE_PD    (BIT(5))
#define PPA_BLEND_CLUT_MEM_FORCE_PD_M  (PPA_BLEND_CLUT_MEM_FORCE_PD_V << PPA_BLEND_CLUT_MEM_FORCE_PD_S)
#define PPA_BLEND_CLUT_MEM_FORCE_PD_V  0x00000001U
#define PPA_BLEND_CLUT_MEM_FORCE_PD_S  5
/** PPA_BLEND_CLUT_MEM_FORCE_PU : R/W; bitpos: [6]; default: 0;
 *  1: force power up BLEND CLUT memory.
 */
#define PPA_BLEND_CLUT_MEM_FORCE_PU    (BIT(6))
#define PPA_BLEND_CLUT_MEM_FORCE_PU_M  (PPA_BLEND_CLUT_MEM_FORCE_PU_V << PPA_BLEND_CLUT_MEM_FORCE_PU_S)
#define PPA_BLEND_CLUT_MEM_FORCE_PU_V  0x00000001U
#define PPA_BLEND_CLUT_MEM_FORCE_PU_S  6
/** PPA_BLEND_CLUT_MEM_CLK_ENA : R/W; bitpos: [7]; default: 0;
 *  1: Force clock on for BLEND CLUT memory.
 */
#define PPA_BLEND_CLUT_MEM_CLK_ENA    (BIT(7))
#define PPA_BLEND_CLUT_MEM_CLK_ENA_M  (PPA_BLEND_CLUT_MEM_CLK_ENA_V << PPA_BLEND_CLUT_MEM_CLK_ENA_S)
#define PPA_BLEND_CLUT_MEM_CLK_ENA_V  0x00000001U
...
/** PPA_SRM_EOF_INT_RAW : R/WTC/SS; bitpos: [0]; default: 0;
...
#define PPA_SRM_EOF_INT_RAW_M  (PPA_SRM_EOF_INT_RAW_V << PPA_SRM_EOF_INT_RAW_S)
#define PPA_SRM_EOF_INT_RAW_V  0x00000001U
...
/** PPA_SRM_PARAM_CFG_ERR_INT_RAW : R/WTC/SS; bitpos: [2]; default: 0;
 ...
 *  PPA_SRM_PARAM_ERR_ST_REG.
 */
#define PPA_SRM_PARAM_CFG_ERR_INT_RAW    (BIT(2))
#define PPA_SRM_PARAM_CFG_ERR_INT_RAW_M  (PPA_SRM_PARAM_CFG_ERR_INT_RAW_V << PPA_SRM_PARAM_CFG_ERR_INT_RAW_S)
#define PPA_SRM_PARAM_CFG_ERR_INT_RAW_V  0x00000001U
...
/** PPA_SRM_EOF_INT_ST : RO; bitpos: [0]; default: 0;
 *  The raw interrupt status bit for the PPA_SRM_EOF_INT interrupt.
 */
#define PPA_SRM_EOF_INT_ST    (BIT(0))
#define PPA_SRM_EOF_INT_ST_M  (PPA_SRM_EOF_INT_ST_V << PPA_SRM_EOF_INT_ST_S)
#define PPA_SRM_EOF_INT_ST_V  0x00000001U
...
/** PPA_SRM_PARAM_CFG_ERR_INT_ST : RO; bitpos: [2]; default: 0;
 *  The raw interrupt status bit for the PPA_SRM_PARAM_CFG_ERR_INT interrupt.
 */
#define PPA_SRM_PARAM_CFG_ERR_INT_ST    (BIT(2))
#define PPA_SRM_PARAM_CFG_ERR_INT_ST_M  (PPA_SRM_PARAM_CFG_ERR_INT_ST_V << PPA_SRM_PARAM_CFG_ERR_INT_ST_S)
#define PPA_SRM_PARAM_CFG_ERR_INT_ST_V  0x00000001U
...
/** PPA_SRM_EOF_INT_ENA : R/W; bitpos: [0]; default: 0;
 *  The interrupt enable bit for the PPA_SRM_EOF_INT interrupt.
 */
#define PPA_SRM_EOF_INT_ENA    (BIT(0))
#define PPA_SRM_EOF_INT_ENA_M  (PPA_SRM_EOF_INT_ENA_V << PPA_SRM_EOF_INT_ENA_S)
#define PPA_SRM_EOF_INT_ENA_V  0x00000001U
...
/** PPA_SRM_PARAM_CFG_ERR_INT_ENA : R/W; bitpos: [2]; default: 0;
 *  The interrupt enable bit for the PPA_SRM_PARAM_CFG_ERR_INT interrupt.
 */
#define PPA_SRM_PARAM_CFG_ERR_INT_ENA    (BIT(2))
#define PPA_SRM_PARAM_CFG_ERR_INT_ENA_M  (PPA_SRM_PARAM_CFG_ERR_INT_ENA_V << PPA_SRM_PARAM_CFG_ERR_INT_ENA_S)
#define PPA_SRM_PARAM_CFG_ERR_INT_ENA_V  0x00000001U
...
/** PPA_SRM_EOF_INT_CLR : WT; bitpos: [0]; default: 0;
 *  Set this bit to clear the PPA_SRM_EOF_INT interrupt.
 */
#define PPA_SRM_EOF_INT_CLR    (BIT(0))
#define PPA_SRM_EOF_INT_CLR_M  (PPA_SRM_EOF_INT_CLR_V << PPA_SRM_EOF_INT_CLR_S)
#define PPA_SRM_EOF_INT_CLR_V  0x00000001U
...
/** PPA_SRM_PARAM_CFG_ERR_INT_CLR : WT; bitpos: [2]; default: 0;
 *  Set this bit to clear the PPA_SRM_RX_YSCAL_ERR_INT interrupt.
 */
#define PPA_SRM_PARAM_CFG_ERR_INT_CLR    (BIT(2))
#define PPA_SRM_PARAM_CFG_ERR_INT_CLR_M  (PPA_SRM_PARAM_CFG_ERR_INT_CLR_V << PPA_SRM_PARAM_CFG_ERR_INT_CLR_S)
#define PPA_SRM_PARAM_CFG_ERR_INT_CLR_V  0x00000001U
 ...
 */
#define PPA_SRM_RX_CM    0x0000000FU
#define PPA_SRM_RX_CM_M  (PPA_SRM_RX_CM_V << PPA_SRM_RX_CM_S)
#define PPA_SRM_RX_CM_V  0x0000000FU
#define PPA_SRM_RX_CM_S  0
/** PPA_SRM_TX_CM : R/W; bitpos: [7:4]; default: 0;
 ...
 */
#define PPA_SRM_TX_CM    0x0000000FU
#define PPA_SRM_TX_CM_M  (PPA_SRM_TX_CM_V << PPA_SRM_TX_CM_S)
#define PPA_SRM_TX_CM_V  0x0000000FU
 ...
 *  RGB565. 3: Reserved. 4: L8. 5: L4. 8: YUV420. 9: YUV422
 */
 ...
 *  RGB565. 3: Reserved. 8: YUV420. 9: YUV422.
 */
...
#define PPA_SRM_RX_BYTE_SWAP_EN_M  (PPA_SRM_RX_BYTE_SWAP_EN_V << PPA_SRM_RX_BYTE_SWAP_EN_S)
#define PPA_SRM_RX_BYTE_SWAP_EN_V  0x00000001U
#define PPA_SRM_RX_BYTE_SWAP_EN_S  0
/** PPA_SRM_RX_RGB_SWAP_EN : R/W; bitpos: [1]; default: 0;
...
#define PPA_SRM_RX_RGB_SWAP_EN_M  (PPA_SRM_RX_RGB_SWAP_EN_V << PPA_SRM_RX_RGB_SWAP_EN_S)
#define PPA_SRM_RX_RGB_SWAP_EN_V  0x00000001U
#define PPA_SRM_RX_RGB_SWAP_EN_S  1
/** PPA_SRM_MACRO_BK_RO_BYPASS : R/W; bitpos: [2]; default: 0;
...
#define PPA_SRM_MACRO_BK_RO_BYPASS_M  (PPA_SRM_MACRO_BK_RO_BYPASS_V << PPA_SRM_MACRO_BK_RO_BYPASS_S)
#define PPA_SRM_MACRO_BK_RO_BYPASS_V  0x00000001U
#define PPA_SRM_MACRO_BK_RO_BYPASS_S  2
/** PPA_SRM_BK_SIZE_SEL : R/W; bitpos: [3]; default: 0;
 *  sel srm pix_blk size, 0:32x32, 1:16x16
 */
#define PPA_SRM_BK_SIZE_SEL    (BIT(3))
#define PPA_SRM_BK_SIZE_SEL_M  (PPA_SRM_BK_SIZE_SEL_V << PPA_SRM_BK_SIZE_SEL_S)
#define PPA_SRM_BK_SIZE_SEL_V  0x00000001U
 ...
 *  Configures blend tx interface. 0: dma2d only, 1: le_enc only, 2: dma2d and ls_enc
 */
...
/** PPA_SRM_FIX_ALPHA_REG register
 *  Scaling and rotating engine alpha override register
 */
#define PPA_SRM_FIX_ALPHA_REG (DR_REG_PPA_BASE + 0x38)
/** PPA_SRM_RX_FIX_ALPHA : R/W; bitpos: [7:0]; default: 128;
 *  The value would replace the alpha value in received pixel for Scaling and Rotating
 *  engine when PPA_SRM_RX_ALPHA_CONF_EN is enabled.
 */
#define PPA_SRM_RX_FIX_ALPHA    0x000000FFU
#define PPA_SRM_RX_FIX_ALPHA_M  (PPA_SRM_RX_FIX_ALPHA_V << PPA_SRM_RX_FIX_ALPHA_S)
#define PPA_SRM_RX_FIX_ALPHA_V  0x000000FFU
#define PPA_SRM_RX_FIX_ALPHA_S  0
/** PPA_SRM_RX_ALPHA_MOD : R/W; bitpos: [9:8]; default: 0;
 *  Alpha mode. 0/3: not replace alpha. 1: replace alpha with PPA_SRM_FIX_ALPHA. 2:
 *  Original alpha multiply with PPA_SRM_FIX_ALPHA/256.
 */
#define PPA_SRM_RX_ALPHA_MOD    0x00000003U
#define PPA_SRM_RX_ALPHA_MOD_M  (PPA_SRM_RX_ALPHA_MOD_V << PPA_SRM_RX_ALPHA_MOD_S)
#define PPA_SRM_RX_ALPHA_MOD_V  0x00000003U
#define PPA_SRM_RX_ALPHA_MOD_S  8
/** PPA_SRM_RX_ALPHA_INV : R/W; bitpos: [10]; default: 0;
...
#define PPA_SRM_RX_ALPHA_INV_M  (PPA_SRM_RX_ALPHA_INV_V << PPA_SRM_RX_ALPHA_INV_S)
#define PPA_SRM_RX_ALPHA_INV_V  0x00000001U
...
/** PPA_SRM_MIRROR_X : R/W; bitpos: [28]; default: 0;
 *  Image mirror in X direction. 0: disable, 1: enable
 */
#define PPA_SRM_MIRROR_X    (BIT(28))
#define PPA_SRM_MIRROR_X_M  (PPA_SRM_MIRROR_X_V << PPA_SRM_MIRROR_X_S)
#define PPA_SRM_MIRROR_X_V  0x00000001U
#define PPA_SRM_MIRROR_X_S  28
/** PPA_SRM_MIRROR_Y : R/W; bitpos: [29]; default: 0;
 *  Image mirror in Y direction. 0: disable, 1: enable
 */
#define PPA_SRM_MIRROR_Y    (BIT(29))
#define PPA_SRM_MIRROR_Y_M  (PPA_SRM_MIRROR_Y_V << PPA_SRM_MIRROR_Y_S)
#define PPA_SRM_MIRROR_Y_V  0x00000001U
#define PPA_SRM_MIRROR_Y_S  29

/** PPA_SRM_MEM_PD_REG register
 *  SR memory power done register
 */
#define PPA_SRM_MEM_PD_REG (DR_REG_PPA_BASE + 0x68)
/** PPA_SRM_MEM_CLK_ENA : R/W; bitpos: [0]; default: 0;
 *  Set this bit to force clock enable of scaling and rotating engine's data memory.
 */
#define PPA_SRM_MEM_CLK_ENA    (BIT(0))
#define PPA_SRM_MEM_CLK_ENA_M  (PPA_SRM_MEM_CLK_ENA_V << PPA_SRM_MEM_CLK_ENA_S)
#define PPA_SRM_MEM_CLK_ENA_V  0x00000001U
#define PPA_SRM_MEM_CLK_ENA_S  0
/** PPA_SRM_MEM_FORCE_PD : R/W; bitpos: [1]; default: 0;
 *  Set this bit to force power down scaling and rotating engine's data memory.
 */
#define PPA_SRM_MEM_FORCE_PD    (BIT(1))
#define PPA_SRM_MEM_FORCE_PD_M  (PPA_SRM_MEM_FORCE_PD_V << PPA_SRM_MEM_FORCE_PD_S)
#define PPA_SRM_MEM_FORCE_PD_V  0x00000001U
#define PPA_SRM_MEM_FORCE_PD_S  1
/** PPA_SRM_MEM_FORCE_PU : R/W; bitpos: [2]; default: 0;
 *  Set this bit to force power up scaling and rotating engine's data memory.
 */
#define PPA_SRM_MEM_FORCE_PU    (BIT(2))
#define PPA_SRM_MEM_FORCE_PU_M  (PPA_SRM_MEM_FORCE_PU_V << PPA_SRM_MEM_FORCE_PU_S)
#define PPA_SRM_MEM_FORCE_PU_V  0x00000001U
...
/** PPA_SRM_PARAM_ERR_ST_REG register
 ...
 *  The error is that the PPA_SRM_SCAL_Y_INT and PPA_SRM_CAL_Y_FRAG both are 0.
 */
...
/** PPA_X_YUV_RX_SCALE_ERR_ST : RO; bitpos: [10]; default: 0;
 *  The error is that the ha/hb/x param in dma2d descriptor is an odd num when enable
 *  yuv422 or yuv420 rx
 */
#define PPA_X_YUV_RX_SCALE_ERR_ST    (BIT(10))
#define PPA_X_YUV_RX_SCALE_ERR_ST_M  (PPA_X_YUV_RX_SCALE_ERR_ST_V << PPA_X_YUV_RX_SCALE_ERR_ST_S)
#define PPA_X_YUV_RX_SCALE_ERR_ST_V  0x00000001U
#define PPA_X_YUV_RX_SCALE_ERR_ST_S  10
/** PPA_Y_YUV_RX_SCALE_ERR_ST : RO; bitpos: [11]; default: 0;
 *  The error is that the va/vb/y param in dma2d descriptor is an odd num when enable
 *  yuv420 rx
 */
#define PPA_Y_YUV_RX_SCALE_ERR_ST    (BIT(11))
#define PPA_Y_YUV_RX_SCALE_ERR_ST_M  (PPA_Y_YUV_RX_SCALE_ERR_ST_V << PPA_Y_YUV_RX_SCALE_ERR_ST_S)
#define PPA_Y_YUV_RX_SCALE_ERR_ST_V  0x00000001U
#define PPA_Y_YUV_RX_SCALE_ERR_ST_S  11
/** PPA_X_YUV_TX_SCALE_ERR_ST : RO; bitpos: [12]; default: 0;
 *  The error is that the ha/hb/x param in dma2d descriptor is an odd num when enable
 *  yuv422 or yuv420 tx
 */
#define PPA_X_YUV_TX_SCALE_ERR_ST    (BIT(12))
#define PPA_X_YUV_TX_SCALE_ERR_ST_M  (PPA_X_YUV_TX_SCALE_ERR_ST_V << PPA_X_YUV_TX_SCALE_ERR_ST_S)
#define PPA_X_YUV_TX_SCALE_ERR_ST_V  0x00000001U
#define PPA_X_YUV_TX_SCALE_ERR_ST_S  12
/** PPA_Y_YUV_TX_SCALE_ERR_ST : RO; bitpos: [13]; default: 0;
 *  The error is that the va/vb/y param in dma2d descriptor is an odd num when enable
 *  yuv420 tx
 */
#define PPA_Y_YUV_TX_SCALE_ERR_ST    (BIT(13))
#define PPA_Y_YUV_TX_SCALE_ERR_ST_M  (PPA_Y_YUV_TX_SCALE_ERR_ST_V << PPA_Y_YUV_TX_SCALE_ERR_ST_S)
#define PPA_Y_YUV_TX_SCALE_ERR_ST_V  0x00000001U
#define PPA_Y_YUV_TX_SCALE_ERR_ST_S  13

/** PPA_SRM_STATUS_REG register
 *  SR FSM register
 */
#define PPA_SRM_STATUS_REG (DR_REG_PPA_BASE + 0x7c)
/** PPA_SRM_RX_DSCR_SAMPLE_STATE : RO; bitpos: [1:0]; default: 0;
 *  Reserved.
 */
#define PPA_SRM_RX_DSCR_SAMPLE_STATE    0x00000003U
#define PPA_SRM_RX_DSCR_SAMPLE_STATE_M  (PPA_SRM_RX_DSCR_SAMPLE_STATE_V << PPA_SRM_RX_DSCR_SAMPLE_STATE_S)
#define PPA_SRM_RX_DSCR_SAMPLE_STATE_V  0x00000003U
#define PPA_SRM_RX_DSCR_SAMPLE_STATE_S  0
/** PPA_SRM_RX_SCAN_STATE : RO; bitpos: [3:2]; default: 0;
 *  Reserved.
 */
#define PPA_SRM_RX_SCAN_STATE    0x00000003U
#define PPA_SRM_RX_SCAN_STATE_M  (PPA_SRM_RX_SCAN_STATE_V << PPA_SRM_RX_SCAN_STATE_S)
#define PPA_SRM_RX_SCAN_STATE_V  0x00000003U
#define PPA_SRM_RX_SCAN_STATE_S  2
/** PPA_SRM_TX_DSCR_SAMPLE_STATE : RO; bitpos: [5:4]; default: 0;
 *  Reserved.
 */
#define PPA_SRM_TX_DSCR_SAMPLE_STATE    0x00000003U
#define PPA_SRM_TX_DSCR_SAMPLE_STATE_M  (PPA_SRM_TX_DSCR_SAMPLE_STATE_V << PPA_SRM_TX_DSCR_SAMPLE_STATE_S)
#define PPA_SRM_TX_DSCR_SAMPLE_STATE_V  0x00000003U
#define PPA_SRM_TX_DSCR_SAMPLE_STATE_S  4
/** PPA_SRM_TX_SCAN_STATE : RO; bitpos: [8:6]; default: 0;
 *  Reserved.
 */
#define PPA_SRM_TX_SCAN_STATE    0x00000007U
#define PPA_SRM_TX_SCAN_STATE_M  (PPA_SRM_TX_SCAN_STATE_V << PPA_SRM_TX_SCAN_STATE_S)
#define PPA_SRM_TX_SCAN_STATE_V  0x00000007U
