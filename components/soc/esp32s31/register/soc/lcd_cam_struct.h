...
typedef union {
    struct {
        ...
        /** lcd_conv_hor_pixel_num : R/W; bitpos: [15:5]; default: 0;
         *  the horizontal pixel number when rgb trans to yuv420
         */
        uint32_t lcd_conv_hor_pixel_num:11;
        /** lcd_conv_mem_clk_en : R/W; bitpos: [16]; default: 0;
         *  0:Open the clock gate for lcd convert memory.1: Close the clock gate for lcd
         *  convert memory
         */
        uint32_t lcd_conv_mem_clk_en:1;
        /** lcd_conv_8bits_data_inv : R/W; bitpos: [17]; default: 0;
         *  1:invert every two 8bits input data. 2. disabled.
         */
        uint32_t lcd_conv_8bits_data_inv:1;
        /** lcd_conv_txtorx : R/W; bitpos: [18]; default: 0;
         *  0: txtorx mode off. 1: txtorx mode on.
         */
        uint32_t lcd_conv_txtorx:1;
        /** lcd_conv_rgb_mode : R/W; bitpos: [19]; default: 0;
         *  0:rgb565.1:rgb888.Determine the rgb format yuv420 trans to.
         */
        uint32_t lcd_conv_rgb_mode:1;
        /** lcd_conv_rgb2rgb_mode : R/W; bitpos: [21:20]; default: 2;
...
typedef union {
    struct {
        ...
        /** lcd_rgb_mode_en : R/W; bitpos: [3]; default: 0;
...
/** Type of lcd_rgb_vertical register
 *  LCD config register.
 */
typedef union {
    struct {
        /** lcd_va_height : R/W; bitpos: [15:0]; default: 0;
         *  It is the vertical active height of a frame.
         */
        uint32_t lcd_va_height:16;
        /** lcd_vt_height : R/W; bitpos: [31:16]; default: 0;
         *  It is the vertical total height of a frame.
         */
        uint32_t lcd_vt_height:16;
    };
    uint32_t val;
} lcdcam_lcd_rgb_vertical_reg_t;

/** Type of lcd_rgb_horizontal register
 *  LCD config register.
 */
typedef union {
    struct {
        /** lcd_ha_width : R/W; bitpos: [15:0]; default: 0;
         *  It is the horizontal active width of a frame.
         */
        uint32_t lcd_ha_width:16;
        /** lcd_ht_width : R/W; bitpos: [31:16]; default: 0;
         *  It is the horizontal total width of a frame.
         */
        uint32_t lcd_ht_width:16;
    };
    uint32_t val;
} lcdcam_lcd_rgb_horizontal_reg_t;

/** Type of lcd_rgb_blank register
 *  LCD config register.
 */
typedef union {
    struct {
        /** lcd_hb_front : R/W; bitpos: [15:0]; default: 0;
         *  It is the horizontal blank front porch of a frame.
         */
        uint32_t lcd_hb_front:16;
        /** lcd_vb_front : R/W; bitpos: [31:16]; default: 0;
         *  It is the vertical blank front porch of a frame.
         */
        uint32_t lcd_vb_front:16;
    };
    uint32_t val;
} lcdcam_lcd_rgb_blank_reg_t;

/** Type of lcd_rgb_ctrl register
 *  LCD config register.
 */
typedef union {
    struct {
        /** lcd_vsync_width : R/W; bitpos: [9:0]; default: 1;
         *  It is the position of LCD_VSYNC active pulse in a line.
         */
        uint32_t lcd_vsync_width:10;
        /** lcd_vsync_idle_pol : R/W; bitpos: [10]; default: 0;
         *  It is the idle value of LCD_VSYNC.
         */
        uint32_t lcd_vsync_idle_pol:1;
        /** lcd_de_idle_pol : R/W; bitpos: [11]; default: 0;
         *  It is the idle value of LCD_DE.
         */
        uint32_t lcd_de_idle_pol:1;
        /** lcd_hs_blank_en : R/W; bitpos: [12]; default: 0;
...
/** Type of lcd_trans_buff_cfg register
 *  LCD trans buffer register
 */
typedef union {
    struct {
        /** lcd_trans_buffer_ena : R/W; bitpos: [0]; default: 0;
         *  1:enable lcd trans buffer.0:not enable lcd trans buffer
         */
        uint32_t lcd_trans_buffer_ena:1;
        uint32_t reserved_1:31;
    };
    uint32_t val;
} lcdcam_lcd_trans_buff_cfg_reg_t;
...
typedef union {
    struct {
        ...
        /** cam_conv_hor_pixel_num : R/W; bitpos: [20:10]; default: 0;
         *  the horizontal pixel number when rgb trans to yuv420
         */
        uint32_t cam_conv_hor_pixel_num:11;
...
/** Group: lcd status registers */
/** Type of lcd_data_dbg register
 *  LCDCAM LCD debug data register
 */
typedef union {
    struct {
        /** lcd_dbg_data_relpace_ena : R/W; bitpos: [0]; default: 0;
         *  1:replace the data read from dma.0:not replace the data read from dma
         */
        uint32_t lcd_dbg_data_relpace_ena:1;
        /** lcd_dbg_data : R/W; bitpos: [24:1]; default: 0;
         *  the debug data that used to replace data read from dma
         */
        uint32_t lcd_dbg_data:24;
        uint32_t reserved_25:7;
    };
    uint32_t val;
} lcdcam_lcd_data_dbg_reg_t;

/** Type of lcd_bw_monitor_dbg register
 *  LCDCAM LCD monitor bandwidth debug register
 */
typedef union {
    struct {
        /** lcd_bw_monitore_ena : R/W; bitpos: [0]; default: 0;
         *  1:enable lcd monitor bandwidth.0: not enable lcd monitor bandwidth
         */
        uint32_t lcd_bw_monitore_ena:1;
        /** lcd_invalid_rd_number : RO; bitpos: [31:1]; default: 0;
         *  the statistical data that lcd rd invalid data
         */
        uint32_t lcd_invalid_rd_number:31;
    };
    uint32_t val;
} lcdcam_lcd_bw_monitor_dbg_reg_t;


/** Group: cam status registers */
/** Type of cam_data_dbg register
 *  LCDCAM CAM debug data register
 */
typedef union {
    struct {
        /** cam_dbg_data_relpace_ena : R/W; bitpos: [0]; default: 0;
         *  1:replace the data write to dma.0:not replace the data write to  dma
         */
        uint32_t cam_dbg_data_relpace_ena:1;
        /** cam_dbg_data : R/W; bitpos: [24:1]; default: 0;
         *  the debug data that used to replace data write to dma
         */
        uint32_t cam_dbg_data:24;
        uint32_t reserved_25:7;
    };
    uint32_t val;
} lcdcam_cam_data_dbg_reg_t;
...
typedef union {
    struct {
        ...
        /** cam_overflow_int_ena : R/W; bitpos: [5]; default: 0;
         *  The enable bit for Camera overflow interrupt
         */
        uint32_t cam_overflow_int_ena:1;
...
typedef union {
    struct {
        ...
        /** cam_overflow_int_raw : RO/WTC/SS; bitpos: [5]; default: 0;
         *  The raw bit for Camera overflow interrupt
         */
        uint32_t cam_overflow_int_raw:1;
        uint32_t reserved_6:26;
    };
    uint32_t val;
...
typedef union {
    struct {
        ...
        /** cam_overflow_int_st : RO; bitpos: [5]; default: 0;
         *  The status bit for Camera overflow interrupt
         */
        uint32_t cam_overflow_int_st:1;
        uint32_t reserved_6:26;
    };
    uint32_t val;
...
typedef union {
    struct {
        ...
        /** cam_overflow_int_clr : WT; bitpos: [5]; default: 0;
         *  The clear bit for Camera overflow interrupt
         */
        uint32_t cam_overflow_int_clr:1;
        uint32_t reserved_6:26;
    };
    uint32_t val;
...
typedef union {
    struct {
        /** lc_date : R/W; bitpos: [27:0]; default: 38814224;
...
typedef struct {
    ...
    volatile lcdcam_lcd_rgb_vertical_reg_t lcd_rgb_vertical;
    volatile lcdcam_lcd_rgb_horizontal_reg_t lcd_rgb_horizontal;
    volatile lcdcam_lcd_rgb_blank_reg_t lcd_rgb_blank;
    volatile lcdcam_lcd_rgb_ctrl_reg_t lcd_rgb_ctrl;
    ...
    volatile lcdcam_lcd_trans_buff_cfg_reg_t lcd_trans_buff_cfg;
    volatile lcdcam_lcd_data_dbg_reg_t lcd_data_dbg;
    volatile lcdcam_lcd_bw_monitor_dbg_reg_t lcd_bw_monitor_dbg;
    volatile lcdcam_cam_data_dbg_reg_t cam_data_dbg;
