...
/** LCDCAM_CAM_CONV_HOR_PIXEL_NUM : R/W; bitpos: [20:10]; default: 0;
 *  the horizontal pixel number when rgb trans to yuv420
 */
#define LCDCAM_CAM_CONV_HOR_PIXEL_NUM    0x000007FFU
#define LCDCAM_CAM_CONV_HOR_PIXEL_NUM_M  (LCDCAM_CAM_CONV_HOR_PIXEL_NUM_V << LCDCAM_CAM_CONV_HOR_PIXEL_NUM_S)
#define LCDCAM_CAM_CONV_HOR_PIXEL_NUM_V  0x000007FFU
#define LCDCAM_CAM_CONV_HOR_PIXEL_NUM_S  10
 ...
 *  0: yuv422. 1: yuv420. 2: yuv411.The format that Data_in should be converted to.
 */
...
/** LCDCAM_LCD_CONV_HOR_PIXEL_NUM : R/W; bitpos: [15:5]; default: 0;
 *  the horizontal pixel number when rgb trans to yuv420
 */
#define LCDCAM_LCD_CONV_HOR_PIXEL_NUM    0x000007FFU
#define LCDCAM_LCD_CONV_HOR_PIXEL_NUM_M  (LCDCAM_LCD_CONV_HOR_PIXEL_NUM_V << LCDCAM_LCD_CONV_HOR_PIXEL_NUM_S)
#define LCDCAM_LCD_CONV_HOR_PIXEL_NUM_V  0x000007FFU
#define LCDCAM_LCD_CONV_HOR_PIXEL_NUM_S  5
/** LCDCAM_LCD_CONV_MEM_CLK_EN : R/W; bitpos: [16]; default: 0;
 *  0:Open the clock gate for lcd convert memory.1: Close the clock gate for lcd
 *  convert memory
 */
#define LCDCAM_LCD_CONV_MEM_CLK_EN    (BIT(16))
#define LCDCAM_LCD_CONV_MEM_CLK_EN_M  (LCDCAM_LCD_CONV_MEM_CLK_EN_V << LCDCAM_LCD_CONV_MEM_CLK_EN_S)
#define LCDCAM_LCD_CONV_MEM_CLK_EN_V  0x00000001U
#define LCDCAM_LCD_CONV_MEM_CLK_EN_S  16
/** LCDCAM_LCD_CONV_8BITS_DATA_INV : R/W; bitpos: [17]; default: 0;
 *  1:invert every two 8bits input data. 2. disabled.
 */
#define LCDCAM_LCD_CONV_8BITS_DATA_INV    (BIT(17))
...
#define LCDCAM_LCD_CONV_8BITS_DATA_INV_S  17
/** LCDCAM_LCD_CONV_TXTORX : R/W; bitpos: [18]; default: 0;
 *  0: txtorx mode off. 1: txtorx mode on.
 */
#define LCDCAM_LCD_CONV_TXTORX    (BIT(18))
...
#define LCDCAM_LCD_CONV_TXTORX_S  18
/** LCDCAM_LCD_CONV_RGB_MODE : R/W; bitpos: [19]; default: 0;
 *  0:rgb565.1:rgb888.Determine the rgb format yuv420 trans to.
 */
#define LCDCAM_LCD_CONV_RGB_MODE    (BIT(19))
#define LCDCAM_LCD_CONV_RGB_MODE_M  (LCDCAM_LCD_CONV_RGB_MODE_V << LCDCAM_LCD_CONV_RGB_MODE_S)
#define LCDCAM_LCD_CONV_RGB_MODE_V  0x00000001U
#define LCDCAM_LCD_CONV_RGB_MODE_S  19
/** LCDCAM_LCD_CONV_RGB2RGB_MODE : R/W; bitpos: [21:20]; default: 2;
 *  0: to rgb565. 1: to rgb888. Others: disabled.To enable rgb2rgb mode, trans_mode
 *  must be set to 0.
 */
...
#define LCDCAM_LCD_CONV_RGB2RGB_MODE_S  20
...
/** LCDCAM_LCD_RGB_MODE_EN : R/W; bitpos: [3]; default: 0;
 *  1: Enable LCD RGB mode. 0: Disable LCD RGB mode.
 */
#define LCDCAM_LCD_RGB_MODE_EN    (BIT(3))
...
#define LCDCAM_LCD_RGB_MODE_EN_S  3
...
/** LCDCAM_LCD_RGB_VERTICAL_REG register
 *  LCD config register.
 */
#define LCDCAM_LCD_RGB_VERTICAL_REG (DR_REG_LCDCAM_BASE + 0x1c)
/** LCDCAM_LCD_VA_HEIGHT : R/W; bitpos: [15:0]; default: 0;
 *  It is the vertical active height of a frame.
 */
#define LCDCAM_LCD_VA_HEIGHT    0x0000FFFFU
#define LCDCAM_LCD_VA_HEIGHT_M  (LCDCAM_LCD_VA_HEIGHT_V << LCDCAM_LCD_VA_HEIGHT_S)
#define LCDCAM_LCD_VA_HEIGHT_V  0x0000FFFFU
#define LCDCAM_LCD_VA_HEIGHT_S  0
/** LCDCAM_LCD_VT_HEIGHT : R/W; bitpos: [31:16]; default: 0;
 *  It is the vertical total height of a frame.
 */
#define LCDCAM_LCD_VT_HEIGHT    0x0000FFFFU
#define LCDCAM_LCD_VT_HEIGHT_M  (LCDCAM_LCD_VT_HEIGHT_V << LCDCAM_LCD_VT_HEIGHT_S)
#define LCDCAM_LCD_VT_HEIGHT_V  0x0000FFFFU
#define LCDCAM_LCD_VT_HEIGHT_S  16

/** LCDCAM_LCD_RGB_HORIZONTAL_REG register
 *  LCD config register.
 */
#define LCDCAM_LCD_RGB_HORIZONTAL_REG (DR_REG_LCDCAM_BASE + 0x20)
/** LCDCAM_LCD_HA_WIDTH : R/W; bitpos: [15:0]; default: 0;
 *  It is the horizontal active width of a frame.
 */
#define LCDCAM_LCD_HA_WIDTH    0x0000FFFFU
#define LCDCAM_LCD_HA_WIDTH_M  (LCDCAM_LCD_HA_WIDTH_V << LCDCAM_LCD_HA_WIDTH_S)
#define LCDCAM_LCD_HA_WIDTH_V  0x0000FFFFU
#define LCDCAM_LCD_HA_WIDTH_S  0
/** LCDCAM_LCD_HT_WIDTH : R/W; bitpos: [31:16]; default: 0;
 *  It is the horizontal total width of a frame.
 */
#define LCDCAM_LCD_HT_WIDTH    0x0000FFFFU
#define LCDCAM_LCD_HT_WIDTH_M  (LCDCAM_LCD_HT_WIDTH_V << LCDCAM_LCD_HT_WIDTH_S)
#define LCDCAM_LCD_HT_WIDTH_V  0x0000FFFFU
#define LCDCAM_LCD_HT_WIDTH_S  16

/** LCDCAM_LCD_RGB_BLANK_REG register
 *  LCD config register.
 */
#define LCDCAM_LCD_RGB_BLANK_REG (DR_REG_LCDCAM_BASE + 0x24)
/** LCDCAM_LCD_HB_FRONT : R/W; bitpos: [15:0]; default: 0;
 *  It is the horizontal blank front porch of a frame.
 */
#define LCDCAM_LCD_HB_FRONT    0x0000FFFFU
#define LCDCAM_LCD_HB_FRONT_M  (LCDCAM_LCD_HB_FRONT_V << LCDCAM_LCD_HB_FRONT_S)
#define LCDCAM_LCD_HB_FRONT_V  0x0000FFFFU
#define LCDCAM_LCD_HB_FRONT_S  0
/** LCDCAM_LCD_VB_FRONT : R/W; bitpos: [31:16]; default: 0;
 *  It is the vertical blank front porch of a frame.
 */
#define LCDCAM_LCD_VB_FRONT    0x0000FFFFU
#define LCDCAM_LCD_VB_FRONT_M  (LCDCAM_LCD_VB_FRONT_V << LCDCAM_LCD_VB_FRONT_S)
#define LCDCAM_LCD_VB_FRONT_V  0x0000FFFFU
#define LCDCAM_LCD_VB_FRONT_S  16

/** LCDCAM_LCD_RGB_CTRL_REG register
 *  LCD config register.
 */
#define LCDCAM_LCD_RGB_CTRL_REG (DR_REG_LCDCAM_BASE + 0x28)
/** LCDCAM_LCD_VSYNC_WIDTH : R/W; bitpos: [9:0]; default: 1;
 *  It is the position of LCD_VSYNC active pulse in a line.
 */
#define LCDCAM_LCD_VSYNC_WIDTH    0x000003FFU
#define LCDCAM_LCD_VSYNC_WIDTH_M  (LCDCAM_LCD_VSYNC_WIDTH_V << LCDCAM_LCD_VSYNC_WIDTH_S)
#define LCDCAM_LCD_VSYNC_WIDTH_V  0x000003FFU
#define LCDCAM_LCD_VSYNC_WIDTH_S  0
/** LCDCAM_LCD_VSYNC_IDLE_POL : R/W; bitpos: [10]; default: 0;
 *  It is the idle value of LCD_VSYNC.
 */
#define LCDCAM_LCD_VSYNC_IDLE_POL    (BIT(10))
...
#define LCDCAM_LCD_VSYNC_IDLE_POL_S  10
/** LCDCAM_LCD_DE_IDLE_POL : R/W; bitpos: [11]; default: 0;
 *  It is the idle value of LCD_DE.
 */
#define LCDCAM_LCD_DE_IDLE_POL    (BIT(11))
...
#define LCDCAM_LCD_DE_IDLE_POL_S  11
/** LCDCAM_LCD_HS_BLANK_EN : R/W; bitpos: [12]; default: 0;
 ...
 */
#define LCDCAM_LCD_HS_BLANK_EN    (BIT(12))
...
#define LCDCAM_LCD_HS_BLANK_EN_S  12
 ...
 *  LCD config register.
 */
#define LCDCAM_LCD_FIRST_CMD_VAL_REG (DR_REG_LCDCAM_BASE + 0x2c)
 ...
 *  LCD config register.
 */
#define LCDCAM_LCD_LATTER_CMD_VAL_REG (DR_REG_LCDCAM_BASE + 0x30)
 ...
 *  LCD config register.
 */
#define LCDCAM_LCD_DLY_MODE_CFG1_REG (DR_REG_LCDCAM_BASE + 0x34)
...
/** LCDCAM_LCD_TRANS_BUFF_CFG_REG register
 *  LCD trans buffer register
 */
#define LCDCAM_LCD_TRANS_BUFF_CFG_REG (DR_REG_LCDCAM_BASE + 0x3c)
/** LCDCAM_LCD_TRANS_BUFFER_ENA : R/W; bitpos: [0]; default: 0;
 *  1:enable lcd trans buffer.0:not enable lcd trans buffer
 */
#define LCDCAM_LCD_TRANS_BUFFER_ENA    (BIT(0))
#define LCDCAM_LCD_TRANS_BUFFER_ENA_M  (LCDCAM_LCD_TRANS_BUFFER_ENA_V << LCDCAM_LCD_TRANS_BUFFER_ENA_S)
#define LCDCAM_LCD_TRANS_BUFFER_ENA_V  0x00000001U
#define LCDCAM_LCD_TRANS_BUFFER_ENA_S  0

/** LCDCAM_LCD_DATA_DBG_REG register
 *  LCDCAM LCD debug data register
 */
#define LCDCAM_LCD_DATA_DBG_REG (DR_REG_LCDCAM_BASE + 0x40)
/** LCDCAM_LCD_DBG_DATA_RELPACE_ENA : R/W; bitpos: [0]; default: 0;
 *  1:replace the data read from dma.0:not replace the data read from dma
 */
#define LCDCAM_LCD_DBG_DATA_RELPACE_ENA    (BIT(0))
#define LCDCAM_LCD_DBG_DATA_RELPACE_ENA_M  (LCDCAM_LCD_DBG_DATA_RELPACE_ENA_V << LCDCAM_LCD_DBG_DATA_RELPACE_ENA_S)
#define LCDCAM_LCD_DBG_DATA_RELPACE_ENA_V  0x00000001U
#define LCDCAM_LCD_DBG_DATA_RELPACE_ENA_S  0
/** LCDCAM_LCD_DBG_DATA : R/W; bitpos: [24:1]; default: 0;
 *  the debug data that used to replace data read from dma
 */
#define LCDCAM_LCD_DBG_DATA    0x00FFFFFFU
#define LCDCAM_LCD_DBG_DATA_M  (LCDCAM_LCD_DBG_DATA_V << LCDCAM_LCD_DBG_DATA_S)
#define LCDCAM_LCD_DBG_DATA_V  0x00FFFFFFU
#define LCDCAM_LCD_DBG_DATA_S  1

/** LCDCAM_LCD_BW_MONITOR_DBG_REG register
 *  LCDCAM LCD monitor bandwidth debug register
 */
#define LCDCAM_LCD_BW_MONITOR_DBG_REG (DR_REG_LCDCAM_BASE + 0x44)
/** LCDCAM_LCD_BW_MONITORE_ENA : R/W; bitpos: [0]; default: 0;
 *  1:enable lcd monitor bandwidth.0: not enable lcd monitor bandwidth
 */
#define LCDCAM_LCD_BW_MONITORE_ENA    (BIT(0))
#define LCDCAM_LCD_BW_MONITORE_ENA_M  (LCDCAM_LCD_BW_MONITORE_ENA_V << LCDCAM_LCD_BW_MONITORE_ENA_S)
#define LCDCAM_LCD_BW_MONITORE_ENA_V  0x00000001U
#define LCDCAM_LCD_BW_MONITORE_ENA_S  0
/** LCDCAM_LCD_INVALID_RD_NUMBER : RO; bitpos: [31:1]; default: 0;
 *  the statistical data that lcd rd invalid data
 */
#define LCDCAM_LCD_INVALID_RD_NUMBER    0x7FFFFFFFU
#define LCDCAM_LCD_INVALID_RD_NUMBER_M  (LCDCAM_LCD_INVALID_RD_NUMBER_V << LCDCAM_LCD_INVALID_RD_NUMBER_S)
#define LCDCAM_LCD_INVALID_RD_NUMBER_V  0x7FFFFFFFU
#define LCDCAM_LCD_INVALID_RD_NUMBER_S  1

/** LCDCAM_CAM_DATA_DBG_REG register
 *  LCDCAM CAM debug data register
 */
#define LCDCAM_CAM_DATA_DBG_REG (DR_REG_LCDCAM_BASE + 0x48)
/** LCDCAM_CAM_DBG_DATA_RELPACE_ENA : R/W; bitpos: [0]; default: 0;
 *  1:replace the data write to dma.0:not replace the data write to  dma
 */
#define LCDCAM_CAM_DBG_DATA_RELPACE_ENA    (BIT(0))
#define LCDCAM_CAM_DBG_DATA_RELPACE_ENA_M  (LCDCAM_CAM_DBG_DATA_RELPACE_ENA_V << LCDCAM_CAM_DBG_DATA_RELPACE_ENA_S)
#define LCDCAM_CAM_DBG_DATA_RELPACE_ENA_V  0x00000001U
#define LCDCAM_CAM_DBG_DATA_RELPACE_ENA_S  0
/** LCDCAM_CAM_DBG_DATA : R/W; bitpos: [24:1]; default: 0;
 *  the debug data that used to replace data write to dma
 */
#define LCDCAM_CAM_DBG_DATA    0x00FFFFFFU
#define LCDCAM_CAM_DBG_DATA_M  (LCDCAM_CAM_DBG_DATA_V << LCDCAM_CAM_DBG_DATA_S)
#define LCDCAM_CAM_DBG_DATA_V  0x00FFFFFFU
#define LCDCAM_CAM_DBG_DATA_S  1
...
/** LCDCAM_CAM_OVERFLOW_INT_ENA : R/W; bitpos: [5]; default: 0;
 *  The enable bit for Camera overflow interrupt
 */
#define LCDCAM_CAM_OVERFLOW_INT_ENA    (BIT(5))
#define LCDCAM_CAM_OVERFLOW_INT_ENA_M  (LCDCAM_CAM_OVERFLOW_INT_ENA_V << LCDCAM_CAM_OVERFLOW_INT_ENA_S)
#define LCDCAM_CAM_OVERFLOW_INT_ENA_V  0x00000001U
#define LCDCAM_CAM_OVERFLOW_INT_ENA_S  5
...
/** LCDCAM_CAM_OVERFLOW_INT_RAW : RO/WTC/SS; bitpos: [5]; default: 0;
 *  The raw bit for Camera overflow interrupt
 */
#define LCDCAM_CAM_OVERFLOW_INT_RAW    (BIT(5))
#define LCDCAM_CAM_OVERFLOW_INT_RAW_M  (LCDCAM_CAM_OVERFLOW_INT_RAW_V << LCDCAM_CAM_OVERFLOW_INT_RAW_S)
#define LCDCAM_CAM_OVERFLOW_INT_RAW_V  0x00000001U
#define LCDCAM_CAM_OVERFLOW_INT_RAW_S  5
...
/** LCDCAM_CAM_OVERFLOW_INT_ST : RO; bitpos: [5]; default: 0;
 *  The status bit for Camera overflow interrupt
 */
#define LCDCAM_CAM_OVERFLOW_INT_ST    (BIT(5))
#define LCDCAM_CAM_OVERFLOW_INT_ST_M  (LCDCAM_CAM_OVERFLOW_INT_ST_V << LCDCAM_CAM_OVERFLOW_INT_ST_S)
#define LCDCAM_CAM_OVERFLOW_INT_ST_V  0x00000001U
#define LCDCAM_CAM_OVERFLOW_INT_ST_S  5
...
/** LCDCAM_CAM_OVERFLOW_INT_CLR : WT; bitpos: [5]; default: 0;
 *  The clear bit for Camera overflow interrupt
 */
#define LCDCAM_CAM_OVERFLOW_INT_CLR    (BIT(5))
#define LCDCAM_CAM_OVERFLOW_INT_CLR_M  (LCDCAM_CAM_OVERFLOW_INT_CLR_V << LCDCAM_CAM_OVERFLOW_INT_CLR_S)
#define LCDCAM_CAM_OVERFLOW_INT_CLR_V  0x00000001U
#define LCDCAM_CAM_OVERFLOW_INT_CLR_S  5

/** LCDCAM_LC_REG_DATE_REG register
 *  Version register
 */
#define LCDCAM_LC_REG_DATE_REG (DR_REG_LCDCAM_BASE + 0xfc)
/** LCDCAM_LC_DATE : R/W; bitpos: [27:0]; default: 38814224;
