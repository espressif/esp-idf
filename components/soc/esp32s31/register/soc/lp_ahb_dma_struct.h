...
typedef union {
    struct {
        /** ahb_apb_sync_clk_en : R/W; bitpos: [1:0]; default: 3;
        ...
        /** out_dscr_clk_en : R/W; bitpos: [6:5]; default: 3;
        ...
        /** out_ctrl_clk_en : R/W; bitpos: [11:10]; default: 3;
        ...
        /** in_dscr_clk_en : R/W; bitpos: [16:15]; default: 3;
        ...
        /** in_ctrl_clk_en : R/W; bitpos: [21:20]; default: 3;
...
typedef union {
    struct {
        /** date : R/W; bitpos: [31:0]; default: 38818352;
         *  Version control register.
         */
        uint32_t date:32;
    };
...
typedef union {
    struct {
        ...
        /** ahbinf_resp_err_ch_id : RO; bitpos: [7:6]; default: 0;
