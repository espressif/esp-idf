...
#define I2C_SARADC_SAR1_INIT_CODE_LSB      0x0
#define I2C_SARADC_SAR1_INIT_CODE_LSB_MSB  0x7
#define I2C_SARADC_SAR1_INIT_CODE_LSB_LSB  0x0

#define I2C_SARADC_SAR1_INIT_CODE_MSB      0x1
#define I2C_SARADC_SAR1_INIT_CODE_MSB_MSB  0x3
#define I2C_SARADC_SAR1_INIT_CODE_MSB_LSB  0x0
...
#define POWER_GLITCH_MODE_VDET_PERIF        10
#define POWER_GLITCH_MODE_VDET_PERIF_MSB    4
#define POWER_GLITCH_MODE_VDET_PERIF_LSB    4

#define POWER_GLITCH_MODE_VDET_VDDPST       10
#define POWER_GLITCH_MODE_VDET_VDDPST_MSB   5
#define POWER_GLITCH_MODE_VDET_VDDPST_LSB   5

#define POWER_GLITCH_MODE_VDET_PLLBB        10
#define POWER_GLITCH_MODE_VDET_PLLBB_MSB    6
#define POWER_GLITCH_MODE_VDET_PLLBB_LSB    6

#define POWER_GLITCH_MODE_VDET_PLL          10
#define POWER_GLITCH_MODE_VDET_PLL_MSB      7
#define POWER_GLITCH_MODE_VDET_PLL_LSB      7
