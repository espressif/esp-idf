...
typedef enum periph_retention_module {
    ...
    SLEEP_RETENTION_MODULE_WIFI_MAC     = 44,
    SLEEP_RETENTION_MODULE_WIFI_BB      = 45,
    SLEEP_RETENTION_MODULE_BLE_MAC      = 46,
    SLEEP_RETENTION_MODULE_BT_BB        = 47,
    SLEEP_RETENTION_MODULE_802154_MAC   = 48,
    SLEEP_RETENTION_MODULE_CLOCK_MODEM  = 49,
    SLEEP_RETENTION_MODULE_MODEM_PHY    = 50,
