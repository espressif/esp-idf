...
typedef enum periph_retention_module {
    ...
    SLEEP_RETENTION_MODULE_LP_AHB_DMA_CH0 = 18,
    SLEEP_RETENTION_MODULE_LP_AHB_DMA_CH1 = 19,
    /* MISC Peripherals */
    SLEEP_RETENTION_MODULE_UART0        = 20,
    SLEEP_RETENTION_MODULE_UART1        = 21,
    SLEEP_RETENTION_MODULE_UART2        = 22,
    SLEEP_RETENTION_MODULE_UART3        = 23,
    SLEEP_RETENTION_MODULE_RMT0         = 24,
    SLEEP_RETENTION_MODULE_I2S0         = 25,
    SLEEP_RETENTION_MODULE_I2S1         = 26,
    SLEEP_RETENTION_MODULE_I2C0         = 27,
    SLEEP_RETENTION_MODULE_I2C1         = 28,
    SLEEP_RETENTION_MODULE_ETM0         = 29,
    SLEEP_RETENTION_MODULE_TWAI0        = 30,
    SLEEP_RETENTION_MODULE_TWAI1        = 31,
    SLEEP_RETENTION_MODULE_PARLIO0      = 32,
    SLEEP_RETENTION_MODULE_GPSPI2       = 33,
    SLEEP_RETENTION_MODULE_GPSPI3       = 34,
    SLEEP_RETENTION_MODULE_LEDC0        = 35,
    SLEEP_RETENTION_MODULE_LEDC1        = 36,
    SLEEP_RETENTION_MODULE_MCPWM0       = 37,
    SLEEP_RETENTION_MODULE_MCPWM1       = 38,
    SLEEP_RETENTION_MODULE_MCPWM2       = 39,
    SLEEP_RETENTION_MODULE_MCPWM3       = 40,
    SLEEP_RETENTION_MODULE_SDM0         = 41,
    SLEEP_RETENTION_MODULE_LCDCAM       = 42,
    SLEEP_RETENTION_MODULE_JPEG         = 43,
    SLEEP_RETENTION_MODULE_DMA2D        = 44,
    SLEEP_RETENTION_MODULE_PPA          = 45,

    /* Modem module, which includes WiFi, BLE and 802.15.4 */
    SLEEP_RETENTION_MODULE_WIFI_MAC     = 46,
    SLEEP_RETENTION_MODULE_WIFI_BB      = 47,
    SLEEP_RETENTION_MODULE_BLE_MAC      = 48,
    SLEEP_RETENTION_MODULE_BT_BB        = 49,
    SLEEP_RETENTION_MODULE_802154_MAC   = 50,
    SLEEP_RETENTION_MODULE_CLOCK_MODEM  = 51,
    SLEEP_RETENTION_MODULE_MODEM_PHY    = 52,
    SLEEP_RETENTION_MODULE_PHY_FE       = 53,
