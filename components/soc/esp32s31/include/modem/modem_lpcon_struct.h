...
typedef volatile struct {
    ...
    union {
        struct {
            ...
            uint32_t cfr_mem_mode              :    3;
            uint32_t cfr_mem_force             :    1;
            uint32_t reserved28                    :    1;
            uint32_t reserved29                    :    1;
            uint32_t reserved30                    :    1;
            uint32_t reserved31                    :    1;
    ...
    union {
        struct {
            uint32_t wifi_mac_intr_wakeup_en   :    1;
            uint32_t wifi_mac_nmi_wakeup_en    :    1;
            uint32_t wifi_pwr_intr_wakeup_en   :    1;
            uint32_t wifi_bb_intr_wakeup_en    :    1;
            uint32_t bt_mac_intr_wakeup_en     :    1;
            uint32_t bt_bb_intr_wakeup_en      :    1;
            uint32_t bt_bb_nmi_wakeup_en       :    1;
            uint32_t lp_timer_intr_wakeup_en   :    1;
            uint32_t coex_intr_wakeup_en       :    1;
            uint32_t ble_timer_intr_wakeup_en  :    1;
            uint32_t ble_sec_intr_wakeup_en    :    1;
            uint32_t i2c_mst_intr_wakeup_en    :    1;
            uint32_t zb_mac_intr_wakeup_en     :    1;
            uint32_t bt_mac_int1_wakeup_en     :    1;
...
#ifndef __cplusplus
_Static_assert(sizeof(modem_lpcon_dev_t) == 0x5c, "Invalid size of modem_lpcon_dev_t structure");
#endif
