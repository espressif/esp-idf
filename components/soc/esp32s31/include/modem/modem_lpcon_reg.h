...
/* MODEM_LPCON_CFR_MEM_FORCE : R/W ;bitpos:[27] ;default: 1'b1 ; */
/*description: .*/
#define MODEM_LPCON_CFR_MEM_FORCE    (BIT(27))
#define MODEM_LPCON_CFR_MEM_FORCE_M  (BIT(27))
#define MODEM_LPCON_CFR_MEM_FORCE_V  0x1
#define MODEM_LPCON_CFR_MEM_FORCE_S  27
/* MODEM_LPCON_CFR_MEM_MODE : R/W ;bitpos:[26:24] ;default: 3'b0 ; */
/*description: .*/
#define MODEM_LPCON_CFR_MEM_MODE    0x00000007
#define MODEM_LPCON_CFR_MEM_MODE_M  ((MODEM_LPCON_CFR_MEM_MODE_V)<<(MODEM_LPCON_CFR_MEM_MODE_S))
#define MODEM_LPCON_CFR_MEM_MODE_V  0x7
#define MODEM_LPCON_CFR_MEM_MODE_S  24
...
/* MODEM_LPCON_PWR_MEM_BASE : R/W ;bitpos:[19:4] ;default: 16'b0 ; */
/*description: .*/
#define MODEM_LPCON_PWR_MEM_BASE    0x0000FFFF
#define MODEM_LPCON_PWR_MEM_BASE_M  ((MODEM_LPCON_PWR_MEM_BASE_V)<<(MODEM_LPCON_PWR_MEM_BASE_S))
#define MODEM_LPCON_PWR_MEM_BASE_V  0xFFFF
#define MODEM_LPCON_PWR_MEM_BASE_S  4
/* MODEM_LPCON_CFR_MEM_EN : R/W ;bitpos:[3] ;default: 1'b0 ; */
/*description: .*/
#define MODEM_LPCON_CFR_MEM_EN    (BIT(3))
#define MODEM_LPCON_CFR_MEM_EN_M  (BIT(3))
#define MODEM_LPCON_CFR_MEM_EN_V  0x1
#define MODEM_LPCON_CFR_MEM_EN_S  3
...
/* MODEM_LPCON_PBUS_MEM_EN : R/W ;bitpos:[1] ;default: 1'b0 ; */
/*description: .*/
...
#define MODEM_LPCON_MODEM_INTR_WAKEUP_CONF_REG          (DR_REG_MODEM_LPCON_BASE + 0x4C)
/* MODEM_LPCON_BT_MAC_INT1_WAKEUP_EN : R/W ;bitpos:[13] ;default: 1'b1 ; */
/*description: .*/
#define MODEM_LPCON_BT_MAC_INT1_WAKEUP_EN    (BIT(13))
#define MODEM_LPCON_BT_MAC_INT1_WAKEUP_EN_M  (BIT(13))
#define MODEM_LPCON_BT_MAC_INT1_WAKEUP_EN_V  0x1
#define MODEM_LPCON_BT_MAC_INT1_WAKEUP_EN_S  13
/* MODEM_LPCON_ZB_MAC_INTR_WAKEUP_EN : R/W ;bitpos:[12] ;default: 1'b1 ; */
/*description: .*/
#define MODEM_LPCON_ZB_MAC_INTR_WAKEUP_EN    (BIT(12))
#define MODEM_LPCON_ZB_MAC_INTR_WAKEUP_EN_M  (BIT(12))
#define MODEM_LPCON_ZB_MAC_INTR_WAKEUP_EN_V  0x1
#define MODEM_LPCON_ZB_MAC_INTR_WAKEUP_EN_S  12
/* MODEM_LPCON_I2C_MST_INTR_WAKEUP_EN : R/W ;bitpos:[11] ;default: 1'b1 ; */
/*description: .*/
#define MODEM_LPCON_I2C_MST_INTR_WAKEUP_EN    (BIT(11))
#define MODEM_LPCON_I2C_MST_INTR_WAKEUP_EN_M  (BIT(11))
#define MODEM_LPCON_I2C_MST_INTR_WAKEUP_EN_V  0x1
#define MODEM_LPCON_I2C_MST_INTR_WAKEUP_EN_S  11
/* MODEM_LPCON_BLE_SEC_INTR_WAKEUP_EN : R/W ;bitpos:[10] ;default: 1'b1 ; */
/*description: .*/
#define MODEM_LPCON_BLE_SEC_INTR_WAKEUP_EN    (BIT(10))
#define MODEM_LPCON_BLE_SEC_INTR_WAKEUP_EN_M  (BIT(10))
#define MODEM_LPCON_BLE_SEC_INTR_WAKEUP_EN_V  0x1
#define MODEM_LPCON_BLE_SEC_INTR_WAKEUP_EN_S  10
/* MODEM_LPCON_BLE_TIMER_INTR_WAKEUP_EN : R/W ;bitpos:[9] ;default: 1'b1 ; */
/*description: .*/
#define MODEM_LPCON_BLE_TIMER_INTR_WAKEUP_EN    (BIT(9))
#define MODEM_LPCON_BLE_TIMER_INTR_WAKEUP_EN_M  (BIT(9))
#define MODEM_LPCON_BLE_TIMER_INTR_WAKEUP_EN_V  0x1
#define MODEM_LPCON_BLE_TIMER_INTR_WAKEUP_EN_S  9
/* MODEM_LPCON_COEX_INTR_WAKEUP_EN : R/W ;bitpos:[8] ;default: 1'b1 ; */
/*description: .*/
#define MODEM_LPCON_COEX_INTR_WAKEUP_EN    (BIT(8))
#define MODEM_LPCON_COEX_INTR_WAKEUP_EN_M  (BIT(8))
#define MODEM_LPCON_COEX_INTR_WAKEUP_EN_V  0x1
#define MODEM_LPCON_COEX_INTR_WAKEUP_EN_S  8
/* MODEM_LPCON_LP_TIMER_INTR_WAKEUP_EN : R/W ;bitpos:[7] ;default: 1'b1 ; */
/*description: .*/
#define MODEM_LPCON_LP_TIMER_INTR_WAKEUP_EN    (BIT(7))
#define MODEM_LPCON_LP_TIMER_INTR_WAKEUP_EN_M  (BIT(7))
#define MODEM_LPCON_LP_TIMER_INTR_WAKEUP_EN_V  0x1
#define MODEM_LPCON_LP_TIMER_INTR_WAKEUP_EN_S  7
/* MODEM_LPCON_BT_BB_NMI_WAKEUP_EN : R/W ;bitpos:[6] ;default: 1'b1 ; */
/*description: .*/
#define MODEM_LPCON_BT_BB_NMI_WAKEUP_EN    (BIT(6))
#define MODEM_LPCON_BT_BB_NMI_WAKEUP_EN_M  (BIT(6))
#define MODEM_LPCON_BT_BB_NMI_WAKEUP_EN_V  0x1
#define MODEM_LPCON_BT_BB_NMI_WAKEUP_EN_S  6
/* MODEM_LPCON_BT_BB_INTR_WAKEUP_EN : R/W ;bitpos:[5] ;default: 1'b1 ; */
/*description: .*/
#define MODEM_LPCON_BT_BB_INTR_WAKEUP_EN    (BIT(5))
#define MODEM_LPCON_BT_BB_INTR_WAKEUP_EN_M  (BIT(5))
#define MODEM_LPCON_BT_BB_INTR_WAKEUP_EN_V  0x1
#define MODEM_LPCON_BT_BB_INTR_WAKEUP_EN_S  5
/* MODEM_LPCON_BT_MAC_INTR_WAKEUP_EN : R/W ;bitpos:[4] ;default: 1'b1 ; */
/*description: .*/
#define MODEM_LPCON_BT_MAC_INTR_WAKEUP_EN    (BIT(4))
#define MODEM_LPCON_BT_MAC_INTR_WAKEUP_EN_M  (BIT(4))
#define MODEM_LPCON_BT_MAC_INTR_WAKEUP_EN_V  0x1
#define MODEM_LPCON_BT_MAC_INTR_WAKEUP_EN_S  4
/* MODEM_LPCON_WIFI_BB_INTR_WAKEUP_EN : R/W ;bitpos:[3] ;default: 1'b1 ; */
/*description: .*/
#define MODEM_LPCON_WIFI_BB_INTR_WAKEUP_EN    (BIT(3))
#define MODEM_LPCON_WIFI_BB_INTR_WAKEUP_EN_M  (BIT(3))
#define MODEM_LPCON_WIFI_BB_INTR_WAKEUP_EN_V  0x1
#define MODEM_LPCON_WIFI_BB_INTR_WAKEUP_EN_S  3
/* MODEM_LPCON_WIFI_PWR_INTR_WAKEUP_EN : R/W ;bitpos:[2] ;default: 1'b1 ; */
/*description: .*/
#define MODEM_LPCON_WIFI_PWR_INTR_WAKEUP_EN    (BIT(2))
#define MODEM_LPCON_WIFI_PWR_INTR_WAKEUP_EN_M  (BIT(2))
#define MODEM_LPCON_WIFI_PWR_INTR_WAKEUP_EN_V  0x1
#define MODEM_LPCON_WIFI_PWR_INTR_WAKEUP_EN_S  2
/* MODEM_LPCON_WIFI_MAC_NMI_WAKEUP_EN : R/W ;bitpos:[1] ;default: 1'b1 ; */
/*description: .*/
#define MODEM_LPCON_WIFI_MAC_NMI_WAKEUP_EN    (BIT(1))
#define MODEM_LPCON_WIFI_MAC_NMI_WAKEUP_EN_M  (BIT(1))
#define MODEM_LPCON_WIFI_MAC_NMI_WAKEUP_EN_V  0x1
#define MODEM_LPCON_WIFI_MAC_NMI_WAKEUP_EN_S  1
/* MODEM_LPCON_WIFI_MAC_INTR_WAKEUP_EN : R/W ;bitpos:[0] ;default: 1'b1 ; */
/*description: .*/
#define MODEM_LPCON_WIFI_MAC_INTR_WAKEUP_EN    (BIT(0))
#define MODEM_LPCON_WIFI_MAC_INTR_WAKEUP_EN_M  (BIT(0))
#define MODEM_LPCON_WIFI_MAC_INTR_WAKEUP_EN_V  0x1
#define MODEM_LPCON_WIFI_MAC_INTR_WAKEUP_EN_S  0

#define MODEM_LPCON_MODEM_INTR_STATUS_REG          (DR_REG_MODEM_LPCON_BASE + 0x50)
/* MODEM_LPCON_MODEM_INTR_VECTOR : RO ;bitpos:[13:0] ;default: 14'h0 ; */
/*description: .*/
#define MODEM_LPCON_MODEM_INTR_VECTOR    0x00003FFF
#define MODEM_LPCON_MODEM_INTR_VECTOR_M  ((MODEM_LPCON_MODEM_INTR_VECTOR_V)<<(MODEM_LPCON_MODEM_INTR_VECTOR_S))
#define MODEM_LPCON_MODEM_INTR_VECTOR_V  0x3FFF
#define MODEM_LPCON_MODEM_INTR_VECTOR_S  0

#define MODEM_LPCON_MEM_CONF2_REG          (DR_REG_MODEM_LPCON_BASE + 0x54)
/* MODEM_LPCON_PWR_MEM_MODE_SEL : R/W ;bitpos:[3:0] ;default: 4'b0100 ; */
/*description: .*/
#define MODEM_LPCON_PWR_MEM_MODE_SEL    0x0000000F
#define MODEM_LPCON_PWR_MEM_MODE_SEL_M  ((MODEM_LPCON_PWR_MEM_MODE_SEL_V)<<(MODEM_LPCON_PWR_MEM_MODE_SEL_S))
#define MODEM_LPCON_PWR_MEM_MODE_SEL_V  0xF
#define MODEM_LPCON_PWR_MEM_MODE_SEL_S  0

#define MODEM_LPCON_DATE_REG          (DR_REG_MODEM_LPCON_BASE + 0x58)
/* MODEM_LPCON_DATE : R/W ;bitpos:[27:0] ;default: 28'h2508150 ; */
/*description: .*/
