...
typedef union {
    ...
    uint32_t val;
} lp_i2c_ana_mst_i2c1_ctrl_reg_t;
...
typedef union {
    ...
    uint32_t val;
} lp_i2c_ana_mst_i2c1_conf_reg_t;
...
typedef union {
    ...
    uint32_t val;
} lp_i2c_ana_mst_i2c_burst_conf_reg_t;
...
typedef union {
    ...
    uint32_t val;
} lp_i2c_ana_mst_i2c_burst_status_reg_t;
...
typedef union {
    ...
    uint32_t val;
} lp_i2c_ana_mst_ana_conf0_reg_t;
...
typedef union {
    ...
    uint32_t val;
} lp_i2c_ana_mst_ana_conf2_reg_t;
...
typedef union {
    ...
    uint32_t val;
} lp_i2c_ana_mst_i2c0_ctrl1_reg_t;
...
typedef union {
    ...
    uint32_t val;
} lp_i2c_ana_mst_i2c1_ctrl1_reg_t;
...
typedef union {
    ...
    uint32_t val;
} lp_i2c_ana_mst_hw_i2c_ctrl_reg_t;
...
typedef struct lp_i2c_ana_mst_dev_t {
    ...
    volatile lp_i2c_ana_mst_i2c1_ctrl_reg_t i2c1_ctrl;
    volatile lp_i2c_ana_mst_i2c0_conf_reg_t i2c0_conf;
    volatile lp_i2c_ana_mst_i2c1_conf_reg_t i2c1_conf;
    volatile lp_i2c_ana_mst_i2c_burst_conf_reg_t i2c_burst_conf;
    volatile lp_i2c_ana_mst_i2c_burst_status_reg_t i2c_burst_status;
    volatile lp_i2c_ana_mst_ana_conf0_reg_t ana_conf0;
    volatile lp_i2c_ana_mst_ana_conf1_reg_t ana_conf1;
    volatile lp_i2c_ana_mst_ana_conf2_reg_t ana_conf2;
    volatile lp_i2c_ana_mst_i2c0_ctrl1_reg_t i2c0_ctrl1;
    volatile lp_i2c_ana_mst_i2c1_ctrl1_reg_t i2c1_ctrl1;
    volatile lp_i2c_ana_mst_hw_i2c_ctrl_reg_t hw_i2c_ctrl;
    volatile lp_i2c_ana_mst_nouse_reg_t nouse;
    volatile lp_i2c_ana_mst_clk160m_reg_t clk160m;
...
#ifndef __cplusplus
_Static_assert(sizeof(lp_i2c_ana_mst_dev_t) == 0x3c, "Invalid size of lp_i2c_ana_mst_dev_t structure");
#endif
