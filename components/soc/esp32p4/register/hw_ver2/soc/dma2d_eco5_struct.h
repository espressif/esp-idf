...
typedef union {
    struct {
        ...
        /** out_arb_priority_h_chn : R/W; bitpos: [7:6]; default: 0;
         *  Set the priority of channel
         */
        uint32_t out_arb_priority_h_chn:2;
...
typedef union {
    struct {
        ...
        /** in_arb_priority_h_chn : R/W; bitpos: [7:5]; default: 0;
         *  Set the priority of channel
         */
        uint32_t in_arb_priority_h_chn:3;
        uint32_t reserved_8:24;
    };
    uint32_t val;
 ...
 *  Configures the rx color convert parameter of channel n
 */
typedef union {
    struct {
...
typedef struct {
    ...
    volatile dma2d_in_ro_pd_conf_chn_reg_t in_ro_pd_conf_ch1;
    volatile dma2d_in_color_convert_chn_reg_t in_color_convert_ch1;
    volatile dma2d_in_scramble_chn_reg_t in_scramble_ch1;
    volatile dma2d_in_color_param0_chn_reg_t in_color_param0_ch1;
    volatile dma2d_in_color_param1_chn_reg_t in_color_param1_ch1;
    volatile dma2d_in_color_param2_chn_reg_t in_color_param2_ch1;
    volatile dma2d_in_color_param3_chn_reg_t in_color_param3_ch1;
    volatile dma2d_in_color_param4_chn_reg_t in_color_param4_ch1;
    volatile dma2d_in_color_param5_chn_reg_t in_color_param5_ch1;
    ...
    volatile dma2d_in_ro_pd_conf_chn_reg_t in_ro_pd_conf_ch2;
    volatile dma2d_in_color_convert_chn_reg_t in_color_convert_ch2;
    volatile dma2d_in_scramble_chn_reg_t in_scramble_ch2;
    volatile dma2d_in_color_param0_chn_reg_t in_color_param0_ch2;
    volatile dma2d_in_color_param1_chn_reg_t in_color_param1_ch2;
    volatile dma2d_in_color_param2_chn_reg_t in_color_param2_ch2;
    volatile dma2d_in_color_param3_chn_reg_t in_color_param3_ch2;
    volatile dma2d_in_color_param4_chn_reg_t in_color_param4_ch2;
    volatile dma2d_in_color_param5_chn_reg_t in_color_param5_ch2;
