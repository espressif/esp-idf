...
/** HP_SYS_CLKRST_REG_USB_OTG11_SYS_CLK_EN : R/W; bitpos: [15]; default: 0;
 *  Reserved
 */
...
/** HP_SYS_CLKRST_REG_L2CACHE_L2MEM_CLK_EN : R/W; bitpos: [4]; default: 1;
 *  Reserved
 */
#define HP_SYS_CLKRST_REG_L2CACHE_L2MEM_CLK_EN    (BIT(4))
#define HP_SYS_CLKRST_REG_L2CACHE_L2MEM_CLK_EN_M  (HP_SYS_CLKRST_REG_L2CACHE_L2MEM_CLK_EN_V << HP_SYS_CLKRST_REG_L2CACHE_L2MEM_CLK_EN_S)
#define HP_SYS_CLKRST_REG_L2CACHE_L2MEM_CLK_EN_V  0x00000001U
#define HP_SYS_CLKRST_REG_L2CACHE_L2MEM_CLK_EN_S  4
...
/** HP_SYS_CLKRST_REG_MIPI_DSI_DPHY_PLL_REFCLK_SRC_SEL : R/W; bitpos: [18:16]; default:
 *  0;
 *  Reserved
 */
#define HP_SYS_CLKRST_REG_MIPI_DSI_DPHY_PLL_REFCLK_SRC_SEL    0x00000007U
#define HP_SYS_CLKRST_REG_MIPI_DSI_DPHY_PLL_REFCLK_SRC_SEL_M  (HP_SYS_CLKRST_REG_MIPI_DSI_DPHY_PLL_REFCLK_SRC_SEL_V << HP_SYS_CLKRST_REG_MIPI_DSI_DPHY_PLL_REFCLK_SRC_SEL_S)
#define HP_SYS_CLKRST_REG_MIPI_DSI_DPHY_PLL_REFCLK_SRC_SEL_V  0x00000007U
#define HP_SYS_CLKRST_REG_MIPI_DSI_DPHY_PLL_REFCLK_SRC_SEL_S  16
/** HP_SYS_CLKRST_REG_MIPI_DSI_DPHY_PLL_REFCLK_DIV_NUM : R/W; bitpos: [26:19]; default:
 *  1;
 *  Reserved
 */
#define HP_SYS_CLKRST_REG_MIPI_DSI_DPHY_PLL_REFCLK_DIV_NUM    0x000000FFU
#define HP_SYS_CLKRST_REG_MIPI_DSI_DPHY_PLL_REFCLK_DIV_NUM_M  (HP_SYS_CLKRST_REG_MIPI_DSI_DPHY_PLL_REFCLK_DIV_NUM_V << HP_SYS_CLKRST_REG_MIPI_DSI_DPHY_PLL_REFCLK_DIV_NUM_S)
#define HP_SYS_CLKRST_REG_MIPI_DSI_DPHY_PLL_REFCLK_DIV_NUM_V  0x000000FFU
#define HP_SYS_CLKRST_REG_MIPI_DSI_DPHY_PLL_REFCLK_DIV_NUM_S  19
...
/** HP_SYS_CLKRST_REG_L2CACHE_L2MEM_CLK_FORCE_ON : R/W; bitpos: [18]; default: 1;
 *  Reserved
 */
#define HP_SYS_CLKRST_REG_L2CACHE_L2MEM_CLK_FORCE_ON    (BIT(18))
#define HP_SYS_CLKRST_REG_L2CACHE_L2MEM_CLK_FORCE_ON_M  (HP_SYS_CLKRST_REG_L2CACHE_L2MEM_CLK_FORCE_ON_V << HP_SYS_CLKRST_REG_L2CACHE_L2MEM_CLK_FORCE_ON_S)
#define HP_SYS_CLKRST_REG_L2CACHE_L2MEM_CLK_FORCE_ON_V  0x00000001U
#define HP_SYS_CLKRST_REG_L2CACHE_L2MEM_CLK_FORCE_ON_S  18
...
/** HP_SYS_CLKRST_AXI_PERF_MON_CLKRST_CTRL0_REG register
 *  Reserved
 */
#define HP_SYS_CLKRST_AXI_PERF_MON_CLKRST_CTRL0_REG (DR_REG_HP_SYS_CLKRST_BASE + 0xf0)
/** HP_SYS_CLKRST_REG_AXI_PERF_MON_SYS_CLK_EN : R/W; bitpos: [0]; default: 0;
 *  Configures axi_perf_mon clk enable
 */
#define HP_SYS_CLKRST_REG_AXI_PERF_MON_SYS_CLK_EN    (BIT(0))
#define HP_SYS_CLKRST_REG_AXI_PERF_MON_SYS_CLK_EN_M  (HP_SYS_CLKRST_REG_AXI_PERF_MON_SYS_CLK_EN_V << HP_SYS_CLKRST_REG_AXI_PERF_MON_SYS_CLK_EN_S)
#define HP_SYS_CLKRST_REG_AXI_PERF_MON_SYS_CLK_EN_V  0x00000001U
#define HP_SYS_CLKRST_REG_AXI_PERF_MON_SYS_CLK_EN_S  0
/** HP_SYS_CLKRST_REG_AXI_PERF_MON_SYS_RST_EN : R/W; bitpos: [1]; default: 0;
 *  Configures axi_perf_mon rst enable
 */
#define HP_SYS_CLKRST_REG_AXI_PERF_MON_SYS_RST_EN    (BIT(1))
#define HP_SYS_CLKRST_REG_AXI_PERF_MON_SYS_RST_EN_M  (HP_SYS_CLKRST_REG_AXI_PERF_MON_SYS_RST_EN_V << HP_SYS_CLKRST_REG_AXI_PERF_MON_SYS_RST_EN_S)
#define HP_SYS_CLKRST_REG_AXI_PERF_MON_SYS_RST_EN_V  0x00000001U
#define HP_SYS_CLKRST_REG_AXI_PERF_MON_SYS_RST_EN_S  1

/** HP_SYS_CLKRST_CPU_WAITI_CTRL0_REG register
 *  Reserved
 */
#define HP_SYS_CLKRST_CPU_WAITI_CTRL0_REG (DR_REG_HP_SYS_CLKRST_BASE + 0xf4)
/** HP_SYS_CLKRST_REG_CORE0_WAITI_ICG_EN : R/W; bitpos: [0]; default: 1;
 ...
 *  related clock
 */
#define HP_SYS_CLKRST_REG_CORE0_WAITI_ICG_EN    (BIT(0))
#define HP_SYS_CLKRST_REG_CORE0_WAITI_ICG_EN_M  (HP_SYS_CLKRST_REG_CORE0_WAITI_ICG_EN_V << HP_SYS_CLKRST_REG_CORE0_WAITI_ICG_EN_S)
#define HP_SYS_CLKRST_REG_CORE0_WAITI_ICG_EN_V  0x00000001U
#define HP_SYS_CLKRST_REG_CORE0_WAITI_ICG_EN_S  0
/** HP_SYS_CLKRST_REG_CORE1_WAITI_ICG_EN : R/W; bitpos: [1]; default: 1;
 *  Configures whether cpu core1 waiti signal can control clock gate. If both core0 and
 *  core1 waiti_icg_en is 1, then only when core0 and core1 all in waiti will close
 *  related clock
 */
#define HP_SYS_CLKRST_REG_CORE1_WAITI_ICG_EN    (BIT(1))
#define HP_SYS_CLKRST_REG_CORE1_WAITI_ICG_EN_M  (HP_SYS_CLKRST_REG_CORE1_WAITI_ICG_EN_V << HP_SYS_CLKRST_REG_CORE1_WAITI_ICG_EN_S)
#define HP_SYS_CLKRST_REG_CORE1_WAITI_ICG_EN_V  0x00000001U
#define HP_SYS_CLKRST_REG_CORE1_WAITI_ICG_EN_S  1
