...
typedef union {
    struct {
        ...
        /** rd_reserve_0_80 : RW; bitpos: [16]; default: 0;
         *  Reserved, it was created by set_missed_fields_in_regs func
         */
        uint32_t rd_reserve_0_80:1;
...
typedef union {
    struct {
        ...
        /** rd_reserve_0_114 : RW; bitpos: [18]; default: 0;
         *  Reserved, it was created by set_missed_fields_in_regs func
         */
        uint32_t rd_reserve_0_114:1;
        ...
        /** rd_reserve_0_120 : RW; bitpos: [25:24]; default: 0;
         *  Reserved, it was created by set_missed_fields_in_regs func
         */
        uint32_t rd_reserve_0_120:2;
...
typedef union {
    struct {
        ...
        /** rd_reserve_0_163 : RW; bitpos: [3]; default: 0;
         *  Reserved, it was created by set_missed_fields_in_regs func
         */
        uint32_t rd_reserve_0_163:1;
        /** key_purpose_5_h : RO; bitpos: [4]; default: 0;
         *  Purpose of Key5. The 5-th bit.
         */
        uint32_t key_purpose_5_h:1;
        /** rd_reserve_0_165 : RW; bitpos: [6:5]; default: 0;
         *  Reserved, it was created by set_missed_fields_in_regs func
         */
        uint32_t rd_reserve_0_165:2;
        ...
        /** rd_reserve_0_172 : RW; bitpos: [15:12]; default: 0;
         *  Reserved, it was created by set_missed_fields_in_regs func
         */
        uint32_t rd_reserve_0_172:4;
...
typedef union {
    struct {
        ...
        /** reserved_1_152 : R; bitpos: [27:24]; default: 0;
         *  reserved
         */
        uint32_t reserved_1_152:4;
...
typedef union {
    struct {
        ...
        /** reserved_1_170 : R; bitpos: [10]; default: 0;
         *  reserved
         */
        uint32_t reserved_1_170:1;
        /** pvt_400m_bias : R; bitpos: [15:11]; default: 0;
         *  PVT_DCM_VSET when the CPU is at 400M
         */
        uint32_t pvt_400m_bias:5;
        /** pvt_40m_bias : R; bitpos: [20:16]; default: 0;
         *  PVT_DCM_VSET corresponding to about 0.9V fixed voltage when the CPU is at 40M
         */
        uint32_t pvt_40m_bias:5;
        /** pvt_100m_bias : R; bitpos: [25:21]; default: 0;
         *  PVT_DCM_VSET corresponding to about 1.0V fixed voltage when the CPU is at 100M
         */
        uint32_t pvt_100m_bias:5;
...
typedef union {
    struct {
        /** temperature_sensor : R; bitpos: [9:0]; default: 0;
         *  Temperature calibration data
         */
        uint32_t temperature_sensor:10;
        /** reserved_10_106 : R; bitpos: [31:10]; default: 0;
         *  reserved
         */
        uint32_t reserved_10_106:22;
    };
    uint32_t val;
...
typedef union {
    struct {
        ...
        /** pvt_pump_limit : RO; bitpos: [23:16]; default: 0;
         *  Use to configure voltage monitor limit for charge pump
         */
        uint32_t pvt_pump_limit:8;
        /** pvt_cell_select : RO; bitpos: [30:24]; default: 0;
         *  Power glitch monitor PVT cell select.
         */
        uint32_t pvt_cell_select:7;
        /** rd_reserve_10_223 : RW; bitpos: [31]; default: 0;
         *  Reserved, it was created by set_missed_fields_in_regs func
         */
        uint32_t rd_reserve_10_223:1;
    };
    uint32_t val;
