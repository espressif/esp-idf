...
typedef union {
    struct {
        /** serial_jtag_rnd_eco_low_48 : R/W; bitpos: [31:0]; default: 0;
         *  Reserved.
         */
        uint32_t serial_jtag_rnd_eco_low_48:32;
    };
    uint32_t val;
...
typedef union {
    struct {
        /** serial_jtag_rnd_eco_high_48 : R/W; bitpos: [31:0]; default: 4294967295;
         *  Reserved.
         */
        uint32_t serial_jtag_rnd_eco_high_48:32;
    };
    uint32_t val;
...
typedef union {
    struct {
        /** serial_jtag_rnd_eco_low_apb : R/W; bitpos: [31:0]; default: 0;
         *  Reserved.
         */
        uint32_t serial_jtag_rnd_eco_low_apb:32;
    };
    uint32_t val;
...
typedef union {
    struct {
        /** serial_jtag_rnd_eco_high_apb : R/W; bitpos: [31:0]; default: 4294967295;
         *  Reserved.
         */
        uint32_t serial_jtag_rnd_eco_high_apb:32;
    };
    uint32_t val;
...
typedef union {
    struct {
        /** serial_jtag_mem_aux_ctrl : R/W; bitpos: [13:0]; default: 4896;
         *  Control signals
         */
        uint32_t serial_jtag_mem_aux_ctrl:14;
...
typedef union {
    struct {
        /** serial_jtag_rdn_result_48 : RO; bitpos: [0]; default: 0;
         *  Reserved.
         */
        uint32_t serial_jtag_rdn_result_48:1;
        /** serial_jtag_rdn_ena_48 : R/W; bitpos: [1]; default: 0;
         *  Reserved.
         */
        uint32_t serial_jtag_rdn_ena_48:1;
        uint32_t reserved_2:30;
    };
    uint32_t val;
...
typedef union {
    struct {
        /** serial_jtag_rdn_result_apb : RO; bitpos: [0]; default: 0;
         *  Reserved.
         */
        uint32_t serial_jtag_rdn_result_apb:1;
        /** serial_jtag_rdn_ena_apb : R/W; bitpos: [1]; default: 0;
         *  Reserved.
         */
        uint32_t serial_jtag_rdn_ena_apb:1;
        uint32_t reserved_2:30;
    };
    uint32_t val;
...
typedef union {
    struct {
        /** serial_jtag_date : R/W; bitpos: [31:0]; default: 34676752;
         *  register version.
         */
