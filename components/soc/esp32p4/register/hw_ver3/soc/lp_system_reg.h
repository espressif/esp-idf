...
/** LP_SYSTEM_REG_LP_SYSTEM_VER_DATE_REG register
 *  need_des
 */
#define LP_SYSTEM_REG_LP_SYSTEM_VER_DATE_REG (DR_REG_LP_SYS_BASE + 0x0)
/** LP_SYSTEM_REG_VER_DATE : R/W; bitpos: [31:0]; default: 539296276;
 *  need_des
 */
...
/** LP_SYSTEM_REG_USBOTG20_LS_MODE : R/W; bitpos: [4]; default: 0;
 *  indicate current mode of usb otg2.0.
 */
#define LP_SYSTEM_REG_USBOTG20_LS_MODE    (BIT(4))
#define LP_SYSTEM_REG_USBOTG20_LS_MODE_M  (LP_SYSTEM_REG_USBOTG20_LS_MODE_V << LP_SYSTEM_REG_USBOTG20_LS_MODE_S)
#define LP_SYSTEM_REG_USBOTG20_LS_MODE_V  0x00000001U
#define LP_SYSTEM_REG_USBOTG20_LS_MODE_S  4
...
/** LP_SYSTEM_REG_PAD_RTC_HOLD_CTRL0_REG register
 *  enable pad hold ctrl
 */
#define LP_SYSTEM_REG_PAD_RTC_HOLD_CTRL0_REG (DR_REG_LP_SYS_BASE + 0x1c4)
/** LP_SYSTEM_REG_PAD_RTC_HOLD_CTRL0 : R/W; bitpos: [31:0]; default: 0;
 *  Set 1 to hold pad 0-31 status
 */
#define LP_SYSTEM_REG_PAD_RTC_HOLD_CTRL0    0xFFFFFFFFU
#define LP_SYSTEM_REG_PAD_RTC_HOLD_CTRL0_M  (LP_SYSTEM_REG_PAD_RTC_HOLD_CTRL0_V << LP_SYSTEM_REG_PAD_RTC_HOLD_CTRL0_S)
#define LP_SYSTEM_REG_PAD_RTC_HOLD_CTRL0_V  0xFFFFFFFFU
#define LP_SYSTEM_REG_PAD_RTC_HOLD_CTRL0_S  0

/** LP_SYSTEM_REG_PAD_RTC_HOLD_CTRL1_REG register
 *  enable pad hold ctrl
 */
#define LP_SYSTEM_REG_PAD_RTC_HOLD_CTRL1_REG (DR_REG_LP_SYS_BASE + 0x1c8)
/** LP_SYSTEM_REG_PAD_RTC_HOLD_CTRL1 : R/W; bitpos: [24:0]; default: 0;
 *  Set 1 to hold pad 32-56 status
 */
#define LP_SYSTEM_REG_PAD_RTC_HOLD_CTRL1    0x01FFFFFFU
#define LP_SYSTEM_REG_PAD_RTC_HOLD_CTRL1_M  (LP_SYSTEM_REG_PAD_RTC_HOLD_CTRL1_V << LP_SYSTEM_REG_PAD_RTC_HOLD_CTRL1_S)
#define LP_SYSTEM_REG_PAD_RTC_HOLD_CTRL1_V  0x01FFFFFFU
#define LP_SYSTEM_REG_PAD_RTC_HOLD_CTRL1_S  0

/** LP_SYSTEM_REG_DED_PAD_RTC_HOLD_CTRL_REG register
 *  enable pad hold ctrl
 */
#define LP_SYSTEM_REG_DED_PAD_RTC_HOLD_CTRL_REG (DR_REG_LP_SYS_BASE + 0x1cc)
/** LP_SYSTEM_REG_DED_PAD_RTC_HOLD_CTRL : R/W; bitpos: [25:0]; default: 0;
 *  Set bit0-5 to hold flash pad status. Set bit6-25 to hold psram pad status.
 */
#define LP_SYSTEM_REG_DED_PAD_RTC_HOLD_CTRL    0x03FFFFFFU
#define LP_SYSTEM_REG_DED_PAD_RTC_HOLD_CTRL_M  (LP_SYSTEM_REG_DED_PAD_RTC_HOLD_CTRL_V << LP_SYSTEM_REG_DED_PAD_RTC_HOLD_CTRL_S)
#define LP_SYSTEM_REG_DED_PAD_RTC_HOLD_CTRL_V  0x03FFFFFFU
#define LP_SYSTEM_REG_DED_PAD_RTC_HOLD_CTRL_S  0

/** LP_SYSTEM_REG_DISCHARGE_REG register
 *  pufmem / ldo flash power discharge control
 */
#define LP_SYSTEM_REG_DISCHARGE_REG (DR_REG_LP_SYS_BASE + 0x200)
/** LP_SYSTEM_REG_LDO_FLASH_DISCHARGE : R/W; bitpos: [0]; default: 0;
 *  Set this bit to discharge ldo flash.
 */
#define LP_SYSTEM_REG_LDO_FLASH_DISCHARGE    (BIT(0))
#define LP_SYSTEM_REG_LDO_FLASH_DISCHARGE_M  (LP_SYSTEM_REG_LDO_FLASH_DISCHARGE_V << LP_SYSTEM_REG_LDO_FLASH_DISCHARGE_S)
#define LP_SYSTEM_REG_LDO_FLASH_DISCHARGE_V  0x00000001U
#define LP_SYSTEM_REG_LDO_FLASH_DISCHARGE_S  0
/** LP_SYSTEM_REG_LP_PUF_MEM_ISO_EN : R/W; bitpos: [1]; default: 0;
 *  Set this bit to discharge lp puf mem.
 */
#define LP_SYSTEM_REG_LP_PUF_MEM_ISO_EN    (BIT(1))
#define LP_SYSTEM_REG_LP_PUF_MEM_ISO_EN_M  (LP_SYSTEM_REG_LP_PUF_MEM_ISO_EN_V << LP_SYSTEM_REG_LP_PUF_MEM_ISO_EN_S)
#define LP_SYSTEM_REG_LP_PUF_MEM_ISO_EN_V  0x00000001U
#define LP_SYSTEM_REG_LP_PUF_MEM_ISO_EN_S  1
/** LP_SYSTEM_REG_LP_PUF_MEM_XPD : R/W; bitpos: [2]; default: 1;
 *  Set this bit to discharge lp puf mem.
 */
#define LP_SYSTEM_REG_LP_PUF_MEM_XPD    (BIT(2))
#define LP_SYSTEM_REG_LP_PUF_MEM_XPD_M  (LP_SYSTEM_REG_LP_PUF_MEM_XPD_V << LP_SYSTEM_REG_LP_PUF_MEM_XPD_S)
#define LP_SYSTEM_REG_LP_PUF_MEM_XPD_V  0x00000001U
#define LP_SYSTEM_REG_LP_PUF_MEM_XPD_S  2
/** LP_SYSTEM_REG_LP_PUF_MEM_DISCHARGE : R/W; bitpos: [3]; default: 0;
 *  Set this bit to discharge lp puf mem.
 */
#define LP_SYSTEM_REG_LP_PUF_MEM_DISCHARGE    (BIT(3))
#define LP_SYSTEM_REG_LP_PUF_MEM_DISCHARGE_M  (LP_SYSTEM_REG_LP_PUF_MEM_DISCHARGE_V << LP_SYSTEM_REG_LP_PUF_MEM_DISCHARGE_S)
#define LP_SYSTEM_REG_LP_PUF_MEM_DISCHARGE_V  0x00000001U
#define LP_SYSTEM_REG_LP_PUF_MEM_DISCHARGE_S  3

/** LP_SYSTEM_REG_HP_USB_OTGHS_PHY_CTRL_REG register
 *  Usb otg2.0 PHY control register
 */
#define LP_SYSTEM_REG_HP_USB_OTGHS_PHY_CTRL_REG (DR_REG_LP_SYS_BASE + 0x204)
/** LP_SYSTEM_REG_HP_UTMIOTG_IDPULLUP : R/W; bitpos: [0]; default: 1;
 *  Set this bit to pull up USB OTG2.0 PHY id
 */
#define LP_SYSTEM_REG_HP_UTMIOTG_IDPULLUP    (BIT(0))
#define LP_SYSTEM_REG_HP_UTMIOTG_IDPULLUP_M  (LP_SYSTEM_REG_HP_UTMIOTG_IDPULLUP_V << LP_SYSTEM_REG_HP_UTMIOTG_IDPULLUP_S)
#define LP_SYSTEM_REG_HP_UTMIOTG_IDPULLUP_V  0x00000001U
#define LP_SYSTEM_REG_HP_UTMIOTG_IDPULLUP_S  0
/** LP_SYSTEM_REG_HP_UTMIOTG_DPPULLDOWN : R/W; bitpos: [1]; default: 1;
 *  Set this bit to pull down USB OTG2.0 PHY dp
 */
#define LP_SYSTEM_REG_HP_UTMIOTG_DPPULLDOWN    (BIT(1))
#define LP_SYSTEM_REG_HP_UTMIOTG_DPPULLDOWN_M  (LP_SYSTEM_REG_HP_UTMIOTG_DPPULLDOWN_V << LP_SYSTEM_REG_HP_UTMIOTG_DPPULLDOWN_S)
#define LP_SYSTEM_REG_HP_UTMIOTG_DPPULLDOWN_V  0x00000001U
#define LP_SYSTEM_REG_HP_UTMIOTG_DPPULLDOWN_S  1
/** LP_SYSTEM_REG_HP_UTMIOTG_DMPULLDOWN : R/W; bitpos: [2]; default: 1;
 *  Set this bit to pull down USB OTG2.0 PHY dm
 */
#define LP_SYSTEM_REG_HP_UTMIOTG_DMPULLDOWN    (BIT(2))
#define LP_SYSTEM_REG_HP_UTMIOTG_DMPULLDOWN_M  (LP_SYSTEM_REG_HP_UTMIOTG_DMPULLDOWN_V << LP_SYSTEM_REG_HP_UTMIOTG_DMPULLDOWN_S)
#define LP_SYSTEM_REG_HP_UTMIOTG_DMPULLDOWN_V  0x00000001U
#define LP_SYSTEM_REG_HP_UTMIOTG_DMPULLDOWN_S  2
/** LP_SYSTEM_REG_HP_UTMISRP_CHRGVBUS : R/W; bitpos: [3]; default: 0;
 *  Set this bit to charge USB OTG2.0 PHY vbus
 */
#define LP_SYSTEM_REG_HP_UTMISRP_CHRGVBUS    (BIT(3))
#define LP_SYSTEM_REG_HP_UTMISRP_CHRGVBUS_M  (LP_SYSTEM_REG_HP_UTMISRP_CHRGVBUS_V << LP_SYSTEM_REG_HP_UTMISRP_CHRGVBUS_S)
#define LP_SYSTEM_REG_HP_UTMISRP_CHRGVBUS_V  0x00000001U
#define LP_SYSTEM_REG_HP_UTMISRP_CHRGVBUS_S  3
/** LP_SYSTEM_REG_HP_UTMISRP_DISCHRGVBUS : R/W; bitpos: [4]; default: 0;
 *  Set this bit to discharge USB OTG2.0 PHY vbus
 */
#define LP_SYSTEM_REG_HP_UTMISRP_DISCHRGVBUS    (BIT(4))
#define LP_SYSTEM_REG_HP_UTMISRP_DISCHRGVBUS_M  (LP_SYSTEM_REG_HP_UTMISRP_DISCHRGVBUS_V << LP_SYSTEM_REG_HP_UTMISRP_DISCHRGVBUS_S)
#define LP_SYSTEM_REG_HP_UTMISRP_DISCHRGVBUS_V  0x00000001U
#define LP_SYSTEM_REG_HP_UTMISRP_DISCHRGVBUS_S  4
