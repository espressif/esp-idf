...
typedef union {
    struct {
        ...
        /** l2_cache_preload_mode : R/W; bitpos: [7]; default: 0;
...
typedef union {
    struct {
        /** date : R/W; bitpos: [27:0]; default: 38810192;
