...
/** GPIO_BIST_MODE : R/W; bitpos: [2]; default: 0;
 *  Set 1 to enable sdio pad ddr200 bist mode
 */
#define GPIO_BIST_MODE    (BIT(2))
#define GPIO_BIST_MODE_M  (GPIO_BIST_MODE_V << GPIO_BIST_MODE_S)
#define GPIO_BIST_MODE_V  0x00000001U
#define GPIO_BIST_MODE_S  2

/** GPIO_DATE_REG register
 *  GPIO version register
 */
#define GPIO_DATE_REG (DR_REG_GPIO_BASE + 0x7fc)
/** GPIO_DATE : R/W; bitpos: [27:0]; default: 2363942;
 *  version register
 */
