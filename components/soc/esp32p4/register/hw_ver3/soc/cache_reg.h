 ...
 *  The bit is used to configure the mode of l1 icache0 preload, 0: load data from next
 *  level memory, 1: not load data from next level memory.
 */
 ...
 *  The bit is used to configure the mode of l1 icache1 preload, 0: load data from next
 *  level memory, 1: not load data from next level memory.
 */
 ...
 *  The bit is used to configure the mode of l1 icache2 preload, 0: load data from next
 *  level memory, 1: not load data from next level memory.
 */
 ...
 *  The bit is used to configure the mode of l1 icache3 preload, 0: load data from next
 *  level memory, 1: not load data from next level memory.
 */
 ...
 *  The bit is used to configure the mode of l1 dcache preload, 0: load data from next
 *  level memory, 1: not load data from next level memory.
 */
...
/** CACHE_L2_CACHE_CACHESIZE_128K : R/W; bitpos: [9]; default: 1;
...
/** CACHE_L2_CACHE_CACHESIZE_256K : R/W; bitpos: [10]; default: 0;
...
/** CACHE_L2_CACHE_PRELOAD_MODE : R/W; bitpos: [7]; default: 0;
 *  The bit is used to configure the mode of l2 cache preload, 0: load data from next
 *  level memory, 1: not load data from next level memory.
 */
...
/** CACHE_DATE : R/W; bitpos: [27:0]; default: 38810192;
