...
typedef union {
    struct {
        /** axi_req_en : R/W; bitpos: [0]; default: 0;
        ...
        /** cache_flash_usr_cmd : R/W; bitpos: [2]; default: 0;
...
typedef union {
    struct {
        ...
        uint32_t reserved_24:7;
        /** sclk_equ_sysclk : HRO; bitpos: [31]; default: 0;
...
typedef union {
    struct {
        ...
        /** sram_addr_bitlen : HRO; bitpos: [19:14]; default: 23;
        ...
        /** cache_sram_usr_wcmd : HRO; bitpos: [20]; default: 1;
         *  For SPI0, In the external RAM mode cache write sram for user define command
         *  This field is only for internal debugging purposes. Do not use it in applications.
         */
        uint32_t cache_sram_usr_wcmd:1;
        /** sram_oct : HRO; bitpos: [21]; default: 0;
         *  reserved
         *  This field is only for internal debugging purposes. Do not use it in applications.
         */
        uint32_t sram_oct:1;
        /** sram_wdummy_cyclelen : HRO; bitpos: [27:22]; default: 1;
...
typedef union {
    struct {
        /** sclk_mode : HRO; bitpos: [1:0]; default: 0;
         *  SPI clock mode bits. 0: SPI clock is off when CS inactive 1: SPI clock is delayed
         *  one cycle after CS inactive 2: SPI clock is delayed two cycles after CS inactive 3:
         *  SPI clock is always on.
         *  This field is only for internal debugging purposes. Do not use it in applications.
        ...
        /** sdout_dual : HRO; bitpos: [11]; default: 0;
        ...
        /** saddr_dual : HRO; bitpos: [12]; default: 0;
        ...
        /** sdin_quad : HRO; bitpos: [14]; default: 0;
        ...
        /** sdout_quad : HRO; bitpos: [15]; default: 0;
        ...
        /** saddr_quad : HRO; bitpos: [16]; default: 0;
        ...
        /** sdummy_wout : HRO; bitpos: [23]; default: 0;
...
/** Type of sram_drd_cmd register
 *  SPI0 external RAM DDR read command control register
 */
typedef union {
    struct {
        /** cache_sram_usr_rd_cmd_value : HRO; bitpos: [15:0]; default: 0;
        ...
        uint32_t reserved_16:12;
        /** cache_sram_usr_rd_cmd_bitlen : HRO; bitpos: [31:28]; default: 0;
...
/** Type of sram_dwr_cmd register
 *  SPI0 external RAM DDR write command control register
 */
typedef union {
    struct {
        /** cache_sram_usr_wr_cmd_value : HRO; bitpos: [15:0]; default: 0;
        ...
        uint32_t reserved_16:12;
        /** cache_sram_usr_wr_cmd_bitlen : HRO; bitpos: [31:28]; default: 0;
...
typedef union {
    struct {
        ...
        uint32_t reserved_10:16;
        /** rx_trans_ovf_int_ena : HRO; bitpos: [26]; default: 0;
         *  The enable bit for SPI_MEM_C_RX_TRANS_OVF_INT interrupt.
         */
        uint32_t rx_trans_ovf_int_ena:1;
        /** tx_trans_udf_int_ena : HRO; bitpos: [27]; default: 0;
         *  The enable bit for SPI_MEM_C_TX_TRANS_UDF_INT interrupt.
         */
        uint32_t tx_trans_udf_int_ena:1;
        uint32_t reserved_28:4;
    };
    uint32_t val;
...
typedef union {
    struct {
        ...
        uint32_t reserved_10:16;
        /** rx_trans_ovf_int_clr : HRO; bitpos: [26]; default: 0;
         *  The clear bit for SPI_MEM_C_RX_TRANS_OVF_INT interrupt.
         */
        uint32_t rx_trans_ovf_int_clr:1;
        /** tx_trans_udf_int_clr : HRO; bitpos: [27]; default: 0;
         *  The clear bit for SPI_MEM_C_TX_TRANS_UDF_INT interrupt.
         */
        uint32_t tx_trans_udf_int_clr:1;
        uint32_t reserved_28:4;
    };
    uint32_t val;
...
typedef union {
    struct {
         ...
         *  SPI_MEM_C_fmem_ECC_ERR_INT_EN is set and  SPI_MEM_C_SMEM_ECC_ERR_INT_EN is
         *  cleared, this bit is triggered when the error times of SPI0/1 ECC read flash are
         *  equal or bigger than SPI_MEM_C_ECC_ERR_INT_NUM. When SPI_MEM_C_fmem_ECC_ERR_INT_EN
         ...
         *  SPI_MEM_C_ECC_ERR_INT_NUM. When SPI_MEM_C_fmem_ECC_ERR_INT_EN and
...
typedef union {
    struct {
        ...
        uint32_t reserved_10:16;
        /** rx_trans_ovf_int_st : HRO; bitpos: [26]; default: 0;
         *  The status bit for  SPI_MEM_C_RX_TRANS_OVF_INT interrupt.
         */
        uint32_t rx_trans_ovf_int_st:1;
        /** tx_trans_udf_int_st : HRO; bitpos: [27]; default: 0;
         *  The status bit for SPI_MEM_C_TX_TRANS_UDF_INT interrupt.
         */
        uint32_t tx_trans_udf_int_st:1;
        uint32_t reserved_28:4;
    };
    uint32_t val;
...
/** Type of dll_dly_db register
 *  MSPI DLL function and debug configuration register
 */
typedef union {
    struct {
        /** dll_db_cfg_vld_cnt : HRO; bitpos: [7:0]; default: 0;
         *  Configures the end time of the debug window.
         */
        uint32_t dll_db_cfg_vld_cnt:8;
        /** dll_db_cnt_mode_sel : HRO; bitpos: [11:8]; default: 0;
...
/** Type of dll_db_st0 register
 *  MSPI DLL debug status0 register
 */
typedef union {
    struct {
        /** db_fifo_cnt_h : RO; bitpos: [31:0]; default: 0;
         ...
         */
        uint32_t db_fifo_cnt_h:32;
    };
    uint32_t val;
} spi_mem_c_dll_db_st0_reg_t;

/** Type of dll_db_st1 register
 *  MSPI DLL debug status1 register
 */
typedef union {
    struct {
        /** db_fifo_cnt_l : RO; bitpos: [31:0]; default: 0;
         *  Debug  for DLL FIFO pointer. Use a 64bits shift register to record pointer changes
         *  during the debug window. db_fifo_cnt[31:0]
         */
        uint32_t db_fifo_cnt_l:32;
    };
    uint32_t val;
...
typedef union {
    struct {
         ...
         *  section n is configured by registers SPI_MEM_C_fmem_PMSn_ADDR_REG and
         *  SPI_MEM_C_fmem_PMSn_SIZE_REG.
         */
         ...
         *  The flash PMS section n is configured by registers SPI_MEM_C_fmem_PMSn_ADDR_REG
         *  and SPI_MEM_C_fmem_PMSn_SIZE_REG.
         */
...
typedef union {
    struct {
         ...
         *  SPI1 flash PMS section n address region is (SPI_MEM_C_fmem_PMSn_ADDR_S,
         *  SPI_MEM_C_fmem_PMSn_ADDR_S + SPI_MEM_C_fmem_PMSn_SIZE)
         */
...
typedef union {
    struct {
         ...
         *  external RAM PMS section n is configured by registers SPI_MEM_C_SMEM_PMSn_ADDR_REG
         *  and SPI_MEM_C_SMEM_PMSn_SIZE_REG.
         */
         ...
         *  SPI_MEM_C_SMEM_PMSn_ADDR_REG and SPI_MEM_C_SMEM_PMSn_SIZE_REG.
         */
...
typedef union {
    struct {
        ...
        /** rdn_ena : HRO; bitpos: [30]; default: 0;
         *  ECO register enable bit
         *  This field is only for internal debugging purposes. Do not use it in applications.
         */
        uint32_t rdn_ena:1;
        /** rdn_result : RO; bitpos: [31]; default: 0;
...
/** Group: ECO registers */
/** Type of registerrnd_eco_high register
 *  MSPI ECO high register
 */
typedef union {
    struct {
        /** registerrnd_eco_high : RO; bitpos: [31:0]; default: 892;
         *  ECO high register
         *  This field is only for internal debugging purposes. Do not use it in applications.
         */
        uint32_t registerrnd_eco_high:32;
    };
    uint32_t val;
} spi_mem_c_registerrnd_eco_high_reg_t;

/** Type of registerrnd_eco_low register
 *  MSPI ECO low register
 */
typedef union {
    struct {
        /** registerrnd_eco_low : RO; bitpos: [31:0]; default: 892;
         *  ECO low register
         *  This field is only for internal debugging purposes. Do not use it in applications.
         */
        uint32_t registerrnd_eco_low:32;
    };
    uint32_t val;
...
typedef union {
    struct {
        /** date : R/W; bitpos: [27:0]; default: 38805888;
...
typedef struct {
    ...
    volatile spi_mem_c_rd_status_reg_t rd_status;
    ...
    volatile spi_mem_c_cache_sctrl_reg_t cache_sctrl;
    volatile spi_mem_c_sram_cmd_reg_t sram_cmd;
    volatile spi_mem_c_sram_drd_cmd_reg_t sram_drd_cmd;
    volatile spi_mem_c_sram_dwr_cmd_reg_t sram_dwr_cmd;
    volatile spi_mem_c_sram_clk_reg_t sram_clk;
    ...
    volatile spi_mem_c_dll_dly_db_reg_t dll_dly_db;
    volatile spi_mem_c_dll_db_st0_reg_t dll_db_st0;
    volatile spi_mem_c_dll_db_st1_reg_t dll_db_st1;
    ...
    volatile spi_mem_c_registerrnd_eco_high_reg_t registerrnd_eco_high;
    volatile spi_mem_c_registerrnd_eco_low_reg_t registerrnd_eco_low;
