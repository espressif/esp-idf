...
/** PPA_BLEND_PARAM_CFG_ERR_INT_RAW : R/WTC/SS; bitpos: [3]; default: 0;
...
#define PPA_BLEND_PARAM_CFG_ERR_INT_RAW_M  (PPA_BLEND_PARAM_CFG_ERR_INT_RAW_V << PPA_BLEND_PARAM_CFG_ERR_INT_RAW_S)
#define PPA_BLEND_PARAM_CFG_ERR_INT_RAW_V  0x00000001U
...
/** PPA_BLEND_PARAM_CFG_ERR_INT_ST : RO; bitpos: [3]; default: 0;
 *  The raw interrupt status bit for the PPA_BLEND_PARAM_CFG_ERR_INT interrupt.
 */
#define PPA_BLEND_PARAM_CFG_ERR_INT_ST    (BIT(3))
#define PPA_BLEND_PARAM_CFG_ERR_INT_ST_M  (PPA_BLEND_PARAM_CFG_ERR_INT_ST_V << PPA_BLEND_PARAM_CFG_ERR_INT_ST_S)
#define PPA_BLEND_PARAM_CFG_ERR_INT_ST_V  0x00000001U
...
/** PPA_BLEND_PARAM_CFG_ERR_INT_ENA : R/W; bitpos: [3]; default: 0;
 *  The interrupt enable bit for the PPA_BLEND_PARAM_CFG_ERR_INT interrupt.
 */
#define PPA_BLEND_PARAM_CFG_ERR_INT_ENA    (BIT(3))
#define PPA_BLEND_PARAM_CFG_ERR_INT_ENA_M  (PPA_BLEND_PARAM_CFG_ERR_INT_ENA_V << PPA_BLEND_PARAM_CFG_ERR_INT_ENA_S)
#define PPA_BLEND_PARAM_CFG_ERR_INT_ENA_V  0x00000001U
...
/** PPA_BLEND_PARAM_CFG_ERR_INT_CLR : WT; bitpos: [3]; default: 0;
 *  Set this bit to clear the PPA_BLEND_PARAM_CFG_ERR_INT interrupt.
 */
#define PPA_BLEND_PARAM_CFG_ERR_INT_CLR    (BIT(3))
#define PPA_BLEND_PARAM_CFG_ERR_INT_CLR_M  (PPA_BLEND_PARAM_CFG_ERR_INT_CLR_V << PPA_BLEND_PARAM_CFG_ERR_INT_CLR_S)
#define PPA_BLEND_PARAM_CFG_ERR_INT_CLR_V  0x00000001U
...
#define PPA_YUV422_RX_BYTE_ORDER_V  0x00000003U
...
/** PPA_BLEND0_RX_YUV_RANGE : R/W; bitpos: [12]; default: 0;
 *  YUV input range when blend0 rx cm is yuv. 0: limit range. 1: full range
 */
#define PPA_BLEND0_RX_YUV_RANGE    (BIT(12))
#define PPA_BLEND0_RX_YUV_RANGE_M  (PPA_BLEND0_RX_YUV_RANGE_V << PPA_BLEND0_RX_YUV_RANGE_S)
#define PPA_BLEND0_RX_YUV_RANGE_V  0x00000001U
#define PPA_BLEND0_RX_YUV_RANGE_S  12
/** PPA_BLEND_TX_YUV_RANGE : R/W; bitpos: [13]; default: 0;
...
#define PPA_BLEND0_RX_YUV422_BYTE_ORDER_V  0x00000003U
...
/** PPA_SR_BK_SIZE_SEL : R/W; bitpos: [3]; default: 0;
 *  sel srm pix_blk size, 0:32x32, 1:16x16
 */
#define PPA_SR_BK_SIZE_SEL    (BIT(3))
#define PPA_SR_BK_SIZE_SEL_M  (PPA_SR_BK_SIZE_SEL_V << PPA_SR_BK_SIZE_SEL_S)
#define PPA_SR_BK_SIZE_SEL_V  0x00000001U
#define PPA_SR_BK_SIZE_SEL_S  3
...
/** PPA_BLEND_YUV_X_SCALE_ERR_ST : RO; bitpos: [1]; default: 0;
 *  Represents that x param is an odd num when enable yuv422 or yuv420
 */
#define PPA_BLEND_YUV_X_SCALE_ERR_ST    (BIT(1))
#define PPA_BLEND_YUV_X_SCALE_ERR_ST_M  (PPA_BLEND_YUV_X_SCALE_ERR_ST_V << PPA_BLEND_YUV_X_SCALE_ERR_ST_S)
#define PPA_BLEND_YUV_X_SCALE_ERR_ST_V  0x00000001U
#define PPA_BLEND_YUV_X_SCALE_ERR_ST_S  1
/** PPA_BLEND_YUV_Y_SCALE_ERR_ST : RO; bitpos: [2]; default: 0;
 *  Represents that y param is an odd num when enable yuv420
 */
#define PPA_BLEND_YUV_Y_SCALE_ERR_ST    (BIT(2))
#define PPA_BLEND_YUV_Y_SCALE_ERR_ST_M  (PPA_BLEND_YUV_Y_SCALE_ERR_ST_V << PPA_BLEND_YUV_Y_SCALE_ERR_ST_S)
#define PPA_BLEND_YUV_Y_SCALE_ERR_ST_V  0x00000001U
...
/** PPA_DEBUG_CTRL0_REG register
 *  debug register
 */
#define PPA_DEBUG_CTRL0_REG (DR_REG_PPA_BASE + 0x90)
/** PPA_DBG_REPLACE_SEL : R/W; bitpos: [2:0]; default: 0;
 ...
 *  blend output
 */
#define PPA_DBG_REPLACE_SEL    0x00000007U
#define PPA_DBG_REPLACE_SEL_M  (PPA_DBG_REPLACE_SEL_V << PPA_DBG_REPLACE_SEL_S)
#define PPA_DBG_REPLACE_SEL_V  0x00000007U
#define PPA_DBG_REPLACE_SEL_S  0

/** PPA_DEBUG_CTRL1_REG register
 *  debug register
 */
#define PPA_DEBUG_CTRL1_REG (DR_REG_PPA_BASE + 0x94)
/** PPA_DBG_REPLACE_DATA : R/W; bitpos: [31:0]; default: 0;
 *  Configures the replace data
 */
#define PPA_DBG_REPLACE_DATA    0xFFFFFFFFU
#define PPA_DBG_REPLACE_DATA_M  (PPA_DBG_REPLACE_DATA_V << PPA_DBG_REPLACE_DATA_S)
#define PPA_DBG_REPLACE_DATA_V  0xFFFFFFFFU
#define PPA_DBG_REPLACE_DATA_S  0

/** PPA_RGB2GRAY_REG register
 *  rgb2gray register
 */
#define PPA_RGB2GRAY_REG (DR_REG_PPA_BASE + 0x98)
/** PPA_RGB2GRAY_B : R/W; bitpos: [7:0]; default: 85;
 *  Configures the b parameter for rgb2gray
 */
#define PPA_RGB2GRAY_B    0x000000FFU
#define PPA_RGB2GRAY_B_M  (PPA_RGB2GRAY_B_V << PPA_RGB2GRAY_B_S)
#define PPA_RGB2GRAY_B_V  0x000000FFU
#define PPA_RGB2GRAY_B_S  0
/** PPA_RGB2GRAY_G : R/W; bitpos: [15:8]; default: 86;
 *  Configures the g parameter for rgb2gray
 */
#define PPA_RGB2GRAY_G    0x000000FFU
#define PPA_RGB2GRAY_G_M  (PPA_RGB2GRAY_G_V << PPA_RGB2GRAY_G_S)
#define PPA_RGB2GRAY_G_V  0x000000FFU
#define PPA_RGB2GRAY_G_S  8
/** PPA_RGB2GRAY_R : R/W; bitpos: [23:16]; default: 85;
 *  Configures the r parameter for rgb2gray
 */
#define PPA_RGB2GRAY_R    0x000000FFU
#define PPA_RGB2GRAY_R_M  (PPA_RGB2GRAY_R_V << PPA_RGB2GRAY_R_S)
#define PPA_RGB2GRAY_R_V  0x000000FFU
#define PPA_RGB2GRAY_R_S  16

/** PPA_DATE_REG register
 *  PPA Version register
 */
#define PPA_DATE_REG (DR_REG_PPA_BASE + 0x100)
/** PPA_DATE : R/W; bitpos: [31:0]; default: 539234848;
 *  register version.
 */
