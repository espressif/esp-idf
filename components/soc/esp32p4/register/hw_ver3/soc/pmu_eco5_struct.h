...
typedef union {
    struct {
        /** hp_modem_dig_icg_func_en : WT; bitpos: [31:0]; default: 0;
         *  need_des
         */
...
typedef union {
    struct {
        /** hp_modem_dig_icg_apb_en : WT; bitpos: [31:0]; default: 0;
         *  need_des
         */
...
typedef union {
    struct {
        uint32_t reserved_0:18;
        /** hp_modem_dcm_vset : WT; bitpos: [22:18]; default: 0;
         *  need_des
         */
...
typedef union {
    struct {
        ...
        /** hp_modem_hp_regulator_slp_mem_xpd : WT; bitpos: [16]; default: 0;
         *  need_des
         */
        uint32_t hp_modem_hp_regulator_slp_mem_xpd:1;
        /** hp_modem_hp_regulator_slp_logic_xpd : WT; bitpos: [17]; default: 0;
         *  need_des
         */
        uint32_t hp_modem_hp_regulator_slp_logic_xpd:1;
        /** hp_modem_hp_regulator_xpd : WT; bitpos: [18]; default: 0;
         *  need_des
         */
        uint32_t hp_modem_hp_regulator_xpd:1;
        /** hp_modem_hp_regulator_slp_mem_dbias : WT; bitpos: [22:19]; default: 0;
         *  need_des
         */
        uint32_t hp_modem_hp_regulator_slp_mem_dbias:4;
        /** hp_modem_hp_regulator_slp_logic_dbias : WT; bitpos: [26:23]; default: 0;
         *  need_des
         */
        uint32_t hp_modem_hp_regulator_slp_logic_dbias:4;
        /** hp_modem_hp_regulator_dbias : WT; bitpos: [31:27]; default: 0;
         *  need_des
         */
...
typedef union {
    struct {
        uint32_t reserved_0:31;
        /** hp_modem_xpd_xtal : WT; bitpos: [31]; default: 0;
         *  need_des
         */
...
typedef union {
    struct {
        ...
        /** lp_ana_wait_target_expand : R/W; bitpos: [23:22]; default: 0;
         *  need_des
         */
...
/** Type of ext_ldo_p0_0p1a register
 *  need_des
 */
typedef union {
    struct {
    ...
    uint32_t val;
} pmu_ext_ldo_p0_0p1a_reg_t;

/** Type of ext_ldo_p0_0p1a_ana register
 *  need_des
 */
typedef union {
    struct {
        uint32_t reserved_0:23;
        /** ana_0p1a_mul_0 : R/W; bitpos: [25:23]; default: 2;
         *  need_des
         */
        uint32_t ana_0p1a_mul_0:3;
        /** ana_0p1a_en_vdet_0 : R/W; bitpos: [26]; default: 0;
         *  need_des
         */
        uint32_t ana_0p1a_en_vdet_0:1;
        /** ana_0p1a_en_cur_lim_0 : R/W; bitpos: [27]; default: 0;
         *  need_des
         */
        uint32_t ana_0p1a_en_cur_lim_0:1;
        /** ana_0p1a_dref_0 : R/W; bitpos: [31:28]; default: 11;
         *  need_des
         */
        uint32_t ana_0p1a_dref_0:4;
    };
    uint32_t val;
} pmu_ext_ldo_p0_0p1a_ana_reg_t;

/** Type of ext_ldo_p0_0p2a register
 *  need_des
 */
typedef union {
    struct {
         ...
         *  need_des
         */
        uint32_t pmu_0p2a_cnt_clr_0:1;
        /** 0p2a_force_tieh_sel_0 : R/W; bitpos: [7]; default: 0;
         *  need_des
         */
    ...
    uint32_t val;
} pmu_ext_ldo_p0_0p2a_reg_t;

/** Type of ext_ldo_p0_0p2a_ana register
 *  need_des
 */
typedef union {
    struct {
        uint32_t reserved_0:23;
        /** ana_0p2a_mul_0 : R/W; bitpos: [25:23]; default: 0;
         *  need_des
         */
        uint32_t ana_0p2a_mul_0:3;
        /** ana_0p2a_en_vdet_0 : R/W; bitpos: [26]; default: 0;
         *  need_des
         */
        uint32_t ana_0p2a_en_vdet_0:1;
        /** ana_0p2a_en_cur_lim_0 : R/W; bitpos: [27]; default: 0;
         *  need_des
         */
        uint32_t ana_0p2a_en_cur_lim_0:1;
        /** ana_0p2a_dref_0 : R/W; bitpos: [31:28]; default: 10;
         *  need_des
         */
        uint32_t ana_0p2a_dref_0:4;
    };
    uint32_t val;
} pmu_ext_ldo_p0_0p2a_ana_reg_t;

/** Type of ext_ldo_p0_0p3a register
 *  need_des
 */
typedef union {
    struct {
    ...
    uint32_t val;
} pmu_ext_ldo_p0_0p3a_reg_t;

/** Type of ext_ldo_p0_0p3a_ana register
 *  need_des
 */
typedef union {
    struct {
        uint32_t reserved_0:23;
        /** ana_0p3a_mul_0 : R/W; bitpos: [25:23]; default: 0;
         *  need_des
         */
        uint32_t ana_0p3a_mul_0:3;
        /** ana_0p3a_en_vdet_0 : R/W; bitpos: [26]; default: 0;
         *  need_des
         */
        uint32_t ana_0p3a_en_vdet_0:1;
        /** ana_0p3a_en_cur_lim_0 : R/W; bitpos: [27]; default: 0;
         *  need_des
         */
        uint32_t ana_0p3a_en_cur_lim_0:1;
        /** ana_0p3a_dref_0 : R/W; bitpos: [31:28]; default: 10;
         *  need_des
         */
        uint32_t ana_0p3a_dref_0:4;
    };
    uint32_t val;
} pmu_ext_ldo_p0_0p3a_ana_reg_t;

/** Type of ext_ldo_p1_0p1a register
 *  need_des
 */
typedef union {
    struct {
    ...
    uint32_t val;
} pmu_ext_ldo_p1_0p1a_reg_t;

/** Type of ext_ldo_p1_0p1a_ana register
 *  need_des
 */
typedef union {
    struct {
        uint32_t reserved_0:23;
        /** ana_0p1a_mul_1 : R/W; bitpos: [25:23]; default: 0;
         *  need_des
         */
        uint32_t ana_0p1a_mul_1:3;
        /** ana_0p1a_en_vdet_1 : R/W; bitpos: [26]; default: 0;
         *  need_des
         */
        uint32_t ana_0p1a_en_vdet_1:1;
        /** ana_0p1a_en_cur_lim_1 : R/W; bitpos: [27]; default: 0;
         *  need_des
         */
        uint32_t ana_0p1a_en_cur_lim_1:1;
        /** ana_0p1a_dref_1 : R/W; bitpos: [31:28]; default: 10;
         *  need_des
         */
        uint32_t ana_0p1a_dref_1:4;
    };
    uint32_t val;
} pmu_ext_ldo_p1_0p1a_ana_reg_t;

/** Type of ext_ldo_p1_0p2a register
 *  need_des
 */
typedef union {
    struct {
    ...
    uint32_t val;
} pmu_ext_ldo_p1_0p2a_reg_t;

/** Type of ext_ldo_p1_0p2a_ana register
 *  need_des
 */
typedef union {
    struct {
        uint32_t reserved_0:23;
        /** ana_0p2a_mul_1 : R/W; bitpos: [25:23]; default: 0;
         *  need_des
         */
        uint32_t ana_0p2a_mul_1:3;
        /** ana_0p2a_en_vdet_1 : R/W; bitpos: [26]; default: 0;
         *  need_des
         */
        uint32_t ana_0p2a_en_vdet_1:1;
        /** ana_0p2a_en_cur_lim_1 : R/W; bitpos: [27]; default: 0;
         *  need_des
         */
        uint32_t ana_0p2a_en_cur_lim_1:1;
        /** ana_0p2a_dref_1 : R/W; bitpos: [31:28]; default: 10;
         *  need_des
         */
        uint32_t ana_0p2a_dref_1:4;
    };
    uint32_t val;
} pmu_ext_ldo_p1_0p2a_ana_reg_t;

/** Type of ext_ldo_p1_0p3a register
 *  need_des
 */
typedef union {
    struct {
    ...
    uint32_t val;
} pmu_ext_ldo_p1_0p3a_reg_t;

/** Type of ext_ldo_p1_0p3a_ana register
 *  need_des
 */
typedef union {
    struct {
        uint32_t reserved_0:23;
        /** ana_0p3a_mul_1 : R/W; bitpos: [25:23]; default: 0;
         *  need_des
         */
        uint32_t ana_0p3a_mul_1:3;
        /** ana_0p3a_en_vdet_1 : R/W; bitpos: [26]; default: 0;
         *  need_des
         */
        uint32_t ana_0p3a_en_vdet_1:1;
        /** ana_0p3a_en_cur_lim_1 : R/W; bitpos: [27]; default: 0;
         *  need_des
         */
        uint32_t ana_0p3a_en_cur_lim_1:1;
        /** ana_0p3a_dref_1 : R/W; bitpos: [31:28]; default: 10;
         *  need_des
         */
        uint32_t ana_0p3a_dref_1:4;
    };
    uint32_t val;
} pmu_ext_ldo_p1_0p3a_ana_reg_t;
...
/** Type of power_pd_hp_cpu_cntl register
 *  need_des
 */
typedef union {
    struct {
    ...
    uint32_t val;
} pmu_power_pd_hp_cpu_cntl_reg_t;

/** Type of power_pd_hp_cpu_mask register
 *  need_des
 */
typedef union {
    struct {
        /** xpd_hp_cpu_mask : R/W; bitpos: [4:0]; default: 0;
         *  need_des
         */
        uint32_t xpd_hp_cpu_mask:5;
        uint32_t reserved_5:22;
        /** pd_hp_cpu_mask : R/W; bitpos: [31:27]; default: 0;
         *  need_des
         */
        uint32_t pd_hp_cpu_mask:5;
    };
    uint32_t val;
} pmu_power_pd_hp_cpu_mask_reg_t;
...
typedef union {
    struct {
        /** pmu_date : R/W; bitpos: [30:0]; default: 38801456;
         *  need_des
         */
...
typedef union {
    struct {
        /** stable_xpd_pll_state : RO; bitpos: [2:0]; default: 0;
         *  need_des
         */
        uint32_t stable_xpd_pll_state:3;
        /** stable_xpd_xtal_state : RO; bitpos: [3]; default: 0;
         *  need_des
         */
        ...
        /** pmu_icg_sys_clk_en_state : RO; bitpos: [14]; default: 1;
         *  need_des
         */
...
typedef struct {
    ...
    volatile pmu_ext_ldo_p0_0p1a_reg_t ext_ldo_p0_0p1a;
    volatile pmu_ext_ldo_p0_0p1a_ana_reg_t ext_ldo_p0_0p1a_ana;
    volatile pmu_ext_ldo_p0_0p2a_reg_t ext_ldo_p0_0p2a;
    volatile pmu_ext_ldo_p0_0p2a_ana_reg_t ext_ldo_p0_0p2a_ana;
    volatile pmu_ext_ldo_p0_0p3a_reg_t ext_ldo_p0_0p3a;
    volatile pmu_ext_ldo_p0_0p3a_ana_reg_t ext_ldo_p0_0p3a_ana;
    volatile pmu_ext_ldo_p1_0p1a_reg_t ext_ldo_p1_0p1a;
    volatile pmu_ext_ldo_p1_0p1a_ana_reg_t ext_ldo_p1_0p1a_ana;
    volatile pmu_ext_ldo_p1_0p2a_reg_t ext_ldo_p1_0p2a;
    volatile pmu_ext_ldo_p1_0p2a_ana_reg_t ext_ldo_p1_0p2a_ana;
    volatile pmu_ext_ldo_p1_0p3a_reg_t ext_ldo_p1_0p3a;
    volatile pmu_ext_ldo_p1_0p3a_ana_reg_t ext_ldo_p1_0p3a_ana;
    ...
    volatile pmu_power_pd_hp_cpu_cntl_reg_t power_pd_hp_cpu_cntl;
    volatile pmu_power_pd_hp_cpu_mask_reg_t power_pd_hp_cpu_mask;
    uint32_t reserved_220[119];
