...
/** ISP_CLK_CROP_FORCE_ON : R/W; bitpos: [19]; default: 0;
 *  this bit configures the clk force on of crop. 0: disable, 1: enable
 */
#define ISP_CLK_CROP_FORCE_ON    (BIT(19))
#define ISP_CLK_CROP_FORCE_ON_M  (ISP_CLK_CROP_FORCE_ON_V << ISP_CLK_CROP_FORCE_ON_S)
#define ISP_CLK_CROP_FORCE_ON_V  0x00000001U
#define ISP_CLK_CROP_FORCE_ON_S  19
/** ISP_CLK_WBG_FORCE_ON : R/W; bitpos: [20]; default: 0;
 *  this bit configures the clk force on of wbg. 0: disable, 1: enable
 */
#define ISP_CLK_WBG_FORCE_ON    (BIT(20))
#define ISP_CLK_WBG_FORCE_ON_M  (ISP_CLK_WBG_FORCE_ON_V << ISP_CLK_WBG_FORCE_ON_S)
#define ISP_CLK_WBG_FORCE_ON_V  0x00000001U
#define ISP_CLK_WBG_FORCE_ON_S  20
...
/** ISP_CROP_EN : R/W; bitpos: [18]; default: 0;
 *  this bit configures crop enable. 0: disable, 1: enable
 */
#define ISP_CROP_EN    (BIT(18))
#define ISP_CROP_EN_M  (ISP_CROP_EN_V << ISP_CROP_EN_S)
#define ISP_CROP_EN_V  0x00000001U
#define ISP_CROP_EN_S  18
/** ISP_WBG_EN : R/W; bitpos: [19]; default: 0;
 *  this bit configures wbg enable. 0: disable, 1: enable
 */
#define ISP_WBG_EN    (BIT(19))
#define ISP_WBG_EN_M  (ISP_WBG_EN_V << ISP_WBG_EN_S)
#define ISP_WBG_EN_V  0x00000001U
#define ISP_WBG_EN_S  19
...
/** ISP_CCM_RR : R/W; bitpos: [12:0]; default: 256;
...
/** ISP_CCM_RG : R/W; bitpos: [25:13]; default: 0;
 *  this field configures the color correction matrix coefficient
 */
...
/** ISP_CCM_RB : R/W; bitpos: [12:0]; default: 0;
 *  this field configures the color correction matrix coefficient
 */
...
/** ISP_CCM_GR : R/W; bitpos: [25:13]; default: 0;
 *  this field configures the color correction matrix coefficient
 */
...
/** ISP_CCM_GG : R/W; bitpos: [12:0]; default: 256;
 *  this field configures the color correction matrix coefficient
 */
...
/** ISP_CCM_GB : R/W; bitpos: [25:13]; default: 0;
 *  this field configures the color correction matrix coefficient
 */
...
/** ISP_CCM_BR : R/W; bitpos: [12:0]; default: 0;
 *  this field configures the color correction matrix coefficient
 */
...
/** ISP_CCM_BG : R/W; bitpos: [25:13]; default: 0;
 *  this field configures the color correction matrix coefficient
 */
...
/** ISP_CCM_BB : R/W; bitpos: [12:0]; default: 256;
 *  this field configures the color correction matrix coefficient
 */
...
/** ISP_CROP_FRAME_INT_RAW : R/SS/WTC; bitpos: [29]; default: 0;
 *  the raw interrupt status of crop frame done
 */
#define ISP_CROP_FRAME_INT_RAW    (BIT(29))
#define ISP_CROP_FRAME_INT_RAW_M  (ISP_CROP_FRAME_INT_RAW_V << ISP_CROP_FRAME_INT_RAW_S)
#define ISP_CROP_FRAME_INT_RAW_V  0x00000001U
#define ISP_CROP_FRAME_INT_RAW_S  29
/** ISP_WBG_FRAME_INT_RAW : R/SS/WTC; bitpos: [30]; default: 0;
 *  the raw interrupt status of wbg frame done
 */
#define ISP_WBG_FRAME_INT_RAW    (BIT(30))
#define ISP_WBG_FRAME_INT_RAW_M  (ISP_WBG_FRAME_INT_RAW_V << ISP_WBG_FRAME_INT_RAW_S)
#define ISP_WBG_FRAME_INT_RAW_V  0x00000001U
#define ISP_WBG_FRAME_INT_RAW_S  30
/** ISP_CROP_ERR_INT_RAW : R/SS/WTC; bitpos: [31]; default: 0;
 *  the raw interrupt status of crop error
 */
#define ISP_CROP_ERR_INT_RAW    (BIT(31))
#define ISP_CROP_ERR_INT_RAW_M  (ISP_CROP_ERR_INT_RAW_V << ISP_CROP_ERR_INT_RAW_S)
#define ISP_CROP_ERR_INT_RAW_V  0x00000001U
#define ISP_CROP_ERR_INT_RAW_S  31
...
/** ISP_CROP_FRAME_INT_ST : RO; bitpos: [29]; default: 0;
 *  the masked interrupt status of crop frame done
 */
#define ISP_CROP_FRAME_INT_ST    (BIT(29))
#define ISP_CROP_FRAME_INT_ST_M  (ISP_CROP_FRAME_INT_ST_V << ISP_CROP_FRAME_INT_ST_S)
#define ISP_CROP_FRAME_INT_ST_V  0x00000001U
#define ISP_CROP_FRAME_INT_ST_S  29
/** ISP_WBG_FRAME_INT_ST : RO; bitpos: [30]; default: 0;
 *  the masked interrupt status of wbg frame done
 */
#define ISP_WBG_FRAME_INT_ST    (BIT(30))
#define ISP_WBG_FRAME_INT_ST_M  (ISP_WBG_FRAME_INT_ST_V << ISP_WBG_FRAME_INT_ST_S)
#define ISP_WBG_FRAME_INT_ST_V  0x00000001U
#define ISP_WBG_FRAME_INT_ST_S  30
/** ISP_CROP_ERR_INT_ST : RO; bitpos: [31]; default: 0;
 *  the masked interrupt status of crop error
 */
#define ISP_CROP_ERR_INT_ST    (BIT(31))
#define ISP_CROP_ERR_INT_ST_M  (ISP_CROP_ERR_INT_ST_V << ISP_CROP_ERR_INT_ST_S)
#define ISP_CROP_ERR_INT_ST_V  0x00000001U
#define ISP_CROP_ERR_INT_ST_S  31
...
/** ISP_CROP_FRAME_INT_ENA : R/W; bitpos: [29]; default: 0;
 *  write 1 to enable crop frame done
 */
#define ISP_CROP_FRAME_INT_ENA    (BIT(29))
#define ISP_CROP_FRAME_INT_ENA_M  (ISP_CROP_FRAME_INT_ENA_V << ISP_CROP_FRAME_INT_ENA_S)
#define ISP_CROP_FRAME_INT_ENA_V  0x00000001U
#define ISP_CROP_FRAME_INT_ENA_S  29
/** ISP_WBG_FRAME_INT_ENA : R/W; bitpos: [30]; default: 0;
 *  write 1 to enable wbg frame done
 */
#define ISP_WBG_FRAME_INT_ENA    (BIT(30))
#define ISP_WBG_FRAME_INT_ENA_M  (ISP_WBG_FRAME_INT_ENA_V << ISP_WBG_FRAME_INT_ENA_S)
#define ISP_WBG_FRAME_INT_ENA_V  0x00000001U
#define ISP_WBG_FRAME_INT_ENA_S  30
/** ISP_CROP_ERR_INT_ENA : R/W; bitpos: [31]; default: 0;
 *  write 1 to enable crop error
 */
#define ISP_CROP_ERR_INT_ENA    (BIT(31))
#define ISP_CROP_ERR_INT_ENA_M  (ISP_CROP_ERR_INT_ENA_V << ISP_CROP_ERR_INT_ENA_S)
#define ISP_CROP_ERR_INT_ENA_V  0x00000001U
#define ISP_CROP_ERR_INT_ENA_S  31
...
/** ISP_CROP_FRAME_INT_CLR : WT; bitpos: [29]; default: 0;
 *  write 1 to clear crop frame done
 */
#define ISP_CROP_FRAME_INT_CLR    (BIT(29))
#define ISP_CROP_FRAME_INT_CLR_M  (ISP_CROP_FRAME_INT_CLR_V << ISP_CROP_FRAME_INT_CLR_S)
#define ISP_CROP_FRAME_INT_CLR_V  0x00000001U
#define ISP_CROP_FRAME_INT_CLR_S  29
/** ISP_WBG_FRAME_INT_CLR : WT; bitpos: [30]; default: 0;
 *  write 1 to clear wbg frame done
 */
#define ISP_WBG_FRAME_INT_CLR    (BIT(30))
#define ISP_WBG_FRAME_INT_CLR_M  (ISP_WBG_FRAME_INT_CLR_V << ISP_WBG_FRAME_INT_CLR_S)
#define ISP_WBG_FRAME_INT_CLR_V  0x00000001U
#define ISP_WBG_FRAME_INT_CLR_S  30
/** ISP_CROP_ERR_INT_CLR : WT; bitpos: [31]; default: 0;
 *  write 1 to clear crop error
 */
#define ISP_CROP_ERR_INT_CLR    (BIT(31))
#define ISP_CROP_ERR_INT_CLR_M  (ISP_CROP_ERR_INT_CLR_V << ISP_CROP_ERR_INT_CLR_S)
#define ISP_CROP_ERR_INT_CLR_V  0x00000001U
#define ISP_CROP_ERR_INT_CLR_S  31
...
/** ISP_CAM_DE_ONLY : R/W; bitpos: [15]; default: 0;
 *  configures whether cam inf only has de, no hsync data. 0: has hsync, 1: no hsync
 */
#define ISP_CAM_DE_ONLY    (BIT(15))
#define ISP_CAM_DE_ONLY_M  (ISP_CAM_DE_ONLY_V << ISP_CAM_DE_ONLY_S)
#define ISP_CAM_DE_ONLY_V  0x00000001U
#define ISP_CAM_DE_ONLY_S  15
...
/** ISP_CROP_CTRL_REG register
 *  isp_crop ctrl register
 */
#define ISP_CROP_CTRL_REG (DR_REG_ISP_BASE + 0x244)
/** ISP_CROP_SFT_RST : WT; bitpos: [0]; default: 0;
 *  Write 1 to clear err st
 */
#define ISP_CROP_SFT_RST    (BIT(0))
#define ISP_CROP_SFT_RST_M  (ISP_CROP_SFT_RST_V << ISP_CROP_SFT_RST_S)
#define ISP_CROP_SFT_RST_V  0x00000001U
#define ISP_CROP_SFT_RST_S  0

/** ISP_CROP_Y_CAPTURE_REG register
 *  isp_crop row capture range register
 */
#define ISP_CROP_Y_CAPTURE_REG (DR_REG_ISP_BASE + 0x248)
/** ISP_CROP_Y_START : R/W; bitpos: [11:0]; default: 0;
 *  isp_crop capture row start index
 */
#define ISP_CROP_Y_START    0x00000FFFU
#define ISP_CROP_Y_START_M  (ISP_CROP_Y_START_V << ISP_CROP_Y_START_S)
#define ISP_CROP_Y_START_V  0x00000FFFU
#define ISP_CROP_Y_START_S  0
/** ISP_CROP_Y_END : R/W; bitpos: [23:12]; default: 0;
 *  isp_crop capture row end index
 */
#define ISP_CROP_Y_END    0x00000FFFU
#define ISP_CROP_Y_END_M  (ISP_CROP_Y_END_V << ISP_CROP_Y_END_S)
#define ISP_CROP_Y_END_V  0x00000FFFU
#define ISP_CROP_Y_END_S  12

/** ISP_CROP_X_CAPTURE_REG register
 *  isp_crop col capture range register
 */
#define ISP_CROP_X_CAPTURE_REG (DR_REG_ISP_BASE + 0x24c)
/** ISP_CROP_X_START : R/W; bitpos: [11:0]; default: 0;
 *  isp_crop capture col start index
 */
#define ISP_CROP_X_START    0x00000FFFU
#define ISP_CROP_X_START_M  (ISP_CROP_X_START_V << ISP_CROP_X_START_S)
#define ISP_CROP_X_START_V  0x00000FFFU
#define ISP_CROP_X_START_S  0
/** ISP_CROP_X_END : R/W; bitpos: [23:12]; default: 0;
 *  isp_crop capture col end index
 */
#define ISP_CROP_X_END    0x00000FFFU
#define ISP_CROP_X_END_M  (ISP_CROP_X_END_V << ISP_CROP_X_END_S)
#define ISP_CROP_X_END_V  0x00000FFFU
#define ISP_CROP_X_END_S  12

/** ISP_CROP_ERR_ST_REG register
 *  crop error state register
 */
#define ISP_CROP_ERR_ST_REG (DR_REG_ISP_BASE + 0x250)
/** ISP_CROP_Y_MISMATCH : RO; bitpos: [0]; default: 0;
 *  Represents isp_corp row end index over image size
 */
#define ISP_CROP_Y_MISMATCH    (BIT(0))
#define ISP_CROP_Y_MISMATCH_M  (ISP_CROP_Y_MISMATCH_V << ISP_CROP_Y_MISMATCH_S)
#define ISP_CROP_Y_MISMATCH_V  0x00000001U
#define ISP_CROP_Y_MISMATCH_S  0
/** ISP_CROP_X_MISMATCH : RO; bitpos: [1]; default: 0;
 *  Represents isp_corp col end index over image size
 */
#define ISP_CROP_X_MISMATCH    (BIT(1))
#define ISP_CROP_X_MISMATCH_M  (ISP_CROP_X_MISMATCH_V << ISP_CROP_X_MISMATCH_S)
#define ISP_CROP_X_MISMATCH_V  0x00000001U
#define ISP_CROP_X_MISMATCH_S  1
/** ISP_CROP_Y_END_EVEN : RO; bitpos: [2]; default: 0;
 *  Represents isp_corp row end index is an even number
 */
#define ISP_CROP_Y_END_EVEN    (BIT(2))
#define ISP_CROP_Y_END_EVEN_M  (ISP_CROP_Y_END_EVEN_V << ISP_CROP_Y_END_EVEN_S)
#define ISP_CROP_Y_END_EVEN_V  0x00000001U
#define ISP_CROP_Y_END_EVEN_S  2
/** ISP_CROP_X_END_EVEN : RO; bitpos: [3]; default: 0;
 *  Represents isp_corp col end index is an even number
 */
#define ISP_CROP_X_END_EVEN    (BIT(3))
#define ISP_CROP_X_END_EVEN_M  (ISP_CROP_X_END_EVEN_V << ISP_CROP_X_END_EVEN_S)
#define ISP_CROP_X_END_EVEN_V  0x00000001U
#define ISP_CROP_X_END_EVEN_S  3
/** ISP_CROP_Y_START_ODD : RO; bitpos: [4]; default: 0;
 *  Represents isp_corp row start index is an odd number
 */
#define ISP_CROP_Y_START_ODD    (BIT(4))
#define ISP_CROP_Y_START_ODD_M  (ISP_CROP_Y_START_ODD_V << ISP_CROP_Y_START_ODD_S)
#define ISP_CROP_Y_START_ODD_V  0x00000001U
#define ISP_CROP_Y_START_ODD_S  4
/** ISP_CROP_X_START_ODD : RO; bitpos: [5]; default: 0;
 *  Represents isp_corp col start index is an odd number
 */
#define ISP_CROP_X_START_ODD    (BIT(5))
#define ISP_CROP_X_START_ODD_M  (ISP_CROP_X_START_ODD_V << ISP_CROP_X_START_ODD_S)
#define ISP_CROP_X_START_ODD_V  0x00000001U
#define ISP_CROP_X_START_ODD_S  5

/** ISP_WBG_COEF_R_REG register
 *  white balance red gain register 0
 */
#define ISP_WBG_COEF_R_REG (DR_REG_ISP_BASE + 0x254)
/** ISP_WBG_R : R/W; bitpos: [11:0]; default: 256;
 *  Configures the white balance red gain
 */
#define ISP_WBG_R    0x00000FFFU
#define ISP_WBG_R_M  (ISP_WBG_R_V << ISP_WBG_R_S)
#define ISP_WBG_R_V  0x00000FFFU
#define ISP_WBG_R_S  0

/** ISP_WBG_COEF_G_REG register
 *  white balance green gain register 0
 */
#define ISP_WBG_COEF_G_REG (DR_REG_ISP_BASE + 0x258)
/** ISP_WBG_G : R/W; bitpos: [11:0]; default: 256;
 *  Configures the white balance green gain
 */
#define ISP_WBG_G    0x00000FFFU
#define ISP_WBG_G_M  (ISP_WBG_G_V << ISP_WBG_G_S)
#define ISP_WBG_G_V  0x00000FFFU
#define ISP_WBG_G_S  0

/** ISP_WBG_COEF_B_REG register
 *  white balance blue gain register 0
 */
#define ISP_WBG_COEF_B_REG (DR_REG_ISP_BASE + 0x25c)
/** ISP_WBG_B : R/W; bitpos: [11:0]; default: 256;
 *  Configures the white balance blue gain
 */
#define ISP_WBG_B    0x00000FFFU
#define ISP_WBG_B_M  (ISP_WBG_B_V << ISP_WBG_B_S)
#define ISP_WBG_B_V  0x00000FFFU
#define ISP_WBG_B_S  0

/** ISP_COLOR_HUE_CTRL_REG register
 *  color control register
 */
#define ISP_COLOR_HUE_CTRL_REG (DR_REG_ISP_BASE + 0x260)
/** ISP_COLOR_HUE_H : R/W; bitpos: [0]; default: 0;
 *  Configures the color hue angle most bit
 */
#define ISP_COLOR_HUE_H    (BIT(0))
#define ISP_COLOR_HUE_H_M  (ISP_COLOR_HUE_H_V << ISP_COLOR_HUE_H_S)
#define ISP_COLOR_HUE_H_V  0x00000001U
#define ISP_COLOR_HUE_H_S  0

/** ISP_AWB_BX_REG register
 *  awb window register in x-direction
 */
#define ISP_AWB_BX_REG (DR_REG_ISP_BASE + 0x264)
/** ISP_AWB_X_BSIZE : R/W; bitpos: [11:0]; default: 0;
 *  Configures every block x size, min number is 4
 */
#define ISP_AWB_X_BSIZE    0x00000FFFU
#define ISP_AWB_X_BSIZE_M  (ISP_AWB_X_BSIZE_V << ISP_AWB_X_BSIZE_S)
#define ISP_AWB_X_BSIZE_V  0x00000FFFU
#define ISP_AWB_X_BSIZE_S  0
/** ISP_AWB_X_START : R/W; bitpos: [23:12]; default: 0;
 *  Configures first block start x address
 */
#define ISP_AWB_X_START    0x00000FFFU
#define ISP_AWB_X_START_M  (ISP_AWB_X_START_V << ISP_AWB_X_START_S)
#define ISP_AWB_X_START_V  0x00000FFFU
#define ISP_AWB_X_START_S  12

/** ISP_AWB_BY_REG register
 *  awb window register in y-direction
 */
#define ISP_AWB_BY_REG (DR_REG_ISP_BASE + 0x268)
/** ISP_AWB_Y_BSIZE : R/W; bitpos: [11:0]; default: 0;
 *  Configures every block y size
 */
#define ISP_AWB_Y_BSIZE    0x00000FFFU
#define ISP_AWB_Y_BSIZE_M  (ISP_AWB_Y_BSIZE_V << ISP_AWB_Y_BSIZE_S)
#define ISP_AWB_Y_BSIZE_V  0x00000FFFU
#define ISP_AWB_Y_BSIZE_S  0
/** ISP_AWB_Y_START : R/W; bitpos: [23:12]; default: 0;
 *  Configures first block start y address
 */
#define ISP_AWB_Y_START    0x00000FFFU
#define ISP_AWB_Y_START_M  (ISP_AWB_Y_START_V << ISP_AWB_Y_START_S)
#define ISP_AWB_Y_START_V  0x00000FFFU
#define ISP_AWB_Y_START_S  12

/** ISP_STATE_REG register
 *  awb window register in y-direction
 */
#define ISP_STATE_REG (DR_REG_ISP_BASE + 0x26c)
/** ISP_TAIL_BUSY : RO; bitpos: [0]; default: 0;
 *  Represents isp_tail state
 */
#define ISP_TAIL_BUSY    (BIT(0))
#define ISP_TAIL_BUSY_M  (ISP_TAIL_BUSY_V << ISP_TAIL_BUSY_S)
#define ISP_TAIL_BUSY_V  0x00000001U
#define ISP_TAIL_BUSY_S  0
/** ISP_HEADER_BUSY : RO; bitpos: [1]; default: 0;
 *  Represents isp_header state
 */
#define ISP_HEADER_BUSY    (BIT(1))
#define ISP_HEADER_BUSY_M  (ISP_HEADER_BUSY_V << ISP_HEADER_BUSY_S)
#define ISP_HEADER_BUSY_V  0x00000001U
#define ISP_HEADER_BUSY_S  1

/** ISP_SHADOW_REG_CTRL_REG register
 *  shadow register ctrl register
 */
#define ISP_SHADOW_REG_CTRL_REG (DR_REG_ISP_BASE + 0x270)
/** ISP_BLC_UPDATE : R/W; bitpos: [0]; default: 0;
 *  Write 1 to update blc configuration register
 */
#define ISP_BLC_UPDATE    (BIT(0))
#define ISP_BLC_UPDATE_M  (ISP_BLC_UPDATE_V << ISP_BLC_UPDATE_S)
#define ISP_BLC_UPDATE_V  0x00000001U
#define ISP_BLC_UPDATE_S  0
/** ISP_DPC_UPDATE : R/W; bitpos: [1]; default: 0;
 *  Write 1 to update dpc configuration register
 */
#define ISP_DPC_UPDATE    (BIT(1))
#define ISP_DPC_UPDATE_M  (ISP_DPC_UPDATE_V << ISP_DPC_UPDATE_S)
#define ISP_DPC_UPDATE_V  0x00000001U
#define ISP_DPC_UPDATE_S  1
/** ISP_BF_UPDATE : R/W; bitpos: [2]; default: 0;
 *  Write 1 to update bf configuration register
 */
#define ISP_BF_UPDATE    (BIT(2))
#define ISP_BF_UPDATE_M  (ISP_BF_UPDATE_V << ISP_BF_UPDATE_S)
#define ISP_BF_UPDATE_V  0x00000001U
#define ISP_BF_UPDATE_S  2
/** ISP_WBG_UPDATE : R/W; bitpos: [3]; default: 0;
 *  Write 1 to update wbg configuration register
 */
#define ISP_WBG_UPDATE    (BIT(3))
#define ISP_WBG_UPDATE_M  (ISP_WBG_UPDATE_V << ISP_WBG_UPDATE_S)
#define ISP_WBG_UPDATE_V  0x00000001U
#define ISP_WBG_UPDATE_S  3
/** ISP_CCM_UPDATE : R/W; bitpos: [4]; default: 0;
 *  Write 1 to update ccm configuration register
 */
#define ISP_CCM_UPDATE    (BIT(4))
#define ISP_CCM_UPDATE_M  (ISP_CCM_UPDATE_V << ISP_CCM_UPDATE_S)
#define ISP_CCM_UPDATE_V  0x00000001U
#define ISP_CCM_UPDATE_S  4
/** ISP_SHARP_UPDATE : R/W; bitpos: [6]; default: 0;
 *  Write 1 to update sharp configuration register
 */
#define ISP_SHARP_UPDATE    (BIT(6))
#define ISP_SHARP_UPDATE_M  (ISP_SHARP_UPDATE_V << ISP_SHARP_UPDATE_S)
#define ISP_SHARP_UPDATE_V  0x00000001U
#define ISP_SHARP_UPDATE_S  6
/** ISP_COLOR_UPDATE : R/W; bitpos: [7]; default: 0;
 *  Write 1 to update color configuration register
 */
#define ISP_COLOR_UPDATE    (BIT(7))
#define ISP_COLOR_UPDATE_M  (ISP_COLOR_UPDATE_V << ISP_COLOR_UPDATE_S)
#define ISP_COLOR_UPDATE_V  0x00000001U
#define ISP_COLOR_UPDATE_S  7
/** ISP_SHADOW_UPDATE_SEL : R/W; bitpos: [31:30]; default: 1;
 ...
 */
#define ISP_SHADOW_UPDATE_SEL    0x00000003U
#define ISP_SHADOW_UPDATE_SEL_M  (ISP_SHADOW_UPDATE_SEL_V << ISP_SHADOW_UPDATE_SEL_S)
#define ISP_SHADOW_UPDATE_SEL_V  0x00000003U
#define ISP_SHADOW_UPDATE_SEL_S  30
