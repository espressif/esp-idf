...
typedef union {
    struct {
        /** hp_peri_pms_date : R/W; bitpos: [31:0]; default: 2363943;
         *  Version control register.
         */
...
typedef union {
    struct {
        ...
        /** coren_mm_hp_h264_dma2d_allow : R/W; bitpos: [29]; default: 1;
         *  Configures whether HP CPUn in machine mode has permission to access 2D-DMA.
         *  0: Not allowed
         *  1: Allowed
         */
        uint32_t coren_mm_hp_axi_perf_mon_allow:1;
...
typedef union {
    struct {
        ...
        /** coren_um_hp_h264_dma2d_allow : R/W; bitpos: [29]; default: 1;
         *  Configures whether HP CPUn in machine mode has permission to access 2D-DMA.
         *  0: Not allowed
         *  1: Allowed
         */
        uint32_t coren_um_hp_axi_perf_mon_allow:1;
        uint32_t reserved_30:2;
    };
    uint32_t val;
...
/** Type of regdma_hp_peri_pms register
 *  HP Peripheral Permission register for REGDMA
 */
typedef union {
    struct {
        /** regdma_peri_hp_peri_allow : R/W; bitpos: [0]; default: 1;
         *  Configures whether REGDMA has permission to access  all HP peripherals.
         *  0: Not allowed
         *  1: Allow
         */
        uint32_t regdma_peri_hp_peri_allow:1;
        uint32_t reserved_1:31;
    };
    uint32_t val;
} pms_regdma_hp_peri_pms_reg_t;
...
typedef struct {
    ...
    volatile pms_regdma_hp_peri_pms_reg_t regdma_hp_peri_pms;
} hp_peri_pms_dev_t;
