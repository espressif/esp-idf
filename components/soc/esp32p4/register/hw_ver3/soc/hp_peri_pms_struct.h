...
typedef union {
    struct {
        ...
        /** reg_core0_mm_axi_perf_mon_allow : R/W; bitpos: [29]; default: 1;
         *  NA
         */
        uint32_t reg_core0_mm_axi_perf_mon_allow:1;
...
typedef union {
    struct {
        ...
        /** reg_core0_um_axi_perf_mon_allow : R/W; bitpos: [29]; default: 1;
         *  NA
         */
        uint32_t reg_core0_um_axi_perf_mon_allow:1;
        uint32_t reserved_30:2;
    };
    uint32_t val;
...
typedef union {
    struct {
        ...
        /** reg_core1_mm_axi_perf_mon_allow : R/W; bitpos: [29]; default: 1;
         *  NA
         */
        uint32_t reg_core1_mm_axi_perf_mon_allow:1;
        uint32_t reserved_30:2;
    };
    uint32_t val;
...
typedef union {
    struct {
        ...
        /** reg_core1_um_axi_perf_mon_allow : R/W; bitpos: [29]; default: 1;
         *  NA
         */
        uint32_t reg_core1_um_axi_perf_mon_allow:1;
        uint32_t reserved_30:2;
    };
    uint32_t val;
