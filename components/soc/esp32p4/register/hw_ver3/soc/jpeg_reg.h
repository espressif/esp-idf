...
/** JPEG_QNR_PRECISION : R/W; bitpos: [2]; default: 0;
 *  0:8bit qnr,1:12bit qnr(TBD)
 */
#define JPEG_QNR_PRECISION    (BIT(2))
#define JPEG_QNR_PRECISION_M  (JPEG_QNR_PRECISION_V << JPEG_QNR_PRECISION_S)
#define JPEG_QNR_PRECISION_V  0x00000001U
...
/** JPEG_QNR_FIFO_EN : R/W; bitpos: [8]; default: 1;
 *  0:use non-fifo way to access qnr ram,1:use fifo way to access qnr ram
 */
#define JPEG_QNR_FIFO_EN    (BIT(8))
#define JPEG_QNR_FIFO_EN_M  (JPEG_QNR_FIFO_EN_V << JPEG_QNR_FIFO_EN_S)
#define JPEG_QNR_FIFO_EN_V  0x00000001U
#define JPEG_QNR_FIFO_EN_S  8
...
/** JPEG_EXTD_CONFIG_REG register
 *  Control and configuration registers
 */
#define JPEG_EXTD_CONFIG_REG (DR_REG_JPEG_BASE + 0xc)
/** JPEG_EXTD_COLOR_SPACE_EN : R/W; bitpos: [0]; default: 0;
 *  Configure whether to extend picture's color space
 *  0:disable
 *  1:enable
 */
#define JPEG_EXTD_COLOR_SPACE_EN    (BIT(0))
#define JPEG_EXTD_COLOR_SPACE_EN_M  (JPEG_EXTD_COLOR_SPACE_EN_V << JPEG_EXTD_COLOR_SPACE_EN_S)
#define JPEG_EXTD_COLOR_SPACE_EN_V  0x00000001U
#define JPEG_EXTD_COLOR_SPACE_EN_S  0
/** JPEG_EXTD_COLOR_SPACE : R/W; bitpos: [1]; default: 0;
 *  Configure extended picture's color space. Valid when JPEG_EXTD_COLOR_SPACE_EN
 *  configured to 1
 *  0:yuv444
 *  1:yuv420
 */
#define JPEG_EXTD_COLOR_SPACE    (BIT(1))
#define JPEG_EXTD_COLOR_SPACE_M  (JPEG_EXTD_COLOR_SPACE_V << JPEG_EXTD_COLOR_SPACE_S)
#define JPEG_EXTD_COLOR_SPACE_V  0x00000001U
#define JPEG_EXTD_COLOR_SPACE_S  1
...
/** JPEG_JPEG_VER : R/W; bitpos: [27:0]; default: 37823072;
 *  Reserved
 */
