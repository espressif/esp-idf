...
typedef union {
    struct {
        /** out_cmdfifo_buf_len_hb_ch0 : RO; bitpos: [27:0]; default: 0;
         *  only for debug
         */
        uint32_t out_cmdfifo_buf_len_hb_ch0:28;
...
typedef union {
    struct {
        /** out_cmdfifo_buf_len_hb_ch1 : RO; bitpos: [27:0]; default: 0;
         *  only for debug
         */
        uint32_t out_cmdfifo_buf_len_hb_ch1:28;
        uint32_t reserved_28:4;
    };
    uint32_t val;
...
typedef union {
    struct {
        /** out_cmdfifo_buf_len_hb_ch2 : RO; bitpos: [27:0]; default: 0;
         *  only for debug
         */
        uint32_t out_cmdfifo_buf_len_hb_ch2:28;
        uint32_t reserved_28:4;
    };
    uint32_t val;
...
typedef union {
    struct {
        /** out_cmdfifo_buf_len_hb_ch3 : RO; bitpos: [27:0]; default: 0;
         *  only for debug
         */
        uint32_t out_cmdfifo_buf_len_hb_ch3:28;
        uint32_t reserved_28:4;
    };
    uint32_t val;
...
typedef union {
    struct {
        /** out_cmdfifo_buf_len_hb_ch4 : RO; bitpos: [27:0]; default: 0;
         *  only for debug
         */
        uint32_t out_cmdfifo_buf_len_hb_ch4:28;
        uint32_t reserved_28:4;
    };
    uint32_t val;
...
/** Type of ch_dbg_en register
 *  channel debug enable register
 */
typedef union {
    struct {
        /** out_ch0_dbg_en : R/W; bitpos: [0]; default: 0;
         *  configures whether to enable out channel 0 debug. 0: disable, 1: enable
         */
        uint32_t out_ch0_dbg_en:1;
        /** out_ch1_dbg_en : R/W; bitpos: [1]; default: 0;
         *  configures whether to enable out channel 1 debug. 0: disable, 1: enable
         */
        uint32_t out_ch1_dbg_en:1;
        /** out_ch2_dbg_en : R/W; bitpos: [2]; default: 0;
         *  configures whether to enable out channel 2 debug. 0: disable, 1: enable
         */
        uint32_t out_ch2_dbg_en:1;
        /** out_ch3_dbg_en : R/W; bitpos: [3]; default: 0;
         *  configures whether to enable out channel 3 debug. 0: disable, 1: enable
         */
        uint32_t out_ch3_dbg_en:1;
        /** out_ch4_dbg_en : R/W; bitpos: [4]; default: 0;
         *  configures whether to enable out channel 4 debug. 0: disable, 1: enable
         */
        uint32_t out_ch4_dbg_en:1;
        uint32_t reserved_5:11;
        /** in_ch0_dbg_en : R/W; bitpos: [16]; default: 0;
         *  configures whether to enable in channel 0 debug. 0: disable, 1: enable
         */
        uint32_t in_ch0_dbg_en:1;
        /** in_ch1_dbg_en : R/W; bitpos: [17]; default: 0;
         *  configures whether to enable in channel 1 debug. 0: disable, 1: enable
         */
        uint32_t in_ch1_dbg_en:1;
        /** in_ch2_dbg_en : R/W; bitpos: [18]; default: 0;
         *  configures whether to enable in channel 2 debug. 0: disable, 1: enable
         */
        uint32_t in_ch2_dbg_en:1;
        /** in_ch3_dbg_en : R/W; bitpos: [19]; default: 0;
         *  configures whether to enable in channel 3 debug. 0: disable, 1: enable
         */
        uint32_t in_ch3_dbg_en:1;
        /** in_ch4_dbg_en : R/W; bitpos: [20]; default: 0;
         *  configures whether to enable in channel 4 debug. 0: disable, 1: enable
         */
        uint32_t in_ch4_dbg_en:1;
        /** in_ch5_dbg_en : R/W; bitpos: [21]; default: 0;
         *  configures whether to enable in channel 5 debug. 0: disable, 1: enable
         */
        uint32_t in_ch5_dbg_en:1;
        uint32_t reserved_22:10;
    };
    uint32_t val;
} h264_dma_ch_dbg_en_reg_t;

/** Type of out_ch0_dbg_data_l register
 *  out channel 0 debug data register
 */
typedef union {
    struct {
        /** out_ch0_dbg_data_l : R/W; bitpos: [31:0]; default: 0;
         *  configures out channel 0 debug data bit 31-0
         */
        uint32_t out_ch0_dbg_data_l:32;
    };
    uint32_t val;
} h264_dma_out_ch0_dbg_data_l_reg_t;

/** Type of out_ch0_dbg_data_h register
 *  out channel 0 debug data register
 */
typedef union {
    struct {
        /** out_ch0_dbg_data_h : R/W; bitpos: [31:0]; default: 0;
         *  configures out channel 0 debug data bit 63-32
         */
        uint32_t out_ch0_dbg_data_h:32;
    };
    uint32_t val;
} h264_dma_out_ch0_dbg_data_h_reg_t;

/** Type of out_ch1_dbg_data_l register
 *  out channel 1 debug data register
 */
typedef union {
    struct {
        /** out_ch1_dbg_data_l : R/W; bitpos: [31:0]; default: 0;
         *  configures out channel 1 debug data bit 31-0
         */
        uint32_t out_ch1_dbg_data_l:32;
    };
    uint32_t val;
} h264_dma_out_ch1_dbg_data_l_reg_t;

/** Type of out_ch1_dbg_data_h register
 *  out channel 1 debug data register
 */
typedef union {
    struct {
        /** out_ch1_dbg_data_h : R/W; bitpos: [31:0]; default: 0;
         *  configures out channel 1 debug data bit 63-32
         */
        uint32_t out_ch1_dbg_data_h:32;
    };
    uint32_t val;
} h264_dma_out_ch1_dbg_data_h_reg_t;

/** Type of out_ch2_dbg_data_l register
 *  out channel 2 debug data register
 */
typedef union {
    struct {
        /** out_ch2_dbg_data_l : R/W; bitpos: [31:0]; default: 0;
         *  configures out channel 2 debug data bit 31-0
         */
        uint32_t out_ch2_dbg_data_l:32;
    };
    uint32_t val;
} h264_dma_out_ch2_dbg_data_l_reg_t;

/** Type of out_ch2_dbg_data_h register
 *  out channel 2 debug data register
 */
typedef union {
    struct {
        /** out_ch2_dbg_data_h : R/W; bitpos: [31:0]; default: 0;
         *  configures out channel 2 debug data bit 63-32
         */
        uint32_t out_ch2_dbg_data_h:32;
    };
    uint32_t val;
} h264_dma_out_ch2_dbg_data_h_reg_t;

/** Type of out_ch3_dbg_data_l register
 *  out channel 3 debug data register
 */
typedef union {
    struct {
        /** out_ch3_dbg_data_l : R/W; bitpos: [31:0]; default: 0;
         *  configures out channel 3 debug data bit 31-0
         */
        uint32_t out_ch3_dbg_data_l:32;
    };
    uint32_t val;
} h264_dma_out_ch3_dbg_data_l_reg_t;

/** Type of out_ch3_dbg_data_h register
 *  out channel 3 debug data register
 */
typedef union {
    struct {
        /** out_ch3_dbg_data_h : R/W; bitpos: [31:0]; default: 0;
         *  configures out channel 3 debug data bit 63-32
         */
        uint32_t out_ch3_dbg_data_h:32;
    };
    uint32_t val;
} h264_dma_out_ch3_dbg_data_h_reg_t;

/** Type of out_ch4_dbg_data_l register
 *  out channel 4 debug data register
 */
typedef union {
    struct {
        /** out_ch4_dbg_data_l : R/W; bitpos: [31:0]; default: 0;
         *  configures out channel 4 debug data bit 31-0
         */
        uint32_t out_ch4_dbg_data_l:32;
    };
    uint32_t val;
} h264_dma_out_ch4_dbg_data_l_reg_t;

/** Type of out_ch4_dbg_data_h register
 *  out channel 4 debug data register
 */
typedef union {
    struct {
        /** out_ch4_dbg_data_h : R/W; bitpos: [31:0]; default: 0;
         *  configures out channel 4 debug data bit 63-32
         */
        uint32_t out_ch4_dbg_data_h:32;
    };
    uint32_t val;
} h264_dma_out_ch4_dbg_data_h_reg_t;

/** Type of in_ch0_dbg_data_l register
 *  in channel 0 debug data register
 */
typedef union {
    struct {
        /** in_ch0_dbg_data_l : R/W; bitpos: [31:0]; default: 0;
         *  configures in channel 0 debug data bit 31-0
         */
        uint32_t in_ch0_dbg_data_l:32;
    };
    uint32_t val;
} h264_dma_in_ch0_dbg_data_l_reg_t;

/** Type of in_ch0_dbg_data_h register
 *  in channel 0 debug data register
 */
typedef union {
    struct {
        /** in_ch0_dbg_data_h : R/W; bitpos: [31:0]; default: 0;
         *  configures in channel 0 debug data bit 63-32
         */
        uint32_t in_ch0_dbg_data_h:32;
    };
    uint32_t val;
} h264_dma_in_ch0_dbg_data_h_reg_t;

/** Type of in_ch1_dbg_data_l register
 *  in channel 1 debug data register
 */
typedef union {
    struct {
        /** in_ch1_dbg_data_l : R/W; bitpos: [31:0]; default: 0;
         *  configures in channel 1 debug data bit 31-0
         */
        uint32_t in_ch1_dbg_data_l:32;
    };
    uint32_t val;
} h264_dma_in_ch1_dbg_data_l_reg_t;

/** Type of in_ch1_dbg_data_h register
 *  in channel 1 debug data register
 */
typedef union {
    struct {
        /** in_ch1_dbg_data_h : R/W; bitpos: [31:0]; default: 0;
         *  configures in channel 1 debug data bit 63-32
         */
        uint32_t in_ch1_dbg_data_h:32;
    };
    uint32_t val;
} h264_dma_in_ch1_dbg_data_h_reg_t;

/** Type of in_ch2_dbg_data_l register
 *  in channel 2 debug data register
 */
typedef union {
    struct {
        /** in_ch2_dbg_data_l : R/W; bitpos: [31:0]; default: 0;
         *  configures in channel 2 debug data bit 31-0
         */
        uint32_t in_ch2_dbg_data_l:32;
    };
    uint32_t val;
} h264_dma_in_ch2_dbg_data_l_reg_t;

/** Type of in_ch2_dbg_data_h register
 *  in channel 2 debug data register
 */
typedef union {
    struct {
        /** in_ch2_dbg_data_h : R/W; bitpos: [31:0]; default: 0;
         *  configures in channel 2 debug data bit 63-32
         */
        uint32_t in_ch2_dbg_data_h:32;
    };
    uint32_t val;
} h264_dma_in_ch2_dbg_data_h_reg_t;

/** Type of in_ch3_dbg_data_l register
 *  in channel 3 debug data register
 */
typedef union {
    struct {
        /** in_ch3_dbg_data_l : R/W; bitpos: [31:0]; default: 0;
         *  configures in channel 3 debug data bit 31-0
         */
        uint32_t in_ch3_dbg_data_l:32;
    };
    uint32_t val;
} h264_dma_in_ch3_dbg_data_l_reg_t;

/** Type of in_ch3_dbg_data_h register
 *  in channel 3 debug data register
 */
typedef union {
    struct {
        /** in_ch3_dbg_data_h : R/W; bitpos: [31:0]; default: 0;
         *  configures in channel 3 debug data bit 63-32
         */
        uint32_t in_ch3_dbg_data_h:32;
    };
    uint32_t val;
} h264_dma_in_ch3_dbg_data_h_reg_t;

/** Type of in_ch4_dbg_data_l register
 *  in channel 4 debug data register
 */
typedef union {
    struct {
        /** in_ch4_dbg_data_l : R/W; bitpos: [31:0]; default: 0;
         *  configures in channel 4 debug data bit 31-0
         */
        uint32_t in_ch4_dbg_data_l:32;
    };
    uint32_t val;
} h264_dma_in_ch4_dbg_data_l_reg_t;

/** Type of in_ch4_dbg_data_h register
 *  in channel 4 debug data register
 */
typedef union {
    struct {
        /** in_ch4_dbg_data_h : R/W; bitpos: [31:0]; default: 0;
         *  configures in channel 4 debug data bit 63-32
         */
        uint32_t in_ch4_dbg_data_h:32;
    };
    uint32_t val;
} h264_dma_in_ch4_dbg_data_h_reg_t;

/** Type of in_ch5_dbg_data_l register
 *  in channel 5 debug data register
 */
typedef union {
    struct {
        /** in_ch5_dbg_data_l : R/W; bitpos: [31:0]; default: 0;
         *  configures in channel 5 debug data bit 31-0
         */
        uint32_t in_ch5_dbg_data_l:32;
    };
    uint32_t val;
} h264_dma_in_ch5_dbg_data_l_reg_t;

/** Type of in_ch5_dbg_data_h register
 *  in channel 5 debug data register
 */
typedef union {
    struct {
        /** in_ch5_dbg_data_h : R/W; bitpos: [31:0]; default: 0;
         *  configures in channel 5 debug data bit 63-32
         */
        uint32_t in_ch5_dbg_data_h:32;
    };
    uint32_t val;
} h264_dma_in_ch5_dbg_data_h_reg_t;
...
typedef struct {
    ...
    volatile h264_dma_ch_dbg_en_reg_t ch_dbg_en;
    volatile h264_dma_out_ch0_dbg_data_l_reg_t out_ch0_dbg_data_l;
    volatile h264_dma_out_ch0_dbg_data_h_reg_t out_ch0_dbg_data_h;
    volatile h264_dma_out_ch1_dbg_data_l_reg_t out_ch1_dbg_data_l;
    volatile h264_dma_out_ch1_dbg_data_h_reg_t out_ch1_dbg_data_h;
    volatile h264_dma_out_ch2_dbg_data_l_reg_t out_ch2_dbg_data_l;
    volatile h264_dma_out_ch2_dbg_data_h_reg_t out_ch2_dbg_data_h;
    volatile h264_dma_out_ch3_dbg_data_l_reg_t out_ch3_dbg_data_l;
    volatile h264_dma_out_ch3_dbg_data_h_reg_t out_ch3_dbg_data_h;
    volatile h264_dma_out_ch4_dbg_data_l_reg_t out_ch4_dbg_data_l;
    volatile h264_dma_out_ch4_dbg_data_h_reg_t out_ch4_dbg_data_h;
    volatile h264_dma_in_ch0_dbg_data_l_reg_t in_ch0_dbg_data_l;
    volatile h264_dma_in_ch0_dbg_data_h_reg_t in_ch0_dbg_data_h;
    volatile h264_dma_in_ch1_dbg_data_l_reg_t in_ch1_dbg_data_l;
    volatile h264_dma_in_ch1_dbg_data_h_reg_t in_ch1_dbg_data_h;
    volatile h264_dma_in_ch2_dbg_data_l_reg_t in_ch2_dbg_data_l;
    volatile h264_dma_in_ch2_dbg_data_h_reg_t in_ch2_dbg_data_h;
    volatile h264_dma_in_ch3_dbg_data_l_reg_t in_ch3_dbg_data_l;
    volatile h264_dma_in_ch3_dbg_data_h_reg_t in_ch3_dbg_data_h;
    volatile h264_dma_in_ch4_dbg_data_l_reg_t in_ch4_dbg_data_l;
    volatile h264_dma_in_ch4_dbg_data_h_reg_t in_ch4_dbg_data_h;
    volatile h264_dma_in_ch5_dbg_data_l_reg_t in_ch5_dbg_data_l;
    volatile h264_dma_in_ch5_dbg_data_h_reg_t in_ch5_dbg_data_h;
} h264_dma_dev_t;

extern h264_dma_dev_t H264_DMA;
