...
typedef union {
    struct {
        ...
        /** reg_usb_otg11_sys_clk_en : R/W; bitpos: [15]; default: 0;
         *  Reserved
         */
...
typedef union {
    struct {
        ...
        /** reg_l2cache_l2mem_clk_en : R/W; bitpos: [4]; default: 1;
         *  Reserved
         */
        uint32_t reg_l2cache_l2mem_clk_en:1;
...
typedef union {
    struct {
        ...
        /** reg_mipi_dsi_dphy_pll_refclk_src_sel : R/W; bitpos: [18:16]; default: 0;
         *  Reserved
         */
        uint32_t reg_mipi_dsi_dphy_pll_refclk_src_sel:3;
        /** reg_mipi_dsi_dphy_pll_refclk_div_num : R/W; bitpos: [26:19]; default: 1;
         *  Reserved
         */
        uint32_t reg_mipi_dsi_dphy_pll_refclk_div_num:8;
...
typedef union {
    struct {
        ...
        /** reg_l2cache_l2mem_clk_force_on : R/W; bitpos: [18]; default: 1;
         *  Reserved
         */
        uint32_t reg_l2cache_l2mem_clk_force_on:1;
...
/** Group: axi_perf_mon_clkrst_ctrl */
/** Type of axi_perf_mon_clkrst_ctrl0 register
 *  Reserved
 */
typedef union {
    struct {
        /** reg_axi_perf_mon_sys_clk_en : R/W; bitpos: [0]; default: 0;
         *  Configures axi_perf_mon clk enable
         */
        uint32_t reg_axi_perf_mon_sys_clk_en:1;
        /** reg_axi_perf_mon_sys_rst_en : R/W; bitpos: [1]; default: 0;
         *  Configures axi_perf_mon rst enable
         */
        uint32_t reg_axi_perf_mon_sys_rst_en:1;
        uint32_t reserved_2:30;
    };
    uint32_t val;
} hp_sys_clkrst_axi_perf_mon_clkrst_ctrl0_reg_t;


/** Group: cpu_waiti_ctrl */
/** Type of cpu_waiti_ctrl0 register
 *  Reserved
 */
typedef union {
    struct {
        /** reg_core0_waiti_icg_en : R/W; bitpos: [0]; default: 1;
         *  Configures whether cpu core0 waiti signal can control clock gate. If both core0 and
         *  core1 waiti_icg_en is 1, then only when core0 and core1 all in waiti will close
         *  related clock
         */
        uint32_t reg_core0_waiti_icg_en:1;
        /** reg_core1_waiti_icg_en : R/W; bitpos: [1]; default: 1;
         *  Configures whether cpu core1 waiti signal can control clock gate. If both core0 and
         *  core1 waiti_icg_en is 1, then only when core0 and core1 all in waiti will close
         *  related clock
         */
        uint32_t reg_core1_waiti_icg_en:1;
        uint32_t reserved_2:30;
    };
    uint32_t val;
} hp_sys_clkrst_cpu_waiti_ctrl0_reg_t;
...
typedef struct {
    ...
    volatile hp_sys_clkrst_axi_perf_mon_clkrst_ctrl0_reg_t axi_perf_mon_clkrst_ctrl0;
    volatile hp_sys_clkrst_cpu_waiti_ctrl0_reg_t cpu_waiti_ctrl0;
} hp_sys_clkrst_dev_t;

extern hp_sys_clkrst_dev_t HP_SYS_CLKRST;

#ifndef __cplusplus
_Static_assert(sizeof(hp_sys_clkrst_dev_t) == 0xf8, "Invalid size of hp_sys_clkrst_dev_t structure");
#endif
