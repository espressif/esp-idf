...
typedef union {
    struct {
        /** tx_start_ch0 : WT; bitpos: [0]; default: 0;
         *  Set this bit to start sending data on CHANNELn.
         */
        uint32_t tx_start_ch0:1;
        /** mem_rd_rst_ch0 : WT; bitpos: [1]; default: 0;
         *  Set this bit to reset read ram address for CHANNELn by accessing transmitter.
         */
        uint32_t mem_rd_rst_ch0:1;
        /** apb_mem_rst_ch0 : WT; bitpos: [2]; default: 0;
         *  Set this bit to reset W/R ram address for CHANNELn by accessing apb fifo.
         */
        uint32_t apb_mem_rst_ch0:1;
        /** tx_conti_mode_ch0 : R/W; bitpos: [3]; default: 0;
         *  Set this bit to restart transmission  from the first data to the last data in
         *  CHANNELn.
         */
        uint32_t tx_conti_mode_ch0:1;
        /** mem_tx_wrap_en_ch0 : R/W; bitpos: [4]; default: 0;
         ...
         */
        uint32_t mem_tx_wrap_en_ch0:1;
        /** idle_out_lv_ch0 : R/W; bitpos: [5]; default: 0;
         *  This bit configures the level of output signal in CHANNELn when the latter is in
         *  IDLE state.
         */
        uint32_t idle_out_lv_ch0:1;
        /** idle_out_en_ch0 : R/W; bitpos: [6]; default: 0;
         *  This is the output enable-control bit for CHANNELn in IDLE state.
         */
        uint32_t idle_out_en_ch0:1;
        /** tx_stop_ch0 : R/W/SC; bitpos: [7]; default: 0;
         *  Set this bit to stop the transmitter of CHANNELn sending data out.
         */
        uint32_t tx_stop_ch0:1;
        /** div_cnt_ch0 : R/W; bitpos: [15:8]; default: 2;
         *  This register is used to configure the divider for clock of CHANNELn.
         */
        uint32_t div_cnt_ch0:8;
        /** mem_size_ch0 : R/W; bitpos: [19:16]; default: 1;
         *  This register is used to configure the maximum size of memory allocated to CHANNELn.
         */
        uint32_t mem_size_ch0:4;
        /** carrier_eff_en_ch0 : R/W; bitpos: [20]; default: 1;
         ...
         */
        uint32_t carrier_eff_en_ch0:1;
        /** carrier_en_ch0 : R/W; bitpos: [21]; default: 1;
         ...
         */
        uint32_t carrier_en_ch0:1;
        /** carrier_out_lv_ch0 : R/W; bitpos: [22]; default: 1;
         *  This bit is used to configure the position of carrier wave for CHANNELn.1'h0: add
         *  carrier wave on low level.1'h1: add carrier wave on high level.
         */
        uint32_t carrier_out_lv_ch0:1;
        uint32_t reserved_23:1;
        /** conf_update_ch0 : WT; bitpos: [24]; default: 0;
         *  synchronization bit for CHANNELn
         */
        uint32_t conf_update_ch0:1;
...
typedef union {
    struct {
        /** div_cnt_ch4 : R/W; bitpos: [7:0]; default: 2;
         *  This register is used to configure the divider for clock of CHANNELm.
         */
        uint32_t div_cnt_ch4:8;
        /** idle_thres_ch4 : R/W; bitpos: [22:8]; default: 32767;
         ...
         */
        uint32_t idle_thres_ch4:15;
        uint32_t reserved_23:1;
        /** mem_size_ch4 : R/W; bitpos: [27:24]; default: 1;
         *  This register is used to configure the maximum size of memory allocated to CHANNELm.
         */
        uint32_t mem_size_ch4:4;
        /** carrier_en_ch4 : R/W; bitpos: [28]; default: 1;
         *  This is the carrier modulation enable-control bit for CHANNELm. 1: Add carrier
         *  modulation in the output signal. 0: No carrier modulation in sig_out.
         */
        uint32_t carrier_en_ch4:1;
        /** carrier_out_lv_ch4 : R/W; bitpos: [29]; default: 1;
         *  This bit is used to configure the position of carrier wave for CHANNELm.1'h0: add
         *  carrier wave on low level.1'h1: add carrier wave on high level.
         */
        uint32_t carrier_out_lv_ch4:1;
...
typedef union {
    struct {
        /** rx_en_ch4 : R/W; bitpos: [0]; default: 0;
         *  Set this bit to enable receiver to receive data on CHANNELm.
         */
        uint32_t rx_en_ch4:1;
        /** mem_wr_rst_ch4 : WT; bitpos: [1]; default: 0;
         *  Set this bit to reset write ram address for CHANNELm by accessing receiver.
         */
        uint32_t mem_wr_rst_ch4:1;
        /** apb_mem_rst_ch4 : WT; bitpos: [2]; default: 0;
         *  Set this bit to reset W/R ram address for CHANNELm by accessing apb fifo.
         */
        uint32_t apb_mem_rst_ch4:1;
        /** mem_owner_ch4 : R/W/SC; bitpos: [3]; default: 1;
         *  This register marks the ownership of CHANNELm's ram block.1'h1: Receiver is using
         *  the ram. 1'h0: APB bus is using the ram.
         */
        uint32_t mem_owner_ch4:1;
        /** rx_filter_en_ch4 : R/W; bitpos: [4]; default: 0;
         *  This is the receive filter's enable bit for CHANNELm.
         */
        uint32_t rx_filter_en_ch4:1;
        /** rx_filter_thres_ch4 : R/W; bitpos: [12:5]; default: 15;
         *  Ignores the input pulse when its width is smaller than this register value in APB
         *  clock periods (in receive mode).
         */
        uint32_t rx_filter_thres_ch4:8;
        /** mem_rx_wrap_en_ch4 : R/W; bitpos: [13]; default: 0;
         ...
         */
        uint32_t mem_rx_wrap_en_ch4:1;
        uint32_t reserved_14:1;
        /** conf_update_ch4 : WT; bitpos: [15]; default: 0;
         *  synchronization bit for CHANNELm
         */
        uint32_t conf_update_ch4:1;
...
typedef union {
    struct {
        /** carrier_low_thres_ch4 : R/W; bitpos: [15:0]; default: 0;
        ...
        /** carrier_high_thres_ch4 : R/W; bitpos: [31:16]; default: 0;
...
typedef union {
    struct {
        /** rx_lim_ch4 : R/W; bitpos: [8:0]; default: 128;
