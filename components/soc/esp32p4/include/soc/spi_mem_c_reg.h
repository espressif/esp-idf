...
/** SPI_MEM_C_AR_SIZE0_1_SUPPORT_EN : R/W; bitpos: [21]; default: 1;
 ...
 */
#define SPI_MEM_C_AR_SIZE0_1_SUPPORT_EN    (BIT(21))
#define SPI_MEM_C_AR_SIZE0_1_SUPPORT_EN_M  (SPI_MEM_C_AR_SIZE0_1_SUPPORT_EN_V << SPI_MEM_C_AR_SIZE0_1_SUPPORT_EN_S)
#define SPI_MEM_C_AR_SIZE0_1_SUPPORT_EN_V  0x00000001U
#define SPI_MEM_C_AR_SIZE0_1_SUPPORT_EN_S  21
/** SPI_MEM_C_AW_SIZE0_1_SUPPORT_EN : R/W; bitpos: [22]; default: 1;
 *  1: MSPI supports AWSIZE 0~3. 0: When AWSIZE 0~1, MSPI reply SLV_ERR.
 */
#define SPI_MEM_C_AW_SIZE0_1_SUPPORT_EN    (BIT(22))
#define SPI_MEM_C_AW_SIZE0_1_SUPPORT_EN_M  (SPI_MEM_C_AW_SIZE0_1_SUPPORT_EN_V << SPI_MEM_C_AW_SIZE0_1_SUPPORT_EN_S)
#define SPI_MEM_C_AW_SIZE0_1_SUPPORT_EN_V  0x00000001U
#define SPI_MEM_C_AW_SIZE0_1_SUPPORT_EN_S  22
/** SPI_MEM_C_AXI_RDATA_BACK_FAST : HRO; bitpos: [23]; default: 1;
 ...
 */
#define SPI_MEM_C_AXI_RDATA_BACK_FAST    (BIT(23))
#define SPI_MEM_C_AXI_RDATA_BACK_FAST_M  (SPI_MEM_C_AXI_RDATA_BACK_FAST_V << SPI_MEM_C_AXI_RDATA_BACK_FAST_S)
#define SPI_MEM_C_AXI_RDATA_BACK_FAST_V  0x00000001U
#define SPI_MEM_C_AXI_RDATA_BACK_FAST_S  23
...
/** SPI_MEM_C_AR_SPLICE_EN : HRO; bitpos: [25]; default: 0;
...
/** SPI_MEM_C_AW_SPLICE_EN : HRO; bitpos: [26]; default: 0;
...
/** SPI_MEM_C_SPLIT_TRANS_EN : R/W; bitpos: [24]; default: 1;
...
/** SPI_MEM_C_USR_DBYTELEN : HRO; bitpos: [8:6]; default: 1;
 *  SPI0 USR_CMD read or write data byte length -1
 */
#define SPI_MEM_C_USR_DBYTELEN    0x00000007U
#define SPI_MEM_C_USR_DBYTELEN_M  (SPI_MEM_C_USR_DBYTELEN_V << SPI_MEM_C_USR_DBYTELEN_S)
#define SPI_MEM_C_USR_DBYTELEN_V  0x00000007U
...
/** SPI_MEM_C_SAME_AW_AR_ADDR_CHK_EN : HRO; bitpos: [30]; default: 1;
 *  Set this bit to check AXI read/write the same address region.
 */
#define SPI_MEM_C_SAME_AW_AR_ADDR_CHK_EN    (BIT(30))
#define SPI_MEM_C_SAME_AW_AR_ADDR_CHK_EN_M  (SPI_SAME_AW_AR_ADDR_CHK_EN_V << SPI_SAME_AW_AR_ADDR_CHK_EN_S)
#define SPI_MEM_C_SAME_AW_AR_ADDR_CHK_EN_V  0x00000001U
#define SPI_MEM_C_SAME_AW_AR_ADDR_CHK_EN_S  30
/** SPI_MEM_C_CLOSE_AXI_INF_EN : R/W; bitpos: [31]; default: 1;
 *  Set this bit to close AXI read/write transfer to MSPI, which means that only
 *  SLV_ERR will be replied to BRESP/RRESP.
 */
#define SPI_MEM_C_CLOSE_AXI_INF_EN    (BIT(31))
#define SPI_MEM_C_CLOSE_AXI_INF_EN_M  (SPI_CLOSE_AXI_INF_EN_V << SPI_CLOSE_AXI_INF_EN_S)
#define SPI_MEM_C_CLOSE_AXI_INF_EN_V  0x00000001U
#define SPI_MEM_C_CLOSE_AXI_INF_EN_S  31
...
/** SPI_MEM_C_SMEM_WDUMMY_DQS_ALWAYS_OUT : HRO; bitpos: [24]; default: 0;
 ...
 */
#define SPI_MEM_C_SMEM_WDUMMY_DQS_ALWAYS_OUT    (BIT(24))
#define SPI_MEM_C_SMEM_WDUMMY_DQS_ALWAYS_OUT_M  (SPI_MEM_C_SMEM_WDUMMY_DQS_ALWAYS_OUT_V << SPI_MEM_C_SMEM_WDUMMY_DQS_ALWAYS_OUT_S)
#define SPI_MEM_C_SMEM_WDUMMY_DQS_ALWAYS_OUT_V  0x00000001U
#define SPI_MEM_C_SMEM_WDUMMY_DQS_ALWAYS_OUT_S  24
/** SPI_MEM_C_SMEM_WDUMMY_ALWAYS_OUT : HRO; bitpos: [25]; default: 0;
 *  In the dummy phase of an MSPI write data transfer when accesses to external RAM,
 *  the level of SPI_IO[7:0] is output by the MSPI controller.
 */
#define SPI_MEM_C_SMEM_WDUMMY_ALWAYS_OUT    (BIT(25))
#define SPI_MEM_C_SMEM_WDUMMY_ALWAYS_OUT_M  (SPI_MEM_C_SMEM_WDUMMY_ALWAYS_OUT_V << SPI_MEM_C_SMEM_WDUMMY_ALWAYS_OUT_S)
#define SPI_MEM_C_SMEM_WDUMMY_ALWAYS_OUT_V  0x00000001U
#define SPI_MEM_C_SMEM_WDUMMY_ALWAYS_OUT_S  25
/** SPI_MEM_C_SMEM_DQS_IE_ALWAYS_ON : HRO; bitpos: [30]; default: 1;
 *  When accesses to external RAM, 1: the IE signals of pads connected to SPI_DQS are
 *  always 1. 0: Others.
 */
#define SPI_MEM_C_SMEM_DQS_IE_ALWAYS_ON    (BIT(30))
#define SPI_MEM_C_SMEM_DQS_IE_ALWAYS_ON_M  (SPI_MEM_C_SMEM_DQS_IE_ALWAYS_ON_V << SPI_MEM_C_SMEM_DQS_IE_ALWAYS_ON_S)
#define SPI_MEM_C_SMEM_DQS_IE_ALWAYS_ON_V  0x00000001U
#define SPI_MEM_C_SMEM_DQS_IE_ALWAYS_ON_S  30
/** SPI_MEM_C_SMEM_DATA_IE_ALWAYS_ON : HRO; bitpos: [31]; default: 1;
 *  When accesses to external RAM, 1: the IE signals of pads connected to SPI_IO[7:0]
 *  are always 1. 0: Others.
 */
#define SPI_MEM_C_SMEM_DATA_IE_ALWAYS_ON    (BIT(31))
#define SPI_MEM_C_SMEM_DATA_IE_ALWAYS_ON_M  (SPI_MEM_C_SMEM_DATA_IE_ALWAYS_ON_V << SPI_MEM_C_SMEM_DATA_IE_ALWAYS_ON_S)
#define SPI_MEM_C_SMEM_DATA_IE_ALWAYS_ON_V  0x00000001U
#define SPI_MEM_C_SMEM_DATA_IE_ALWAYS_ON_S  31

/** SPI_MEM_C_FSM_REG register
 *  SPI0 FSM status register
 */
#define SPI_MEM_C_FSM_REG (DR_REG_FLASH_SPI0_BASE + 0x54)
/** SPI_MEM_C_LOCK_DELAY_TIME : R/W; bitpos: [11:7]; default: 4;
 *  The lock delay time of SPI0/1 arbiter by spi0_slv_st, after PER is sent by SPI1.
 */
#define SPI_MEM_C_LOCK_DELAY_TIME    0x0000001FU
#define SPI_MEM_C_LOCK_DELAY_TIME_M  (SPI_MEM_C_LOCK_DELAY_TIME_V << SPI_MEM_C_LOCK_DELAY_TIME_S)
#define SPI_MEM_C_LOCK_DELAY_TIME_V  0x0000001FU
...
/** SPI_MEM_C_AXI_WR_FLASH_ERR_INT_ENA : HRO; bitpos: [8]; default: 0;
...
/** SPI_MEM_C_AXI_WADDR_ERR_INT__ENA : HRO; bitpos: [9]; default: 0;
...
/** SPI_MEM_C_AXI_WR_FLASH_ERR_INT_CLR : HRO; bitpos: [8]; default: 0;
...
/** SPI_MEM_C_AXI_WADDR_ERR_INT_CLR : HRO; bitpos: [9]; default: 0;
 ...
 *  The raw bit for SPI_MEM_C_ECC_ERR_INT interrupt. When SPI_MEM_C_FMEM__ECC_ERR_INT_EN is set
 ...
 *  than SPI_MEM_C_ECC_ERR_INT_NUM. When SPI_MEM_C_FMEM__ECC_ERR_INT_EN and
 ...
 *  SPI_MEM_C_ECC_ERR_INT_NUM. When SPI_MEM_C_FMEM__ECC_ERR_INT_EN and  SPI_MEM_C_SMEM_ECC_ERR_INT_EN
...
/** SPI_MEM_C_AXI_WR_FLASH_ERR_INT_RAW : HRO; bitpos: [8]; default: 0;
...
/** SPI_MEM_C_AXI_WADDR_ERR_INT_RAW : HRO; bitpos: [9]; default: 0;
...
/** SPI_MEM_C_ECC_ERR_INT_ST : HRO; bitpos: [5]; default: 0;
...
/** SPI_MEM_C_AXI_WR_FLASH_ERR_INT_ST : HRO; bitpos: [8]; default: 0;
 *  The enable bit for SPI_MEM_C_AXI_WR_FALSH_ERR_INT interrupt.
 */
...
/** SPI_MEM_C_AXI_WADDR_ERR_INT_ST : HRO; bitpos: [9]; default: 0;
 *  The enable bit for SPI_MEM_C_AXI_WADDR_ERR_INT interrupt.
 */
...
/** SPI_MEM_C_FMEM__DDR_EN : HRO; bitpos: [0]; default: 0;
 *  1: in DDR mode,  0 in SDR mode
 */
#define SPI_MEM_C_FMEM__DDR_EN    (BIT(0))
#define SPI_MEM_C_FMEM__DDR_EN_M  (SPI_MEM_C_FMEM__DDR_EN_V << SPI_MEM_C_FMEM__DDR_EN_S)
#define SPI_MEM_C_FMEM__DDR_EN_V  0x00000001U
#define SPI_MEM_C_FMEM__DDR_EN_S  0
/** SPI_MEM_C_FMEM__VAR_DUMMY : HRO; bitpos: [1]; default: 0;
 *  Set the bit to enable variable dummy cycle in spi DDR mode.
 */
#define SPI_MEM_C_FMEM__VAR_DUMMY    (BIT(1))
#define SPI_MEM_C_FMEM__VAR_DUMMY_M  (SPI_MEM_C_FMEM__VAR_DUMMY_V << SPI_MEM_C_FMEM__VAR_DUMMY_S)
#define SPI_MEM_C_FMEM__VAR_DUMMY_V  0x00000001U
#define SPI_MEM_C_FMEM__VAR_DUMMY_S  1
/** SPI_MEM_C_FMEM__DDR_RDAT_SWP : HRO; bitpos: [2]; default: 0;
 *  Set the bit to reorder rx data of the word in spi DDR mode.
 */
#define SPI_MEM_C_FMEM__DDR_RDAT_SWP    (BIT(2))
#define SPI_MEM_C_FMEM__DDR_RDAT_SWP_M  (SPI_MEM_C_FMEM__DDR_RDAT_SWP_V << SPI_MEM_C_FMEM__DDR_RDAT_SWP_S)
#define SPI_MEM_C_FMEM__DDR_RDAT_SWP_V  0x00000001U
#define SPI_MEM_C_FMEM__DDR_RDAT_SWP_S  2
/** SPI_MEM_C_FMEM__DDR_WDAT_SWP : HRO; bitpos: [3]; default: 0;
 *  Set the bit to reorder tx data of the word in spi DDR mode.
 */
#define SPI_MEM_C_FMEM__DDR_WDAT_SWP    (BIT(3))
#define SPI_MEM_C_FMEM__DDR_WDAT_SWP_M  (SPI_MEM_C_FMEM__DDR_WDAT_SWP_V << SPI_MEM_C_FMEM__DDR_WDAT_SWP_S)
#define SPI_MEM_C_FMEM__DDR_WDAT_SWP_V  0x00000001U
#define SPI_MEM_C_FMEM__DDR_WDAT_SWP_S  3
/** SPI_MEM_C_FMEM__DDR_CMD_DIS : HRO; bitpos: [4]; default: 0;
 *  the bit is used to disable dual edge in command phase when DDR mode.
 */
#define SPI_MEM_C_FMEM__DDR_CMD_DIS    (BIT(4))
#define SPI_MEM_C_FMEM__DDR_CMD_DIS_M  (SPI_MEM_C_FMEM__DDR_CMD_DIS_V << SPI_MEM_C_FMEM__DDR_CMD_DIS_S)
#define SPI_MEM_C_FMEM__DDR_CMD_DIS_V  0x00000001U
#define SPI_MEM_C_FMEM__DDR_CMD_DIS_S  4
/** SPI_MEM_C_FMEM__OUTMINBYTELEN : HRO; bitpos: [11:5]; default: 1;
 *  It is the minimum output data length in the panda device.
 */
#define SPI_MEM_C_FMEM__OUTMINBYTELEN    0x0000007FU
#define SPI_MEM_C_FMEM__OUTMINBYTELEN_M  (SPI_MEM_C_FMEM__OUTMINBYTELEN_V << SPI_MEM_C_FMEM__OUTMINBYTELEN_S)
#define SPI_MEM_C_FMEM__OUTMINBYTELEN_V  0x0000007FU
#define SPI_MEM_C_FMEM__OUTMINBYTELEN_S  5
/** SPI_MEM_C_FMEM__TX_DDR_MSK_EN : HRO; bitpos: [12]; default: 1;
 *  Set this bit to mask the first or the last byte in SPI0 ECC DDR write mode, when
 *  accesses to flash.
 */
#define SPI_MEM_C_FMEM__TX_DDR_MSK_EN    (BIT(12))
#define SPI_MEM_C_FMEM__TX_DDR_MSK_EN_M  (SPI_MEM_C_FMEM__TX_DDR_MSK_EN_V << SPI_MEM_C_FMEM__TX_DDR_MSK_EN_S)
#define SPI_MEM_C_FMEM__TX_DDR_MSK_EN_V  0x00000001U
#define SPI_MEM_C_FMEM__TX_DDR_MSK_EN_S  12
/** SPI_MEM_C_FMEM__RX_DDR_MSK_EN : HRO; bitpos: [13]; default: 1;
 *  Set this bit to mask the first or the last byte in SPI0 ECC DDR read mode, when
 *  accesses to flash.
 */
#define SPI_MEM_C_FMEM__RX_DDR_MSK_EN    (BIT(13))
#define SPI_MEM_C_FMEM__RX_DDR_MSK_EN_M  (SPI_MEM_C_FMEM__RX_DDR_MSK_EN_V << SPI_MEM_C_FMEM__RX_DDR_MSK_EN_S)
#define SPI_MEM_C_FMEM__RX_DDR_MSK_EN_V  0x00000001U
#define SPI_MEM_C_FMEM__RX_DDR_MSK_EN_S  13
/** SPI_MEM_C_FMEM__USR_DDR_DQS_THD : HRO; bitpos: [20:14]; default: 0;
 *  The delay number of data strobe which from memory based on SPI clock.
 */
#define SPI_MEM_C_FMEM__USR_DDR_DQS_THD    0x0000007FU
#define SPI_MEM_C_FMEM__USR_DDR_DQS_THD_M  (SPI_MEM_C_FMEM__USR_DDR_DQS_THD_V << SPI_MEM_C_FMEM__USR_DDR_DQS_THD_S)
#define SPI_MEM_C_FMEM__USR_DDR_DQS_THD_V  0x0000007FU
#define SPI_MEM_C_FMEM__USR_DDR_DQS_THD_S  14
/** SPI_MEM_C_FMEM__DDR_DQS_LOOP : HRO; bitpos: [21]; default: 0;
 ...
 */
#define SPI_MEM_C_FMEM__DDR_DQS_LOOP    (BIT(21))
#define SPI_MEM_C_FMEM__DDR_DQS_LOOP_M  (SPI_MEM_C_FMEM__DDR_DQS_LOOP_V << SPI_MEM_C_FMEM__DDR_DQS_LOOP_S)
#define SPI_MEM_C_FMEM__DDR_DQS_LOOP_V  0x00000001U
#define SPI_MEM_C_FMEM__DDR_DQS_LOOP_S  21
/** SPI_MEM_C_FMEM__CLK_DIFF_EN : HRO; bitpos: [24]; default: 0;
 *  Set this bit to enable the differential SPI_CLK#.
 */
#define SPI_MEM_C_FMEM__CLK_DIFF_EN    (BIT(24))
#define SPI_MEM_C_FMEM__CLK_DIFF_EN_M  (SPI_MEM_C_FMEM__CLK_DIFF_EN_V << SPI_MEM_C_FMEM__CLK_DIFF_EN_S)
#define SPI_MEM_C_FMEM__CLK_DIFF_EN_V  0x00000001U
#define SPI_MEM_C_FMEM__CLK_DIFF_EN_S  24
/** SPI_MEM_C_FMEM__DQS_CA_IN : HRO; bitpos: [26]; default: 0;
 *  Set this bit to enable the input of SPI_DQS signal in SPI phases of CMD and ADDR.
 */
#define SPI_MEM_C_FMEM__DQS_CA_IN    (BIT(26))
#define SPI_MEM_C_FMEM__DQS_CA_IN_M  (SPI_MEM_C_FMEM__DQS_CA_IN_V << SPI_MEM_C_FMEM__DQS_CA_IN_S)
#define SPI_MEM_C_FMEM__DQS_CA_IN_V  0x00000001U
#define SPI_MEM_C_FMEM__DQS_CA_IN_S  26
/** SPI_MEM_C_FMEM__HYPERBUS_DUMMY_2X : HRO; bitpos: [27]; default: 0;
 ...
 */
#define SPI_MEM_C_FMEM__HYPERBUS_DUMMY_2X    (BIT(27))
#define SPI_MEM_C_FMEM__HYPERBUS_DUMMY_2X_M  (SPI_MEM_C_FMEM__HYPERBUS_DUMMY_2X_V << SPI_MEM_C_FMEM__HYPERBUS_DUMMY_2X_S)
#define SPI_MEM_C_FMEM__HYPERBUS_DUMMY_2X_V  0x00000001U
#define SPI_MEM_C_FMEM__HYPERBUS_DUMMY_2X_S  27
/** SPI_MEM_C_FMEM__CLK_DIFF_INV : HRO; bitpos: [28]; default: 0;
 *  Set this bit to invert SPI_DIFF when accesses to flash. .
 */
#define SPI_MEM_C_FMEM__CLK_DIFF_INV    (BIT(28))
#define SPI_MEM_C_FMEM__CLK_DIFF_INV_M  (SPI_MEM_C_FMEM__CLK_DIFF_INV_V << SPI_MEM_C_FMEM__CLK_DIFF_INV_S)
#define SPI_MEM_C_FMEM__CLK_DIFF_INV_V  0x00000001U
#define SPI_MEM_C_FMEM__CLK_DIFF_INV_S  28
/** SPI_MEM_C_FMEM__OCTA_RAM_ADDR : HRO; bitpos: [29]; default: 0;
 ...
 */
#define SPI_MEM_C_FMEM__OCTA_RAM_ADDR    (BIT(29))
#define SPI_MEM_C_FMEM__OCTA_RAM_ADDR_M  (SPI_MEM_C_FMEM__OCTA_RAM_ADDR_V << SPI_MEM_C_FMEM__OCTA_RAM_ADDR_S)
#define SPI_MEM_C_FMEM__OCTA_RAM_ADDR_V  0x00000001U
#define SPI_MEM_C_FMEM__OCTA_RAM_ADDR_S  29
/** SPI_MEM_C_FMEM__HYPERBUS_CA : HRO; bitpos: [30]; default: 0;
 ...
 */
#define SPI_MEM_C_FMEM__HYPERBUS_CA    (BIT(30))
#define SPI_MEM_C_FMEM__HYPERBUS_CA_M  (SPI_MEM_C_FMEM__HYPERBUS_CA_V << SPI_MEM_C_FMEM__HYPERBUS_CA_S)
#define SPI_MEM_C_FMEM__HYPERBUS_CA_V  0x00000001U
#define SPI_MEM_C_FMEM__HYPERBUS_CA_S  30

/** SPI_MEM_C_SMEM_DDR_REG register
 *  SPI0 external RAM DDR mode control register
 */
#define SPI_MEM_C_SMEM_DDR_REG (DR_REG_FLASH_SPI0_BASE + 0xd8)
/** SPI_MEM_C_SMEM_DDR_EN : HRO; bitpos: [0]; default: 0;
 *  1: in DDR mode,  0 in SDR mode
 */
#define SPI_MEM_C_SMEM_DDR_EN    (BIT(0))
#define SPI_MEM_C_SMEM_DDR_EN_M  (SPI_MEM_C_SMEM_DDR_EN_V << SPI_MEM_C_SMEM_DDR_EN_S)
#define SPI_MEM_C_SMEM_DDR_EN_V  0x00000001U
#define SPI_MEM_C_SMEM_DDR_EN_S  0
/** SPI_MEM_C_SMEM_VAR_DUMMY : HRO; bitpos: [1]; default: 0;
 *  Set the bit to enable variable dummy cycle in spi DDR mode.
 */
#define SPI_MEM_C_SMEM_VAR_DUMMY    (BIT(1))
#define SPI_MEM_C_SMEM_VAR_DUMMY_M  (SPI_MEM_C_SMEM_VAR_DUMMY_V << SPI_MEM_C_SMEM_VAR_DUMMY_S)
#define SPI_MEM_C_SMEM_VAR_DUMMY_V  0x00000001U
#define SPI_MEM_C_SMEM_VAR_DUMMY_S  1
/** SPI_MEM_C_SMEM_DDR_RDAT_SWP : HRO; bitpos: [2]; default: 0;
 *  Set the bit to reorder rx data of the word in spi DDR mode.
 */
#define SPI_MEM_C_SMEM_DDR_RDAT_SWP    (BIT(2))
#define SPI_MEM_C_SMEM_DDR_RDAT_SWP_M  (SPI_MEM_C_SMEM_DDR_RDAT_SWP_V << SPI_MEM_C_SMEM_DDR_RDAT_SWP_S)
#define SPI_MEM_C_SMEM_DDR_RDAT_SWP_V  0x00000001U
#define SPI_MEM_C_SMEM_DDR_RDAT_SWP_S  2
/** SPI_MEM_C_SMEM_DDR_WDAT_SWP : HRO; bitpos: [3]; default: 0;
 *  Set the bit to reorder tx data of the word in spi DDR mode.
 */
#define SPI_MEM_C_SMEM_DDR_WDAT_SWP    (BIT(3))
#define SPI_MEM_C_SMEM_DDR_WDAT_SWP_M  (SPI_MEM_C_SMEM_DDR_WDAT_SWP_V << SPI_MEM_C_SMEM_DDR_WDAT_SWP_S)
#define SPI_MEM_C_SMEM_DDR_WDAT_SWP_V  0x00000001U
#define SPI_MEM_C_SMEM_DDR_WDAT_SWP_S  3
/** SPI_MEM_C_SMEM_DDR_CMD_DIS : HRO; bitpos: [4]; default: 0;
 *  the bit is used to disable dual edge in command phase when DDR mode.
 */
#define SPI_MEM_C_SMEM_DDR_CMD_DIS    (BIT(4))
#define SPI_MEM_C_SMEM_DDR_CMD_DIS_M  (SPI_MEM_C_SMEM_DDR_CMD_DIS_V << SPI_MEM_C_SMEM_DDR_CMD_DIS_S)
#define SPI_MEM_C_SMEM_DDR_CMD_DIS_V  0x00000001U
#define SPI_MEM_C_SMEM_DDR_CMD_DIS_S  4
/** SPI_MEM_C_SMEM_OUTMINBYTELEN : HRO; bitpos: [11:5]; default: 1;
 *  It is the minimum output data length in the DDR psram.
 */
#define SPI_MEM_C_SMEM_OUTMINBYTELEN    0x0000007FU
#define SPI_MEM_C_SMEM_OUTMINBYTELEN_M  (SPI_MEM_C_SMEM_OUTMINBYTELEN_V << SPI_MEM_C_SMEM_OUTMINBYTELEN_S)
#define SPI_MEM_C_SMEM_OUTMINBYTELEN_V  0x0000007FU
#define SPI_MEM_C_SMEM_OUTMINBYTELEN_S  5
/** SPI_MEM_C_SMEM_TX_DDR_MSK_EN : HRO; bitpos: [12]; default: 1;
 *  Set this bit to mask the first or the last byte in SPI0 ECC DDR write mode, when
 *  accesses to external RAM.
 */
#define SPI_MEM_C_SMEM_TX_DDR_MSK_EN    (BIT(12))
#define SPI_MEM_C_SMEM_TX_DDR_MSK_EN_M  (SPI_MEM_C_SMEM_TX_DDR_MSK_EN_V << SPI_MEM_C_SMEM_TX_DDR_MSK_EN_S)
#define SPI_MEM_C_SMEM_TX_DDR_MSK_EN_V  0x00000001U
#define SPI_MEM_C_SMEM_TX_DDR_MSK_EN_S  12
/** SPI_MEM_C_SMEM_RX_DDR_MSK_EN : HRO; bitpos: [13]; default: 1;
 *  Set this bit to mask the first or the last byte in SPI0 ECC DDR read mode, when
 *  accesses to external RAM.
 */
#define SPI_MEM_C_SMEM_RX_DDR_MSK_EN    (BIT(13))
#define SPI_MEM_C_SMEM_RX_DDR_MSK_EN_M  (SPI_MEM_C_SMEM_RX_DDR_MSK_EN_V << SPI_MEM_C_SMEM_RX_DDR_MSK_EN_S)
#define SPI_MEM_C_SMEM_RX_DDR_MSK_EN_V  0x00000001U
#define SPI_MEM_C_SMEM_RX_DDR_MSK_EN_S  13
/** SPI_MEM_C_SMEM_USR_DDR_DQS_THD : HRO; bitpos: [20:14]; default: 0;
 *  The delay number of data strobe which from memory based on SPI clock.
 */
#define SPI_MEM_C_SMEM_USR_DDR_DQS_THD    0x0000007FU
#define SPI_MEM_C_SMEM_USR_DDR_DQS_THD_M  (SPI_MEM_C_SMEM_USR_DDR_DQS_THD_V << SPI_MEM_C_SMEM_USR_DDR_DQS_THD_S)
#define SPI_MEM_C_SMEM_USR_DDR_DQS_THD_V  0x0000007FU
#define SPI_MEM_C_SMEM_USR_DDR_DQS_THD_S  14
/** SPI_MEM_C_SMEM_DDR_DQS_LOOP : HRO; bitpos: [21]; default: 0;
 *  1: Do not need the input of SPI_DQS signal, SPI0 starts to receive data when
 *  spi0_slv_st is in SPI_MEM_C_DIN state. It is used when there is no SPI_DQS signal or
 *  SPI_DQS signal is not stable. 0: SPI0 starts to store data at the positive and
 *  negative edge of SPI_DQS.
 */
#define SPI_MEM_C_SMEM_DDR_DQS_LOOP    (BIT(21))
#define SPI_MEM_C_SMEM_DDR_DQS_LOOP_M  (SPI_MEM_C_SMEM_DDR_DQS_LOOP_V << SPI_MEM_C_SMEM_DDR_DQS_LOOP_S)
#define SPI_MEM_C_SMEM_DDR_DQS_LOOP_V  0x00000001U
#define SPI_MEM_C_SMEM_DDR_DQS_LOOP_S  21
/** SPI_MEM_C_SMEM_CLK_DIFF_EN : HRO; bitpos: [24]; default: 0;
 *  Set this bit to enable the differential SPI_CLK#.
 */
#define SPI_MEM_C_SMEM_CLK_DIFF_EN    (BIT(24))
#define SPI_MEM_C_SMEM_CLK_DIFF_EN_M  (SPI_MEM_C_SMEM_CLK_DIFF_EN_V << SPI_MEM_C_SMEM_CLK_DIFF_EN_S)
#define SPI_MEM_C_SMEM_CLK_DIFF_EN_V  0x00000001U
#define SPI_MEM_C_SMEM_CLK_DIFF_EN_S  24
/** SPI_MEM_C_SMEM_DQS_CA_IN : HRO; bitpos: [26]; default: 0;
 *  Set this bit to enable the input of SPI_DQS signal in SPI phases of CMD and ADDR.
 */
#define SPI_MEM_C_SMEM_DQS_CA_IN    (BIT(26))
#define SPI_MEM_C_SMEM_DQS_CA_IN_M  (SPI_MEM_C_SMEM_DQS_CA_IN_V << SPI_MEM_C_SMEM_DQS_CA_IN_S)
#define SPI_MEM_C_SMEM_DQS_CA_IN_V  0x00000001U
#define SPI_MEM_C_SMEM_DQS_CA_IN_S  26
/** SPI_MEM_C_SMEM_HYPERBUS_DUMMY_2X : HRO; bitpos: [27]; default: 0;
 *  Set this bit to enable the vary dummy function in SPI HyperBus mode, when SPI0
 *  accesses flash or SPI1 accesses flash or sram.
 */
#define SPI_MEM_C_SMEM_HYPERBUS_DUMMY_2X    (BIT(27))
#define SPI_MEM_C_SMEM_HYPERBUS_DUMMY_2X_M  (SPI_MEM_C_SMEM_HYPERBUS_DUMMY_2X_V << SPI_MEM_C_SMEM_HYPERBUS_DUMMY_2X_S)
#define SPI_MEM_C_SMEM_HYPERBUS_DUMMY_2X_V  0x00000001U
#define SPI_MEM_C_SMEM_HYPERBUS_DUMMY_2X_S  27
/** SPI_MEM_C_SMEM_CLK_DIFF_INV : HRO; bitpos: [28]; default: 0;
 *  Set this bit to invert SPI_DIFF when accesses to external RAM. .
 */
#define SPI_MEM_C_SMEM_CLK_DIFF_INV    (BIT(28))
#define SPI_MEM_C_SMEM_CLK_DIFF_INV_M  (SPI_MEM_C_SMEM_CLK_DIFF_INV_V << SPI_MEM_C_SMEM_CLK_DIFF_INV_S)
#define SPI_MEM_C_SMEM_CLK_DIFF_INV_V  0x00000001U
#define SPI_MEM_C_SMEM_CLK_DIFF_INV_S  28
/** SPI_MEM_C_SMEM_OCTA_RAM_ADDR : HRO; bitpos: [29]; default: 0;
 ...
 *  1'b0}.
 */
#define SPI_MEM_C_SMEM_OCTA_RAM_ADDR    (BIT(29))
#define SPI_MEM_C_SMEM_OCTA_RAM_ADDR_M  (SPI_MEM_C_SMEM_OCTA_RAM_ADDR_V << SPI_MEM_C_SMEM_OCTA_RAM_ADDR_S)
#define SPI_MEM_C_SMEM_OCTA_RAM_ADDR_V  0x00000001U
#define SPI_MEM_C_SMEM_OCTA_RAM_ADDR_S  29
/** SPI_MEM_C_SMEM_HYPERBUS_CA : HRO; bitpos: [30]; default: 0;
 ...
 */
#define SPI_MEM_C_SMEM_HYPERBUS_CA    (BIT(30))
#define SPI_MEM_C_SMEM_HYPERBUS_CA_M  (SPI_MEM_C_SMEM_HYPERBUS_CA_V << SPI_MEM_C_SMEM_HYPERBUS_CA_S)
#define SPI_MEM_C_SMEM_HYPERBUS_CA_V  0x00000001U
#define SPI_MEM_C_SMEM_HYPERBUS_CA_S  30

/** SPI_MEM_C_FMEM__PMS0_ATTR_REG register
 *  MSPI flash PMS section 0 attribute register
 */
#define SPI_MEM_C_FMEM__PMS0_ATTR_REG (DR_REG_FLASH_SPI0_BASE + 0x100)
/** SPI_MEM_C_FMEM__PMS0_RD_ATTR : R/W; bitpos: [0]; default: 1;
 *  1: SPI1 flash PMS section 0 read accessible. 0: Not allowed.
 */
#define SPI_MEM_C_FMEM__PMS0_RD_ATTR    (BIT(0))
#define SPI_MEM_C_FMEM__PMS0_RD_ATTR_M  (SPI_MEM_C_FMEM__PMS0_RD_ATTR_V << SPI_MEM_C_FMEM__PMS0_RD_ATTR_S)
#define SPI_MEM_C_FMEM__PMS0_RD_ATTR_V  0x00000001U
#define SPI_MEM_C_FMEM__PMS0_RD_ATTR_S  0
/** SPI_MEM_C_FMEM__PMS0_WR_ATTR : R/W; bitpos: [1]; default: 1;
 *  1: SPI1 flash PMS section 0 write accessible. 0: Not allowed.
 */
#define SPI_MEM_C_FMEM__PMS0_WR_ATTR    (BIT(1))
#define SPI_MEM_C_FMEM__PMS0_WR_ATTR_M  (SPI_MEM_C_FMEM__PMS0_WR_ATTR_V << SPI_MEM_C_FMEM__PMS0_WR_ATTR_S)
#define SPI_MEM_C_FMEM__PMS0_WR_ATTR_V  0x00000001U
#define SPI_MEM_C_FMEM__PMS0_WR_ATTR_S  1
/** SPI_MEM_C_FMEM__PMS0_ECC : R/W; bitpos: [2]; default: 0;
 *  SPI1 flash PMS section 0 ECC mode, 1: enable ECC mode. 0: Disable it. The flash PMS
 *  section 0 is configured by registers SPI_MEM_C_FMEM__PMS0_ADDR_REG and
 *  SPI_MEM_C_FMEM__PMS0_SIZE_REG.
 */
#define SPI_MEM_C_FMEM__PMS0_ECC    (BIT(2))
#define SPI_MEM_C_FMEM__PMS0_ECC_M  (SPI_MEM_C_FMEM__PMS0_ECC_V << SPI_MEM_C_FMEM__PMS0_ECC_S)
#define SPI_MEM_C_FMEM__PMS0_ECC_V  0x00000001U
#define SPI_MEM_C_FMEM__PMS0_ECC_S  2

/** SPI_MEM_C_FMEM__PMS1_ATTR_REG register
 *  MSPI flash PMS section 1 attribute register
 */
#define SPI_MEM_C_FMEM__PMS1_ATTR_REG (DR_REG_FLASH_SPI0_BASE + 0x104)
/** SPI_MEM_C_FMEM__PMS1_RD_ATTR : R/W; bitpos: [0]; default: 1;
 *  1: SPI1 flash PMS section 1 read accessible. 0: Not allowed.
 */
#define SPI_MEM_C_FMEM__PMS1_RD_ATTR    (BIT(0))
#define SPI_MEM_C_FMEM__PMS1_RD_ATTR_M  (SPI_MEM_C_FMEM__PMS1_RD_ATTR_V << SPI_MEM_C_FMEM__PMS1_RD_ATTR_S)
#define SPI_MEM_C_FMEM__PMS1_RD_ATTR_V  0x00000001U
#define SPI_MEM_C_FMEM__PMS1_RD_ATTR_S  0
/** SPI_MEM_C_FMEM__PMS1_WR_ATTR : R/W; bitpos: [1]; default: 1;
 *  1: SPI1 flash PMS section 1 write accessible. 0: Not allowed.
 */
#define SPI_MEM_C_FMEM__PMS1_WR_ATTR    (BIT(1))
#define SPI_MEM_C_FMEM__PMS1_WR_ATTR_M  (SPI_MEM_C_FMEM__PMS1_WR_ATTR_V << SPI_MEM_C_FMEM__PMS1_WR_ATTR_S)
#define SPI_MEM_C_FMEM__PMS1_WR_ATTR_V  0x00000001U
#define SPI_MEM_C_FMEM__PMS1_WR_ATTR_S  1
/** SPI_MEM_C_FMEM__PMS1_ECC : R/W; bitpos: [2]; default: 0;
 *  SPI1 flash PMS section 1 ECC mode, 1: enable ECC mode. 0: Disable it. The flash PMS
 *  section 1 is configured by registers SPI_MEM_C_FMEM__PMS1_ADDR_REG and
 *  SPI_MEM_C_FMEM__PMS1_SIZE_REG.
 */
#define SPI_MEM_C_FMEM__PMS1_ECC    (BIT(2))
#define SPI_MEM_C_FMEM__PMS1_ECC_M  (SPI_MEM_C_FMEM__PMS1_ECC_V << SPI_MEM_C_FMEM__PMS1_ECC_S)
#define SPI_MEM_C_FMEM__PMS1_ECC_V  0x00000001U
#define SPI_MEM_C_FMEM__PMS1_ECC_S  2

/** SPI_MEM_C_FMEM__PMS2_ATTR_REG register
 *  MSPI flash PMS section 2 attribute register
 */
#define SPI_MEM_C_FMEM__PMS2_ATTR_REG (DR_REG_FLASH_SPI0_BASE + 0x108)
/** SPI_MEM_C_FMEM__PMS2_RD_ATTR : R/W; bitpos: [0]; default: 1;
 *  1: SPI1 flash PMS section 2 read accessible. 0: Not allowed.
 */
#define SPI_MEM_C_FMEM__PMS2_RD_ATTR    (BIT(0))
#define SPI_MEM_C_FMEM__PMS2_RD_ATTR_M  (SPI_MEM_C_FMEM__PMS2_RD_ATTR_V << SPI_MEM_C_FMEM__PMS2_RD_ATTR_S)
#define SPI_MEM_C_FMEM__PMS2_RD_ATTR_V  0x00000001U
#define SPI_MEM_C_FMEM__PMS2_RD_ATTR_S  0
/** SPI_MEM_C_FMEM__PMS2_WR_ATTR : R/W; bitpos: [1]; default: 1;
 *  1: SPI1 flash PMS section 2 write accessible. 0: Not allowed.
 */
#define SPI_MEM_C_FMEM__PMS2_WR_ATTR    (BIT(1))
#define SPI_MEM_C_FMEM__PMS2_WR_ATTR_M  (SPI_MEM_C_FMEM__PMS2_WR_ATTR_V << SPI_MEM_C_FMEM__PMS2_WR_ATTR_S)
#define SPI_MEM_C_FMEM__PMS2_WR_ATTR_V  0x00000001U
#define SPI_MEM_C_FMEM__PMS2_WR_ATTR_S  1
/** SPI_MEM_C_FMEM__PMS2_ECC : R/W; bitpos: [2]; default: 0;
 *  SPI1 flash PMS section 2 ECC mode, 1: enable ECC mode. 0: Disable it. The flash PMS
 *  section 2 is configured by registers SPI_MEM_C_FMEM__PMS2_ADDR_REG and
 *  SPI_MEM_C_FMEM__PMS2_SIZE_REG.
 */
#define SPI_MEM_C_FMEM__PMS2_ECC    (BIT(2))
#define SPI_MEM_C_FMEM__PMS2_ECC_M  (SPI_MEM_C_FMEM__PMS2_ECC_V << SPI_MEM_C_FMEM__PMS2_ECC_S)
#define SPI_MEM_C_FMEM__PMS2_ECC_V  0x00000001U
#define SPI_MEM_C_FMEM__PMS2_ECC_S  2

/** SPI_MEM_C_FMEM__PMS3_ATTR_REG register
 *  MSPI flash PMS section 3 attribute register
 */
#define SPI_MEM_C_FMEM__PMS3_ATTR_REG (DR_REG_FLASH_SPI0_BASE + 0x10c)
/** SPI_MEM_C_FMEM__PMS3_RD_ATTR : R/W; bitpos: [0]; default: 1;
 *  1: SPI1 flash PMS section 3 read accessible. 0: Not allowed.
 */
#define SPI_MEM_C_FMEM__PMS3_RD_ATTR    (BIT(0))
#define SPI_MEM_C_FMEM__PMS3_RD_ATTR_M  (SPI_MEM_C_FMEM__PMS3_RD_ATTR_V << SPI_MEM_C_FMEM__PMS3_RD_ATTR_S)
#define SPI_MEM_C_FMEM__PMS3_RD_ATTR_V  0x00000001U
#define SPI_MEM_C_FMEM__PMS3_RD_ATTR_S  0
/** SPI_MEM_C_FMEM__PMS3_WR_ATTR : R/W; bitpos: [1]; default: 1;
 *  1: SPI1 flash PMS section 3 write accessible. 0: Not allowed.
 */
#define SPI_MEM_C_FMEM__PMS3_WR_ATTR    (BIT(1))
#define SPI_MEM_C_FMEM__PMS3_WR_ATTR_M  (SPI_MEM_C_FMEM__PMS3_WR_ATTR_V << SPI_MEM_C_FMEM__PMS3_WR_ATTR_S)
#define SPI_MEM_C_FMEM__PMS3_WR_ATTR_V  0x00000001U
#define SPI_MEM_C_FMEM__PMS3_WR_ATTR_S  1
/** SPI_MEM_C_FMEM__PMS3_ECC : R/W; bitpos: [2]; default: 0;
 *  SPI1 flash PMS section 3 ECC mode, 1: enable ECC mode. 0: Disable it. The flash PMS
 *  section 3 is configured by registers SPI_MEM_C_FMEM__PMS3_ADDR_REG and
 *  SPI_MEM_C_FMEM__PMS3_SIZE_REG.
 */
#define SPI_MEM_C_FMEM__PMS3_ECC    (BIT(2))
#define SPI_MEM_C_FMEM__PMS3_ECC_M  (SPI_MEM_C_FMEM__PMS3_ECC_V << SPI_MEM_C_FMEM__PMS3_ECC_S)
#define SPI_MEM_C_FMEM__PMS3_ECC_V  0x00000001U
#define SPI_MEM_C_FMEM__PMS3_ECC_S  2

/** SPI_MEM_C_FMEM__PMS0_ADDR_REG register
 *  SPI1 flash PMS section 0 start address register
 */
#define SPI_MEM_C_FMEM__PMS0_ADDR_REG (DR_REG_FLASH_SPI0_BASE + 0x110)
/** SPI_MEM_C_FMEM__PMS0_ADDR_S : R/W; bitpos: [26:0]; default: 0;
 *  SPI1 flash PMS section 0 start address value
 */
#define SPI_MEM_C_FMEM__PMS0_ADDR_S    0x07FFFFFFU
#define SPI_MEM_C_FMEM__PMS0_ADDR_S_M  (SPI_MEM_C_FMEM__PMS0_ADDR_S_V << SPI_MEM_C_FMEM__PMS0_ADDR_S_S)
#define SPI_MEM_C_FMEM__PMS0_ADDR_S_V  0x07FFFFFFU
#define SPI_MEM_C_FMEM__PMS0_ADDR_S_S  0

/** SPI_MEM_C_FMEM__PMS1_ADDR_REG register
 *  SPI1 flash PMS section 1 start address register
 */
#define SPI_MEM_C_FMEM__PMS1_ADDR_REG (DR_REG_FLASH_SPI0_BASE + 0x114)
/** SPI_MEM_C_FMEM__PMS1_ADDR_S : R/W; bitpos: [26:0]; default: 0;
 *  SPI1 flash PMS section 1 start address value
 */
#define SPI_MEM_C_FMEM__PMS1_ADDR_S    0x07FFFFFFU
#define SPI_MEM_C_FMEM__PMS1_ADDR_S_M  (SPI_MEM_C_FMEM__PMS1_ADDR_S_V << SPI_MEM_C_FMEM__PMS1_ADDR_S_S)
#define SPI_MEM_C_FMEM__PMS1_ADDR_S_V  0x07FFFFFFU
#define SPI_MEM_C_FMEM__PMS1_ADDR_S_S  0

/** SPI_MEM_C_FMEM__PMS2_ADDR_REG register
 *  SPI1 flash PMS section 2 start address register
 */
#define SPI_MEM_C_FMEM__PMS2_ADDR_REG (DR_REG_FLASH_SPI0_BASE + 0x118)
/** SPI_MEM_C_FMEM__PMS2_ADDR_S : R/W; bitpos: [26:0]; default: 0;
 *  SPI1 flash PMS section 2 start address value
 */
#define SPI_MEM_C_FMEM__PMS2_ADDR_S    0x07FFFFFFU
#define SPI_MEM_C_FMEM__PMS2_ADDR_S_M  (SPI_MEM_C_FMEM__PMS2_ADDR_S_V << SPI_MEM_C_FMEM__PMS2_ADDR_S_S)
#define SPI_MEM_C_FMEM__PMS2_ADDR_S_V  0x07FFFFFFU
#define SPI_MEM_C_FMEM__PMS2_ADDR_S_S  0

/** SPI_MEM_C_FMEM__PMS3_ADDR_REG register
 *  SPI1 flash PMS section 3 start address register
 */
#define SPI_MEM_C_FMEM__PMS3_ADDR_REG (DR_REG_FLASH_SPI0_BASE + 0x11c)
/** SPI_MEM_C_FMEM__PMS3_ADDR_S : R/W; bitpos: [26:0]; default: 0;
 *  SPI1 flash PMS section 3 start address value
 */
#define SPI_MEM_C_FMEM__PMS3_ADDR_S    0x07FFFFFFU
#define SPI_MEM_C_FMEM__PMS3_ADDR_S_M  (SPI_MEM_C_FMEM__PMS3_ADDR_S_V << SPI_MEM_C_FMEM__PMS3_ADDR_S_S)
#define SPI_MEM_C_FMEM__PMS3_ADDR_S_V  0x07FFFFFFU
#define SPI_MEM_C_FMEM__PMS3_ADDR_S_S  0

/** SPI_MEM_C_FMEM__PMS0_SIZE_REG register
 *  SPI1 flash PMS section 0 start address register
 */
#define SPI_MEM_C_FMEM__PMS0_SIZE_REG (DR_REG_FLASH_SPI0_BASE + 0x120)
/** SPI_MEM_C_FMEM__PMS0_SIZE : R/W; bitpos: [14:0]; default: 4096;
 *  SPI1 flash PMS section 0 address region is (SPI_MEM_C_FMEM__PMS0_ADDR_S,
 *  SPI_MEM_C_FMEM__PMS0_ADDR_S + SPI_MEM_C_FMEM__PMS0_SIZE)
 */
#define SPI_MEM_C_FMEM__PMS0_SIZE    0x00007FFFU
#define SPI_MEM_C_FMEM__PMS0_SIZE_M  (SPI_MEM_C_FMEM__PMS0_SIZE_V << SPI_MEM_C_FMEM__PMS0_SIZE_S)
#define SPI_MEM_C_FMEM__PMS0_SIZE_V  0x00007FFFU
#define SPI_MEM_C_FMEM__PMS0_SIZE_S  0

/** SPI_MEM_C_FMEM__PMS1_SIZE_REG register
 *  SPI1 flash PMS section 1 start address register
 */
#define SPI_MEM_C_FMEM__PMS1_SIZE_REG (DR_REG_FLASH_SPI0_BASE + 0x124)
/** SPI_MEM_C_FMEM__PMS1_SIZE : R/W; bitpos: [14:0]; default: 4096;
 *  SPI1 flash PMS section 1 address region is (SPI_MEM_C_FMEM__PMS1_ADDR_S,
 *  SPI_MEM_C_FMEM__PMS1_ADDR_S + SPI_MEM_C_FMEM__PMS1_SIZE)
 */
#define SPI_MEM_C_FMEM__PMS1_SIZE    0x00007FFFU
#define SPI_MEM_C_FMEM__PMS1_SIZE_M  (SPI_MEM_C_FMEM__PMS1_SIZE_V << SPI_MEM_C_FMEM__PMS1_SIZE_S)
#define SPI_MEM_C_FMEM__PMS1_SIZE_V  0x00007FFFU
#define SPI_MEM_C_FMEM__PMS1_SIZE_S  0

/** SPI_MEM_C_FMEM__PMS2_SIZE_REG register
 *  SPI1 flash PMS section 2 start address register
 */
#define SPI_MEM_C_FMEM__PMS2_SIZE_REG (DR_REG_FLASH_SPI0_BASE + 0x128)
/** SPI_MEM_C_FMEM__PMS2_SIZE : R/W; bitpos: [14:0]; default: 4096;
 *  SPI1 flash PMS section 2 address region is (SPI_MEM_C_FMEM__PMS2_ADDR_S,
 *  SPI_MEM_C_FMEM__PMS2_ADDR_S + SPI_MEM_C_FMEM__PMS2_SIZE)
 */
#define SPI_MEM_C_FMEM__PMS2_SIZE    0x00007FFFU
#define SPI_MEM_C_FMEM__PMS2_SIZE_M  (SPI_MEM_C_FMEM__PMS2_SIZE_V << SPI_MEM_C_FMEM__PMS2_SIZE_S)
#define SPI_MEM_C_FMEM__PMS2_SIZE_V  0x00007FFFU
#define SPI_MEM_C_FMEM__PMS2_SIZE_S  0

/** SPI_MEM_C_FMEM__PMS3_SIZE_REG register
 *  SPI1 flash PMS section 3 start address register
 */
#define SPI_MEM_C_FMEM__PMS3_SIZE_REG (DR_REG_FLASH_SPI0_BASE + 0x12c)
/** SPI_MEM_C_FMEM__PMS3_SIZE : R/W; bitpos: [14:0]; default: 4096;
 *  SPI1 flash PMS section 3 address region is (SPI_MEM_C_FMEM__PMS3_ADDR_S,
 *  SPI_MEM_C_FMEM__PMS3_ADDR_S + SPI_MEM_C_FMEM__PMS3_SIZE)
 */
#define SPI_MEM_C_FMEM__PMS3_SIZE    0x00007FFFU
#define SPI_MEM_C_FMEM__PMS3_SIZE_M  (SPI_MEM_C_FMEM__PMS3_SIZE_V << SPI_MEM_C_FMEM__PMS3_SIZE_S)
#define SPI_MEM_C_FMEM__PMS3_SIZE_V  0x00007FFFU
#define SPI_MEM_C_FMEM__PMS3_SIZE_S  0

/** SPI_MEM_C_SMEM_PMS0_ATTR_REG register
 *  SPI1 flash PMS section 0 start address register
 */
#define SPI_MEM_C_SMEM_PMS0_ATTR_REG (DR_REG_FLASH_SPI0_BASE + 0x130)
/** SPI_MEM_C_SMEM_PMS0_RD_ATTR : R/W; bitpos: [0]; default: 1;
 *  1: SPI1 external RAM PMS section 0 read accessible. 0: Not allowed.
 */
#define SPI_MEM_C_SMEM_PMS0_RD_ATTR    (BIT(0))
#define SPI_MEM_C_SMEM_PMS0_RD_ATTR_M  (SPI_MEM_C_SMEM_PMS0_RD_ATTR_V << SPI_MEM_C_SMEM_PMS0_RD_ATTR_S)
#define SPI_MEM_C_SMEM_PMS0_RD_ATTR_V  0x00000001U
#define SPI_MEM_C_SMEM_PMS0_RD_ATTR_S  0
/** SPI_MEM_C_SMEM_PMS0_WR_ATTR : R/W; bitpos: [1]; default: 1;
 *  1: SPI1 external RAM PMS section 0 write accessible. 0: Not allowed.
 */
#define SPI_MEM_C_SMEM_PMS0_WR_ATTR    (BIT(1))
#define SPI_MEM_C_SMEM_PMS0_WR_ATTR_M  (SPI_MEM_C_SMEM_PMS0_WR_ATTR_V << SPI_MEM_C_SMEM_PMS0_WR_ATTR_S)
#define SPI_MEM_C_SMEM_PMS0_WR_ATTR_V  0x00000001U
#define SPI_MEM_C_SMEM_PMS0_WR_ATTR_S  1
/** SPI_MEM_C_SMEM_PMS0_ECC : R/W; bitpos: [2]; default: 0;
 *  SPI1 external RAM PMS section 0 ECC mode, 1: enable ECC mode. 0: Disable it. The
 *  external RAM PMS section 0 is configured by registers SPI_MEM_C_SMEM_PMS0_ADDR_REG and
 *  SPI_MEM_C_SMEM_PMS0_SIZE_REG.
 */
#define SPI_MEM_C_SMEM_PMS0_ECC    (BIT(2))
#define SPI_MEM_C_SMEM_PMS0_ECC_M  (SPI_MEM_C_SMEM_PMS0_ECC_V << SPI_MEM_C_SMEM_PMS0_ECC_S)
#define SPI_MEM_C_SMEM_PMS0_ECC_V  0x00000001U
#define SPI_MEM_C_SMEM_PMS0_ECC_S  2

/** SPI_MEM_C_SMEM_PMS1_ATTR_REG register
 *  SPI1 flash PMS section 1 start address register
 */
#define SPI_MEM_C_SMEM_PMS1_ATTR_REG (DR_REG_FLASH_SPI0_BASE + 0x134)
/** SPI_MEM_C_SMEM_PMS1_RD_ATTR : R/W; bitpos: [0]; default: 1;
 *  1: SPI1 external RAM PMS section 1 read accessible. 0: Not allowed.
 */
#define SPI_MEM_C_SMEM_PMS1_RD_ATTR    (BIT(0))
#define SPI_MEM_C_SMEM_PMS1_RD_ATTR_M  (SPI_MEM_C_SMEM_PMS1_RD_ATTR_V << SPI_MEM_C_SMEM_PMS1_RD_ATTR_S)
#define SPI_MEM_C_SMEM_PMS1_RD_ATTR_V  0x00000001U
#define SPI_MEM_C_SMEM_PMS1_RD_ATTR_S  0
/** SPI_MEM_C_SMEM_PMS1_WR_ATTR : R/W; bitpos: [1]; default: 1;
 *  1: SPI1 external RAM PMS section 1 write accessible. 0: Not allowed.
 */
#define SPI_MEM_C_SMEM_PMS1_WR_ATTR    (BIT(1))
#define SPI_MEM_C_SMEM_PMS1_WR_ATTR_M  (SPI_MEM_C_SMEM_PMS1_WR_ATTR_V << SPI_MEM_C_SMEM_PMS1_WR_ATTR_S)
#define SPI_MEM_C_SMEM_PMS1_WR_ATTR_V  0x00000001U
#define SPI_MEM_C_SMEM_PMS1_WR_ATTR_S  1
/** SPI_MEM_C_SMEM_PMS1_ECC : R/W; bitpos: [2]; default: 0;
 *  SPI1 external RAM PMS section 1 ECC mode, 1: enable ECC mode. 0: Disable it. The
 *  external RAM PMS section 1 is configured by registers SPI_MEM_C_SMEM_PMS1_ADDR_REG and
 *  SPI_MEM_C_SMEM_PMS1_SIZE_REG.
 */
#define SPI_MEM_C_SMEM_PMS1_ECC    (BIT(2))
#define SPI_MEM_C_SMEM_PMS1_ECC_M  (SPI_MEM_C_SMEM_PMS1_ECC_V << SPI_MEM_C_SMEM_PMS1_ECC_S)
#define SPI_MEM_C_SMEM_PMS1_ECC_V  0x00000001U
#define SPI_MEM_C_SMEM_PMS1_ECC_S  2

/** SPI_MEM_C_SMEM_PMS2_ATTR_REG register
 *  SPI1 flash PMS section 2 start address register
 */
#define SPI_MEM_C_SMEM_PMS2_ATTR_REG (DR_REG_FLASH_SPI0_BASE + 0x138)
/** SPI_MEM_C_SMEM_PMS2_RD_ATTR : R/W; bitpos: [0]; default: 1;
 *  1: SPI1 external RAM PMS section 2 read accessible. 0: Not allowed.
 */
#define SPI_MEM_C_SMEM_PMS2_RD_ATTR    (BIT(0))
#define SPI_MEM_C_SMEM_PMS2_RD_ATTR_M  (SPI_MEM_C_SMEM_PMS2_RD_ATTR_V << SPI_MEM_C_SMEM_PMS2_RD_ATTR_S)
#define SPI_MEM_C_SMEM_PMS2_RD_ATTR_V  0x00000001U
#define SPI_MEM_C_SMEM_PMS2_RD_ATTR_S  0
/** SPI_MEM_C_SMEM_PMS2_WR_ATTR : R/W; bitpos: [1]; default: 1;
 *  1: SPI1 external RAM PMS section 2 write accessible. 0: Not allowed.
 */
#define SPI_MEM_C_SMEM_PMS2_WR_ATTR    (BIT(1))
#define SPI_MEM_C_SMEM_PMS2_WR_ATTR_M  (SPI_MEM_C_SMEM_PMS2_WR_ATTR_V << SPI_MEM_C_SMEM_PMS2_WR_ATTR_S)
#define SPI_MEM_C_SMEM_PMS2_WR_ATTR_V  0x00000001U
#define SPI_MEM_C_SMEM_PMS2_WR_ATTR_S  1
/** SPI_MEM_C_SMEM_PMS2_ECC : R/W; bitpos: [2]; default: 0;
 *  SPI1 external RAM PMS section 2 ECC mode, 1: enable ECC mode. 0: Disable it. The
 *  external RAM PMS section 2 is configured by registers SPI_MEM_C_SMEM_PMS2_ADDR_REG and
 *  SPI_MEM_C_SMEM_PMS2_SIZE_REG.
 */
#define SPI_MEM_C_SMEM_PMS2_ECC    (BIT(2))
#define SPI_MEM_C_SMEM_PMS2_ECC_M  (SPI_MEM_C_SMEM_PMS2_ECC_V << SPI_MEM_C_SMEM_PMS2_ECC_S)
#define SPI_MEM_C_SMEM_PMS2_ECC_V  0x00000001U
#define SPI_MEM_C_SMEM_PMS2_ECC_S  2

/** SPI_MEM_C_SMEM_PMS3_ATTR_REG register
 *  SPI1 flash PMS section 3 start address register
 */
#define SPI_MEM_C_SMEM_PMS3_ATTR_REG (DR_REG_FLASH_SPI0_BASE + 0x13c)
/** SPI_MEM_C_SMEM_PMS3_RD_ATTR : R/W; bitpos: [0]; default: 1;
 *  1: SPI1 external RAM PMS section 3 read accessible. 0: Not allowed.
 */
#define SPI_MEM_C_SMEM_PMS3_RD_ATTR    (BIT(0))
#define SPI_MEM_C_SMEM_PMS3_RD_ATTR_M  (SPI_MEM_C_SMEM_PMS3_RD_ATTR_V << SPI_MEM_C_SMEM_PMS3_RD_ATTR_S)
#define SPI_MEM_C_SMEM_PMS3_RD_ATTR_V  0x00000001U
#define SPI_MEM_C_SMEM_PMS3_RD_ATTR_S  0
/** SPI_MEM_C_SMEM_PMS3_WR_ATTR : R/W; bitpos: [1]; default: 1;
 *  1: SPI1 external RAM PMS section 3 write accessible. 0: Not allowed.
 */
#define SPI_MEM_C_SMEM_PMS3_WR_ATTR    (BIT(1))
#define SPI_MEM_C_SMEM_PMS3_WR_ATTR_M  (SPI_MEM_C_SMEM_PMS3_WR_ATTR_V << SPI_MEM_C_SMEM_PMS3_WR_ATTR_S)
#define SPI_MEM_C_SMEM_PMS3_WR_ATTR_V  0x00000001U
#define SPI_MEM_C_SMEM_PMS3_WR_ATTR_S  1
/** SPI_MEM_C_SMEM_PMS3_ECC : R/W; bitpos: [2]; default: 0;
 *  SPI1 external RAM PMS section 3 ECC mode, 1: enable ECC mode. 0: Disable it. The
 *  external RAM PMS section 3 is configured by registers SPI_MEM_C_SMEM_PMS3_ADDR_REG and
 *  SPI_MEM_C_SMEM_PMS3_SIZE_REG.
 */
#define SPI_MEM_C_SMEM_PMS3_ECC    (BIT(2))
#define SPI_MEM_C_SMEM_PMS3_ECC_M  (SPI_MEM_C_SMEM_PMS3_ECC_V << SPI_MEM_C_SMEM_PMS3_ECC_S)
#define SPI_MEM_C_SMEM_PMS3_ECC_V  0x00000001U
#define SPI_MEM_C_SMEM_PMS3_ECC_S  2

/** SPI_MEM_C_SMEM_PMS0_ADDR_REG register
 *  SPI1 external RAM PMS section 0 start address register
 */
#define SPI_MEM_C_SMEM_PMS0_ADDR_REG (DR_REG_FLASH_SPI0_BASE + 0x140)
/** SPI_MEM_C_SMEM_PMS0_ADDR_S : R/W; bitpos: [26:0]; default: 0;
 *  SPI1 external RAM PMS section 0 start address value
 */
#define SPI_MEM_C_SMEM_PMS0_ADDR_S    0x07FFFFFFU
#define SPI_MEM_C_SMEM_PMS0_ADDR_S_M  (SPI_MEM_C_SMEM_PMS0_ADDR_S_V << SPI_MEM_C_SMEM_PMS0_ADDR_S_S)
#define SPI_MEM_C_SMEM_PMS0_ADDR_S_V  0x07FFFFFFU
#define SPI_MEM_C_SMEM_PMS0_ADDR_S_S  0

/** SPI_MEM_C_SMEM_PMS1_ADDR_REG register
 *  SPI1 external RAM PMS section 1 start address register
 */
#define SPI_MEM_C_SMEM_PMS1_ADDR_REG (DR_REG_FLASH_SPI0_BASE + 0x144)
/** SPI_MEM_C_SMEM_PMS1_ADDR_S : R/W; bitpos: [26:0]; default: 0;
 *  SPI1 external RAM PMS section 1 start address value
 */
#define SPI_MEM_C_SMEM_PMS1_ADDR_S    0x07FFFFFFU
#define SPI_MEM_C_SMEM_PMS1_ADDR_S_M  (SPI_MEM_C_SMEM_PMS1_ADDR_S_V << SPI_MEM_C_SMEM_PMS1_ADDR_S_S)
#define SPI_MEM_C_SMEM_PMS1_ADDR_S_V  0x07FFFFFFU
#define SPI_MEM_C_SMEM_PMS1_ADDR_S_S  0

/** SPI_MEM_C_SMEM_PMS2_ADDR_REG register
 *  SPI1 external RAM PMS section 2 start address register
 */
#define SPI_MEM_C_SMEM_PMS2_ADDR_REG (DR_REG_FLASH_SPI0_BASE + 0x148)
/** SPI_MEM_C_SMEM_PMS2_ADDR_S : R/W; bitpos: [26:0]; default: 0;
 *  SPI1 external RAM PMS section 2 start address value
 */
#define SPI_MEM_C_SMEM_PMS2_ADDR_S    0x07FFFFFFU
#define SPI_MEM_C_SMEM_PMS2_ADDR_S_M  (SPI_MEM_C_SMEM_PMS2_ADDR_S_V << SPI_MEM_C_SMEM_PMS2_ADDR_S_S)
#define SPI_MEM_C_SMEM_PMS2_ADDR_S_V  0x07FFFFFFU
#define SPI_MEM_C_SMEM_PMS2_ADDR_S_S  0

/** SPI_MEM_C_SMEM_PMS3_ADDR_REG register
 *  SPI1 external RAM PMS section 3 start address register
 */
#define SPI_MEM_C_SMEM_PMS3_ADDR_REG (DR_REG_FLASH_SPI0_BASE + 0x14c)
/** SPI_MEM_C_SMEM_PMS3_ADDR_S : R/W; bitpos: [26:0]; default: 0;
 *  SPI1 external RAM PMS section 3 start address value
 */
#define SPI_MEM_C_SMEM_PMS3_ADDR_S    0x07FFFFFFU
#define SPI_MEM_C_SMEM_PMS3_ADDR_S_M  (SPI_MEM_C_SMEM_PMS3_ADDR_S_V << SPI_MEM_C_SMEM_PMS3_ADDR_S_S)
#define SPI_MEM_C_SMEM_PMS3_ADDR_S_V  0x07FFFFFFU
#define SPI_MEM_C_SMEM_PMS3_ADDR_S_S  0

/** SPI_MEM_C_SMEM_PMS0_SIZE_REG register
 *  SPI1 external RAM PMS section 0 start address register
 */
#define SPI_MEM_C_SMEM_PMS0_SIZE_REG (DR_REG_FLASH_SPI0_BASE + 0x150)
/** SPI_MEM_C_SMEM_PMS0_SIZE : R/W; bitpos: [14:0]; default: 4096;
 *  SPI1 external RAM PMS section 0 address region is (SPI_MEM_C_SMEM_PMS0_ADDR_S,
 *  SPI_MEM_C_SMEM_PMS0_ADDR_S + SPI_MEM_C_SMEM_PMS0_SIZE)
 */
#define SPI_MEM_C_SMEM_PMS0_SIZE    0x00007FFFU
#define SPI_MEM_C_SMEM_PMS0_SIZE_M  (SPI_MEM_C_SMEM_PMS0_SIZE_V << SPI_MEM_C_SMEM_PMS0_SIZE_S)
#define SPI_MEM_C_SMEM_PMS0_SIZE_V  0x00007FFFU
#define SPI_MEM_C_SMEM_PMS0_SIZE_S  0

/** SPI_MEM_C_SMEM_PMS1_SIZE_REG register
 *  SPI1 external RAM PMS section 1 start address register
 */
#define SPI_MEM_C_SMEM_PMS1_SIZE_REG (DR_REG_FLASH_SPI0_BASE + 0x154)
/** SPI_MEM_C_SMEM_PMS1_SIZE : R/W; bitpos: [14:0]; default: 4096;
 *  SPI1 external RAM PMS section 1 address region is (SPI_MEM_C_SMEM_PMS1_ADDR_S,
 *  SPI_MEM_C_SMEM_PMS1_ADDR_S + SPI_MEM_C_SMEM_PMS1_SIZE)
 */
#define SPI_MEM_C_SMEM_PMS1_SIZE    0x00007FFFU
#define SPI_MEM_C_SMEM_PMS1_SIZE_M  (SPI_MEM_C_SMEM_PMS1_SIZE_V << SPI_MEM_C_SMEM_PMS1_SIZE_S)
#define SPI_MEM_C_SMEM_PMS1_SIZE_V  0x00007FFFU
#define SPI_MEM_C_SMEM_PMS1_SIZE_S  0

/** SPI_MEM_C_SMEM_PMS2_SIZE_REG register
 *  SPI1 external RAM PMS section 2 start address register
 */
#define SPI_MEM_C_SMEM_PMS2_SIZE_REG (DR_REG_FLASH_SPI0_BASE + 0x158)
/** SPI_MEM_C_SMEM_PMS2_SIZE : R/W; bitpos: [14:0]; default: 4096;
 *  SPI1 external RAM PMS section 2 address region is (SPI_MEM_C_SMEM_PMS2_ADDR_S,
 *  SPI_MEM_C_SMEM_PMS2_ADDR_S + SPI_MEM_C_SMEM_PMS2_SIZE)
 */
#define SPI_MEM_C_SMEM_PMS2_SIZE    0x00007FFFU
#define SPI_MEM_C_SMEM_PMS2_SIZE_M  (SPI_MEM_C_SMEM_PMS2_SIZE_V << SPI_MEM_C_SMEM_PMS2_SIZE_S)
#define SPI_MEM_C_SMEM_PMS2_SIZE_V  0x00007FFFU
#define SPI_MEM_C_SMEM_PMS2_SIZE_S  0

/** SPI_MEM_C_SMEM_PMS3_SIZE_REG register
 *  SPI1 external RAM PMS section 3 start address register
 */
#define SPI_MEM_C_SMEM_PMS3_SIZE_REG (DR_REG_FLASH_SPI0_BASE + 0x15c)
/** SPI_MEM_C_SMEM_PMS3_SIZE : R/W; bitpos: [14:0]; default: 4096;
 *  SPI1 external RAM PMS section 3 address region is (SPI_MEM_C_SMEM_PMS3_ADDR_S,
 *  SPI_MEM_C_SMEM_PMS3_ADDR_S + SPI_MEM_C_SMEM_PMS3_SIZE)
 */
#define SPI_MEM_C_SMEM_PMS3_SIZE    0x00007FFFU
#define SPI_MEM_C_SMEM_PMS3_SIZE_M  (SPI_MEM_C_SMEM_PMS3_SIZE_V << SPI_MEM_C_SMEM_PMS3_SIZE_S)
#define SPI_MEM_C_SMEM_PMS3_SIZE_V  0x00007FFFU
#define SPI_MEM_C_SMEM_PMS3_SIZE_S  0

/** SPI_MEM_C_PMS_REJECT_REG register
 *  SPI1 access reject register
 */
#define SPI_MEM_C_PMS_REJECT_REG (DR_REG_FLASH_SPI0_BASE + 0x164)
/** SPI_MEM_C_REJECT_ADDR : R/SS/WTC; bitpos: [26:0]; default: 0;
 *  This bits show the first SPI1 access error address. It is cleared by when
 *  SPI_MEM_C_PMS_REJECT_INT_CLR bit is set.
 */
#define SPI_MEM_C_REJECT_ADDR    0x07FFFFFFU
#define SPI_MEM_C_REJECT_ADDR_M  (SPI_MEM_C_REJECT_ADDR_V << SPI_MEM_C_REJECT_ADDR_S)
#define SPI_MEM_C_REJECT_ADDR_V  0x07FFFFFFU
...
/** SPI_MEM_C_FMEM__ECC_ERR_INT_NUM : HRO; bitpos: [16:11]; default: 10;
 *  Set the error times of MSPI ECC read to generate MSPI SPI_MEM_C_ECC_ERR_INT interrupt.
 */
#define SPI_MEM_C_FMEM__ECC_ERR_INT_NUM    0x0000003FU
#define SPI_MEM_C_FMEM__ECC_ERR_INT_NUM_M  (SPI_MEM_C_FMEM__ECC_ERR_INT_NUM_V << SPI_MEM_C_FMEM__ECC_ERR_INT_NUM_S)
#define SPI_MEM_C_FMEM__ECC_ERR_INT_NUM_V  0x0000003FU
#define SPI_MEM_C_FMEM__ECC_ERR_INT_NUM_S  11
/** SPI_MEM_C_FMEM__ECC_ERR_INT_EN : HRO; bitpos: [17]; default: 0;
 *  Set this bit to calculate the error times of MSPI ECC read when accesses to flash.
 */
#define SPI_MEM_C_FMEM__ECC_ERR_INT_EN    (BIT(17))
#define SPI_MEM_C_FMEM__ECC_ERR_INT_EN_M  (SPI_MEM_C_FMEM__ECC_ERR_INT_EN_V << SPI_MEM_C_FMEM__ECC_ERR_INT_EN_S)
#define SPI_MEM_C_FMEM__ECC_ERR_INT_EN_V  0x00000001U
#define SPI_MEM_C_FMEM__ECC_ERR_INT_EN_S  17
/** SPI_MEM_C_FMEM__PAGE_SIZE : R/W; bitpos: [19:18]; default: 0;
 *  Set the page size of the flash accessed by MSPI. 0: 256 bytes. 1: 512 bytes. 2:
 *  1024 bytes. 3: 2048 bytes.
 */
#define SPI_MEM_C_FMEM__PAGE_SIZE    0x00000003U
#define SPI_MEM_C_FMEM__PAGE_SIZE_M  (SPI_MEM_C_FMEM__PAGE_SIZE_V << SPI_MEM_C_FMEM__PAGE_SIZE_S)
#define SPI_MEM_C_FMEM__PAGE_SIZE_V  0x00000003U
#define SPI_MEM_C_FMEM__PAGE_SIZE_S  18
/** SPI_MEM_C_FMEM__ECC_ADDR_EN : HRO; bitpos: [20]; default: 0;
 ...
 */
#define SPI_MEM_C_FMEM__ECC_ADDR_EN    (BIT(20))
#define SPI_MEM_C_FMEM__ECC_ADDR_EN_M  (SPI_MEM_C_FMEM__ECC_ADDR_EN_V << SPI_MEM_C_FMEM__ECC_ADDR_EN_S)
#define SPI_MEM_C_FMEM__ECC_ADDR_EN_V  0x00000001U
#define SPI_MEM_C_FMEM__ECC_ADDR_EN_S  20
/** SPI_MEM_C_USR_ECC_ADDR_EN : HRO; bitpos: [21]; default: 0;
 *  Set this bit to enable ECC address convert in SPI0/1 USR_CMD transfer.
 */
#define SPI_MEM_C_USR_ECC_ADDR_EN    (BIT(21))
...
#define SPI_MEM_C_USR_ECC_ADDR_EN_S  21
...
/** SPI_MEM_C_AXI_ERR_ADDR : R/SS/WTC; bitpos: [26:0]; default: 0;
 ...
 */
#define SPI_MEM_C_AXI_ERR_ADDR    0x07FFFFFFU
#define SPI_MEM_C_AXI_ERR_ADDR_M  (SPI_MEM_C_AXI_ERR_ADDR_V << SPI_MEM_C_AXI_ERR_ADDR_S)
#define SPI_MEM_C_AXI_ERR_ADDR_V  0x07FFFFFFU
#define SPI_MEM_C_AXI_ERR_ADDR_S  0

/** SPI_MEM_C_SMEM_ECC_CTRL_REG register
 *  MSPI ECC control register
 */
#define SPI_MEM_C_SMEM_ECC_CTRL_REG (DR_REG_FLASH_SPI0_BASE + 0x174)
/** SPI_MEM_C_SMEM_ECC_ERR_INT_EN : HRO; bitpos: [17]; default: 0;
 *  Set this bit to calculate the error times of MSPI ECC read when accesses to
 *  external RAM.
 */
#define SPI_MEM_C_SMEM_ECC_ERR_INT_EN    (BIT(17))
#define SPI_MEM_C_SMEM_ECC_ERR_INT_EN_M  (SPI_MEM_C_SMEM_ECC_ERR_INT_EN_V << SPI_MEM_C_SMEM_ECC_ERR_INT_EN_S)
#define SPI_MEM_C_SMEM_ECC_ERR_INT_EN_V  0x00000001U
#define SPI_MEM_C_SMEM_ECC_ERR_INT_EN_S  17
/** SPI_MEM_C_SMEM_PAGE_SIZE : HRO; bitpos: [19:18]; default: 2;
 *  Set the page size of the external RAM accessed by MSPI. 0: 256 bytes. 1: 512 bytes.
 *  2: 1024 bytes. 3: 2048 bytes.
 */
#define SPI_MEM_C_SMEM_PAGE_SIZE    0x00000003U
#define SPI_MEM_C_SMEM_PAGE_SIZE_M  (SPI_MEM_C_SMEM_PAGE_SIZE_V << SPI_MEM_C_SMEM_PAGE_SIZE_S)
#define SPI_MEM_C_SMEM_PAGE_SIZE_V  0x00000003U
#define SPI_MEM_C_SMEM_PAGE_SIZE_S  18
/** SPI_MEM_C_SMEM_ECC_ADDR_EN : HRO; bitpos: [20]; default: 0;
 *  Set this bit to enable MSPI ECC address conversion, no matter MSPI accesses to the
 ...
 */
#define SPI_MEM_C_SMEM_ECC_ADDR_EN    (BIT(20))
#define SPI_MEM_C_SMEM_ECC_ADDR_EN_M  (SPI_MEM_C_SMEM_ECC_ADDR_EN_V << SPI_MEM_C_SMEM_ECC_ADDR_EN_S)
#define SPI_MEM_C_SMEM_ECC_ADDR_EN_V  0x00000001U
#define SPI_MEM_C_SMEM_ECC_ADDR_EN_S  20

/** SPI_MEM_C_SMEM_AXI_ADDR_CTRL_REG register
 *  SPI0 AXI address control register
 */
#define SPI_MEM_C_SMEM_AXI_ADDR_CTRL_REG (DR_REG_FLASH_SPI0_BASE + 0x178)
...
/** SPI_MEM_C_RDATA_AFIFO_REMPTY : RO; bitpos: [27]; default: 1;
 *  1: RDATA_AFIFO is empty. 0: At least one AXI read transfer is pending.
 */
#define SPI_MEM_C_RDATA_AFIFO_REMPTY    (BIT(27))
#define SPI_MEM_C_RDATA_AFIFO_REMPTY_M  (SPI_MEM_C_RDATA_AFIFO_REMPTY_V << SPI_MEM_C_RDATA_AFIFO_REMPTY_S)
#define SPI_MEM_C_RDATA_AFIFO_REMPTY_V  0x00000001U
#define SPI_MEM_C_RDATA_AFIFO_REMPTY_S  27
/** SPI_MEM_C_RADDR_AFIFO_REMPTY : RO; bitpos: [28]; default: 1;
 *  1: AXI_RADDR_CTL_AFIFO is empty. 0: At least one AXI read transfer is pending.
 */
#define SPI_MEM_C_RADDR_AFIFO_REMPTY    (BIT(28))
#define SPI_MEM_C_RADDR_AFIFO_REMPTY_M  (SPI_MEM_C_RADDR_AFIFO_REMPTY_V << SPI_MEM_C_RADDR_AFIFO_REMPTY_S)
#define SPI_MEM_C_RADDR_AFIFO_REMPTY_V  0x00000001U
#define SPI_MEM_C_RADDR_AFIFO_REMPTY_S  28
/** SPI_MEM_C_WDATA_AFIFO_REMPTY : RO; bitpos: [29]; default: 1;
 *  1: WDATA_AFIFO is empty. 0: At least one AXI write transfer is pending.
 */
#define SPI_MEM_C_WDATA_AFIFO_REMPTY    (BIT(29))
#define SPI_MEM_C_WDATA_AFIFO_REMPTY_M  (SPI_MEM_C_WDATA_AFIFO_REMPTY_V << SPI_MEM_C_WDATA_AFIFO_REMPTY_S)
#define SPI_MEM_C_WDATA_AFIFO_REMPTY_V  0x00000001U
#define SPI_MEM_C_WDATA_AFIFO_REMPTY_S  29
/** SPI_MEM_C_WBLEN_AFIFO_REMPTY : RO; bitpos: [30]; default: 1;
 *  1: WBLEN_AFIFO is empty. 0: At least one AXI write transfer is pending.
 */
#define SPI_MEM_C_WBLEN_AFIFO_REMPTY    (BIT(30))
#define SPI_MEM_C_WBLEN_AFIFO_REMPTY_M  (SPI_MEM_C_WBLEN_AFIFO_REMPTY_V << SPI_MEM_C_WBLEN_AFIFO_REMPTY_S)
#define SPI_MEM_C_WBLEN_AFIFO_REMPTY_V  0x00000001U
#define SPI_MEM_C_WBLEN_AFIFO_REMPTY_S  30
/** SPI_MEM_C_ALL_AXI_TRANS_AFIFO_EMPTY : RO; bitpos: [31]; default: 1;
 ...
 */
#define SPI_MEM_C_ALL_AXI_TRANS_AFIFO_EMPTY    (BIT(31))
#define SPI_MEM_C_ALL_AXI_TRANS_AFIFO_EMPTY_M  (SPI_MEM_C_ALL_AXI_TRANS_AFIFO_EMPTY_V << SPI_MEM_C_ALL_AXI_TRANS_AFIFO_EMPTY_S)
#define SPI_MEM_C_ALL_AXI_TRANS_AFIFO_EMPTY_V  0x00000001U
#define SPI_MEM_C_ALL_AXI_TRANS_AFIFO_EMPTY_S  31
...
/** SPI_MEM_C_AW_RESP_EN_MMU_VLD : HRO; bitpos: [0]; default: 0;
...
/** SPI_MEM_C_AW_RESP_EN_MMU_GID : HRO; bitpos: [1]; default: 0;
...
/** SPI_MEM_C_AW_RESP_EN_AXI_SIZE : HRO; bitpos: [2]; default: 0;
...
/** SPI_MEM_C_AW_RESP_EN_AXI_FLASH : HRO; bitpos: [3]; default: 0;
...
/** SPI_MEM_C_AW_RESP_EN_MMU_ECC : HRO; bitpos: [4]; default: 0;
...
/** SPI_MEM_C_AW_RESP_EN_MMU_SENS : HRO; bitpos: [5]; default: 0;
...
/** SPI_MEM_C_AW_RESP_EN_AXI_WSTRB : HRO; bitpos: [6]; default: 0;
...
/** SPI_MEM_C_SMEM_TIMING_CALI_REG register
 *  MSPI external RAM timing calibration register
 */
#define SPI_MEM_C_SMEM_TIMING_CALI_REG (DR_REG_FLASH_SPI0_BASE + 0x190)
/** SPI_MEM_C_SMEM_TIMING_CLK_ENA : HRO; bitpos: [0]; default: 1;
 *  For sram, the bit is used to enable timing adjust clock for all reading operations.
 */
#define SPI_MEM_C_SMEM_TIMING_CLK_ENA    (BIT(0))
#define SPI_MEM_C_SMEM_TIMING_CLK_ENA_M  (SPI_MEM_C_SMEM_TIMING_CLK_ENA_V << SPI_MEM_C_SMEM_TIMING_CLK_ENA_S)
#define SPI_MEM_C_SMEM_TIMING_CLK_ENA_V  0x00000001U
#define SPI_MEM_C_SMEM_TIMING_CLK_ENA_S  0
/** SPI_MEM_C_SMEM_TIMING_CALI : HRO; bitpos: [1]; default: 0;
 *  For sram, the bit is used to enable timing auto-calibration for all reading
 *  operations.
 */
#define SPI_MEM_C_SMEM_TIMING_CALI    (BIT(1))
#define SPI_MEM_C_SMEM_TIMING_CALI_M  (SPI_MEM_C_SMEM_TIMING_CALI_V << SPI_MEM_C_SMEM_TIMING_CALI_S)
#define SPI_MEM_C_SMEM_TIMING_CALI_V  0x00000001U
#define SPI_MEM_C_SMEM_TIMING_CALI_S  1
/** SPI_MEM_C_SMEM_EXTRA_DUMMY_CYCLELEN : HRO; bitpos: [4:2]; default: 0;
 *  For sram, add extra dummy spi clock cycle length for spi clock calibration.
 */
#define SPI_MEM_C_SMEM_EXTRA_DUMMY_CYCLELEN    0x00000007U
#define SPI_MEM_C_SMEM_EXTRA_DUMMY_CYCLELEN_M  (SPI_MEM_C_SMEM_EXTRA_DUMMY_CYCLELEN_V << SPI_MEM_C_SMEM_EXTRA_DUMMY_CYCLELEN_S)
#define SPI_MEM_C_SMEM_EXTRA_DUMMY_CYCLELEN_V  0x00000007U
#define SPI_MEM_C_SMEM_EXTRA_DUMMY_CYCLELEN_S  2
/** SPI_MEM_C_SMEM_DLL_TIMING_CALI : HRO; bitpos: [5]; default: 0;
 *  Set this bit to enable DLL for timing calibration in DDR mode when accessed to
 *  EXT_RAM.
 */
#define SPI_MEM_C_SMEM_DLL_TIMING_CALI    (BIT(5))
#define SPI_MEM_C_SMEM_DLL_TIMING_CALI_M  (SPI_MEM_C_SMEM_DLL_TIMING_CALI_V << SPI_MEM_C_SMEM_DLL_TIMING_CALI_S)
#define SPI_MEM_C_SMEM_DLL_TIMING_CALI_V  0x00000001U
#define SPI_MEM_C_SMEM_DLL_TIMING_CALI_S  5

/** SPI_MEM_C_SMEM_DIN_MODE_REG register
 *  MSPI external RAM input timing delay mode control register
 */
#define SPI_MEM_C_SMEM_DIN_MODE_REG (DR_REG_FLASH_SPI0_BASE + 0x194)
/** SPI_MEM_C_SMEM_DIN0_MODE : HRO; bitpos: [2:0]; default: 0;
 *  the input signals are delayed by system clock cycles, 0: input without delayed, 1:
 *  input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: input
 *  with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input with the
 *  spi_clk high edge,  6: input with the spi_clk low edge
 */
#define SPI_MEM_C_SMEM_DIN0_MODE    0x00000007U
#define SPI_MEM_C_SMEM_DIN0_MODE_M  (SPI_MEM_C_SMEM_DIN0_MODE_V << SPI_MEM_C_SMEM_DIN0_MODE_S)
#define SPI_MEM_C_SMEM_DIN0_MODE_V  0x00000007U
#define SPI_MEM_C_SMEM_DIN0_MODE_S  0
/** SPI_MEM_C_SMEM_DIN1_MODE : HRO; bitpos: [5:3]; default: 0;
 *  the input signals are delayed by system clock cycles, 0: input without delayed, 1:
 *  input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: input
 *  with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input with the
 *  spi_clk high edge,  6: input with the spi_clk low edge
 */
#define SPI_MEM_C_SMEM_DIN1_MODE    0x00000007U
#define SPI_MEM_C_SMEM_DIN1_MODE_M  (SPI_MEM_C_SMEM_DIN1_MODE_V << SPI_MEM_C_SMEM_DIN1_MODE_S)
#define SPI_MEM_C_SMEM_DIN1_MODE_V  0x00000007U
#define SPI_MEM_C_SMEM_DIN1_MODE_S  3
/** SPI_MEM_C_SMEM_DIN2_MODE : HRO; bitpos: [8:6]; default: 0;
 *  the input signals are delayed by system clock cycles, 0: input without delayed, 1:
 *  input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: input
 *  with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input with the
 *  spi_clk high edge,  6: input with the spi_clk low edge
 */
#define SPI_MEM_C_SMEM_DIN2_MODE    0x00000007U
#define SPI_MEM_C_SMEM_DIN2_MODE_M  (SPI_MEM_C_SMEM_DIN2_MODE_V << SPI_MEM_C_SMEM_DIN2_MODE_S)
#define SPI_MEM_C_SMEM_DIN2_MODE_V  0x00000007U
#define SPI_MEM_C_SMEM_DIN2_MODE_S  6
/** SPI_MEM_C_SMEM_DIN3_MODE : HRO; bitpos: [11:9]; default: 0;
 *  the input signals are delayed by system clock cycles, 0: input without delayed, 1:
 *  input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: input
 *  with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input with the
 *  spi_clk high edge,  6: input with the spi_clk low edge
 */
#define SPI_MEM_C_SMEM_DIN3_MODE    0x00000007U
#define SPI_MEM_C_SMEM_DIN3_MODE_M  (SPI_MEM_C_SMEM_DIN3_MODE_V << SPI_MEM_C_SMEM_DIN3_MODE_S)
#define SPI_MEM_C_SMEM_DIN3_MODE_V  0x00000007U
#define SPI_MEM_C_SMEM_DIN3_MODE_S  9
/** SPI_MEM_C_SMEM_DIN4_MODE : HRO; bitpos: [14:12]; default: 0;
 *  the input signals are delayed by system clock cycles, 0: input without delayed, 1:
 *  input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: input
 *  with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input with the
 *  spi_clk high edge,  6: input with the spi_clk low edge
 */
#define SPI_MEM_C_SMEM_DIN4_MODE    0x00000007U
#define SPI_MEM_C_SMEM_DIN4_MODE_M  (SPI_MEM_C_SMEM_DIN4_MODE_V << SPI_MEM_C_SMEM_DIN4_MODE_S)
#define SPI_MEM_C_SMEM_DIN4_MODE_V  0x00000007U
#define SPI_MEM_C_SMEM_DIN4_MODE_S  12
/** SPI_MEM_C_SMEM_DIN5_MODE : HRO; bitpos: [17:15]; default: 0;
 *  the input signals are delayed by system clock cycles, 0: input without delayed, 1:
 *  input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: input
 *  with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input with the
 *  spi_clk high edge,  6: input with the spi_clk low edge
 */
#define SPI_MEM_C_SMEM_DIN5_MODE    0x00000007U
#define SPI_MEM_C_SMEM_DIN5_MODE_M  (SPI_MEM_C_SMEM_DIN5_MODE_V << SPI_MEM_C_SMEM_DIN5_MODE_S)
#define SPI_MEM_C_SMEM_DIN5_MODE_V  0x00000007U
#define SPI_MEM_C_SMEM_DIN5_MODE_S  15
/** SPI_MEM_C_SMEM_DIN6_MODE : HRO; bitpos: [20:18]; default: 0;
 *  the input signals are delayed by system clock cycles, 0: input without delayed, 1:
 *  input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: input
 *  with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input with the
 *  spi_clk high edge,  6: input with the spi_clk low edge
 */
#define SPI_MEM_C_SMEM_DIN6_MODE    0x00000007U
#define SPI_MEM_C_SMEM_DIN6_MODE_M  (SPI_MEM_C_SMEM_DIN6_MODE_V << SPI_MEM_C_SMEM_DIN6_MODE_S)
#define SPI_MEM_C_SMEM_DIN6_MODE_V  0x00000007U
#define SPI_MEM_C_SMEM_DIN6_MODE_S  18
/** SPI_MEM_C_SMEM_DIN7_MODE : HRO; bitpos: [23:21]; default: 0;
 *  the input signals are delayed by system clock cycles, 0: input without delayed, 1:
 *  input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: input
 *  with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input with the
 *  spi_clk high edge,  6: input with the spi_clk low edge
 */
#define SPI_MEM_C_SMEM_DIN7_MODE    0x00000007U
#define SPI_MEM_C_SMEM_DIN7_MODE_M  (SPI_MEM_C_SMEM_DIN7_MODE_V << SPI_MEM_C_SMEM_DIN7_MODE_S)
#define SPI_MEM_C_SMEM_DIN7_MODE_V  0x00000007U
#define SPI_MEM_C_SMEM_DIN7_MODE_S  21
/** SPI_MEM_C_SMEM_DINS_MODE : HRO; bitpos: [26:24]; default: 0;
 *  the input signals are delayed by system clock cycles, 0: input without delayed, 1:
 *  input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: input
 *  with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input with the
 *  spi_clk high edge,  6: input with the spi_clk low edge
 */
#define SPI_MEM_C_SMEM_DINS_MODE    0x00000007U
#define SPI_MEM_C_SMEM_DINS_MODE_M  (SPI_MEM_C_SMEM_DINS_MODE_V << SPI_MEM_C_SMEM_DINS_MODE_S)
#define SPI_MEM_C_SMEM_DINS_MODE_V  0x00000007U
#define SPI_MEM_C_SMEM_DINS_MODE_S  24

/** SPI_MEM_C_SMEM_DIN_NUM_REG register
 *  MSPI external RAM input timing delay number control register
 */
#define SPI_MEM_C_SMEM_DIN_NUM_REG (DR_REG_FLASH_SPI0_BASE + 0x198)
/** SPI_MEM_C_SMEM_DIN0_NUM : HRO; bitpos: [1:0]; default: 0;
 *  the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
 *  delayed by 2 cycles,...
 */
#define SPI_MEM_C_SMEM_DIN0_NUM    0x00000003U
#define SPI_MEM_C_SMEM_DIN0_NUM_M  (SPI_MEM_C_SMEM_DIN0_NUM_V << SPI_MEM_C_SMEM_DIN0_NUM_S)
#define SPI_MEM_C_SMEM_DIN0_NUM_V  0x00000003U
#define SPI_MEM_C_SMEM_DIN0_NUM_S  0
/** SPI_MEM_C_SMEM_DIN1_NUM : HRO; bitpos: [3:2]; default: 0;
 *  the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
 *  delayed by 2 cycles,...
 */
#define SPI_MEM_C_SMEM_DIN1_NUM    0x00000003U
#define SPI_MEM_C_SMEM_DIN1_NUM_M  (SPI_MEM_C_SMEM_DIN1_NUM_V << SPI_MEM_C_SMEM_DIN1_NUM_S)
#define SPI_MEM_C_SMEM_DIN1_NUM_V  0x00000003U
#define SPI_MEM_C_SMEM_DIN1_NUM_S  2
/** SPI_MEM_C_SMEM_DIN2_NUM : HRO; bitpos: [5:4]; default: 0;
 *  the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
 *  delayed by 2 cycles,...
 */
#define SPI_MEM_C_SMEM_DIN2_NUM    0x00000003U
#define SPI_MEM_C_SMEM_DIN2_NUM_M  (SPI_MEM_C_SMEM_DIN2_NUM_V << SPI_MEM_C_SMEM_DIN2_NUM_S)
#define SPI_MEM_C_SMEM_DIN2_NUM_V  0x00000003U
#define SPI_MEM_C_SMEM_DIN2_NUM_S  4
/** SPI_MEM_C_SMEM_DIN3_NUM : HRO; bitpos: [7:6]; default: 0;
 *  the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
 *  delayed by 2 cycles,...
 */
#define SPI_MEM_C_SMEM_DIN3_NUM    0x00000003U
#define SPI_MEM_C_SMEM_DIN3_NUM_M  (SPI_MEM_C_SMEM_DIN3_NUM_V << SPI_MEM_C_SMEM_DIN3_NUM_S)
#define SPI_MEM_C_SMEM_DIN3_NUM_V  0x00000003U
#define SPI_MEM_C_SMEM_DIN3_NUM_S  6
/** SPI_MEM_C_SMEM_DIN4_NUM : HRO; bitpos: [9:8]; default: 0;
 *  the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
 *  delayed by 2 cycles,...
 */
#define SPI_MEM_C_SMEM_DIN4_NUM    0x00000003U
#define SPI_MEM_C_SMEM_DIN4_NUM_M  (SPI_MEM_C_SMEM_DIN4_NUM_V << SPI_MEM_C_SMEM_DIN4_NUM_S)
#define SPI_MEM_C_SMEM_DIN4_NUM_V  0x00000003U
#define SPI_MEM_C_SMEM_DIN4_NUM_S  8
/** SPI_MEM_C_SMEM_DIN5_NUM : HRO; bitpos: [11:10]; default: 0;
 *  the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
 *  delayed by 2 cycles,...
 */
#define SPI_MEM_C_SMEM_DIN5_NUM    0x00000003U
#define SPI_MEM_C_SMEM_DIN5_NUM_M  (SPI_MEM_C_SMEM_DIN5_NUM_V << SPI_MEM_C_SMEM_DIN5_NUM_S)
#define SPI_MEM_C_SMEM_DIN5_NUM_V  0x00000003U
#define SPI_MEM_C_SMEM_DIN5_NUM_S  10
/** SPI_MEM_C_SMEM_DIN6_NUM : HRO; bitpos: [13:12]; default: 0;
 *  the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
 *  delayed by 2 cycles,...
 */
#define SPI_MEM_C_SMEM_DIN6_NUM    0x00000003U
#define SPI_MEM_C_SMEM_DIN6_NUM_M  (SPI_MEM_C_SMEM_DIN6_NUM_V << SPI_MEM_C_SMEM_DIN6_NUM_S)
#define SPI_MEM_C_SMEM_DIN6_NUM_V  0x00000003U
#define SPI_MEM_C_SMEM_DIN6_NUM_S  12
/** SPI_MEM_C_SMEM_DIN7_NUM : HRO; bitpos: [15:14]; default: 0;
 *  the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
 *  delayed by 2 cycles,...
 */
#define SPI_MEM_C_SMEM_DIN7_NUM    0x00000003U
#define SPI_MEM_C_SMEM_DIN7_NUM_M  (SPI_MEM_C_SMEM_DIN7_NUM_V << SPI_MEM_C_SMEM_DIN7_NUM_S)
#define SPI_MEM_C_SMEM_DIN7_NUM_V  0x00000003U
#define SPI_MEM_C_SMEM_DIN7_NUM_S  14
/** SPI_MEM_C_SMEM_DINS_NUM : HRO; bitpos: [17:16]; default: 0;
 *  the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
 *  delayed by 2 cycles,...
 */
#define SPI_MEM_C_SMEM_DINS_NUM    0x00000003U
#define SPI_MEM_C_SMEM_DINS_NUM_M  (SPI_MEM_C_SMEM_DINS_NUM_V << SPI_MEM_C_SMEM_DINS_NUM_S)
#define SPI_MEM_C_SMEM_DINS_NUM_V  0x00000003U
#define SPI_MEM_C_SMEM_DINS_NUM_S  16

/** SPI_MEM_C_SMEM_DOUT_MODE_REG register
 *  MSPI external RAM output timing adjustment control register
 */
#define SPI_MEM_C_SMEM_DOUT_MODE_REG (DR_REG_FLASH_SPI0_BASE + 0x19c)
/** SPI_MEM_C_SMEM_DOUT0_MODE : HRO; bitpos: [0]; default: 0;
 *  the output signals are delayed by system clock cycles, 0: output without delayed,
 *  1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 *  output with the posedge of clk_160,4 output with the negedge of clk_160,5: output
 *  with the spi_clk high edge ,6: output with the spi_clk low edge
 */
#define SPI_MEM_C_SMEM_DOUT0_MODE    (BIT(0))
#define SPI_MEM_C_SMEM_DOUT0_MODE_M  (SPI_MEM_C_SMEM_DOUT0_MODE_V << SPI_MEM_C_SMEM_DOUT0_MODE_S)
#define SPI_MEM_C_SMEM_DOUT0_MODE_V  0x00000001U
#define SPI_MEM_C_SMEM_DOUT0_MODE_S  0
/** SPI_MEM_C_SMEM_DOUT1_MODE : HRO; bitpos: [1]; default: 0;
 *  the output signals are delayed by system clock cycles, 0: output without delayed,
 *  1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 *  output with the posedge of clk_160,4 output with the negedge of clk_160,5: output
 *  with the spi_clk high edge ,6: output with the spi_clk low edge
 */
#define SPI_MEM_C_SMEM_DOUT1_MODE    (BIT(1))
#define SPI_MEM_C_SMEM_DOUT1_MODE_M  (SPI_MEM_C_SMEM_DOUT1_MODE_V << SPI_MEM_C_SMEM_DOUT1_MODE_S)
#define SPI_MEM_C_SMEM_DOUT1_MODE_V  0x00000001U
#define SPI_MEM_C_SMEM_DOUT1_MODE_S  1
/** SPI_MEM_C_SMEM_DOUT2_MODE : HRO; bitpos: [2]; default: 0;
 *  the output signals are delayed by system clock cycles, 0: output without delayed,
 *  1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 *  output with the posedge of clk_160,4 output with the negedge of clk_160,5: output
 *  with the spi_clk high edge ,6: output with the spi_clk low edge
 */
#define SPI_MEM_C_SMEM_DOUT2_MODE    (BIT(2))
#define SPI_MEM_C_SMEM_DOUT2_MODE_M  (SPI_MEM_C_SMEM_DOUT2_MODE_V << SPI_MEM_C_SMEM_DOUT2_MODE_S)
#define SPI_MEM_C_SMEM_DOUT2_MODE_V  0x00000001U
#define SPI_MEM_C_SMEM_DOUT2_MODE_S  2
/** SPI_MEM_C_SMEM_DOUT3_MODE : HRO; bitpos: [3]; default: 0;
 *  the output signals are delayed by system clock cycles, 0: output without delayed,
 *  1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 *  output with the posedge of clk_160,4 output with the negedge of clk_160,5: output
 *  with the spi_clk high edge ,6: output with the spi_clk low edge
 */
#define SPI_MEM_C_SMEM_DOUT3_MODE    (BIT(3))
#define SPI_MEM_C_SMEM_DOUT3_MODE_M  (SPI_MEM_C_SMEM_DOUT3_MODE_V << SPI_MEM_C_SMEM_DOUT3_MODE_S)
#define SPI_MEM_C_SMEM_DOUT3_MODE_V  0x00000001U
#define SPI_MEM_C_SMEM_DOUT3_MODE_S  3
/** SPI_MEM_C_SMEM_DOUT4_MODE : HRO; bitpos: [4]; default: 0;
 *  the output signals are delayed by system clock cycles, 0: output without delayed,
 *  1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 *  output with the posedge of clk_160,4 output with the negedge of clk_160,5: output
 *  with the spi_clk high edge ,6: output with the spi_clk low edge
 */
#define SPI_MEM_C_SMEM_DOUT4_MODE    (BIT(4))
#define SPI_MEM_C_SMEM_DOUT4_MODE_M  (SPI_MEM_C_SMEM_DOUT4_MODE_V << SPI_MEM_C_SMEM_DOUT4_MODE_S)
#define SPI_MEM_C_SMEM_DOUT4_MODE_V  0x00000001U
#define SPI_MEM_C_SMEM_DOUT4_MODE_S  4
/** SPI_MEM_C_SMEM_DOUT5_MODE : HRO; bitpos: [5]; default: 0;
 *  the output signals are delayed by system clock cycles, 0: output without delayed,
 *  1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 *  output with the posedge of clk_160,4 output with the negedge of clk_160,5: output
 *  with the spi_clk high edge ,6: output with the spi_clk low edge
 */
#define SPI_MEM_C_SMEM_DOUT5_MODE    (BIT(5))
#define SPI_MEM_C_SMEM_DOUT5_MODE_M  (SPI_MEM_C_SMEM_DOUT5_MODE_V << SPI_MEM_C_SMEM_DOUT5_MODE_S)
#define SPI_MEM_C_SMEM_DOUT5_MODE_V  0x00000001U
#define SPI_MEM_C_SMEM_DOUT5_MODE_S  5
/** SPI_MEM_C_SMEM_DOUT6_MODE : HRO; bitpos: [6]; default: 0;
 *  the output signals are delayed by system clock cycles, 0: output without delayed,
 *  1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 *  output with the posedge of clk_160,4 output with the negedge of clk_160,5: output
 *  with the spi_clk high edge ,6: output with the spi_clk low edge
 */
#define SPI_MEM_C_SMEM_DOUT6_MODE    (BIT(6))
#define SPI_MEM_C_SMEM_DOUT6_MODE_M  (SPI_MEM_C_SMEM_DOUT6_MODE_V << SPI_MEM_C_SMEM_DOUT6_MODE_S)
#define SPI_MEM_C_SMEM_DOUT6_MODE_V  0x00000001U
#define SPI_MEM_C_SMEM_DOUT6_MODE_S  6
/** SPI_MEM_C_SMEM_DOUT7_MODE : HRO; bitpos: [7]; default: 0;
 *  the output signals are delayed by system clock cycles, 0: output without delayed,
 *  1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 *  output with the posedge of clk_160,4 output with the negedge of clk_160,5: output
 *  with the spi_clk high edge ,6: output with the spi_clk low edge
 */
#define SPI_MEM_C_SMEM_DOUT7_MODE    (BIT(7))
#define SPI_MEM_C_SMEM_DOUT7_MODE_M  (SPI_MEM_C_SMEM_DOUT7_MODE_V << SPI_MEM_C_SMEM_DOUT7_MODE_S)
#define SPI_MEM_C_SMEM_DOUT7_MODE_V  0x00000001U
#define SPI_MEM_C_SMEM_DOUT7_MODE_S  7
/** SPI_MEM_C_SMEM_DOUTS_MODE : HRO; bitpos: [8]; default: 0;
 *  the output signals are delayed by system clock cycles, 0: output without delayed,
 *  1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 *  output with the posedge of clk_160,4 output with the negedge of clk_160,5: output
 *  with the spi_clk high edge ,6: output with the spi_clk low edge
 */
#define SPI_MEM_C_SMEM_DOUTS_MODE    (BIT(8))
#define SPI_MEM_C_SMEM_DOUTS_MODE_M  (SPI_MEM_C_SMEM_DOUTS_MODE_V << SPI_MEM_C_SMEM_DOUTS_MODE_S)
#define SPI_MEM_C_SMEM_DOUTS_MODE_V  0x00000001U
#define SPI_MEM_C_SMEM_DOUTS_MODE_S  8

/** SPI_MEM_C_SMEM_AC_REG register
 *  MSPI external RAM ECC and SPI CS timing control register
 */
#define SPI_MEM_C_SMEM_AC_REG (DR_REG_FLASH_SPI0_BASE + 0x1a0)
/** SPI_MEM_C_SMEM_CS_SETUP : HRO; bitpos: [0]; default: 0;
 *  For SPI0 and SPI1, spi cs is enable when spi is in prepare phase. 1: enable 0:
 *  disable.
 */
#define SPI_MEM_C_SMEM_CS_SETUP    (BIT(0))
#define SPI_MEM_C_SMEM_CS_SETUP_M  (SPI_MEM_C_SMEM_CS_SETUP_V << SPI_MEM_C_SMEM_CS_SETUP_S)
#define SPI_MEM_C_SMEM_CS_SETUP_V  0x00000001U
#define SPI_MEM_C_SMEM_CS_SETUP_S  0
/** SPI_MEM_C_SMEM_CS_HOLD : HRO; bitpos: [1]; default: 0;
 *  For SPI0 and SPI1, spi cs keep low when spi is in done phase. 1: enable 0: disable.
 */
#define SPI_MEM_C_SMEM_CS_HOLD    (BIT(1))
#define SPI_MEM_C_SMEM_CS_HOLD_M  (SPI_MEM_C_SMEM_CS_HOLD_V << SPI_MEM_C_SMEM_CS_HOLD_S)
#define SPI_MEM_C_SMEM_CS_HOLD_V  0x00000001U
#define SPI_MEM_C_SMEM_CS_HOLD_S  1
/** SPI_MEM_C_SMEM_CS_SETUP_TIME : HRO; bitpos: [6:2]; default: 1;
 *  For spi0, (cycles-1) of prepare phase by spi clock this bits are combined with
 *  spi_mem_cs_setup bit.
 */
#define SPI_MEM_C_SMEM_CS_SETUP_TIME    0x0000001FU
#define SPI_MEM_C_SMEM_CS_SETUP_TIME_M  (SPI_MEM_C_SMEM_CS_SETUP_TIME_V << SPI_MEM_C_SMEM_CS_SETUP_TIME_S)
#define SPI_MEM_C_SMEM_CS_SETUP_TIME_V  0x0000001FU
#define SPI_MEM_C_SMEM_CS_SETUP_TIME_S  2
/** SPI_MEM_C_SMEM_CS_HOLD_TIME : HRO; bitpos: [11:7]; default: 1;
 *  For SPI0 and SPI1, spi cs signal is delayed to inactive by spi clock this bits are
 *  combined with spi_mem_cs_hold bit.
 */
#define SPI_MEM_C_SMEM_CS_HOLD_TIME    0x0000001FU
#define SPI_MEM_C_SMEM_CS_HOLD_TIME_M  (SPI_MEM_C_SMEM_CS_HOLD_TIME_V << SPI_MEM_C_SMEM_CS_HOLD_TIME_S)
#define SPI_MEM_C_SMEM_CS_HOLD_TIME_V  0x0000001FU
#define SPI_MEM_C_SMEM_CS_HOLD_TIME_S  7
/** SPI_MEM_C_SMEM_ECC_CS_HOLD_TIME : HRO; bitpos: [14:12]; default: 3;
 ...
 */
#define SPI_MEM_C_SMEM_ECC_CS_HOLD_TIME    0x00000007U
#define SPI_MEM_C_SMEM_ECC_CS_HOLD_TIME_M  (SPI_MEM_C_SMEM_ECC_CS_HOLD_TIME_V << SPI_MEM_C_SMEM_ECC_CS_HOLD_TIME_S)
#define SPI_MEM_C_SMEM_ECC_CS_HOLD_TIME_V  0x00000007U
#define SPI_MEM_C_SMEM_ECC_CS_HOLD_TIME_S  12
/** SPI_MEM_C_SMEM_ECC_SKIP_PAGE_CORNER : HRO; bitpos: [15]; default: 1;
 *  1: SPI0 skips page corner when accesses external RAM. 0: Not skip page corner when
 *  accesses external RAM.
 */
#define SPI_MEM_C_SMEM_ECC_SKIP_PAGE_CORNER    (BIT(15))
#define SPI_MEM_C_SMEM_ECC_SKIP_PAGE_CORNER_M  (SPI_MEM_C_SMEM_ECC_SKIP_PAGE_CORNER_V << SPI_MEM_C_SMEM_ECC_SKIP_PAGE_CORNER_S)
#define SPI_MEM_C_SMEM_ECC_SKIP_PAGE_CORNER_V  0x00000001U
#define SPI_MEM_C_SMEM_ECC_SKIP_PAGE_CORNER_S  15
/** SPI_MEM_C_SMEM_ECC_16TO18_BYTE_EN : HRO; bitpos: [16]; default: 0;
 *  Set this bit to enable SPI0 and SPI1 ECC 16 bytes data with 2 ECC bytes mode when
 *  accesses external RAM.
 */
#define SPI_MEM_C_SMEM_ECC_16TO18_BYTE_EN    (BIT(16))
#define SPI_MEM_C_SMEM_ECC_16TO18_BYTE_EN_M  (SPI_MEM_C_SMEM_ECC_16TO18_BYTE_EN_V << SPI_MEM_C_SMEM_ECC_16TO18_BYTE_EN_S)
#define SPI_MEM_C_SMEM_ECC_16TO18_BYTE_EN_V  0x00000001U
#define SPI_MEM_C_SMEM_ECC_16TO18_BYTE_EN_S  16
/** SPI_MEM_C_SMEM_CS_HOLD_DELAY : HRO; bitpos: [30:25]; default: 0;
 *  These bits are used to set the minimum CS high time tSHSL between SPI burst
 *  transfer when accesses to external RAM. tSHSL is (SPI_MEM_C_SMEM_CS_HOLD_DELAY[5:0] + 1)
 *  MSPI core clock cycles.
 */
#define SPI_MEM_C_SMEM_CS_HOLD_DELAY    0x0000003FU
#define SPI_MEM_C_SMEM_CS_HOLD_DELAY_M  (SPI_MEM_C_SMEM_CS_HOLD_DELAY_V << SPI_MEM_C_SMEM_CS_HOLD_DELAY_S)
#define SPI_MEM_C_SMEM_CS_HOLD_DELAY_V  0x0000003FU
#define SPI_MEM_C_SMEM_CS_HOLD_DELAY_S  25
/** SPI_MEM_C_SMEM_SPLIT_TRANS_EN : HRO; bitpos: [31]; default: 1;
 ...
 */
#define SPI_MEM_C_SMEM_SPLIT_TRANS_EN    (BIT(31))
#define SPI_MEM_C_SMEM_SPLIT_TRANS_EN_M  (SPI_MEM_C_SMEM_SPLIT_TRANS_EN_V << SPI_MEM_C_SMEM_SPLIT_TRANS_EN_S)
#define SPI_MEM_C_SMEM_SPLIT_TRANS_EN_V  0x00000001U
#define SPI_MEM_C_SMEM_SPLIT_TRANS_EN_S  31

/** SPI_MEM_C_CLOCK_GATE_REG register
 *  SPI0 clock gate register
 */
#define SPI_MEM_C_CLOCK_GATE_REG (DR_REG_FLASH_SPI0_BASE + 0x200)
/** SPI_MEM_C_CLK_EN : R/W; bitpos: [0]; default: 1;
 *  Register clock gate enable signal. 1: Enable. 0: Disable.
 */
#define SPI_MEM_C_CLK_EN    (BIT(0))
#define SPI_MEM_C_CLK_EN_M  (SPI_CLK_EN_V << SPI_CLK_EN_S)
#define SPI_MEM_C_CLK_EN_V  0x00000001U
#define SPI_MEM_C_CLK_EN_S  0
...
/** SPI_MEM_C_XTS_PLAIN : R/W; bitpos: [31:0]; default: 0;
 *  This field is only used to generate include file in c case. This field is useless.
 *  Please do not use this field.
 */
#define SPI_MEM_C_XTS_PLAIN    0xFFFFFFFFU
#define SPI_MEM_C_XTS_PLAIN_M  (SPI_XTS_PLAIN_V << SPI_XTS_PLAIN_S)
#define SPI_MEM_C_XTS_PLAIN_V  0xFFFFFFFFU
#define SPI_MEM_C_XTS_PLAIN_S  0
...
/** SPI_MEM_C_XTS_LINESIZE : R/W; bitpos: [1:0]; default: 0;
 ...
 */
#define SPI_MEM_C_XTS_LINESIZE    0x00000003U
#define SPI_MEM_C_XTS_LINESIZE_M  (SPI_XTS_LINESIZE_V << SPI_XTS_LINESIZE_S)
#define SPI_MEM_C_XTS_LINESIZE_V  0x00000003U
#define SPI_MEM_C_XTS_LINESIZE_S  0
...
/** SPI_MEM_C_XTS_DESTINATION : R/W; bitpos: [0]; default: 0;
 ...
 */
#define SPI_MEM_C_XTS_DESTINATION    (BIT(0))
#define SPI_MEM_C_XTS_DESTINATION_M  (SPI_XTS_DESTINATION_V << SPI_XTS_DESTINATION_S)
#define SPI_MEM_C_XTS_DESTINATION_V  0x00000001U
#define SPI_MEM_C_XTS_DESTINATION_S  0
...
/** SPI_MEM_C_XTS_PHYSICAL_ADDRESS : R/W; bitpos: [25:0]; default: 0;
 ...
 *  line-size parameter.
 */
#define SPI_MEM_C_XTS_PHYSICAL_ADDRESS    0x03FFFFFFU
#define SPI_MEM_C_XTS_PHYSICAL_ADDRESS_M  (SPI_XTS_PHYSICAL_ADDRESS_V << SPI_XTS_PHYSICAL_ADDRESS_S)
#define SPI_MEM_C_XTS_PHYSICAL_ADDRESS_V  0x03FFFFFFU
#define SPI_MEM_C_XTS_PHYSICAL_ADDRESS_S  0
...
/** SPI_MEM_C_XTS_RELEASE : WT; bitpos: [0]; default: 0;
 ...
 */
#define SPI_MEM_C_XTS_RELEASE    (BIT(0))
#define SPI_MEM_C_XTS_RELEASE_M  (SPI_XTS_RELEASE_V << SPI_XTS_RELEASE_S)
#define SPI_MEM_C_XTS_RELEASE_V  0x00000001U
#define SPI_MEM_C_XTS_RELEASE_S  0

/** SPI_MEM_C_XTS_DESTROY_REG register
 *  Manual Encryption physical address register
 */
#define SPI_MEM_C_XTS_DESTROY_REG (DR_REG_FLASH_SPI0_BASE + 0x354)
/** SPI_MEM_C_XTS_DESTROY : WT; bitpos: [0]; default: 0;
 ...
 *  become 0.
 */
#define SPI_MEM_C_XTS_DESTROY    (BIT(0))
#define SPI_MEM_C_XTS_DESTROY_M  (SPI_XTS_DESTROY_V << SPI_XTS_DESTROY_S)
#define SPI_MEM_C_XTS_DESTROY_V  0x00000001U
#define SPI_MEM_C_XTS_DESTROY_S  0

/** SPI_MEM_C_XTS_STATE_REG register
 *  Manual Encryption physical address register
 */
#define SPI_MEM_C_XTS_STATE_REG (DR_REG_FLASH_SPI0_BASE + 0x358)
/** SPI_MEM_C_XTS_STATE : RO; bitpos: [1:0]; default: 0;
 ...
 */
#define SPI_MEM_C_XTS_STATE    0x00000003U
#define SPI_MEM_C_XTS_STATE_M  (SPI_XTS_STATE_V << SPI_XTS_STATE_S)
#define SPI_MEM_C_XTS_STATE_V  0x00000003U
#define SPI_MEM_C_XTS_STATE_S  0
...
/** SPI_MEM_C_XTS_DATE : R/W; bitpos: [29:0]; default: 538972176;
 *  This bits stores the last modified-time of manual encryption feature.
 */
#define SPI_MEM_C_XTS_DATE    0x3FFFFFFFU
#define SPI_MEM_C_XTS_DATE_M  (SPI_XTS_DATE_V << SPI_XTS_DATE_S)
#define SPI_MEM_C_XTS_DATE_V  0x3FFFFFFFU
#define SPI_MEM_C_XTS_DATE_S  0
...
/** SPI_MEM_C_MMU_ITEM_CONTENT : R/W; bitpos: [31:0]; default: 892;
 *  MSPI-MMU item content
 */
#define SPI_MEM_C_MMU_ITEM_CONTENT    0xFFFFFFFFU
#define SPI_MEM_C_MMU_ITEM_CONTENT_M  (SPI_MMU_ITEM_CONTENT_V << SPI_MMU_ITEM_CONTENT_S)
#define SPI_MEM_C_MMU_ITEM_CONTENT_V  0xFFFFFFFFU
#define SPI_MEM_C_MMU_ITEM_CONTENT_S  0
...
/** SPI_MEM_C_MMU_ITEM_INDEX : R/W; bitpos: [31:0]; default: 0;
 *  MSPI-MMU item index
 */
#define SPI_MEM_C_MMU_ITEM_INDEX    0xFFFFFFFFU
#define SPI_MEM_C_MMU_ITEM_INDEX_M  (SPI_MMU_ITEM_INDEX_V << SPI_MMU_ITEM_INDEX_S)
#define SPI_MEM_C_MMU_ITEM_INDEX_V  0xFFFFFFFFU
#define SPI_MEM_C_MMU_ITEM_INDEX_S  0
...
/** SPI_MEM_C_MMU_MEM_FORCE_ON : R/W; bitpos: [0]; default: 0;
 *  Set this bit to enable mmu-memory clock force on
 */
#define SPI_MEM_C_MMU_MEM_FORCE_ON    (BIT(0))
#define SPI_MEM_C_MMU_MEM_FORCE_ON_M  (SPI_MMU_MEM_FORCE_ON_V << SPI_MMU_MEM_FORCE_ON_S)
#define SPI_MEM_C_MMU_MEM_FORCE_ON_V  0x00000001U
#define SPI_MEM_C_MMU_MEM_FORCE_ON_S  0
/** SPI_MEM_C_MMU_MEM_FORCE_PD : R/W; bitpos: [1]; default: 0;
 *  Set this bit to force mmu-memory powerdown
 */
#define SPI_MEM_C_MMU_MEM_FORCE_PD    (BIT(1))
#define SPI_MEM_C_MMU_MEM_FORCE_PD_M  (SPI_MMU_MEM_FORCE_PD_V << SPI_MMU_MEM_FORCE_PD_S)
#define SPI_MEM_C_MMU_MEM_FORCE_PD_V  0x00000001U
#define SPI_MEM_C_MMU_MEM_FORCE_PD_S  1
/** SPI_MEM_C_MMU_MEM_FORCE_PU : R/W; bitpos: [2]; default: 1;
 *  Set this bit to force mmu-memory powerup, in this case, the power should also be
 *  controlled by rtc.
 */
#define SPI_MEM_C_MMU_MEM_FORCE_PU    (BIT(2))
#define SPI_MEM_C_MMU_MEM_FORCE_PU_M  (SPI_MMU_MEM_FORCE_PU_V << SPI_MMU_MEM_FORCE_PU_S)
#define SPI_MEM_C_MMU_MEM_FORCE_PU_V  0x00000001U
#define SPI_MEM_C_MMU_MEM_FORCE_PU_S  2
/** SPI_MEM_C_MMU_PAGE_SIZE : R/W; bitpos: [4:3]; default: 0;
 *  0: Max page size , 1: Max page size/2 , 2: Max page size/4, 3: Max page size/8
 */
#define SPI_MEM_C_MMU_PAGE_SIZE    0x00000003U
#define SPI_MEM_C_MMU_PAGE_SIZE_M  (SPI_MMU_PAGE_SIZE_V << SPI_MMU_PAGE_SIZE_S)
#define SPI_MEM_C_MMU_PAGE_SIZE_V  0x00000003U
#define SPI_MEM_C_MMU_PAGE_SIZE_S  3
...
/** SPI_MEM_C_CRYPT_SECURITY_LEVEL : R/W; bitpos: [2:0]; default: 7;
 ...
 */
#define SPI_MEM_C_CRYPT_SECURITY_LEVEL    0x00000007U
#define SPI_MEM_C_CRYPT_SECURITY_LEVEL_M  (SPI_CRYPT_SECURITY_LEVEL_V << SPI_CRYPT_SECURITY_LEVEL_S)
#define SPI_MEM_C_CRYPT_SECURITY_LEVEL_V  0x00000007U
#define SPI_MEM_C_CRYPT_SECURITY_LEVEL_S  0
/** SPI_MEM_C_CRYPT_CALC_D_DPA_EN : R/W; bitpos: [3]; default: 1;
 ...
 *  using key 1.
 */
#define SPI_MEM_C_CRYPT_CALC_D_DPA_EN    (BIT(3))
#define SPI_MEM_C_CRYPT_CALC_D_DPA_EN_M  (SPI_CRYPT_CALC_D_DPA_EN_V << SPI_CRYPT_CALC_D_DPA_EN_S)
#define SPI_MEM_C_CRYPT_CALC_D_DPA_EN_V  0x00000001U
#define SPI_MEM_C_CRYPT_CALC_D_DPA_EN_S  3
/** SPI_MEM_C_CRYPT_DPA_SELECT_REGISTER : R/W; bitpos: [4]; default: 0;
 ...
 */
#define SPI_MEM_C_CRYPT_DPA_SELECT_REGISTER    (BIT(4))
#define SPI_MEM_C_CRYPT_DPA_SELECT_REGISTER_M  (SPI_CRYPT_DPA_SELECT_REGISTER_V << SPI_CRYPT_DPA_SELECT_REGISTER_S)
#define SPI_MEM_C_CRYPT_DPA_SELECT_REGISTER_V  0x00000001U
#define SPI_MEM_C_CRYPT_DPA_SELECT_REGISTER_S  4

/** SPI_MEM_C_DATE_REG register
 *  SPI0 version control register
 */
#define SPI_MEM_C_DATE_REG (DR_REG_FLASH_SPI0_BASE + 0x3fc)
/** SPI_MEM_C_DATE : R/W; bitpos: [27:0]; default: 36712560;
