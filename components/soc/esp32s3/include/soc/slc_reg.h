...
#define SLC_SLCCONF0_REG          (DR_REG_SLC_BASE + 0x0)
...
#define SLC_INT_RAW_REG          (DR_REG_SLC_BASE + 0x4)
...
#define SLC_INT_ST_REG          (DR_REG_SLC_BASE + 0x8)
...
#define SLC_INT_ENA_REG          (DR_REG_SLC_BASE + 0xC)
...
#define SLC_INT_CLR_REG          (DR_REG_SLC_BASE + 0x10)
...
#define SLC_SLCRX_STATUS_REG          (DR_REG_SLC_BASE + 0x24)
...
#define SLC_RXFIFO_PUSH_REG          (DR_REG_SLC_BASE + 0x28)
...
#define SLC_SLCTX_STATUS_REG          (DR_REG_SLC_BASE + 0x30)
...
#define SLC_TXFIFO_POP_REG          (DR_REG_SLC_BASE + 0x34)
...
#define SLC_RX_LINK_REG          (DR_REG_SLC_BASE + 0x3C)
...
#define SLC_TX_LINK_REG          (DR_REG_SLC_BASE + 0x40)
...
#define SLC_SLCINTVEC_TOHOST_REG          (DR_REG_SLC_BASE + 0x4C)
...
#define SLC_TOKEN0_REG          (DR_REG_SLC_BASE + 0x50)
...
#define SLC_TOKEN1_REG          (DR_REG_SLC_BASE + 0x54)
...
#define SLC_SLCCONF1_REG          (DR_REG_SLC_BASE + 0x60)
...
#define SLC_STATE0_REG          (DR_REG_SLC_BASE + 0x64)
...
#define SLC_STATE1_REG          (DR_REG_SLC_BASE + 0x68)
...
#define SLC_SLCBRIDGE_CONF_REG          (DR_REG_SLC_BASE + 0x74)
...
#define SLC_TO_EOF_DES_ADDR_REG          (DR_REG_SLC_BASE + 0x78)
...
#define SLC_TX_EOF_DES_ADDR_REG          (DR_REG_SLC_BASE + 0x7C)
...
#define SLC_TO_EOF_BFR_DES_ADDR_REG          (DR_REG_SLC_BASE + 0x80)
...
#define SLC_TXLINK_DSCR_REG          (DR_REG_SLC_BASE + 0x9C)
...
#define SLC_TXLINK_DSCR_BF0_REG          (DR_REG_SLC_BASE + 0xA0)
...
#define SLC_TXLINK_DSCR_BF1_REG          (DR_REG_SLC_BASE + 0xA4)
...
#define SLC_RXLINK_DSCR_REG          (DR_REG_SLC_BASE + 0xA8)
...
#define SLC_RXLINK_DSCR_BF0_REG          (DR_REG_SLC_BASE + 0xAC)
...
#define SLC_RXLINK_DSCR_BF1_REG          (DR_REG_SLC_BASE + 0xB0)
...
#define SLC_TX_ERREOF_DES_ADDR_REG          (DR_REG_SLC_BASE + 0xCC)
...
#define SLC_LEN_CONF_REG          (DR_REG_SLC_BASE + 0xE4)
...
#define SLC_LENGTH_REG          (DR_REG_SLC_BASE + 0xE8)
...
#define SLC_TXPKT_H_DSCR_REG          (DR_REG_SLC_BASE + 0xEC)
...
#define SLC_TXPKT_E_DSCR_REG          (DR_REG_SLC_BASE + 0xF0)
...
#define SLC_RXPKT_H_DSCR_REG          (DR_REG_SLC_BASE + 0xF4)
...
#define SLC_RXPKT_E_DSCR_REG          (DR_REG_SLC_BASE + 0xF8)
...
#define SLC_TXPKTU_H_DSCR_REG          (DR_REG_SLC_BASE + 0xFC)
...
#define SLC_TXPKTU_E_DSCR_REG          (DR_REG_SLC_BASE + 0x100)
...
#define SLC_RXPKTU_H_DSCR_REG          (DR_REG_SLC_BASE + 0x104)
...
#define SLC_RXPKTU_E_DSCR_REG          (DR_REG_SLC_BASE + 0x108)
...
#define SLC_DSCR_REC_CONF_REG          (DR_REG_SLC_BASE + 0x118)
...
#define SLC_EOF_START_DES_REG          (DR_REG_SLC_BASE + 0x124)
...
#define SLC_PUSH_DSCR_ADDR_REG          (DR_REG_SLC_BASE + 0x128)
...
#define SLC_DONE_DSCR_ADDR_REG          (DR_REG_SLC_BASE + 0x12C)
...
#define SLC_SUB_START_DES_REG          (DR_REG_SLC_BASE + 0x130)
...
#define SLC_DSCR_CNT_REG          (DR_REG_SLC_BASE + 0x134)
...
#define SLC_LEN_LIM_CONF_REG          (DR_REG_SLC_BASE + 0x138)
...
#define SLC_INT_ST1_REG          (DR_REG_SLC_BASE + 0x13C)
...
#define SLC_INT_ENA1_REG          (DR_REG_SLC_BASE + 0x140)
...
#define SLC_SLCDATE_REG          (DR_REG_SLC_BASE + 0x1F8)
...
#define SLC_SLCID_REG          (DR_REG_SLC_BASE + 0x1FC)
