...
#define SYSTEM_ROM_CTRL_0_REG (DR_REG_SYSTEM_BASE + 0x000)
/* SYSTEM_ROM_IRAM0_DRAM0_CLKGATE_FORCE_ON : R/W ;bitpos:[2] ;default: ~1'b0 ; */
/*description: */
#define SYSTEM_ROM_IRAM0_DRAM0_CLKGATE_FORCE_ON (BIT(2))
#define SYSTEM_ROM_IRAM0_DRAM0_CLKGATE_FORCE_ON_M (BIT(2))
#define SYSTEM_ROM_IRAM0_DRAM0_CLKGATE_FORCE_ON_V 0x1
#define SYSTEM_ROM_IRAM0_DRAM0_CLKGATE_FORCE_ON_S 2
/* SYSTEM_ROM_IRAM0_CLKGATE_FORCE_ON : R/W ;bitpos:[1:0] ;default: ~2'b0 ; */
/*description: */
#define SYSTEM_ROM_IRAM0_CLKGATE_FORCE_ON 0x00000003
#define SYSTEM_ROM_IRAM0_CLKGATE_FORCE_ON_M ((SYSTEM_ROM_IRAM0_CLKGATE_FORCE_ON_V) << (SYSTEM_ROM_IRAM0_CLKGATE_FORCE_ON_S))
#define SYSTEM_ROM_IRAM0_CLKGATE_FORCE_ON_V 0x3
#define SYSTEM_ROM_IRAM0_CLKGATE_FORCE_ON_S 0

#define SYSTEM_ROM_CTRL_1_REG (DR_REG_SYSTEM_BASE + 0x004)
/* SYSTEM_ROM_IRAM0_DRAM0_POWER_UP : R/W ;bitpos:[5] ;default: 1'b1 ; */
/*description: */
#define SYSTEM_ROM_IRAM0_DRAM0_POWER_UP (BIT(5))
#define SYSTEM_ROM_IRAM0_DRAM0_POWER_UP_M (BIT(5))
#define SYSTEM_ROM_IRAM0_DRAM0_POWER_UP_V 0x1
#define SYSTEM_ROM_IRAM0_DRAM0_POWER_UP_S 5
/* SYSTEM_ROM_IRAM0_DRAM0_POWER_DOWN : R/W ;bitpos:[4] ;default: 1'b0 ; */
/*description: */
#define SYSTEM_ROM_IRAM0_DRAM0_POWER_DOWN (BIT(4))
#define SYSTEM_ROM_IRAM0_DRAM0_POWER_DOWN_M (BIT(4))
#define SYSTEM_ROM_IRAM0_DRAM0_POWER_DOWN_V 0x1
#define SYSTEM_ROM_IRAM0_DRAM0_POWER_DOWN_S 4
/* SYSTEM_ROM_IRAM0_POWER_UP : R/W ;bitpos:[3:2] ;default: 2'b11 ; */
/*description: */
#define SYSTEM_ROM_IRAM0_POWER_UP 0x00000003
#define SYSTEM_ROM_IRAM0_POWER_UP_M ((SYSTEM_ROM_IRAM0_POWER_UP_V) << (SYSTEM_ROM_IRAM0_POWER_UP_S))
#define SYSTEM_ROM_IRAM0_POWER_UP_V 0x3
#define SYSTEM_ROM_IRAM0_POWER_UP_S 2
/* SYSTEM_ROM_IRAM0_POWER_DOWN : R/W ;bitpos:[1:0] ;default: 2'b0 ; */
/*description: */
#define SYSTEM_ROM_IRAM0_POWER_DOWN 0x00000003
#define SYSTEM_ROM_IRAM0_POWER_DOWN_M ((SYSTEM_ROM_IRAM0_POWER_DOWN_V) << (SYSTEM_ROM_IRAM0_POWER_DOWN_S))
#define SYSTEM_ROM_IRAM0_POWER_DOWN_V 0x3
#define SYSTEM_ROM_IRAM0_POWER_DOWN_S 0

#define SYSTEM_SRAM_CTRL_0_REG (DR_REG_SYSTEM_BASE + 0x008)
/* SYSTEM_SRAM_CLKGATE_FORCE_ON : R/W ;bitpos:[10:0] ;default: ~11'b0 ; */
/*description: */
#define SYSTEM_SRAM_CLKGATE_FORCE_ON 0x000007FF
#define SYSTEM_SRAM_CLKGATE_FORCE_ON_M ((SYSTEM_SRAM_CLKGATE_FORCE_ON_V) << (SYSTEM_SRAM_CLKGATE_FORCE_ON_S))
#define SYSTEM_SRAM_CLKGATE_FORCE_ON_V 0x7FF
#define SYSTEM_SRAM_CLKGATE_FORCE_ON_S 0

#define SYSTEM_SRAM_CTRL_1_REG (DR_REG_SYSTEM_BASE + 0x00C)
/* SYSTEM_SRAM_POWER_DOWN : R/W ;bitpos:[10:0] ;default: 11'b0 ; */
/*description: */
#define SYSTEM_SRAM_POWER_DOWN 0x000007FF
#define SYSTEM_SRAM_POWER_DOWN_M ((SYSTEM_SRAM_POWER_DOWN_V) << (SYSTEM_SRAM_POWER_DOWN_S))
#define SYSTEM_SRAM_POWER_DOWN_V 0x7FF
#define SYSTEM_SRAM_POWER_DOWN_S 0

#define SYSTEM_SRAM_CTRL_2_REG (DR_REG_SYSTEM_BASE + 0x010)
/* SYSTEM_SRAM_POWER_UP : R/W ;bitpos:[10:0] ;default: ~11'b0 ; */
/*description: */
#define SYSTEM_SRAM_POWER_UP 0x000007FF
#define SYSTEM_SRAM_POWER_UP_M ((SYSTEM_SRAM_POWER_UP_V) << (SYSTEM_SRAM_POWER_UP_S))
#define SYSTEM_SRAM_POWER_UP_V 0x7FF
#define SYSTEM_SRAM_POWER_UP_S 0

#define SYSTEM_CORE_1_CONTROL_0_REG (DR_REG_SYSTEM_BASE + 0x014)
...
#define SYSTEM_CONTROL_CORE_1_CLKGATE_EN_M (BIT(1))
#define SYSTEM_CONTROL_CORE_1_CLKGATE_EN_V 0x1
#define SYSTEM_CONTROL_CORE_1_CLKGATE_EN_S 1
/* SYSTEM_CONTROL_CORE_1_RUNSTALL : R/W ;bitpos:[0] ;default: 1'b0 ; */
/*description: */
#define SYSTEM_CONTROL_CORE_1_RUNSTALL (BIT(0))
#define SYSTEM_CONTROL_CORE_1_RUNSTALL_M (BIT(0))
#define SYSTEM_CONTROL_CORE_1_RUNSTALL_V 0x1
#define SYSTEM_CONTROL_CORE_1_RUNSTALL_S 0

#define SYSTEM_CORE_1_CONTROL_1_REG (DR_REG_SYSTEM_BASE + 0x018)
/* SYSTEM_CONTROL_CORE_1_MESSAGE : R/W ;bitpos:[31:0] ;default: 32'b0 ; */
/*description: */
...
#define SYSTEM_CPU_PERI_CLK_EN_REG (DR_REG_SYSTEM_BASE + 0x01C)
...
#define SYSTEM_CPU_PERI_RST_EN_REG (DR_REG_SYSTEM_BASE + 0x020)
...
#define SYSTEM_CPU_PER_CONF_REG (DR_REG_SYSTEM_BASE + 0x024)
...
#define SYSTEM_JTAG_CTRL_0_REG (DR_REG_SYSTEM_BASE + 0x028)
...
#define SYSTEM_JTAG_CTRL_1_REG (DR_REG_SYSTEM_BASE + 0x02C)
...
#define SYSTEM_JTAG_CTRL_2_REG (DR_REG_SYSTEM_BASE + 0x030)
...
#define SYSTEM_JTAG_CTRL_3_REG (DR_REG_SYSTEM_BASE + 0x034)
...
#define SYSTEM_JTAG_CTRL_4_REG (DR_REG_SYSTEM_BASE + 0x038)
...
#define SYSTEM_JTAG_CTRL_5_REG (DR_REG_SYSTEM_BASE + 0x03C)
...
#define SYSTEM_JTAG_CTRL_6_REG (DR_REG_SYSTEM_BASE + 0x040)
...
#define SYSTEM_JTAG_CTRL_7_REG (DR_REG_SYSTEM_BASE + 0x044)
...
#define SYSTEM_MEM_PD_MASK_REG (DR_REG_SYSTEM_BASE + 0x048)
...
#define SYSTEM_PERIP_CLK_EN0_REG (DR_REG_SYSTEM_BASE + 0x04C)
...
/* SYSTEM_USB_CLK_EN : R/W ;bitpos:[23] ;default: 1'b1 ; */
/*description: */
#define SYSTEM_USB_CLK_EN (BIT(23))
#define SYSTEM_USB_CLK_EN_M (BIT(23))
#define SYSTEM_USB_CLK_EN_V 0x1
...
#define SYSTEM_PERIP_CLK_EN1_REG (DR_REG_SYSTEM_BASE + 0x050)
...
#define SYSTEM_PERIP_RST_EN0_REG (DR_REG_SYSTEM_BASE + 0x054)
...
/* SYSTEM_USB_RST : R/W ;bitpos:[23] ;default: 1'b0 ; */
/*description: */
#define SYSTEM_USB_RST (BIT(23))
#define SYSTEM_USB_RST_M (BIT(23))
#define SYSTEM_USB_RST_V 0x1
...
#define SYSTEM_PERIP_RST_EN1_REG (DR_REG_SYSTEM_BASE + 0x058)
...
#define SYSTEM_BT_LPCK_DIV_INT_REG (DR_REG_SYSTEM_BASE + 0x05C)
...
#define SYSTEM_BT_LPCK_DIV_FRAC_REG (DR_REG_SYSTEM_BASE + 0x060)
...
#define SYSTEM_CPU_INTR_FROM_CPU_0_REG (DR_REG_SYSTEM_BASE + 0x064)
...
#define SYSTEM_CPU_INTR_FROM_CPU_1_REG (DR_REG_SYSTEM_BASE + 0x068)
...
#define SYSTEM_CPU_INTR_FROM_CPU_2_REG (DR_REG_SYSTEM_BASE + 0x06C)
...
#define SYSTEM_CPU_INTR_FROM_CPU_3_REG (DR_REG_SYSTEM_BASE + 0x070)
...
#define SYSTEM_RSA_PD_CTRL_REG (DR_REG_SYSTEM_BASE + 0x074)
...
#define SYSTEM_EDMA_CTRL_REG (DR_REG_SYSTEM_BASE + 0x078)
...
#define SYSTEM_CACHE_CONTROL_REG (DR_REG_SYSTEM_BASE + 0x07C)
...
#define SYSTEM_EXTERNAL_DEVICE_ENCRYPT_DECRYPT_CONTROL_REG (DR_REG_SYSTEM_BASE + 0x080)
...
#define SYSTEM_RTC_FASTMEM_CONFIG_REG (DR_REG_SYSTEM_BASE + 0x084)
...
#define SYSTEM_RTC_FASTMEM_CRC_REG (DR_REG_SYSTEM_BASE + 0x088)
...
#define SYSTEM_REDUNDANT_ECO_CTRL_REG (DR_REG_SYSTEM_BASE + 0x08C)
...
#define SYSTEM_CLOCK_GATE_REG (DR_REG_SYSTEM_BASE + 0x090)
...
#define SYSTEM_SYSCLK_CONF_REG (DR_REG_SYSTEM_BASE + 0x094)
...
#define SYSTEM_MEM_PVT_REG (DR_REG_SYSTEM_BASE + 0x098)
...
#define SYSTEM_COMB_PVT_REG (DR_REG_SYSTEM_BASE + 0x09C)
/* SYSTEM_COMB_TIMING_ERR_CNT : RO ;bitpos:[22:7] ;default: 16'h0 ; */
/*description: */
#define SYSTEM_COMB_TIMING_ERR_CNT 0x0000FFFF
#define SYSTEM_COMB_TIMING_ERR_CNT_M ((SYSTEM_COMB_TIMING_ERR_CNT_V) << (SYSTEM_COMB_TIMING_ERR_CNT_S))
#define SYSTEM_COMB_TIMING_ERR_CNT_V 0xFFFF
#define SYSTEM_COMB_TIMING_ERR_CNT_S 7
/* SYSTEM_COMB_PVT_MONITOR_EN : R/W ;bitpos:[6] ;default: 1'b0 ; */
/*description: */
#define SYSTEM_COMB_PVT_MONITOR_EN (BIT(6))
#define SYSTEM_COMB_PVT_MONITOR_EN_M (BIT(6))
#define SYSTEM_COMB_PVT_MONITOR_EN_V 0x1
#define SYSTEM_COMB_PVT_MONITOR_EN_S 6
/* SYSTEM_COMB_ERR_CNT_CLR : WO ;bitpos:[5] ;default: 1'b0 ; */
/*description: */
#define SYSTEM_COMB_ERR_CNT_CLR (BIT(5))
#define SYSTEM_COMB_ERR_CNT_CLR_M (BIT(5))
#define SYSTEM_COMB_ERR_CNT_CLR_V 0x1
#define SYSTEM_COMB_ERR_CNT_CLR_S 5
/* SYSTEM_COMB_PATH_LEN : R/W ;bitpos:[4:0] ;default: 5'h3 ; */
/*description: */
#define SYSTEM_COMB_PATH_LEN 0x0000001F
#define SYSTEM_COMB_PATH_LEN_M ((SYSTEM_COMB_PATH_LEN_V) << (SYSTEM_COMB_PATH_LEN_S))
#define SYSTEM_COMB_PATH_LEN_V 0x1F
#define SYSTEM_COMB_PATH_LEN_S 0

#define SYSTEM_RETENTION_BUS_CTRL_REG (DR_REG_SYSTEM_BASE + 0x100)
/* SYSTEM_RETENTION_LINK_ADDR : R/W ;bitpos:[26:0] ;default: 27'd0 ; */
/*description: */
#define SYSTEM_RETENTION_LINK_ADDR 0x07FFFFFF
#define SYSTEM_RETENTION_LINK_ADDR_M ((SYSTEM_RETENTION_LINK_ADDR_V) << (SYSTEM_RETENTION_LINK_ADDR_S))
#define SYSTEM_RETENTION_LINK_ADDR_V 0x7FFFFFF
#define SYSTEM_RETENTION_LINK_ADDR_S 0

#define SYSTEM_DATE_REG (DR_REG_SYSTEM_BASE + 0xFFC)
/* SYSTEM_DATE : R/W ;bitpos:[27:0] ;default: 28'h2002281 ; */
/*description: */
