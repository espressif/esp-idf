...
#define SENS_SAR_PERI_CLK_GATE_CONF_REG (DR_REG_SENS_BASE + 0x0144)
...
/* SENS_CLK_EN : R/W ;bitpos:[30] ;default: 1'b0 ; */
/*description: */
#define SENS_CLK_EN (BIT(30))
#define SENS_CLK_EN_M (BIT(30))
#define SENS_CLK_EN_V 0x1
#define SENS_CLK_EN_S 30
...
/* SENS_DAC_CLK_EN : R/W ;bitpos:[26] ;default: 1'b0 ; */
/*description: */
#define SENS_DAC_CLK_EN (BIT(26))
#define SENS_DAC_CLK_EN_M (BIT(26))
#define SENS_DAC_CLK_EN_V 0x1
#define SENS_DAC_CLK_EN_S 26

#define SENS_SAR_PERI_RESET_CONF_REG (DR_REG_SENS_BASE + 0x0148)
/* SENS_RESET : R/W ;bitpos:[30] ;default: 1'b0 ; */
/*description: */
#define SENS_RESET (BIT(30))
#define SENS_RESET_M (BIT(30))
#define SENS_RESET_V 0x1
#define SENS_RESET_S 30
...
#define SENS_SAR_COCPU_INT_ENA_W1TS_REG (DR_REG_SENS_BASE + 0x014c)
...
/* SENS_COCPU_SENS2_INT_ENA_W1TS : WO ;bitpos:[4] ;default: 1'b0 ; */
/*description: */
#define SENS_COCPU_SENS2_INT_ENA_W1TS (BIT(4))
#define SENS_COCPU_SENS2_INT_ENA_W1TS_M (BIT(4))
#define SENS_COCPU_SENS2_INT_ENA_W1TS_V 0x1
#define SENS_COCPU_SENS2_INT_ENA_W1TS_S 4
/* SENS_COCPU_SENS1_INT_ENA_W1TS : WO ;bitpos:[3] ;default: 1'b0 ; */
/*description: */
#define SENS_COCPU_SENS1_INT_ENA_W1TS (BIT(3))
#define SENS_COCPU_SENS1_INT_ENA_W1TS_M (BIT(3))
#define SENS_COCPU_SENS1_INT_ENA_W1TS_V 0x1
#define SENS_COCPU_SENS1_INT_ENA_W1TS_S 3
...
#define SENS_SAR_COCPU_INT_ENA_W1TC_REG (DR_REG_SENS_BASE + 0x0150)
...
/* SENS_COCPU_SENS2_INT_ENA_W1TC : WO ;bitpos:[4] ;default: 1'b0 ; */
/*description: */
#define SENS_COCPU_SENS2_INT_ENA_W1TC (BIT(4))
#define SENS_COCPU_SENS2_INT_ENA_W1TC_M (BIT(4))
#define SENS_COCPU_SENS2_INT_ENA_W1TC_V 0x1
#define SENS_COCPU_SENS2_INT_ENA_W1TC_S 4
/* SENS_COCPU_SENS1_INT_ENA_W1TC : WO ;bitpos:[3] ;default: 1'b0 ; */
/*description: */
#define SENS_COCPU_SENS1_INT_ENA_W1TC (BIT(3))
#define SENS_COCPU_SENS1_INT_ENA_W1TC_M (BIT(3))
#define SENS_COCPU_SENS1_INT_ENA_W1TC_V 0x1
#define SENS_COCPU_SENS1_INT_ENA_W1TC_S 3
...
#define SENS_SARDATE_REG (DR_REG_SENS_BASE + 0x0154)
/* SENS_SAR_DATE : R/W ;bitpos:[27:0] ;default: 28'h1909160 ; */
/*description: */
