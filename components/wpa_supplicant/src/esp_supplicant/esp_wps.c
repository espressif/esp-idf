...
int wps_dev_init(void)
{
    ...
    strncpy(dev->manufacturer, s_factory_info->manufacturer, WPS_MAX_MANUFACTURER_LEN);
    ...
    strncpy(dev->model_number, s_factory_info->model_number, WPS_MAX_MODEL_NUMBER_LEN);
    ...
    strncpy(dev->device_name, s_factory_info->device_name, WPS_MAX_DEVICE_NAME_LEN);
