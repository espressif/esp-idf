...
/**
  ...
  */
void rom_gpio_lppad_select_mux(uint32_t gpio_num, uint32_t mux_sel);
...
/**
  ...
  * @return None
  */
void rom_gpio_ded_pad_set_drv(uint32_t ded_gpio_num, uint32_t drv);
...
/**
  ...
  * @return None
  */
void rom_gpio_ded_pad_pullup(uint32_t ded_gpio_num);
...
/**
  ...
  * @return None
  */
void rom_gpio_ded_pad_pulldown(uint32_t ded_gpio_num);
...
/**
  ...
  * @return None
  */
void rom_gpio_ded_pad_unhold(uint32_t ded_gpio_num);
...
/**
  ...
  * @return None
  */
void rom_gpio_ded_pad_hold(uint32_t gpio_num);
