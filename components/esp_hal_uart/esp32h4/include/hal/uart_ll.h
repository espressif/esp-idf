...
{
    uint32_t total_fifo_len = UART_LL_FIFO_DEF_LEN;
    uint32_t txfifo_len = HAL_FORCE_READ_U32_REG_FIELD(hw->status, txfifo_cnt);
 ...
 *
 * @param  hw Beginning address of the peripheral registers.
 * @param  full_thrhd The full threshold value of the rxfifo.
 *
 * @return None.
 */
