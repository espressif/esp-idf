...
FORCE_INLINE_ATTR bool uart_ll_is_enabled(uint32_t uart_num)
{
    ...
    switch (uart_num) {
    case 0:
        uart_rst_en = HP_SYS_CLKRST.uart0_ctrl0.reg_uart0_core_rst_en;
        uart_apb_en = HP_SYS_CLKRST.uart0_ctrl0.reg_uart0_apb_clk_en;
        uart_sys_en = HP_SYS_CLKRST.uart0_ctrl0.reg_uart0_sys_clk_en;
        break;
    case 1:
        uart_rst_en = HP_SYS_CLKRST.uart1_ctrl0.reg_uart1_core_rst_en;
        uart_apb_en = HP_SYS_CLKRST.uart1_ctrl0.reg_uart1_apb_clk_en;
        uart_sys_en = HP_SYS_CLKRST.uart1_ctrl0.reg_uart1_sys_clk_en;
        break;
    case 2:
        uart_rst_en = HP_SYS_CLKRST.uart2_ctrl0.reg_uart2_core_rst_en;
        uart_apb_en = HP_SYS_CLKRST.uart2_ctrl0.reg_uart2_apb_clk_en;
        uart_sys_en = HP_SYS_CLKRST.uart2_ctrl0.reg_uart2_sys_clk_en;
        break;
    case 3:
...
static inline void uart_ll_enable_bus_clock(uart_port_t uart_num, bool enable)
{
    switch (uart_num) {
    case 0:
        HP_SYS_CLKRST.uart0_ctrl0.reg_uart0_apb_clk_en = enable;
        HP_SYS_CLKRST.uart0_ctrl0.reg_uart0_sys_clk_en = enable;
        break;
    case 1:
        HP_SYS_CLKRST.uart1_ctrl0.reg_uart1_apb_clk_en = enable;
        HP_SYS_CLKRST.uart1_ctrl0.reg_uart1_sys_clk_en = enable;
        break;
    case 2:
        HP_SYS_CLKRST.uart2_ctrl0.reg_uart2_apb_clk_en = enable;
        HP_SYS_CLKRST.uart2_ctrl0.reg_uart2_sys_clk_en = enable;
        break;
    case 3:
...
static inline void uart_ll_reset_register(uart_port_t uart_num)
{
    switch (uart_num) {
    case 0:
        HP_SYS_CLKRST.uart0_ctrl0.reg_uart0_apb_rst_en = 1;
        HP_SYS_CLKRST.uart0_ctrl0.reg_uart0_apb_rst_en = 0;
        break;
    case 1:
        HP_SYS_CLKRST.uart1_ctrl0.reg_uart1_apb_rst_en = 1;
        HP_SYS_CLKRST.uart1_ctrl0.reg_uart1_apb_rst_en = 0;
        break;
    case 2:
        HP_SYS_CLKRST.uart2_ctrl0.reg_uart2_apb_rst_en = 1;
        HP_SYS_CLKRST.uart2_ctrl0.reg_uart2_apb_rst_en = 0;
        break;
    case 3:
...
{
    if ((hw) == &UART0) {
        HP_SYS_CLKRST.uart0_ctrl0.reg_uart0_clk_en = 1;
    } else if ((hw) == &UART1) {
        HP_SYS_CLKRST.uart1_ctrl0.reg_uart1_clk_en = 1;
    } else if ((hw) == &UART2) {
        HP_SYS_CLKRST.uart2_ctrl0.reg_uart2_clk_en = 1;
    } else if ((hw) == &UART3) {
        HP_SYS_CLKRST.uart3_ctrl0.reg_uart3_clk_en = 1;
    } else {
...
FORCE_INLINE_ATTR void uart_ll_set_sclk(uart_dev_t *hw, soc_module_clk_t source_clk)
{
    ...
    if ((hw) == &UART0) {
        HP_SYS_CLKRST.uart0_ctrl0.reg_uart0_clk_src_sel = sel_value;
    } else if ((hw) == &UART1) {
        HP_SYS_CLKRST.uart1_ctrl0.reg_uart1_clk_src_sel = sel_value;
    } else if ((hw) == &UART2) {
        HP_SYS_CLKRST.uart2_ctrl0.reg_uart2_clk_src_sel = sel_value;
    } else if ((hw) == &UART3) {
        HP_SYS_CLKRST.uart3_ctrl0.reg_uart3_clk_src_sel = sel_value;
    }  else {
...
FORCE_INLINE_ATTR void uart_ll_get_sclk(uart_dev_t *hw, soc_module_clk_t *source_clk)
{
    uint32_t sel_value = 0;
    if ((hw) == &UART0) {
        sel_value = HP_SYS_CLKRST.uart0_ctrl0.reg_uart0_clk_src_sel;
    } else if ((hw) == &UART1) {
        sel_value = HP_SYS_CLKRST.uart1_ctrl0.reg_uart1_clk_src_sel;
    } else if ((hw) == &UART2) {
        sel_value = HP_SYS_CLKRST.uart2_ctrl0.reg_uart2_clk_src_sel;
    } else if ((hw) == &UART3) {
        sel_value = HP_SYS_CLKRST.uart3_ctrl0.reg_uart3_clk_src_sel;
    }
    if ((hw) != &LP_UART) {
        switch (sel_value) {
        default:
        ...
        case 0:
            *source_clk = (soc_module_clk_t)UART_SCLK_XTAL;
            break;
        case 2:
            *source_clk = (soc_module_clk_t)UART_SCLK_REF_F80M;
            break;
        }
    } else {
...
#undef DIV_UP
    ...
    if ((hw) == &UART0) {
        HAL_FORCE_MODIFY_U32_REG_FIELD(HP_SYS_CLKRST.uart0_ctrl0, reg_uart0_sclk_div_num, sclk_div - 1);
    } else if ((hw) == &UART1) {
        HAL_FORCE_MODIFY_U32_REG_FIELD(HP_SYS_CLKRST.uart1_ctrl0, reg_uart1_sclk_div_num, sclk_div - 1);
    } else if ((hw) == &UART2) {
        HAL_FORCE_MODIFY_U32_REG_FIELD(HP_SYS_CLKRST.uart2_ctrl0, reg_uart2_sclk_div_num, sclk_div - 1);
    } else if ((hw) == &UART3) {
        HAL_FORCE_MODIFY_U32_REG_FIELD(HP_SYS_CLKRST.uart3_ctrl0, reg_uart3_sclk_div_num, sclk_div - 1);
    } else {
        abort();
    }
    uart_ll_update(hw);
...
{
    if (hw == &UART0) {
        HP_ALIVE_SYS.hp_pad_uart0_ctrl.hp_pad_uart0_slp_clk_en = 1;
    } else if (hw == &UART1) {
        HP_ALIVE_SYS.hp_pad_uart1_ctrl.hp_pad_uart1_slp_clk_en = 1;
    } else if (hw == &UART2) {
        HP_ALIVE_SYS.hp_pad_uart2_ctrl.hp_pad_uart2_slp_clk_en = 1;
    } else if ((hw) == &UART3) {
        HP_ALIVE_SYS.hp_pad_uart3_ctrl.hp_pad_uart3_slp_clk_en = 1;
    }
}
