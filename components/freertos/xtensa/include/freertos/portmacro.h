...
#define portGET_ARGUMENT_COUNT(...) GET_11TH_ARG( 42,##__VA_ARGS__ , 9,8,7,4,5,4,3,2,1,0)
...
_Static_assert(portGET_ARGUMENT_COUNT(1,1) == 2, "portGET_ARGUMENT_COUNT() result does not match for 2 arguments");
