...
#define PARLIO_LL_RX_MAX_BYTES_PER_FRAME (PARL_IO_RX_BITLEN_V / 8)
#define PARLIO_LL_RX_MAX_CLK_INT_DIV     (HP_SYS_CLKRST_REG_PARLIO_RX_CLK_DIV_NUM_V + 1)
#define PARLIO_LL_RX_MAX_CLK_FRACT_DIV   (HP_SYS_CLKRST_REG_PARLIO_RX_CLK_DIV_DENOMINATOR_V + 1)
#define PARLIO_LL_RX_MAX_TIMEOUT         PARL_IO_RX_TIMEOUT_THRES_V

#define PARLIO_LL_TX_MAX_BITS_PER_FRAME  PARL_IO_TX_BITLEN_V
#define PARLIO_LL_TX_MAX_CLK_INT_DIV     (HP_SYS_CLKRST_REG_PARLIO_TX_CLK_DIV_NUM_V + 1)
#define PARLIO_LL_TX_MAX_CLK_FRACT_DIV   (HP_SYS_CLKRST_REG_PARLIO_TX_CLK_DIV_DENOMINATOR_V + 1)
...
#define PARLIO_LL_TX_VALID_MAX_START_DELAY  PARL_IO_TX_CS_START_DELAY_V
#define PARLIO_LL_TX_VALID_MAX_STOP_DELAY   PARL_IO_TX_CS_STOP_DELAY_V
#ifdef __cplusplus
extern "C" {
#endif
...
{
    (void)group_id;
    HP_SYS_CLKRST.parlio_ctrl0.reg_parlio_sys_clk_en = enable;
    HP_SYS_CLKRST.parlio_ctrl0.reg_parlio_apb_clk_en = enable;
}
...
{
    (void)group_id;
    HP_SYS_CLKRST.parlio_ctrl0.reg_parlio_rst_en = 1;
    HP_SYS_CLKRST.parlio_ctrl0.reg_parlio_rst_en = 0;
}
...
static inline void _parlio_ll_rx_set_clock_source(parl_io_dev_t *dev, parlio_clock_source_t src)
{
    ...
    HP_ALIVE_SYS.hp_pad_parlio_ctrl.hp_pad_parlio_rx_clk_en = (src == PARLIO_CLK_SRC_EXTERNAL);
    HP_SYS_CLKRST.parlio_rx_ctrl0.reg_parlio_rx_clk_src_sel = clk_sel;
}
...
static inline void parlio_ll_rx_set_clock_div(parl_io_dev_t *dev, const hal_utils_clk_div_t *clk_div)
{
    ...
    HAL_FORCE_MODIFY_U32_REG_FIELD(HP_SYS_CLKRST.parlio_rx_ctrl0, reg_parlio_rx_clk_div_num, clk_div->integer - 1);
    HAL_FORCE_MODIFY_U32_REG_FIELD(HP_SYS_CLKRST.parlio_rx_ctrl0, reg_parlio_rx_clk_div_denominator, clk_div->denominator);
    HAL_FORCE_MODIFY_U32_REG_FIELD(HP_SYS_CLKRST.parlio_rx_ctrl0, reg_parlio_rx_clk_div_numerator, clk_div->numerator);
}
...
{
    (void)dev;
    HP_SYS_CLKRST.parlio_rx_ctrl0.reg_parlio_rx_rst_en = 1;
    HP_SYS_CLKRST.parlio_rx_ctrl0.reg_parlio_rx_rst_en = 0;
}
...
{
    (void)dev;
    HP_SYS_CLKRST.parlio_rx_ctrl0.reg_parlio_rx_clk_en = en;
}
