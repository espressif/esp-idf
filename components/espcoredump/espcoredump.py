...
def main():
    ...
    parser_debug_coredump.add_argument('--off', '-o', help='Offset of coredump partition in flash (type "make partition_table" to see).', type=lambda x: int(x, 0), default=0x110000)
    ...
    parser_info_coredump.add_argument('--off', '-o', help='Offset of coredump partition in flash (type "make partition_table" to see).', type=lambda x: int(x, 0), default=0x110000)
