...
/**
 * This class defines a custom Spinel transport using
 * esp_openthread_transport_config_t (HDLC-framed).
 *
 */
class CustomSpinelInterface : public ot::Spinel::SpinelInterface {
public:
    /**
     * @brief   This constructor of object.
     */
    CustomSpinelInterface(void);
     ...
     */
    esp_err_t Enable(const esp_openthread_transport_config_t &transport_config);
...
private:
    ...
    esp_openthread_transport_config_t m_transport_cfg;

    int m_notify_fd;

    otRcpInterfaceMetrics mInterfaceMetrics;

    CustomSpinelInterface(const CustomSpinelInterface &);
    CustomSpinelInterface &operator=(const CustomSpinelInterface &);
