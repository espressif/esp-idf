...
/**
 * @brief Ethernet DMA Transmit descriptor Word 0 (TDES0) (status/control)
 *
 */
typedef union {
    struct {
...
/**
 * @brief Ethernet DMA Transmit descriptor Word 1 (TDES1)
 *
 */
typedef union {
    struct {
...
*/
typedef struct {
    volatile eth_dma_tdes0_t TDES0;        /*!< Transmit descriptor Word 0 (TDES0) */
    volatile eth_dma_tdes1_t TDES1;        /*!< Transmit descriptor Word 1 (TDES1) */
    ...
    volatile uint32_t TimeStampLow;        /*!< Transmit Frame Timestamp Low */
    volatile uint32_t TimeStampHigh;       /*!< Transmit Frame Timestamp High */
...
/**
 * @brief Ethernet DMA Receive descriptor Word 0 (RDES0) (status)
 *
 */
typedef union {
    struct {
...
/**
 * @brief Ethernet DMA Receive descriptor Word 1 (RDES1)
 *
 */
typedef union {
    struct {
...
/**
 * @brief Ethernet DMA Receive descriptor Word 4 (RDES4) (extended status)
 *
 */
typedef union {
    struct {
...
*/
typedef struct {
    volatile eth_dma_rdes0_t RDES0;           /*!< Receive descriptor Word 0 (RDES0) (status) */
    volatile eth_dma_rdes1_t RDES1;           /*!< Receive descriptor Word 1 (RDES1) */
    volatile uint32_t Buffer1Addr;            /*!< Buffer1 address pointer */
    volatile uint32_t Buffer2NextDescAddr;    /*!< Buffer2 or next descriptor address pointer */
    volatile eth_dma_rdes4_t ExtendedStatus;  /*!< Receive descriptor Word 4 (RDES4) (extended status) */
    volatile uint32_t Reserved;               /*!< Reserved */
    volatile uint32_t TimeStampLow;           /*!< Receive frame timestamp low */
    volatile uint32_t TimeStampHigh;          /*!< Receive frame timestamp high */
