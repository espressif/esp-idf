...
/**
 * @brief Select the clock source for temperature sensor. On ESP32-H21, temperature sensor
 *        can use XTAL or RC_FAST. Suggest using XTAL for better accuracy.
 *
...
{
    return 0; // IDF-15912: eFuse calibration layout not available yet
}
