...
TEST_CASE("uart software flow control (XON/XOFF)", "[uart_flow_ctrl]")
{
    ...
    if (is_hp_uart) {
        ...
        rx_pin = uart_periph_signal[CONFIG_CONSOLE_UART_NUM].pins[SOC_UART_RX_PIN_IDX].default_gpio;
    ...
    const int console_tx_pin = uart_periph_signal[CONFIG_CONSOLE_UART_NUM].pins[SOC_UART_TX_PIN_IDX].default_gpio;
    const int console_tx_signal = uart_periph_signal[CONFIG_CONSOLE_UART_NUM].pins[SOC_UART_TX_PIN_IDX].signal;
    const int uart_tx_signal = uart_periph_signal[uart_num].pins[SOC_UART_TX_PIN_IDX].signal;
