...
#define LEDC_LL_DUTY_CHANGE_END_INTR_MASK(speed_mode)  ((speed_mode) == LEDC_LOW_SPEED_MODE ? (0xffUL << LEDC_DUTY_CHNG_END_LSCH0_INT_ENA_S) : (0xffUL << LEDC_DUTY_CHNG_END_HSCH0_INT_ENA_S))

#define LEDC_LL_EVENT_CHANNEL_DUTY_CHANGE_END(speed_mode, channel)  ((speed_mode) == LEDC_LOW_SPEED_MODE ? BIT(LEDC_DUTY_CHNG_END_LSCH0_INT_ENA_S + (channel)) : BIT(LEDC_DUTY_CHNG_END_HSCH0_INT_ENA_S + (channel)))
#define LEDC_LL_EVENT_CHANNEL_MASK(speed_mode, channel)             (LEDC_LL_EVENT_CHANNEL_DUTY_CHANGE_END(speed_mode, channel))
