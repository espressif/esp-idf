...
static inline void gpio_ll_pullup_dis(gpio_dev_t *hw, uint32_t gpio_num)
{
    ...
    // Note that esp32h21 has supported USB_EXCHG_PINS feature. If this efuse is burnt, the gpio pin
...
{
    *status = 0; // Less than 32 GPIOs in ESP32-H21
}
...
{
    // Less than 32 GPIOs on ESP32-H21 Do nothing.
}
