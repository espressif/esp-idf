...
static void test_gdma_crc_calculation(gdma_channel_handle_t tx_chan, gdma_channel_handle_t rx_chan, int test_num_crc_algorithm)
{
    ...
    static const char test_input_string[] __attribute__((aligned(SOC_AXI_DMA_EXT_MEM_ENC_ALIGNMENT))) = "GDMACRC::TEST::LONGSTRING::REPEAT::GDMACRC::TEST::LONGSTRING::REPEAT::GDMACRC::TEST::LONGSTRING::REPEAT::GDMACRC::TEST::LONGSTRING::REPEAT::END!";
    size_t input_data_size = strlen(test_input_string);
    TEST_ASSERT_EQUAL((uintptr_t)test_input_string % SOC_AXI_DMA_EXT_MEM_ENC_ALIGNMENT, 0);
