...
esp_err_t sleep_clock_system_retention_init(void *arg)
{
    ...
    const static sleep_retention_entries_config_t pcr_regs_retention[] = {
        ...
        [10] = { .config = REGDMA_LINK_WAIT_INIT     (REGDMA_PCR_LINK(10),  DS_QUERY_BUSY_REG,          0,                              DS_QUERY_BUSY_M,                1, 0), .owner = ENTRY(0) | ENTRY(2) },
        [11] = { .config = REGDMA_LINK_WAIT_INIT     (REGDMA_PCR_LINK(11),  ECDSA_STATE_REG,            0,                              ECDSA_BUSY_M,                   1, 0), .owner = ENTRY(0) | ENTRY(2) },
        [12] = { .config = REGDMA_LINK_ADDR_MAP_INIT(REGDMA_PCR_LINK(12), PCR_DS_CONF_REG, PCR_DS_CONF_REG, 2, 0, 0,
