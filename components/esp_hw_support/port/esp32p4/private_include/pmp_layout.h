...
/* rev < 3.0: 3..14 are application-owned (SRAM/flash/LP-RAM split). */
#define PMP_ENTRY_PERIPHERAL_REV_LESS_THAN_V3     15  /* NAPOT RW */
...
ESP_STATIC_ASSERT(PMP_ENTRY_PERIPHERAL_REV_LESS_THAN_V3 == 15,
               "rev < 3.0 peripheral entry is locked by shipped bootloaders and must never move");
