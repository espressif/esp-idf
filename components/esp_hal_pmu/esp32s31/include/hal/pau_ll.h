...
// The LL layer for ESP32-S31 PAU(Power Assist Unit) register operations
...
{
    if (enable) {
        HP_SYS_CLKRST.regdma_ctrl0.reg_regdma_sys_clk_en = 1;
        HP_SYS_CLKRST.regdma_ctrl0.reg_regdma_rst_en = 0;
    } else {
        HP_SYS_CLKRST.regdma_ctrl0.reg_regdma_sys_clk_en = 0;
        HP_SYS_CLKRST.regdma_ctrl0.reg_regdma_rst_en = 1;
    }
}
