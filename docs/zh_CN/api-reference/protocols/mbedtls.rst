...
.. code-block:: c
    ...
    static psa_status_t my_set(void *ctx, psa_storage_uid_t uid,
    ...
    static psa_status_t my_get(void *ctx, psa_storage_uid_t uid,
    ...
    static psa_status_t my_get_info(void *ctx, psa_storage_uid_t uid,
                                    struct psa_storage_info_t *p_info)
    {
        /* 返回 uid 对应 blob 的大小和标志位 */
    }

    static psa_status_t my_remove(void *ctx, psa_storage_uid_t uid)
    {
        /* 删除 uid 对应的 blob */
    }
