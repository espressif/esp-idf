...
.. only:: esp32c61
    ...
    对于 {IDF_TARGET_NAME}，可以使用 `ESP32-C61-DevKitC-1 <https://docs.espressif.com/projects/espressif-esp-dev-kits/en/latest/esp32c61/esp32-c61-devkitc-1/index.html>`__ 等开发板。这些开发板配有排针，可以用来测量模组的功耗。
