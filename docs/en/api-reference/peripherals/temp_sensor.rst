...
.. note::
    ...
    The temperature sensor is mainly used to measure the **internal** temperature variations of the chip and is not recommended for use as an ambient temperature sensor. The temperature readings can be used to monitor temperature trends, but they do not provide accurate absolute temperature values.
