...
To configure an ESP-IDF project in CLion, follow the `Working with ESP-IDF in CLion <https://developer.espressif.com/blog/clion/#configuring-an-esp-idf-project>`__ tutorial. It explains the current approach to working with ESP-IDF projects in the IDE. The tutorial provides detailed instructions on how to configure a project, build an application, flash it to a board, and debug it. There is also `CLion's ESP-IDF documentation <https://www.jetbrains.com/help/clion/esp-idf.html#cmake-setup>`__, which will soon be updated.
