...
#define EXAMPLE_LCD_COLOR_FORMAT ESP_COLOR_FOURCC_RGB16
#elif CONFIG_EXAMPLE_LCD_DATA_LINES_24
#define EXAMPLE_LCD_COLOR_FORMAT ESP_COLOR_FOURCC_BGR24
#else
#error "Unsupported LCD data lines"
#endif
...
static void s_srm_ops(void *in_buf, void **out_buf, size_t buf_size, esp_lcd_panel_handle_t panel_handle, ppa_client_handle_t ppa_srm_handle, void *clear_buf)
{
    ppa_srm_oper_config_t srm_config = {
        .in = {
            .buffer = in_buf,
            .pic_w = EXAMPLE_IMAGE_W,
            .pic_h = EXAMPLE_IMAGE_H,
            .block_w = EXAMPLE_IMAGE_W,
        ...
        .out = {
            ...
            .block_offset_x = 0,
            .block_offset_y = 0,
            .srm_cm = (ppa_srm_color_mode_t)EXAMPLE_LCD_COLOR_FORMAT,
        },
    ...
    for (int i = 0; i < 3; i++) {
        ...
        ESP_ERROR_CHECK(esp_lcd_panel_draw_bitmap(panel_handle, 0, 0, EXAMPLE_IMAGE_W * size_mul[i], EXAMPLE_IMAGE_H * size_mul[i], out_buf[buffer_cnt]));
        vTaskDelay(800 / portTICK_PERIOD_MS);
        ESP_ERROR_CHECK(esp_lcd_panel_draw_bitmap(panel_handle, 0, 0, EXAMPLE_IMAGE_W * size_mul[i], EXAMPLE_IMAGE_H * size_mul[i], clear_buf));
        srm_config.in.srm_cm = srm_config.out.srm_cm;
    ...
    ESP_ERROR_CHECK(ppa_do_scale_rotate_mirror(ppa_srm_handle, &srm_config));
    ESP_ERROR_CHECK(esp_lcd_panel_draw_bitmap(panel_handle, 0, 0, EXAMPLE_IMAGE_H * 1.5, EXAMPLE_IMAGE_W * 1.5, out_buf[buffer_cnt]));
    vTaskDelay(800 / portTICK_PERIOD_MS);
    ESP_ERROR_CHECK(esp_lcd_panel_draw_bitmap(panel_handle, 0, 0, EXAMPLE_IMAGE_H * 1.5, EXAMPLE_IMAGE_W * 1.5, clear_buf));
    ...
    ESP_ERROR_CHECK(ppa_do_scale_rotate_mirror(ppa_srm_handle, &srm_config));
    ESP_ERROR_CHECK(esp_lcd_panel_draw_bitmap(panel_handle, 0, 0, EXAMPLE_IMAGE_W * 1.5, EXAMPLE_IMAGE_H * 1.5, out_buf[buffer_cnt]));
    vTaskDelay(800 / portTICK_PERIOD_MS);
    ESP_ERROR_CHECK(esp_lcd_panel_draw_bitmap(panel_handle, 0, 0, EXAMPLE_IMAGE_W * 1.5, EXAMPLE_IMAGE_H * 1.5, clear_buf));
    ...
    ESP_ERROR_CHECK(ppa_do_scale_rotate_mirror(ppa_srm_handle, &srm_config));
    ESP_ERROR_CHECK(esp_lcd_panel_draw_bitmap(panel_handle, 0, 0, EXAMPLE_IMAGE_W, EXAMPLE_IMAGE_H, out_buf[buffer_cnt]));
    vTaskDelay(800 / portTICK_PERIOD_MS);
    ESP_ERROR_CHECK(esp_lcd_panel_draw_bitmap(panel_handle, 0, 0, EXAMPLE_IMAGE_W, EXAMPLE_IMAGE_H, clear_buf));
}

static void s_blend_ops(void *bg_buf, void *fg_buf, void *out_buf, size_t buf_size, esp_lcd_panel_handle_t panel_handle, ppa_client_handle_t ppa_blend_handle, void *clear_buf)
{
    ...
    ppa_blend_oper_config_t blend_config = {
        .in_bg = {
            ...
            .block_offset_x = 0,
            .block_offset_y = 0,
            .blend_cm = PPA_SRM_COLOR_MODE_RGB565,
        },
        .in_fg = {
            .buffer = fg_buf,
            .pic_w = EXAMPLE_IMAGE_W,
        ...
        .out = {
            ...
            .block_offset_x = 0,
            .block_offset_y = 0,
            .blend_cm = (ppa_blend_color_mode_t)EXAMPLE_LCD_COLOR_FORMAT,
        },
    ...
    ESP_ERROR_CHECK(esp_lcd_panel_draw_bitmap(panel_handle, 0, 0, EXAMPLE_IMAGE_W, EXAMPLE_IMAGE_H, out_buf));
    vTaskDelay(800 / portTICK_PERIOD_MS);
    ESP_ERROR_CHECK(esp_lcd_panel_draw_bitmap(panel_handle, 0, 0, EXAMPLE_IMAGE_W, EXAMPLE_IMAGE_H, clear_buf));
...
static void s_fill_ops(void *out_buf, size_t buf_size, esp_lcd_panel_handle_t panel_handle, ppa_client_handle_t ppa_fill_handle)
{
    int buffer_cnt = 0;
    ppa_fill_oper_config_t fill_config = {
        .out = {
            ...
            .block_offset_x = 0,
            .block_offset_y = 20,
            .fill_cm = (ppa_fill_color_mode_t)EXAMPLE_LCD_COLOR_FORMAT,
        },
        .fill_block_w = 10,
        .fill_block_h = 200,
        .fill_argb_color = {
...
void app_main(void)
{
    ...
    s_srm_ops(pixels, (void **)out_buf, out_buf_size, panel_handle, ppa_srm_handle, clear_buf);
    ...
    s_blend_ops(pixels, fg_buf, out_buf[0], out_buf_size, panel_handle, ppa_blend_handle, clear_buf);
    ...
    s_fill_ops(out_buf[0], out_buf_size, panel_handle, ppa_fill_handle);
    ...
    ESP_ERROR_CHECK(example_rgb_panel_deinit(panel_handle));
}
