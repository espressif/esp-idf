...
This example is demonstrating how to set up ESP32-S2 chip to work as a Mass storage class USB Device. You can specify a manufacturer, device's name, ID and other USB-devices parameters responsible for identification by host.
...
I (328) TUSB:descriptors_control: Setting of a descriptor: 
.bDeviceClass       = 0
.bDeviceSubClass    = 0,
.bDeviceProtocol    = 0,
.bMaxPacketSize0    = 64,
...
I (358) example: USB initialization DONE
I (368) example: USB task started
