...
This example is able to run on any commonly available ESP32 and ESP32-S31 development board, and is supposed to connect to [A2DP sink example](../a2dp_sink_stream) in ESP-IDF.
