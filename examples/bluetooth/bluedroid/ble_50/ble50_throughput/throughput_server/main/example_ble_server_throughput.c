...
static uint8_t ext_adv_raw_data[] = {
        0x02, BT_AD_TYPE_FLAGS, 0x06,
        0x02, BT_AD_TYPE_TX_POWER_LEVEL, 0xeb,
        0x03, BT_AD_TYPE_SERVICE_LIST_16BITS_COMPLETE, 0xab, 0xcd,
        0x11, BT_AD_TYPE_SERVICE_LIST_128BITS_COMPLETE, 0xfb, 0x34, 0x9b, 0x5f, 0x80, 0x00, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, 0xEE, 0x00, 0x00, 0x00,
        0x11, BT_AD_TYPE_SERVICE_LIST_128BITS_COMPLETE, 0xfb, 0x34, 0x9b, 0x5f, 0x80, 0x00, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, 0xFF, 0x00, 0x00, 0x00,
        0x14, BT_AD_TYPE_LOCAL_NAME_COMPLETE, 'T', 'H', 'R', 'O', 'U', 'G', 'H', 'P', 'U', 'T', '_', 'P', 'H', 'Y', '_', 'D', 'E', 'M', 'O',
};
