...
static uint8_t dev_uuid[16] = { 0xec, 0xa6 };
...
static esp_ble_mesh_cfg_srv_t config_server = {
    ...
    .net_transmit = ESP_BLE_MESH_TRANSMIT(3, 10),
...
static esp_ble_mesh_model_op_t test_op[] = {
    ESP_BLE_MESH_MODEL_OP(ESP_BLE_MESH_VND_MODEL_OP_TEST_SEND, 2),
...
static esp_ble_mesh_model_t vnd_models[] = {
    ESP_BLE_MESH_VENDOR_MODEL(CID_ESP, ESP_BLE_MESH_VND_MODEL_ID_TEST_SRV,
    test_op, NULL, NULL),
};
                                              ...
                                              esp_ble_mesh_cfg_server_cb_param_t *param)
{
    if (event == ESP_BLE_MESH_CFG_SERVER_STATE_CHANGE_EVT) {
        ...
        case ESP_BLE_MESH_MODEL_OP_MODEL_APP_BIND:
            ...
            config_server.net_transmit = ESP_BLE_MESH_TRANSMIT(2, 80);
            break;
                                             ...
                                             esp_ble_mesh_model_cb_param_t *param)
{
    ...
    case ESP_BLE_MESH_MODEL_SEND_COMP_EVT:
        ESP_LOGI(TAG, "send %d", param->model_send_comp.err_code);
        break;
