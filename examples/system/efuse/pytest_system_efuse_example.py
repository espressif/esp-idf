...
@pytest.mark.generic
@idf_parametrize('target', ['esp32', 'esp32c2', 'esp32c3'], indirect=['target'])
...
@idf_parametrize(
    'target', ['esp32', 'esp32c2', 'esp32c3', 'esp32c6', 'esp32h2', 'esp32s2', 'esp32s3'], indirect=['target']
)
...
@pytest.mark.parametrize('skip_autoflash', ['y'], indirect=True)
@idf_parametrize(
    'target', ['esp32c3', 'esp32c2', 'esp32c6', 'esp32h2', 'esp32p4', 'esp32s2', 'esp32s3'], indirect=['target']
)
...
@idf_parametrize('target', ['esp32c3', 'esp32c2', 'esp32c6', 'esp32h2', 'esp32s2', 'esp32s3'], indirect=['target'])
